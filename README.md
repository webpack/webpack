...
- [CATEGORY TOWER DEFENSE118](https://iskillquest.pages.dev/category-tower-defense118.html)
...
- [KICK LOSER](https://thelearnquester.web.app/kick-loser.html)
- [MAD TRUCK](https://studyquests.pages.dev/mad-truck.html)
...
- [ENERGY CLICKER](https://theskillquest.pages.dev/energy-clicker.html)
- [COLOSSATRON](https://studyquests.github.io/colossatron.html)
- [ITALIAN BRAINROT TUNG TUNG RACING](https://learnquester.pages.dev/italian-brainrot-tung-tung-racing.html)
- [BREAKTHROUGH TEAM](https://iskillquest.pages.dev/breakthrough-team.html)
...
- [MY PURRFECT CAT HOTEL](https://themindzone.pages.dev/my-purrfect-cat-hotel.html)
...
- [HOME RUN BOY](https://iskillplay.web.app/home-run-boy.html)
...
- [CATEGORY SIMULATION 2](https://skillplay.github.io/category-simulation-2.html)
- [THE BEST WARRIOR](https://skillplay.github.io/the-best-warrior.html)
...
- [SORT RESORT](https://themindplay.pages.dev/sort-resort.html)
- [METAL GUNS FURY](https://studyplaying.github.io/metal-guns-fury.html)
...
- [FARM OF WORDS](https://themindplay.github.io/farm-of-words.html)
...
- [BLIND BOAT SHOOTING MASTER](https://themindzone.pages.dev/blind-boat-shooting-master.html)
- [COLOR NUTS BOLTS PUZZLE](https://quizverses.pages.dev/color-nuts-bolts-puzzle.html)
...
- [WORD RIVERS](https://themindskillplayplay.pages.dev/word-rivers.html)
...
- [PAINT IT](https://iskillquest.pages.dev/paint-it.html)
...
- [ITALIAN BRAINROT SURVIVAL ARENA](https://thequizzone.pages.dev/italian-brainrot-survival-arena.html)
- [BULLET SUPERHERO](https://iskillplay.web.app/bullet-superhero.html)
- [AQUA SORT WATER COLOR PUZZLE](https://studyplaying.github.io/aqua-sort-water-color-puzzle.html)
- [STRONGBLADE](https://iskillplay.web.app/strongblade.html)
...
- [POPCORN STACK](https://themindplay.github.io/popcorn-stack.html)
