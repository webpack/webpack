...
If you're just getting started, take a look at [our new docs and concepts page](https://webpack.js.org/concepts/). This has a high level overview that is great for beginners!! You can also check out [minipack](https://github.com/ronami/minipack) which is a detailed explanation of how a simple module bundler works.
