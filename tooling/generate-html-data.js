...
// A `<body>` start tag stays when one of these opens the body: the parser would
// read it as head content and move it out (§13.1.2.4).
const BODY_START_KEPT_BEFORE = ["meta", "link", "script", "style", "template"];
