...
import { Server as ServerImportHttps, ServerOptions as ServerOptionsImportHttps } from "https"
import { Session as SessionImportInspectorClass_1, Session as SessionImportInspectorClass_2 } from "inspector"
...
type AfterContextResolveData = (ContextResolveData & ContextOptions & { resource: (string | (string)[]); resourceQuery?: (string); resourceFragment?: (string); resolveDependencies: (( fs: InputFileSystem, options: ContextModuleOptions, callback: (( err: (null | Error), dependencies?: ((ContextElementDependency)[])) => void)) => void) });
...
type AnyLoaderContext = (NormalModuleLoaderContext<any> & LoaderRunnerLoaderContext<any> & LoaderPluginLoaderContext & HotModuleReplacementPluginLoaderContext);
 ...
 */
generateError( error: Error, module: NormalModule, generateContext: GenerateContext): (null | Source);
}
...
type AssetFilterItemTypes = (string | RegExp | (( name: string, asset: StatsAsset) => (boolean)));
declare abstract class AssetGenerator extends Generator {
	dataUrlOptions?: (AssetGeneratorDataUrlOptions | (( source: (string | Buffer), context: { filename: string; module: Module }) => string));
...
type AssetGeneratorOptions = (AssetInlineGeneratorOptions & AssetResourceGeneratorOptions);
 ...
 */
dataUrl?: (AssetGeneratorDataUrlOptions | (( source: (string | Buffer), context: { filename: string; module: Module }) => string));
}
type AssetModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownNormalModuleBuildInfo & KnownAssetModuleBuildInfo);
declare abstract class AssetParser extends ParserClass {
	dataUrlCondition?: (boolean | AssetParserDataUrlOptions | (( source: (string | Buffer), context: { filename: string; module: Module }) => (boolean)));
}
 ...
 */
dataUrlCondition?: (AssetParserDataUrlOptions | (( source: (string | Buffer), context: { filename: string; module: Module }) => (boolean)));
}
...
declare class AsyncDependenciesBlock extends DependenciesBlock {
	constructor( groupOptions: (null | string | GroupOptionsAsyncDependenciesBlock), loc?: (null | SyntheticDependencyLocation | RealDependencyLocation), request?: (null | string));
...
declare abstract class AsyncQueue<T, K, R> {
	hooks: { beforeAdd: AsyncSeriesHook<[T]>; added: SyncHook<[T]>; beforeStart: AsyncSeriesHook<[T]>; started: SyncHook<[T]>; result: SyncHook<[T, (undefined | null | WebpackError), (undefined | null | R)]> };
 ...
 */
banner: (string | (( data: { hash?: (string); chunk: Chunk; filename: string }) => string));
 ...
 */
asCompileTimeValue( ): (undefined | null | string | number | bigint | boolean | RegExp | (any)[]);
	isTruthy( ): (boolean);
	isFalsy( ): (boolean);
 ...
 */
setIdentifier( identifier: (string | VariableInfo), rootInfo: (string | VariableInfo), getMembers: (( ) => (string)[]), getMembersOptionals?: ((( ) => ((boolean))[])), getMemberRanges?: ((( ) => ([number, number])[]))): BasicEvaluatedExpression;
	
/**
 * Wraps an array of expressions with a prefix and postfix expression.
 */
setWrapped( prefix?: (null | BasicEvaluatedExpression), postfix?: (null | BasicEvaluatedExpression), innerExpressions?: ((BasicEvaluatedExpression)[])): BasicEvaluatedExpression;
 ...
 */
setTemplateString( quasis: (BasicEvaluatedExpression)[], parts: (BasicEvaluatedExpression)[], kind: ("cooked" | "raw")): BasicEvaluatedExpression;
...
type BufferEncoding = ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex");
 ...
 */
constructor( );
	hooks: { get: AsyncSeriesBailHook<[string, (null | Etag), (GotHandler<any>)[]], any>; store: AsyncParallelHook<[string, (null | Etag), any]>; storeBuildDependencies: AsyncParallelHook<[Iterable<string>]>; beginIdle: SyncHook<[]>; endIdle: AsyncParallelHook<[]>; shutdown: AsyncParallelHook<[]> };
 ...
 * Returns value.
 */
get<T>( identifier: string, etag: (null | Etag), callback: CallbackCacheCacheFacade<T>): void;
 ...
 */
store<T>( identifier: string, etag: (null | Etag), data: T, callback: CallbackCacheCacheFacade<void>): void;
 ...
 * Processes the provided identifier.
 */
provide<T>( identifier: string, etag: (null | Etag), computer: (( callback: CallbackNormalErrorCache<T>) => void), callback: CallbackNormalErrorCache<T>): void;
...
declare interface CacheGroupSource {
	...
	filename?: (string | (( pathData: PathDataChunk, assetInfo?: (AssetInfo)) => string));
	idHint?: (string);
 ...
 */
getChildIdsByOrders( chunkGraph: ChunkGraph, filterFn?: ((( c: Chunk, chunkGraph: ChunkGraph) => (boolean)))): Record<string, (ChunkId)[]>;
	
/**
 * Gets children of type in order.
 */
getChildrenOfTypeInOrder( chunkGraph: ChunkGraph, type: string): (undefined | (ChunkChildOfTypeInOrder)[]);
	
/**
 * Gets child ids by orders map.
 */
getChildIdsByOrdersMap( chunkGraph: ChunkGraph, includeDirectChildren?: (boolean), filterFn?: ((( c: Chunk, chunkGraph: ChunkGraph) => (boolean)))): ChunkChildIdsByOrdersMapByData;
...
type ChunkFilenameTemplate = (string | (( pathData: PathDataChunk, assetInfo?: (AssetInfo)) => string));
 ...
 */
getOrderedModuleChunksIterable( module: Module, sortFn: (( a: Chunk, b: Chunk) => (0 | 1 | -1))): Iterable<Chunk>;
 ...
 */
setChunkModuleSourceTypes( chunk: Chunk, module: Module, sourceTypes: ReadonlySet<string>): void;
 ...
 */
getOrderedChunkModulesIterable( chunk: Chunk, comparator: (( a: Module, b: Module) => (0 | 1 | -1))): Iterable<Module>;
	
/**
 * Gets ordered chunk modules iterable by source type.
 */
getOrderedChunkModulesIterableBySourceType( chunk: Chunk, sourceType: string, comparator: (( a: Module, b: Module) => (0 | 1 | -1))): (undefined | Iterable<Module>);
 ...
 */
getOrderedChunkModules( chunk: Chunk, comparator: (( a: Module, b: Module) => (0 | 1 | -1))): (Module)[];
 ...
 */
getChunkModuleRenderedHashMap( chunk: Chunk, filterFn: (( m: Module) => (boolean)), hashLength?: number, includeAllChunks?: (boolean)): ChunkModuleHashMap;
	
/**
 * Gets chunk condition map.
 */
getChunkConditionMap( chunk: Chunk, filterFn: (( c: Chunk, chunkGraph: ChunkGraph) => (boolean))): ChunkConditionMap;
 ...
 */
getChildOrderOptions( childGroup: ChunkGroup, chunkGraph: ChunkGraph): Record<string, number>;
 ...
 */
contentHashWithDigest?: (Record<string, (( digest: string, length?: (number)) => string)>);
}
...
declare interface CodeGenMapOverloads {
	...
	set: (<K extends string>( key: K, value: CodeGenValue<K>) => CodeGenerationResultData);
	has: (<K extends string>( key: K) => (boolean));
	delete: (<K extends string>( key: K) => (boolean));
}
type CodeGenValue<K extends string> = (K extends ("filename" | "assetInfo" | "share-init" | "topLevelDeclarations" | "freeNames" | "chunkInitFragments" | "url" | "fullContentHash") ? (AllCodeGenerationSchemas)[K] : any);
...
type CodeGenerationResultData = (Omit<Map<string, any>, ("get" | "set" | "has" | "delete")> & CodeGenMapOverloads);
 ...
 */
getRuntimeRequirements( module: Module, runtime: RuntimeSpec): (null | ReadonlySet<string>);
...
type CodeValue = (undefined | null | string | number | bigint | boolean | Function | RegExp | RuntimeValue | { [index: string]: RecursiveArrayOrRecord<(undefined | null | string | number | bigint | boolean | Function | RegExp | RuntimeValue)> } | (RecursiveArrayOrRecord<(undefined | null | string | number | bigint | boolean | Function | RegExp | RuntimeValue)>)[]);
type CodeValuePrimitive = (undefined | null | string | number | bigint | boolean | Function | RegExp);
...
type CommentJavascriptParser = (CommentImport & { start: number; end: number; loc: SourceLocation });
 ...
 */
factorizeModule( options: (FactorizeModuleOptions & { factoryResult?: (false) }), callback: (( err?: (null | WebpackError), result?: (null | Module)) => void)): void;
 ...
 */
factorizeModule( options: (FactorizeModuleOptions & { factoryResult: true }), callback: (( err?: (null | WebpackError), result?: (null | ModuleFactoryResult)) => void)): void;
 ...
 */
contextInfo?: (Partial<ModuleFactoryCreateDataContextInfo>) }, callback: (( err?: (null | WebpackError), result?: (null | Module)) => void)): void;
 ...
 * chunkGraphEntries
 */
chunkGraphEntries?: (Iterable<Chunk>) }): void;
 ...
 */
updateAsset( file: string, newSourceOrFunction: (Source | (( source: Source) => Source)), assetInfoUpdateOrFunction?: (AssetInfo | (( assetInfo?: (AssetInfo)) => (undefined | AssetInfo)))): void;
 ...
 */
getPath<T extends PathData = PathData>( filename: (string | TemplatePathFn<T>), data?: (T)): string;
	
/**
 * Gets path with info.
 */
getPathWithInfo<T extends PathData = PathData>( filename: (string | TemplatePathFn<T>), data?: (T)): InterpolatedPathAndAssetInfo;
	
/**
 * Returns interpolated path.
 */
getAssetPath<T extends PathData = PathData>( filename: (string | TemplatePathFn<T>), data: T): string;
	
/**
 * Gets asset path with info.
 */
getAssetPathWithInfo<T extends PathData = PathData>( filename: (string | TemplatePathFn<T>), data: T): InterpolatedPathAndAssetInfo;
	getWarnings( ): (Error)[];
	getErrors( ): (Error)[];
 ...
 */
createChildCompiler( name: string, outputOptions?: (Partial<OutputNormalized>), plugins?: (((undefined | null | false | "" | 0 | ((this: Compiler,  compiler: Compiler) => void) | WebpackPluginInstance))[])): Compiler;
	
/**
 * Processes the provided module.
 */
executeModule( module: Module, options: ExecuteModuleOptions, callback: (( err?: (null | WebpackError), result?: (null | ExecuteModuleResult)) => void)): void;
	checkConstraints( ): void;
 ...
 */
orderModules: SyncBailHook<[Chunk, (Module)[], Compilation], (undefined | void | (Module)[])>;
}
...
declare interface CompilationHooksJavascriptModulesPlugin {
	renderModuleContent: SyncWaterfallHook<[Source, Module, ModuleRenderContext], Source>;
	renderModuleContainer: SyncWaterfallHook<[Source, Module, ModuleRenderContext], Source>;
	renderModulePackage: SyncWaterfallHook<[Source, Module, ModuleRenderContext], Source>;
	renderChunk: SyncWaterfallHook<[Source, RenderContextJavascriptModulesPlugin], Source>;
	renderMain: SyncWaterfallHook<[Source, RenderContextJavascriptModulesPlugin], Source>;
	renderContent: SyncWaterfallHook<[Source, RenderContextJavascriptModulesPlugin], Source>;
	render: SyncWaterfallHook<[Source, RenderContextJavascriptModulesPlugin], Source>;
	renderStartup: SyncWaterfallHook<[Source, Module, StartupRenderContext], Source>;
	...
	embedInRuntimeBailout: SyncBailHook<[Module, RenderContextJavascriptModulesPlugin], (string | void)>;
	strictRuntimeBailout: SyncBailHook<[RenderContextJavascriptModulesPlugin], (string | void)>;
	chunkHash: SyncHook<[Chunk, Hash, ChunkHashContext]>;
	useSourceMap: SyncBailHook<[Chunk, RenderContextJavascriptModulesPlugin], (boolean | void)>;
}
...
createFileSerializer: (<D, S, C>( fs: IntermediateFileSystem, hashFunction: HashFunction) => Serializer<D, S, C>) }; cleverMerge: (<T, O>( first?: (null | T), second?: (null | O)) => (T | O | (T & O))); LazySet: typeof LazySet; compileBooleanMatcher: _functionCompileBooleanMatcher }>; sources: declarations; experiments: Readonly<{ schemes: Readonly<{ HttpUriPlugin: typeof HttpUriPlugin; VirtualUrlPlugin: typeof VirtualUrlPlugin }>; ids: Readonly<{ SyncModuleIdsPlugin: typeof SyncModuleIdsPlugin }> }> };
	...
	fileTimestamps?: (Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>);
	contextTimestamps?: (Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>);
	fsStartTime?: (number);
	resolverFactory: defaultResolverFactory;
 ...
 */
watch( watchOptions: WatchOptions, handler: CallbackWebpackFunction_2<Stats, void>): (undefined | Watching);
 ...
 */
runAsChild( callback: (( err: (null | Error), entries?: ((Chunk)[]), compilation?: (Compilation)) => void)): void;
	purgeInputFileSystem( ): void;
	
/**
 * Processes the provided compilation.
 */
emitAssets( compilation: Compilation, callback: (( err: (null | Error), result?: (void)) => void)): void;
 ...
 */
createChildCompiler( compilation: Compilation, compilerName: string, compilerIndex: number, outputOptions?: (Partial<OutputNormalized>), plugins?: (((undefined | null | false | "" | 0 | ((this: Compiler,  compiler: Compiler) => void) | WebpackPluginInstance))[])): Compiler;
	isChild( ): (boolean);
 ...
 */
validate<T extends (Parameters<typeof validateFunction>)[1] = object>( schema: ((JSONSchema4 & ExtendedSchema) | (JSONSchema6 & ExtendedSchema) | (JSONSchema7 & ExtendedSchema) | (( ) => (Parameters<typeof validateFunction>)[0])), value: T, options?: (ValidationErrorConfiguration), check?: ((( value: T) => (boolean)))): void;
}
...
type ConcatenatedModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownConcatenatedModuleBuildInfo);
 ...
 */
exportsTypeStrict?: ("namespace" | "default-only" | "default-with-named" | "dynamic");
	
/**
 * memoized getExportsType(strict=false)
 */
exportsTypeNonStrict?: ("namespace" | "default-only" | "default-with-named" | "dynamic");
}
 ...
 */
module?: (RegExp) } | (( warning: Error, compilation: Compilation) => (boolean))))[]);
 ...
 */
stats?: (boolean | StatsOptions | "verbose" | "none" | "summary" | "errors-only" | "errors-warnings" | "minimal" | "normal" | "detailed");
...
type ConnectionState = (boolean | typeof CIRCULAR_CONNECTION | typeof TRANSITIVE_ONLY);
declare class ConstDependency extends NullDependency {
	
/**
 * Creates an instance of ConstDependency.
 */
constructor( expression: string, range: (number | [number, number]), runtimeRequirements?: (null | (string)[]));
	expression: string;
...
type ContextMode = ("eager" | "weak" | "lazy" | "lazy-once" | "sync" | "async-weak");
type ContextModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownContextModuleBuildInfo);
declare abstract class ContextModuleFactory extends ModuleFactory {
	hooks: Readonly<{ beforeResolve: AsyncSeriesWaterfallHook<[BeforeContextResolveData], (false | void | BeforeContextResolveData)>; afterResolve: AsyncSeriesWaterfallHook<[AfterContextResolveData], (false | void | AfterContextResolveData)>; contextModuleFiles: SyncWaterfallHook<[(string)[]], (string)[]>; alternatives: FakeHook<Pick<AsyncSeriesWaterfallHook<[(ContextAlternativeRequest)[]], (ContextAlternativeRequest)[]>, ("name" | "tapAsync" | "tapPromise" | "tap")>>; alternativeRequests: AsyncSeriesWaterfallHook<[(ContextAlternativeRequest)[], ContextModuleOptions], (ContextAlternativeRequest)[]> }>;
	resolverFactory: defaultResolverFactory;
 ...
 */
constructor( resourceRegExp: RegExp, newContentResource?: (string | boolean | RegExp | (( context: (BeforeContextResolveData | AfterContextResolveData)) => void)), newContentRecursive?: (boolean | RegExp | NewContentCreateContextMap), newContentRegExp?: (RegExp));
...
type ContextTimestamp = (null | "ignore" | ContextFileSystemInfoEntry | ExistenceOnlyTimeEntryFileSystemInfo);
...
type CreateReadStreamFSImplementation = (FSImplementation & { read: (( ...args: (any)[]) => any) });
type CreateStatsOptionsContext = (KnownCreateStatsOptionsContext & Record<string, any>);
type CreateWriteStreamFSImplementation = (FSImplementation & { write: (( ...args: (any)[]) => any); close?: ((( ...args: (any)[]) => any)) });
type CreatedObject<T, F> = (T extends (ChunkGroupInfoWithName)[] ? Record<string, StatsChunkGroup> : (T extends (infer V)[] ? (StatsObject<V, F>)[] : StatsObject<T, F>));
 ...
 * Processes the provided module.
 */
sourceDependency( dependency: Dependency, source: ReplaceSource, templateContext: (DependencyTemplateContext & { cssData: CssData; type: string })): void;
	
/**
 * Processes the provided module.
 */
sourceModule( module: NormalModule, initFragments: (InitFragment<GenerateContext>)[], source: ReplaceSource, generateContext: (GenerateContext & { cssData: CssData })): void;
...
type CssModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownNormalModuleBuildInfo & KnownCssModuleBuildInfo);
type CssModuleBuildMeta = (KnownBuildMeta & Record<string, any> & KnownCssModuleBuildMeta);
 ...
 */
exportsConvention?: ("as-is" | "camel-case" | "camel-case-only" | "dashes" | "dashes-only" | (( name: string) => (string | (string)[])));
 ...
 */
getModulesInOrder( chunk: Chunk, modules: (undefined | Iterable<Module>), compilation: Compilation): (Module)[];
	
/**
 * Gets ordered chunk css modules.
 */
getOrderedChunkCssModules( chunk: Chunk, chunkGraph: ChunkGraph, compilation: Compilation): (CssModule)[];
 ...
 */
static renderModule( module: CssModule, renderContext: ChunkRenderContextCssModulesPlugin, hooks: CompilationHooksCssModulesPlugin): (null | Source);
	
/**
 * Gets chunk filename template.
 */
static getChunkFilenameTemplate( chunk: Chunk, outputOptions: OutputNormalizedWithDefaults): ChunkFilenameTemplate;
...
declare abstract class CssParser extends ParserClass {
	defaultMode: ("auto" | "global" | "local" | "pure");
	options: { 
/**
 * Enable/disable renaming of `@keyframes`.
 */
...
type DefineConfigInput = (Configuration | MultiConfiguration | (( env: Record<string, any>, argv: Record<string, any>) => MaybePromise<(Configuration | MultiConfiguration)>) | ((( env: Record<string, any>, argv: Record<string, any>) => MaybePromise<(Configuration | MultiConfiguration)>))[] | Promise<(Configuration | MultiConfiguration | (( env: Record<string, any>, argv: Record<string, any>) => MaybePromise<(Configuration | MultiConfiguration)>) | ((( env: Record<string, any>, argv: Record<string, any>) => MaybePromise<(Configuration | MultiConfiguration)>))[])>);
 ...
 */
static runtimeValue( fn: (( value: { module: NormalModule; key: string; readonly version: ValueCacheVersion }) => CodeValuePrimitive), options?: (true | (string)[] | RuntimeValueOptions)): RuntimeValue;
 ...
 */
serialize( __0: ObjectSerializerContextObjectMiddlewareObject_4): void;
 ...
 */
getCondition( moduleGraph: ModuleGraph): (null | false | (( moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState));
...
type DevtoolFallbackModuleFilenameTemplate = (string | (( context: ModuleFilenameTemplateContext) => string));
type DevtoolModuleFilenameTemplate = (string | (( context: ModuleFilenameTemplateContext) => string));
 ...
 */
sourceType?: ("commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "global" | "commonjs2" | "commonjs-module" | "amd" | "amd-require" | "umd" | "umd2" | "system"); 
/**
 ...
 */
type?: ("commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "global" | "commonjs2" | "commonjs-module" | "amd" | "amd-require" | "umd" | "umd2" | "system");
}
...
declare interface EffectUse {
	type: EffectUseType;
	value: { loader: string; options?: (null | string | Record<string, any>); ident?: (string) };
}
 ...
 */
constructor( context?: ("main" | "preload" | "renderer"), type?: ("import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url"));
	type: ExternalsType;
...
type EncodingOptionFs = (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | ObjectEncodingOptionsFs);
type EncodingOptionTypes = (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | ObjectEncodingOptionsTypes);
...
type EntryLibIndex = (string | (( ) => (string | EntryObject | (string)[] | Promise<EntryStatic>)) | EntryObject | (string)[]);
 ...
 */
entry: SyncBailHook<[string, string, EntryDescriptionNormalized], (undefined | string)>;
}
...
type EnumValue = (null | string | number | boolean | EnumValueObject | (EnumValue)[]);
 ...
 */
setTarget( key: Dependency, connection: ModuleGraphConnection, exportName?: (null | (string)[]), priority?: (number)): (boolean);
 ...
 */
getUsedName( fallbackName: (undefined | string), runtime: RuntimeSpec): (string | false | InlinedUsedName);
 ...
 */
getTerminalBinding( moduleGraph: ModuleGraph, resolveTargetFilter?: (( target: TargetItemWithConnection) => (boolean))): (undefined | ExportsInfo | ExportInfo);
	isReexport( ): (undefined | boolean);
	
/**
 * Returns the target, undefined when there is no target, false when no target is valid.
 */
findTarget( moduleGraph: ModuleGraph, validTargetModuleFilter: (( module: Module) => (boolean))): (undefined | null | false | TargetItemWithoutConnection);
	
/**
 * Returns the target.
 */
getTarget( moduleGraph: ModuleGraph, resolveTargetFilter?: (( target: TargetItemWithConnection) => (boolean))): (undefined | TargetItemWithConnection);
	
/**
 * Move the target forward as long resolveTargetFilter is fulfilled
 */
moveTarget( moduleGraph: ModuleGraph, resolveTargetFilter: (( target: TargetItemWithConnection) => (boolean)), updateOriginalConnection?: ((( target: TargetItemWithConnection) => (undefined | ModuleGraphConnection)))): (undefined | TargetItemWithConnection);
...
type ExportModeType = ("unused" | "missing" | "empty-star" | "reexport-dynamic-default" | "reexport-named-default" | "reexport-namespace-object" | "reexport-fake-namespace-object" | "reexport-undefined" | "normal-reexport" | "dynamic-reexport");
 ...
 */
setUnknownExportsProvided( canMangle?: (boolean), excludeExports?: (Set<string>), targetKey?: (Dependency), targetModule?: (ModuleGraphConnection), priority?: (number)): (boolean);
...
type ExternalItem = (string | RegExp | (ExternalItemObjectKnown & ExternalItemObjectUnknown) | (( data: ExternalItemFunctionData, callback: (( err?: (null | Error), result?: (string | boolean | (string)[] | (ExternalItemValueObjectKnown & ExternalItemValueObjectUnknown))) => void)) => void) | (( data: ExternalItemFunctionData) => Promise<ExternalItemValue>));
type ExternalItemFunction = ((( data: ExternalItemFunctionData, callback: (( err?: (null | Error), result?: (string | boolean | (string)[] | (ExternalItemValueObjectKnown & ExternalItemValueObjectUnknown))) => void)) => void) | (( data: ExternalItemFunctionData) => Promise<ExternalItemValue>));
 ...
 */
getResolve: (( options?: (ResolveOptions)) => ((( context: string, request: string, callback: (( err?: (null | Error), result?: (string | false), resolveRequest?: (ResolveRequest)) => void)) => void) | (( context: string, request: string) => Promise<string>)));
...
type ExternalItemValue = (string | boolean | (string)[] | (ExternalItemValueObjectKnown & ExternalItemValueObjectUnknown));
 ...
 */
constructor( request: ExternalModuleRequest, type: ExternalsType, userRequest: string, dependencyMeta?: (ImportDependencyMeta | CssImportDependencyMeta | AssetDependencyMeta), interop?: ("default" | "esModule"));
...
type Externals = (string | RegExp | (ExternalItemObjectKnown & ExternalItemObjectUnknown) | (( data: ExternalItemFunctionData, callback: (( err?: (null | Error), result?: (string | boolean | (string)[] | (ExternalItemValueObjectKnown & ExternalItemValueObjectUnknown))) => void)) => void) | (( data: ExternalItemFunctionData) => Promise<ExternalItemValue>) | (ExternalItem)[]);
declare class ExternalsPlugin {
	
/**
 * Creates an instance of ExternalsPlugin.
 */
constructor( type: ("import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url" | (( dependency: Dependency) => ExternalsType)), externals: Externals);
	type: ("import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url" | (( dependency: Dependency) => ExternalsType));
	externals: Externals;
...
type ExternalsPresetsNormalizedWithDefaults = (ExternalsPresets & { web: NonNullable<(undefined | boolean)>; node: NonNullable<(undefined | boolean)>; nwjs: NonNullable<(undefined | boolean)>; electron: NonNullable<(undefined | boolean)>; electronMain: NonNullable<(undefined | boolean)>; electronPreload: NonNullable<(undefined | boolean)>; electronRenderer: NonNullable<(undefined | boolean)> });
type ExternalsType = ("import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url");
 ...
 * read json method
 */
readJson?: ((( pathOrFileDescription: PathOrFileDescriptorTypes, callback: (( err: (null | Error | NodeJS.ErrnoException), result?: (JsonObjectTypes)) => void)) => void));
 ...
 */
addFileTimestamps( map: ReadonlyMap<string, FileTimestamp>, immutable?: (boolean)): void;
	
/**
 * Adds context timestamps.
 */
addContextTimestamps( map: ReadonlyMap<string, ContextTimestamp>, immutable?: (boolean)): void;
	
/**
 * Gets file timestamp.
 */
getFileTimestamp( path: string, callback: (( err?: (null | WebpackError), fileTimestamp?: (null | "ignore" | FileSystemInfoEntry)) => void)): void;
	
/**
 * Gets context timestamp.
 */
getContextTimestamp( path: string, callback: (( err?: (null | WebpackError), resolvedContextTimestamp?: (null | "ignore" | ResolvedContextFileSystemInfoEntry)) => void)): void;
	
/**
 * Returns file hash.
 */
getFileHash( path: string, callback: (( err?: (null | WebpackError), hash?: (null | string)) => void)): void;
	
/**
 * Returns context hash.
 */
getContextHash( path: string, callback: (( err?: (null | WebpackError), contextHash?: (string)) => void)): void;
	
/**
 * Returns context tsh.
 */
getContextTsh( path: string, callback: (( err?: (null | WebpackError), resolvedContextTimestampAndHash?: (null | ResolvedContextTimestampAndHash)) => void)): void;
	
/**
 * Resolves build dependencies.
 */
resolveBuildDependencies( context: string, deps: Iterable<string>, callback: (( err?: (null | Error), resolveBuildDependenciesResult?: (ResolveBuildDependenciesResult)) => void)): void;
	
/**
 * Checks resolve results valid.
 */
checkResolveResultsValid( resolveResults: Map<string, (undefined | string | false)>, callback: (( err?: (null | Error), result?: (boolean)) => void)): void;
	
/**
 * Creates a snapshot.
 */
createSnapshot( startTime: (undefined | null | number), files: (undefined | null | Iterable<string>), directories: (undefined | null | Iterable<string>), missing: (undefined | null | Iterable<string>), options: (undefined | null | SnapshotOptionsFileSystemInfo), callback: (( err: (null | WebpackError), snapshot: (null | Snapshot)) => void)): void;
 ...
 */
checkSnapshotValid( snapshot: Snapshot, callback: (( err?: (null | WebpackError), result?: (boolean)) => void)): void;
...
type FileTimestamp = (null | "ignore" | FileSystemInfoEntry | ExistenceOnlyTimeEntryFileSystemInfo);
 ...
 */
static byType( map: { [index: string]: (undefined | Generator) }): ByTypeGenerator;
}
declare interface GeneratorOptions {
	[index: string]: any;
}
type GeneratorOptionsByModuleType = (GeneratorOptionsByModuleTypeKnown & GeneratorOptionsByModuleTypeUnknown);
...
declare class GetChunkFilenameRuntimeModule extends RuntimeModule {
	constructor( contentType: string, name: string, global: string, getFilenameForChunk: (( chunk: Chunk) => (string | false | (( pathData: PathDataChunk, assetInfo?: (AssetInfo)) => string))), allChunks: (boolean), usesFullHashDigest?: (boolean));
	contentType: string;
	global: string;
	getFilenameForChunk: (( chunk: Chunk) => (string | false | (( pathData: PathDataChunk, assetInfo?: (AssetInfo)) => string)));
	allChunks: (boolean);
...
type GroupOptionsAsyncDependenciesBlock = (RawChunkGroupOptions & { name?: (null | string) } & { entryOptions?: (EntryOptions) } & { circular?: (boolean) });
...
declare interface HMRJavascriptParserHooks {
	hotAcceptCallback: SyncBailHook<[(UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement), (string)[]], void>;
 ...
 * Gets star reexports.
 */
getStarReexports( moduleGraph: ModuleGraph, runtime: RuntimeSpec, exportsInfo?: ExportsInfo, importedModule?: Module): { exports?: (Set<string>); checked?: (Set<string>); ignoredExports: Set<string>; hidden?: (Set<string>) };
}
 ...
 */
constructor( request: string, sourceOrder: number, phase?: (0 | 1 | 2), attributes?: (ImportAttributes));
 ...
 */
resolveFromOptions( specificValue: (undefined | string | false), options: JavascriptParserOptions): ExportPresenceMode };
	static getNonOptionalPart: (( members: (string)[], membersOptionals: ((boolean))[]) => (string)[]);
 ...
 */
hashDigest?: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex");
...
type Head<T extends ReadonlyArray<any>> = (T extends readonly [infer H, ...(any)[]] ? H : (T extends readonly [] ? any : (T extends (infer E)[] ? E : never)));
...
declare interface HtmlEntryInfo {
	request: string;
	entryName: string;
	type: ("html" | "script" | "stylesheet" | "script-module" | "preload" | "modulepreload" | "prefetch");
	css?: (boolean);
}
 ...
 * Processes the provided module.
 */
sourceDependency( dependency: Dependency, source: ReplaceSource, templateContext: DependencyTemplateContext): void;
	
/**
 * Processes the provided dependencies block.
 */
sourceBlock( block: DependenciesBlock, source: ReplaceSource, templateContext: DependencyTemplateContext): void;
	
/**
 * Processes the provided module.
 */
sourceModule( module: NormalModule, initFragments: (InitFragment<GenerateContext>)[], source: ReplaceSource, generateContext: GenerateContext): void;
...
type HtmlModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownNormalModuleBuildInfo & KnownHtmlModuleBuildInfo);
 ...
 */
type: ("html" | "script" | "css-url" | "stylesheet" | "src" | "srcset" | "script-module" | "stylesheet-style" | "stylesheet-style-attribute" | "srcdoc") }))[]);
...
type IBigIntStatsFs = (IStatsBaseFs<bigint> & { atimeNs: bigint; mtimeNs: bigint; ctimeNs: bigint; birthtimeNs: bigint });
type IBigIntStatsTypes = (IStatsBaseTypes<bigint> & { atimeNs: bigint; mtimeNs: bigint; ctimeNs: bigint; birthtimeNs: bigint });
 ...
 */
checkIgnore( resolveData: (ResolveData | BeforeContextResolveData)): (undefined | false);
...
type ImportExpressionJavascriptParser = (ImportExpressionImport & { phase?: ("source" | "defer") });
type ImportMetaParserOptions = (ImportMetaParserOptionsKnown & ImportMetaParserOptionsUnknown);
...
type ImportSource = (undefined | null | string | SimpleLiteral | RegExpLiteral | BigIntLiteral);
 ...
 * Log level.
 */
level?: ("error" | "log" | "verbose" | "info" | "none" | "warn");
 ...
 */
stream?: ((NodeJS.WritableStream & { isTTY?: (boolean); columns?: (number); rows?: (number) }));
}
type InfrastructureLoggingNormalizedWithDefaults = (InfrastructureLogging & { stream: (NodeJS.WritableStream & { isTTY?: (boolean); columns?: (number); rows?: (number) }); level: NonNullable<(undefined | "error" | "log" | "verbose" | "info" | "none" | "warn")>; debug: NonNullable<(undefined | string | boolean | RegExp | (FilterItemTypes)[] | (( value: string) => (boolean)))>; colors: NonNullable<(undefined | boolean)>; appendOnly: NonNullable<(undefined | boolean)> });
 ...
 */
constructor( content: (undefined | string | Source), stage: number, position: number, key?: (string), endContent?: (string | Source));
...
declare namespace InnerGraph {
export let getDependencyUsedByExportsCondition: (( dependency: Dependency, moduleGraph: ModuleGraph) => (null | false | (( moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState)));
export let getInnerGraphUtils: (( compilation: Compilation) => InnerGraphUtils);
...
declare interface InnerGraphUtils {
	...
	addUsage: (( parserState: ParserState, symbol: (null | TopLevelSymbol), usage: Usage) => void);
	onUsage: (( parserState: ParserState, onUsageCallback: (( value: (undefined | boolean | Set<string>), module: Module) => void)) => void);
	...
	tagTopLevelSymbol: (( parser: JavascriptParser, name: string, pure?: (boolean | (( compilation: Compilation, module: Module) => (boolean)))) => (undefined | TopLevelSymbol));
...
declare interface InputFileSystem {
	...
	readJson?: ((( pathOrFileDescriptor: PathOrFileDescriptorFs, callback: (( err: (null | Error | NodeJS.ErrnoException), result?: (JsonObjectFs)) => void)) => void));
...
declare interface IntermediateFileSystemExtras {
	mkdirSync: MkdirSync;
	createWriteStream: (( pathLike: PathLikeFs, result?: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | WriteStreamOptions)) => NodeJS.WritableStream);
	open: Open;
	read: Read<NodeJS.ArrayBufferView>;
	close: (( df: number, callback: (( err: (null | NodeJS.ErrnoException)) => void)) => void);
	rename: (( a: PathLikeFs, b: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException)) => void)) => void);
}
 ...
 * Processes the provided module.
 */
sourceDependency( dependency: Dependency, source: ReplaceSource, templateContext: DependencyTemplateContext, generateContext: GenerateContext): void;
	
/**
 * Processes the provided module.
 */
sourceBlock( module: Module, block: DependenciesBlock, templateContext: DependencyTemplateContext, source: ReplaceSource, generateContext: GenerateContext): void;
...
type JavascriptModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownNormalModuleBuildInfo & KnownJavascriptModuleBuildInfo);
type JavascriptModuleBuildMeta = (KnownBuildMeta & Record<string, any> & KnownJavascriptModuleBuildMeta);
 ...
 * Renders the newly generated source from rendering.
 */
renderModule( module: Module, renderContext: ModuleRenderContext, hooks: CompilationHooksJavascriptModulesPlugin): (null | Source);
 ...
 */
constructor( sourceType?: ("module" | "auto" | "script"), options?: ({ parse?: ((( code: string, options: ParseOptions) => ParseResult)); typescript?: (boolean); importPhases?: (boolean) }));
	hooks: Readonly<{ evaluateTypeof: HookMap<SyncBailHook<[UnaryExpression], (undefined | null | BasicEvaluatedExpression)>>; evaluate: HookMap<SyncBailHook<[(UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement | PrivateIdentifier | Super)], (undefined | null | BasicEvaluatedExpression)>>; evaluateIdentifier: HookMap<SyncBailHook<[(Identifier | MemberExpression | MetaProperty | ThisExpression)], (undefined | null | BasicEvaluatedExpression)>>; evaluateDefinedIdentifier: HookMap<SyncBailHook<[(Identifier | MemberExpression | ThisExpression)], (undefined | null | BasicEvaluatedExpression)>>; evaluateNewExpression: HookMap<SyncBailHook<[NewExpression], (undefined | null | BasicEvaluatedExpression)>>; evaluateCallExpression: HookMap<SyncBailHook<[CallExpression], (undefined | null | BasicEvaluatedExpression)>>; evaluateCallExpressionMember: HookMap<SyncBailHook<[CallExpression, BasicEvaluatedExpression], (undefined | null | BasicEvaluatedExpression)>>; isPure: HookMap<SyncBailHook<[(UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | PrivateIdentifier | FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration), number], (boolean | void)>>; preStatement: SyncBailHook<[(FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)], (boolean | void)>; preStatementByType: HookMap<SyncBailHook<[(FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)], (boolean | void)>>; blockPreStatement: SyncBailHook<[(FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)], (boolean | void)>; blockPreStatementByType: HookMap<SyncBailHook<[(FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)], (boolean | void)>>; statement: SyncBailHook<[(FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)], (boolean | void)>; statementIf: SyncBailHook<[IfStatement], (boolean | void)>; collectGuards: SyncBailHook<[Expression], (void | GuardCollection)>; classExtendsExpression: SyncBailHook<[Expression, (ClassExpression | ClassDeclaration | MaybeNamedClassDeclaration)], (boolean | void)>; classBodyElement: SyncBailHook<[(StaticBlock | MethodDefinition | PropertyDefinition), (ClassExpression | ClassDeclaration | MaybeNamedClassDeclaration)], (boolean | void)>; classBodyValue: SyncBailHook<[Expression, (MethodDefinition | PropertyDefinition), (ClassExpression | ClassDeclaration | MaybeNamedClassDeclaration)], (boolean | void)>; label: HookMap<SyncBailHook<[LabeledStatement], (boolean | void)>>; import: SyncBailHook<[ImportDeclaration, ImportSource], (boolean | void)>; importSpecifier: SyncBailHook<[ImportDeclaration, ImportSource, (null | string), string], (boolean | void)>; export: SyncBailHook<[(ExportNamedDeclaration | ExportDefaultDeclaration)], (boolean | void)>; exportImport: SyncBailHook<[(ExportNamedDeclaration | ExportAllDeclaration), ImportSource], (boolean | void)>; exportDeclaration: SyncBailHook<[(ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration), Declaration], (boolean | void)>; exportExpression: SyncBailHook<[ExportDefaultDeclaration, (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | MaybeNamedFunctionDeclaration | MaybeNamedClassDeclaration)], (boolean | void)>; exportSpecifier: SyncBailHook<[(ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration), string, string, (undefined | number)], (boolean | void)>; exportImportSpecifier: SyncBailHook<[(ExportNamedDeclaration | ExportAllDeclaration), ImportSource, (null | string), (null | string), (undefined | number)], (boolean | void)>; preDeclarator: SyncBailHook<[VariableDeclarator, VariableDeclaration], (boolean | void)>; declarator: SyncBailHook<[VariableDeclarator, Statement], (boolean | void)>; varDeclaration: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; varDeclarationLet: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; varDeclarationConst: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; varDeclarationUsing: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; varDeclarationVar: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; pattern: HookMap<SyncBailHook<[Identifier], (boolean | void)>>; collectDestructuringAssignmentProperties: SyncBailHook<[Expression], (boolean | void)>; canRename: HookMap<SyncBailHook<[Expression], (boolean | void)>>; rename: HookMap<SyncBailHook<[Expression], (boolean | void)>>; assign: HookMap<SyncBailHook<[AssignmentExpression], (boolean | void)>>; assignMemberChain: HookMap<SyncBailHook<[AssignmentExpression, (string)[]], (boolean | void)>>; typeof: HookMap<SyncBailHook<[Expression], (boolean | void)>>; importCall: SyncBailHook<[ImportExpressionJavascriptParser, (undefined | SimpleCallExpression | NewExpression)], (boolean | void)>; topLevelAwait: SyncBailHook<[(UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | ForOfStatement)], (boolean | void)>; call: HookMap<SyncBailHook<[CallExpression], (boolean | void)>>; callMemberChain: HookMap<SyncBailHook<[CallExpression, (string)[], ((boolean))[], ([number, number])[]], (boolean | void)>>; memberChainOfCallMemberChain: HookMap<SyncBailHook<[Expression, (string)[], CallExpression, (string)[], ([number, number])[]], (boolean | void)>>; callMemberChainOfCallMemberChain: HookMap<SyncBailHook<[CallExpression, (string)[], CallExpression, (string)[], ([number, number])[]], (boolean | void)>>; optionalChaining: SyncBailHook<[ChainExpression], (boolean | void)>; new: HookMap<SyncBailHook<[NewExpression], (boolean | void)>>; binaryExpression: SyncBailHook<[BinaryExpression], (boolean | void)>; expression: HookMap<SyncBailHook<[Expression], (boolean | void)>>; expressionMemberChain: HookMap<SyncBailHook<[MemberExpression, (string)[], ((boolean))[], ([number, number])[]], (boolean | void)>>; unhandledExpressionMemberChain: HookMap<SyncBailHook<[MemberExpression, (string)[]], (boolean | void)>>; expressionConditionalOperator: SyncBailHook<[ConditionalExpression], (boolean | void)>; expressionLogicalOperator: SyncBailHook<[LogicalExpression], (boolean | void)>; program: SyncBailHook<[Program, (CommentJavascriptParser)[]], (boolean | void)>; terminate: SyncBailHook<[(ReturnStatement | ThrowStatement)], (boolean | void)>; finish: SyncBailHook<[Program, (CommentJavascriptParser)[]], (boolean | void)>; unusedStatement: SyncBailHook<[Statement], (boolean | void)> }>;
	sourceType: ("module" | "auto" | "script");
	options: { parse?: ((( code: string, options: ParseOptions) => ParseResult)); typescript?: (boolean); importPhases?: (boolean) };
	scope: ScopeInfo;
	state: JavascriptParserState;
	comments?: ((CommentJavascriptParser)[]);
	semicolons?: (Set<number>);
	statementPath?: ((StatementPathItem)[]);
	prevStatement?: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration);
	destructuringAssignmentProperties?: (WeakMap<Expression, Set<DestructuringAssignmentProperty>>);
	currentTagData?: (Record<string, any> | HarmonySettings | ImportSettings | CommonJsImportSettings | TopLevelSymbol | CompatibilitySettings);
	magicCommentContext: ContextImport;
 ...
 */
getRenameIdentifier( expr: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement)): (undefined | string | VariableInfo);
 ...
 */
preWalkStatements( statements: ((FunctionDeclaration | VariableDeclaration | ClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration))[]): void;
	
/**
 * Block pre walking iterates the scope for block variable declarations
 */
blockPreWalkStatements( statements: ((FunctionDeclaration | VariableDeclaration | ClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration))[]): void;
	
/**
 * Walking iterates the statements and expressions and processes them
 */
walkStatements( statements: ((FunctionDeclaration | VariableDeclaration | ClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration))[]): void;
	
/**
 * Walking iterates the statements and expressions and processes them
 */
preWalkStatement( statement: (FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)): void;
	
/**
 * Block pre walk statement.
 */
blockPreWalkStatement( statement: (FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)): void;
	
/**
 * Processes the provided statement.
 */
walkStatement( statement: (FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration)): void;
 ...
 */
enterDestructuringAssignment( pattern: Pattern, expression: Expression): (undefined | UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression);
 ...
 */
enterDeclaration( declaration: Declaration, onIdent: (( ident: string, identifier: Identifier) => void)): void;
 ...
 */
walkExpressions( expressions: ((null | UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement))[]): void;
	
/**
 * Processes the provided expression.
 */
walkExpression( expression: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement | PrivateIdentifier | Super)): void;
 ...
 */
walkMemberExpressionWithExpressionName<R>( expression: MemberExpression, name: string, rootInfo: (string | VariableInfo), members: (string)[], onUnhandled: (( ) => (undefined | R))): void;
 ...
 */
callHooksForExpression<T, R>( hookMap: HookMap<SyncBailHook<T, R>>, expr: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | Super), ...args: AsArray<T>): (undefined | R);
	
/**
 * Call hooks for expression with fallback.
 */
callHooksForExpressionWithFallback<T, R>( hookMap: HookMap<SyncBailHook<T, R>>, expr: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | Super), fallback: (undefined | (( name: string, rootInfo: (string | ScopeInfo | VariableInfo), getMembers: (( ) => (string)[])) => R)), defined: (undefined | (( result?: (string)) => (undefined | R))), ...args: AsArray<T>): (undefined | R);
 ...
 */
callHooksForInfoWithFallback<T, R>( hookMap: HookMap<SyncBailHook<T, R>>, info: ExportedVariableInfo, fallback: (undefined | (( name: string) => (undefined | R))), defined: (undefined | (( result?: (string)) => (undefined | R))), ...args: AsArray<T>): (undefined | R);
	
/**
 * Call hooks for name with fallback.
 */
callHooksForNameWithFallback<T, R>( hookMap: HookMap<SyncBailHook<T, R>>, name: string, fallback: (undefined | (( value: string) => (undefined | R))), defined: (undefined | (( ) => R)), ...args: AsArray<T>): (undefined | R);
	
/**
 * Processes the provided param.
 * @deprecated
 */
inScope( params: ((string | Identifier | MemberExpression | Property | ObjectPattern | ArrayPattern | RestElement | AssignmentPattern))[], fn: (( ) => void)): void;
 ...
 * Processes the provided statement.
 */
detectMode( statements: ((FunctionDeclaration | VariableDeclaration | ClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration | Directive))[]): void;
	
/**
 * Processes the provided pattern.
 */
enterPatterns( patterns: ((string | Identifier | MemberExpression | Property | ObjectPattern | ArrayPattern | RestElement | AssignmentPattern))[], onIdent: (( ident: string) => void)): void;
	
/**
 * Processes the provided pattern.
 */
enterPattern( pattern: (Identifier | MemberExpression | Property | ObjectPattern | ArrayPattern | RestElement | AssignmentPattern), onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Processes the provided pattern.
 */
enterIdentifier( pattern: Identifier, onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Enter object pattern.
 */
enterObjectPattern( pattern: ObjectPattern, onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Enter array pattern.
 */
enterArrayPattern( pattern: ArrayPattern, onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Enter rest element.
 */
enterRestElement( pattern: RestElement, onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Enter assignment pattern.
 */
enterAssignmentPattern( pattern: AssignmentPattern, onIdent: (( ident: string, identifier: Identifier) => void)): void;
	
/**
 * Evaluate expression.
 */
evaluateExpression( expression: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement | PrivateIdentifier | Super)): BasicEvaluatedExpression;
 ...
 */
isPure( expr: (undefined | null | UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | PrivateIdentifier | FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration), commentsStartPos: number): (boolean);
 ...
 * Returns tag data.
 */
getTagData( name: string, tag: symbol): (undefined | Record<string, any> | HarmonySettings | ImportSettings | CommonJsImportSettings | TopLevelSymbol | CompatibilitySettings);
	
/**
 * Processes the provided name.
 */
tagVariable( name: string, tag: symbol, data?: (Record<string, any> | HarmonySettings | ImportSettings | CommonJsImportSettings | TopLevelSymbol | CompatibilitySettings), flags?: (0 | 1 | 2 | 4)): void;
 ...
 */
parseCommentOptions( range: [number, number]): { options: (null | Record<string, any>); errors: (null | ((Error & { comment: CommentJavascriptParser }))[]) };
 ...
 */
getMemberExpressionRoot( expression: (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | Super)): (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | Super);
 ...
 */
getNameInfoFromVariable( varName: string): (undefined | { name: string; info: (string | VariableInfo) });
 ...
 */
getNameForExpression( expression: Expression): (undefined | { name: string; rootInfo: ExportedVariableInfo; getMembers: (( ) => (string)[]) });
	
/**
 * Returns parser.
 */
static extend( ...plugins: ((( BaseParser: typeof ParserImport) => typeof ParserImport))[]): typeof JavascriptParser;
	...
	static getImportAttributes: (( node: (ImportDeclaration | ExportNamedDeclaration | ExportAllDeclaration | ImportExpressionJavascriptParser)) => (undefined | ImportAttributes));
}
 ...
 */
importExportsPresence?: (false | "error" | "auto" | "warn");
 ...
 */
reexportExportsPresence?: (false | "error" | "auto" | "warn");
...
type JavascriptParserState = (ParserStateBase & Record<string, any> & KnownJavascriptParserState);
 ...
 */
get( ): (undefined | null | string | number | boolean | JsonObjectFs | (JsonValueFs)[]);
...
type JsonModuleBuildInfo = (KnownBuildInfo & Record<string, any> & KnownNormalModuleBuildInfo & KnownJsonModuleBuildInfo);
declare interface JsonObjectFs {
	[index: string]: (undefined | null | string | number | boolean | JsonObjectFs | (JsonValueFs)[]);
}
 ...
 */
parse?: ((( input: string) => (null | string | number | boolean | Buffer | JsonObjectFs | (JsonValueFs)[])));
}
type JsonValueFs = (null | string | number | boolean | JsonObjectFs | (JsonValueFs)[]);
...
declare interface KnownBuildMeta {
	exportsType?: ("default" | "namespace" | "dynamic" | "flagged");
 ...
 * resolve step hook
 */
resolveStep: SyncHook<[AsyncSeriesBailHook<[ResolveRequest, ResolveContext], (null | ResolveRequest)>, ResolveRequest]>;
...
declare interface KnownNormalizedStatsOptions {
	...
	logging: (false | "error" | "log" | "verbose" | "info" | "none" | "warn");
...
declare interface KnownStatsPrinterFormatters {
	...
	formatChunkId?: ((( id: (string | number), direction?: ("parent" | "child" | "sibling")) => string));
...
declare interface LStatFs {
	( path: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsFs)) => void)): void;
	( path: PathLikeFs, options: (undefined | (StatOptionsFs & { bigint?: (false) })), callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsFs)) => void)): void;
	( path: PathLikeFs, options: (StatOptionsFs & { bigint: true }), callback: (( err: (null | NodeJS.ErrnoException), result?: (IBigIntStatsFs)) => void)): void;
	( path: PathLikeFs, options: (undefined | StatOptionsFs), callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsFs | IBigIntStatsFs)) => void)): void;
}
declare interface LStatSync {
	( path: PathLikeFs): IStatsFs;
	( path: PathLikeFs, options?: ((StatSyncOptions & { bigint?: (false); throwIfNoEntry?: (true) }))): IStatsFs;
	( path: PathLikeFs, options: (StatSyncOptions & { bigint: true; throwIfNoEntry?: (true) })): IBigIntStatsFs;
	( path: PathLikeFs, options?: ((StatSyncOptions & { bigint?: (false); throwIfNoEntry: false }))): (undefined | IStatsFs);
	( path: PathLikeFs, options: (StatSyncOptions & { bigint: true; throwIfNoEntry: false })): (undefined | IBigIntStatsFs);
	( path: PathLikeFs, options: (StatSyncOptions & { bigint: (boolean); throwIfNoEntry?: (true) })): (IStatsFs | IBigIntStatsFs);
	( path: PathLikeFs, options?: (StatSyncOptions)): (undefined | IStatsFs | IBigIntStatsFs);
}
declare interface LStatTypes {
	( path: PathLikeTypes, callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsTypes)) => void)): void;
	( path: PathLikeTypes, options: (undefined | (StatOptionsTypes & { bigint?: (false) })), callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsTypes)) => void)): void;
	( path: PathLikeTypes, options: (StatOptionsTypes & { bigint: true }), callback: (( err: (null | NodeJS.ErrnoException), result?: (IBigIntStatsTypes)) => void)): void;
	( path: PathLikeTypes, options: (undefined | StatOptionsTypes), callback: (( err: (null | NodeJS.ErrnoException), result?: (IStatsTypes | IBigIntStatsTypes)) => void)): void;
}
 ...
 */
server?: (ServerOptionsImportHttps<typeof IncomingMessage> | ServerOptionsImportHttp<typeof IncomingMessage> | (( ) => ServerLazyCompilationBackend));
}
 ...
 */
backend?: ((( compiler: Compiler, callback: (( err: (null | Error), backendApi?: (BackendApi)) => void)) => void) | (( compiler: Compiler) => Promise<BackendApi>) | LazyCompilationDefaultBackendOptions);
...
type LazyFunction<InputValue, OutputValue, InternalLazyTarget extends SerializerMiddleware<any, any, Record<string, any>>, InternalLazyOptions extends (undefined | LazyOptions)> = ((( ) => (InputValue | Promise<InputValue>)) & Partial<{ options: InternalLazyOptions }>);
 ...
 */
serialize( __0: ObjectSerializerContextObjectMiddlewareObject_5<((number | T))[]>): void;
 ...
 */
static deserialize<T>( __0: ObjectDeserializerContextObjectMiddlewareObject_4<((number | T))[]>): LazySet<T>;
}
...
type LoaderContext<OptionsType> = (NormalModuleLoaderContext<OptionsType> & LoaderRunnerLoaderContext<OptionsType> & LoaderPluginLoaderContext & HotModuleReplacementPluginLoaderContext);
...
declare interface LoaderDefinitionFunction<OptionsType = {  }, ContextAdditions = {  }> {
	(this: (NormalModuleLoaderContext<OptionsType> & LoaderRunnerLoaderContext<OptionsType> & LoaderPluginLoaderContext & HotModuleReplacementPluginLoaderContext & ContextAdditions),  content: string, sourceMap?: (string | RawSourceMap), additionalData?: (AdditionalData)): (string | void | Buffer | Promise<(string | Buffer)>);
}
 ...
 */
loadModule( request: string, callback: (( err: (null | Error), source?: (string | Buffer), sourceMap?: (null | object), module?: (Module)) => void)): void;
	importModule( request: string, options: (undefined | ImportModuleOptions), callback: (( err?: (null | Error), exports?: any) => void)): void;
 ...
 */
async( ): (( err?: (null | Error), content?: (string | Buffer), sourceMap?: (null | string | RawSourceMap), additionalData?: (AdditionalData)) => void);
...
cacheable( flag?: (boolean)): void;
	callback: (( err?: (null | Error), content?: (string | Buffer), sourceMap?: (null | string | RawSourceMap), additionalData?: (AdditionalData)) => void);
 ...
 * ]
 */
loaders: ({ request: string; path: string; query: string; fragment: string; options?: (string | object); ident: string; normal?: (Function); pitch?: (Function); raw?: (boolean); data?: (object); pitchExecuted: (boolean); normalExecuted: (boolean); type?: ("module" | "commonjs") })[];
...
declare interface LogEntry {
	type: ("error" | "log" | "info" | "profile" | "warn" | "clear" | "debug" | "trace" | "group" | "groupCollapsed" | "groupEnd" | "profileEnd" | "time" | "status");
	args?: ((any)[]);
	time: number;
	trace?: ((string)[]);
}
type LogTypeEnum = ("error" | "log" | "info" | "profile" | "warn" | "clear" | "debug" | "trace" | "group" | "groupCollapsed" | "groupEnd" | "profileEnd" | "time" | "status");
...
type Matcher = (string | RegExp | (( str: string) => (boolean)) | ((string | RegExp | (( str: string) => (boolean))))[]);
...
declare interface MaybeMergeableInitFragment<GenerateContext> {
	...
	getContent: (( context: GenerateContext) => (undefined | string | Source));
	getEndContent: (( context: GenerateContext) => (undefined | string | Source));
	merge?: ((( fragments: MaybeMergeableInitFragment<GenerateContext>) => MaybeMergeableInitFragment<GenerateContext>));
	mergeAll?: ((( fragments: (MaybeMergeableInitFragment<GenerateContext>)[]) => (MaybeMergeableInitFragment<GenerateContext>)[]));
}
...
declare interface Mkdir {
	( file: PathLikeFs, options: (MakeDirectoryOptions & { recursive: true }), callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
	( file: PathLikeFs, options: (undefined | null | string | number | (MakeDirectoryOptions & { recursive?: (false) })), callback: (( err: (null | NodeJS.ErrnoException)) => void)): void;
	( file: PathLikeFs, options: (undefined | null | string | number | MakeDirectoryOptions), callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
	( file: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException)) => void)): void;
}
declare interface MkdirSync {
	( path: PathLikeFs, options: (MakeDirectoryOptions & { recursive: true })): (undefined | string);
	( path: PathLikeFs, options?: (null | string | number | (MakeDirectoryOptions & { recursive?: (false) }))): void;
	( path: PathLikeFs, options?: (null | string | number | MakeDirectoryOptions)): (undefined | string);
}
 ...
 */
build( options: WebpackOptionsNormalizedWithDefaults, compilation: Compilation, resolver: ResolverWithOptions, fs: InputFileSystem, callback: (( err?: (WebpackError)) => void)): void;
 ...
 */
constructor( request: string, imported: Imported, ident?: (string), dependencyMeta?: (ImportDependencyMeta), hashFunction?: (string | typeof Hash));
 ...
 * Processes the provided data.
 */
create( data: ModuleFactoryCreateData, callback: (( err?: (null | Error), result?: (ModuleFactoryResult)) => void)): void;
}
 ...
 * The external type of the remote containers.
 */
remoteType?: ("import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url");
...
type ModuleFilterItemTypes = (string | RegExp | (( name: string, module: StatsModule, type: ("module" | "chunk" | "root-of-chunk" | "nested")) => (boolean)));
 ...
 */
updateParent( dependency: Dependency, connection?: (ModuleGraphConnection), parentModule?: (Module)): void;
 ...
 */
moveModuleConnections( oldModule: Module, newModule: Module, filterConnection: (( moduleGraphConnection: ModuleGraphConnection) => (boolean))): void;
	
/**
 * Copies outgoing module connections.
 */
copyOutgoingModuleConnections( oldModule: Module, newModule: Module, filterConnection: (( moduleGraphConnection: ModuleGraphConnection) => (boolean))): void;
 ...
 */
getIncomingConnectionsByOriginModule( module: Module): ReadonlyMap<(undefined | null | Module), ReadonlyArray<ModuleGraphConnection>>;
	
/**
 * Gets outgoing connections by module.
 */
getOutgoingConnectionsByModule( module: Module): (undefined | ReadonlyMap<(undefined | Module), ReadonlyArray<ModuleGraphConnection>>);
 ...
 */
cached<T extends (any)[], R>( fn: (( moduleGraph: ModuleGraph, ...args: T) => R), ...args: T): R;
 ...
 */
constructor( originModule: (null | Module), dependency: (null | Dependency), module: Module, explanation?: (string), weak?: (boolean), condition?: (null | false | (( moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState)));
	originModule: (null | Module);
	...
	weak?: (boolean);
	conditional: (boolean);
	condition?: (null | false | (( moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState));
 ...
 */
addCondition( condition: (( moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState)): void;
 ...
 */
noParse?: (string | RegExp | (( content: string) => (boolean)) | (Exclude<NoParse, (any)[]>)[]);
 ...
 * Returns json output.
 */
toJson( options?: (boolean | StatsOptions | "verbose" | "none" | "summary" | "errors-only" | "errors-warnings" | "minimal" | "normal" | "detailed")): StatsCompilation;
	
/**
 * Returns a string representation.
 */
toString( options?: (boolean | StatsOptions | "verbose" | "none" | "summary" | "errors-only" | "errors-warnings" | "minimal" | "normal" | "detailed")): string;
}
declare abstract class MultiWatching {
	watchings: (Watching)[];
	compiler: defaultMultiCompiler;
...
type NoParse = (string | RegExp | (( content: string) => (boolean)) | (Exclude<NoParse, (any)[]>)[]);
...
declare class NormalModule extends Module {
	constructor( __0: NormalModuleCreateDataNormalModuleObject_2<string>);
	request: string;
	userRequest: string;
	rawRequest: string;
	binary: (boolean);
 ...
 */
restoreFromUnsafeCache( unsafeCacheData: UnsafeCacheData, normalModuleFactory: NormalModuleFactory): void;
	createSourceForAsset( context: string, name: string, content: (string | Buffer), sourceMap?: (string | RawSourceMap), associatedObjectForCache?: (object)): Source;
	getCurrentLoader( loaderContext: AnyLoaderContext, index?: number): (null | LoaderItem);
	createSource( context: string, content: (string | Buffer), sourceMap?: (null | string | RawSourceMap), associatedObjectForCache?: (object)): Source;
...
declare interface NormalModuleCompilationHooks {
	...
	readResourceForScheme: HookMap<FakeHook<AsyncSeriesBailHook<[string, NormalModule], (null | string | Buffer)>>>;
	readResource: HookMap<AsyncSeriesBailHook<[AnyLoaderContext], (null | string | Buffer)>>;
	processResult: SyncWaterfallHook<[[(string | Buffer), (undefined | string | RawSourceMap), (undefined | PreparsedAst)], NormalModule], [(string | Buffer), (undefined | string | RawSourceMap), (undefined | PreparsedAst)]>;
	needBuild: AsyncSeriesBailHook<[NormalModule, NeedBuildContext], (boolean)>;
}
declare interface NormalModuleCreateDataNormalModuleObject_2<T extends string = string> {
 ...
 */
resolveRequestArray( contextInfo: ModuleFactoryCreateDataContextInfo, context: string, array: (LoaderItem)[], resolver: ResolverWithOptions, resolveContext: ResolveContext, callback: CallbackWebpackFunction_1<(LoaderItem)[]>): void;
 ...
 */
resolve( context: string, request: string, callback: (( err: (null | ErrorWithDetail), res?: (string | false), req?: (ResolveRequest)) => void)): void;
 ...
 */
getResolve( options?: (ResolveOptionsWithDependencyType)): { ( context: string, request: string, callback: (( err: (null | ErrorWithDetail), res?: (string | false), req?: (ResolveRequest)) => void)): void; ( context: string, request: string): Promise<string> };
 ...
 */
constructor( resourceRegExp: RegExp, newResource: (string | (( resolveData: ResolveData) => void)));
	resourceRegExp: RegExp;
...
declare interface ObjectDeserializerContextObjectMiddlewareObject_1 {
	read: (( ) => string);
	rest: ObjectDeserializerContextObjectMiddlewareObject_4<[number, (boolean)]>;
	setCircularReference: (( value: ReferenceableItem) => void);
}
declare namespace ObjectDeserializerContextObjectMiddlewareObject_2 {
export let read: (( ) => any);
export let rest: ObjectDeserializerContextObjectMiddlewareObject_4<ReadonlyArray<any>>;
...
declare interface ObjectDeserializerContextObjectMiddlewareObject_3 {
	read: (( ) => any);
	rest: ObjectDeserializerContextObjectMiddlewareObject_4<ReadonlyArray<any>>;
	setCircularReference: (( value: ReferenceableItem) => void);
}
 ...
 * Updates set size using the provided set.
 */
declare interface ObjectDeserializerContextObjectMiddlewareObject_4<T extends ReadonlyArray<any> = ReadonlyArray<any>> {
	read: (( ) => Head<T>);
	rest: ObjectDeserializerContextObjectMiddlewareObject_4<Tail<T>>;
	setCircularReference: (( value: ReferenceableItem) => void);
}
...
declare interface ObjectEncodingOptionsFs {
	encoding?: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex");
}
...
declare interface ObjectSerializer {
	serialize: (( value: any, context: ObjectSerializerContextObjectMiddlewareObject_5<any>) => void);
	deserialize: (( context: ObjectDeserializerContextObjectMiddlewareObject_4<any>) => any);
}
...
declare interface ObjectSerializerContextObjectMiddlewareObject_1 {
	write: (( value: (RestoreProvidedDataExports)[]) => ObjectSerializerContextObjectMiddlewareObject_5<[(undefined | null | boolean), (undefined | boolean), (boolean)]>);
	setCircularReference: (( value: ReferenceableItem) => void);
...
declare interface ObjectSerializerContextObjectMiddlewareObject_2 {
	write: (( value: string) => ObjectSerializerContextObjectMiddlewareObject_5<[number, (boolean)]>);
	setCircularReference: (( value: ReferenceableItem) => void);
	snapshot: (( ) => ObjectSerializerSnapshot);
	rollback: (( snapshot: ObjectSerializerSnapshot) => void);
	writeLazy?: ((( item?: any) => void));
...
export let write: (( value?: any) => ObjectSerializerContextObjectMiddlewareObject_5<ReadonlyArray<any>>);
export let setCircularReference: (( value: ReferenceableItem) => void);
...
export let writeSeparate: (undefined | (( item: any, obj?: (LazyOptions)) => LazyFunction<any, any, any, LazyOptions>));
...
declare interface ObjectSerializerContextObjectMiddlewareObject_4 {
	write: (( value?: any) => ObjectSerializerContextObjectMiddlewareObject_5<ReadonlyArray<any>>);
	setCircularReference: (( value: ReferenceableItem) => void);
	snapshot: (( ) => ObjectSerializerSnapshot);
	rollback: (( snapshot: ObjectSerializerSnapshot) => void);
	writeLazy?: ((( item?: any) => void));
 ...
 * Updates set size using the provided set.
 */
declare interface ObjectSerializerContextObjectMiddlewareObject_5<T extends ReadonlyArray<any> = ReadonlyArray<any>> {
	write: (( value: Head<T>) => ObjectSerializerContextObjectMiddlewareObject_5<Tail<T>>);
	setCircularReference: (( value: ReferenceableItem) => void);
	snapshot: (( ) => ObjectSerializerSnapshot);
	rollback: (( snapshot: ObjectSerializerSnapshot) => void);
	writeLazy?: ((( item?: any) => void));
...
declare interface Open {
	( file: PathLikeFs, flags: (undefined | string | number), mode: (undefined | null | string | number), callback: (( err: (null | NodeJS.ErrnoException), result?: (number)) => void)): void;
	( file: PathLikeFs, flags: (undefined | string | number), callback: (( err: (null | NodeJS.ErrnoException), result?: (number)) => void)): void;
	( file: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (number)) => void)): void;
}
 ...
 */
minimizer?: (((undefined | null | false | "" | 0 | ((this: Compiler,  compiler: Compiler) => void) | WebpackPluginInstance | "..."))[]);
...
type OptimizationNormalizedWithDefaults = (OptimizationNormalized & { runtimeChunk: NonNullable<(undefined | false | { 
/**
 * The name factory for the runtime chunks.
 */
 ...
 */
chunks?: (RegExp | "all" | "initial" | "async" | (( chunk: Chunk) => (undefined | boolean)));
 ...
 */
name?: (string | false | (( module: Module, chunks: (Chunk)[], key: string) => (undefined | string)));
 ...
 */
cacheGroups?: ({ [index: string]: (string | false | RegExp | (( module: Module) => (void | OptimizationSplitChunksCacheGroup | (OptimizationSplitChunksCacheGroup)[])) | OptimizationSplitChunksCacheGroup) });
...
declare class OriginalSource extends Source {
	...
	getName( ): string;
	streamChunks( options: StreamChunksOptions, onChunk: (( chunk: (undefined | string), generatedLine: number, generatedColumn: number, sourceIndex: number, originalLine: number, originalColumn: number, nameIndex: number) => void), onSource: (( sourceIndex: number, source: (null | string), sourceContent?: (string)) => void), _onName: (( nameIndex: number, name: string) => void)): GeneratedSourceInfo;
}
...
declare interface OutputFileSystem {
	mkdir: Mkdir;
	readdir?: (ReaddirFs);
	rmdir?: ((( file: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException)) => void)) => void));
	writeFile: WriteFile;
	unlink?: ((( pathLike: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException)) => void)) => void));
	stat: StatFs;
	lstat?: (LStatFs);
	readFile: ReadFileFs;
	createReadStream?: ((( path: PathLikeFs, options?: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | ReadStreamOptions)) => NodeJS.ReadableStream));
	join?: ((( path1: string, path2: string) => string));
	relative?: ((( from: string, to: string) => string));
	dirname?: ((( dirname: string) => string));
}
...
type OutputNormalizedWithDefaults = (OutputNormalized & { uniqueName: string; filename: NonNullable<(undefined | string | TemplatePathFn<PathDataChunk>)>; cssFilename: NonNullable<(undefined | string | TemplatePathFn<PathDataChunk>)>; chunkFilename: NonNullable<(undefined | string | TemplatePathFn<PathDataChunk>)>; cssChunkFilename: NonNullable<(undefined | string | TemplatePathFn<PathDataChunk>)>; hotUpdateChunkFilename: string; hotUpdateGlobal: string; assetModuleFilename: NonNullable<(undefined | string | TemplatePathFn<PathDataModule>)>; webassemblyModuleFilename: string; sourceMapFilename: string; hotUpdateMainFilename: string; devtoolNamespace: string; publicPath: NonNullable<(undefined | string | TemplatePathFn<PathData>)>; workerPublicPath: string; workerChunkFilename: NonNullable<(undefined | string | TemplatePathFn<PathDataChunk>)>; workerWasmLoading: NonNullable<(undefined | string | false)>; workerChunkLoading: NonNullable<(undefined | string | false)>; chunkFormat: NonNullable<(undefined | string | false)>; module: NonNullable<(undefined | boolean)>; asyncChunks: NonNullable<(undefined | boolean)>; charset: NonNullable<(undefined | boolean)>; iife: NonNullable<(undefined | boolean)>; globalObject: string; scriptType: NonNullable<(undefined | false | "module" | "text/javascript")>; path: string; pathinfo: NonNullable<(undefined | boolean | "verbose")>; hashFunction: NonNullable<(undefined | string | typeof Hash)>; hashDigest: string; hashDigestLength: number; chunkLoadTimeout: number; chunkLoading: NonNullable<(undefined | string | false)>; chunkLoadingGlobal: string; compareBeforeEmit: NonNullable<(undefined | boolean)>; strictModuleErrorHandling: NonNullable<(undefined | boolean)>; strictModuleExceptionHandling: NonNullable<(undefined | boolean)>; strictModuleResolution: NonNullable<(undefined | boolean)>; importFunctionName: string; importMetaName: string; environment: RecursiveNonNullable<Environment>; crossOriginLoading: NonNullable<(undefined | false | "anonymous" | "use-credentials")>; wasmLoading: NonNullable<(undefined | string | false)> });
...
type ParserOptionsByModuleType = (ParserOptionsByModuleTypeKnown & ParserOptionsByModuleTypeUnknown);
...
type PathDataModule = (PathData & { module: (Module | ModulePathData); chunkGraph: ChunkGraph });
...
declare interface PitchLoaderDefinitionFunction<OptionsType = {  }, ContextAdditions = {  }> {
...
type Plugin = (undefined | null | false | "" | 0 | { apply: ((this: Resolver,  resolver: Resolver) => void) } | ((this: Resolver,  resolver: Resolver) => void));
declare interface PnpApi {
	
/**
 * resolve to unqualified
 */
resolveToUnqualified: (( packageName: string, issuer: string, options: { considerBuiltins: (boolean) }) => (null | string));
}
...
type ProblemType = ("unknown-argument" | "unexpected-non-array-in-path" | "unexpected-non-object-in-path" | "prototype-pollution-in-path" | "multiple-values-unexpected" | "invalid-value");
...
constructor( options?: ProgressPluginArgument);
	...
	percentBy: (null | "entries" | "dependencies" | "modules");
	progressBar: (false | "auto" | Required<{ 
/**
 ...
 * Applies the plugin by registering its hooks on the compiler.
 */
apply( compiler: (Compiler | defaultMultiCompiler)): void;
	
/**
 * Returns a progress reporter, if any.
 */
static getReporter( compiler: Compiler): (undefined | (( p: number, ...args: (string)[]) => void));
	static defaultOptions: Required<Omit<ProgressPluginOptions, "handler">>;
	static createDefaultHandler: (( profile: (undefined | null | boolean), logger: WebpackLogger, progressBar?: (false | Required<{ 
/**
 * Color used for the filled portion of the bar.
 */
color?: (string); 
 ...
 * Width of the progress bar in characters. Default: 25.
 */
width?: (number) }>), timing?: (TimingOptions)) => (( percentage: number, msg: string, ...args: (string)[]) => void));
}
...
type PureCondition = (boolean | (( compilation: Compilation, module: Module) => (boolean)));
...
declare interface RawLoaderDefinitionFunction<OptionsType = {  }, ContextAdditions = {  }> {
	(this: (NormalModuleLoaderContext<OptionsType> & LoaderRunnerLoaderContext<OptionsType> & LoaderPluginLoaderContext & HotModuleReplacementPluginLoaderContext & ContextAdditions),  content: Buffer, sourceMap?: (string | RawSourceMap), additionalData?: (AdditionalData)): (string | void | Buffer | Promise<(string | Buffer)>);
}
...
declare interface Read<TBuffer extends NodeJS.ArrayBufferView = NodeJS.ArrayBufferView> {
	( fd: number, buffer: TBuffer, offset: number, length: number, position: (null | number | bigint), callback: (( err: (null | NodeJS.ErrnoException), bytesRead: number, buffer: TBuffer) => void)): void;
	...
	( fd: number, callback: (( err: (null | NodeJS.ErrnoException), bytesRead: number, buffer: NodeJS.ArrayBufferView) => void)): void;
}
...
declare interface ReadFileFs {
	...
	( path: PathOrFileDescriptorFs, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsFs & { flag?: (string) } & Abortable)), callback: (( err: (null | NodeJS.ErrnoException), result?: (string | Buffer)) => void)): void;
	( path: PathOrFileDescriptorFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (Buffer)) => void)): void;
}
declare interface ReadFileSync {
	( path: PathOrFileDescriptorFs, options?: (null | { encoding?: (null); flag?: (string) })): Buffer;
	( path: PathOrFileDescriptorFs, options: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | { encoding: BufferEncoding; flag?: (string) })): string;
	( path: PathOrFileDescriptorFs, options?: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsFs & { flag?: (string) }))): (string | Buffer);
}
declare interface ReadFileTypes {
	( path: PathOrFileDescriptorTypes, options: (undefined | null | ({ encoding?: (null); flag?: (string) } & Abortable)), callback: (( err: (null | NodeJS.ErrnoException), result?: (Buffer)) => void)): void;
	( path: PathOrFileDescriptorTypes, options: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | ({ encoding: BufferEncoding; flag?: (string) } & Abortable)), callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
	( path: PathOrFileDescriptorTypes, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsTypes & { flag?: (string) } & Abortable)), callback: (( err: (null | NodeJS.ErrnoException), result?: (string | Buffer)) => void)): void;
	( path: PathOrFileDescriptorTypes, callback: (( err: (null | NodeJS.ErrnoException), result?: (Buffer)) => void)): void;
}
type ReadStreamOptions = (StreamOptions & { fs?: (null | CreateReadStreamFSImplementation); end?: (number) });
declare interface ReaddirFs {
	( path: PathLikeFs, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | { encoding: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex"); withFileTypes?: (false); recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[])) => void)): void;
	( path: PathLikeFs, options: ("buffer" | { encoding: "buffer"; withFileTypes?: (false); recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((Buffer)[])) => void)): void;
	( path: PathLikeFs, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsFs & { withFileTypes?: (false); recursive?: (boolean) })), callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[] | (Buffer)[])) => void)): void;
	( path: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[])) => void)): void;
	( path: PathLikeFs, options: (ObjectEncodingOptionsFs & { withFileTypes: true; recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((DirentFs<string>)[])) => void)): void;
	( path: PathLikeFs, options: { encoding: "buffer"; withFileTypes: true; recursive?: (boolean) }, callback: (( err: (null | NodeJS.ErrnoException), files: (DirentFs<Buffer>)[]) => void)): void;
}
declare interface ReaddirSync {
	( path: PathLikeFs, options?: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | { encoding: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex"); withFileTypes?: (false); recursive?: (boolean) })): (string)[];
	( path: PathLikeFs, options: ("buffer" | { encoding: "buffer"; withFileTypes?: (false); recursive?: (boolean) })): (Buffer)[];
	( path: PathLikeFs, options?: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsFs & { withFileTypes?: (false); recursive?: (boolean) }))): ((string)[] | (Buffer)[]);
	( path: PathLikeFs, options: (ObjectEncodingOptionsFs & { withFileTypes: true; recursive?: (boolean) })): (DirentFs<string>)[];
	( path: PathLikeFs, options: { encoding: "buffer"; withFileTypes: true; recursive?: (boolean) }): (DirentFs<Buffer>)[];
}
declare interface ReaddirTypes {
	( path: PathLikeTypes, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | { encoding: (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex"); withFileTypes?: (false); recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[])) => void)): void;
	( path: PathLikeTypes, options: ("buffer" | { encoding: "buffer"; withFileTypes?: (false); recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((Buffer)[])) => void)): void;
	( path: PathLikeTypes, options: (undefined | null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsTypes & { withFileTypes?: (false); recursive?: (boolean) })), callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[] | (Buffer)[])) => void)): void;
	( path: PathLikeTypes, callback: (( err: (null | NodeJS.ErrnoException), files?: ((string)[])) => void)): void;
	( path: PathLikeTypes, options: (ObjectEncodingOptionsTypes & { withFileTypes: true; recursive?: (boolean) }), callback: (( err: (null | NodeJS.ErrnoException), files?: ((DirentTypes<string>)[])) => void)): void;
	( path: PathLikeTypes, options: { encoding: "buffer"; withFileTypes: true; recursive?: (boolean) }, callback: (( err: (null | NodeJS.ErrnoException), files: (DirentTypes<Buffer>)[]) => void)): void;
}
declare interface ReadlinkFs {
	( path: PathLikeFs, options: EncodingOptionFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
	( path: PathLikeFs, options: BufferEncodingOption, callback: (( err: (null | NodeJS.ErrnoException), result?: (Buffer)) => void)): void;
	( path: PathLikeFs, options: EncodingOptionFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (string | Buffer)) => void)): void;
	( path: PathLikeFs, callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
}
...
declare interface ReadlinkTypes {
	( path: PathLikeTypes, options: EncodingOptionTypes, callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
	( path: PathLikeTypes, options: BufferEncodingOption, callback: (( err: (null | NodeJS.ErrnoException), result?: (Buffer)) => void)): void;
	( path: PathLikeTypes, options: EncodingOptionTypes, callback: (( err: (null | NodeJS.ErrnoException), result?: (string | Buffer)) => void)): void;
	( path: PathLikeTypes, callback: (( err: (null | NodeJS.ErrnoException), result?: (string)) => void)): void;
}
...
type Records = (KnownRecords & Record<string, (KnownRecords)[]> & Record<string, any>);
...
type RecursiveArrayOrRecord<T> = ({ [index: string]: RecursiveArrayOrRecord<T> } | (RecursiveArrayOrRecord<T>)[] | T);
...
declare interface Reference {
	...
	writeExpr: (null | Program | UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | SpreadElement | PrivateIdentifier | Super | FunctionDeclaration | VariableDeclaration | ClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration | MethodDefinition | PropertyDefinition | VariableDeclarator | AssignmentProperty | Property | CatchClause | ClassBody | ImportSpecifier | ImportDefaultSpecifier | ImportNamespaceSpecifier | ExportSpecifier | ObjectPattern | ArrayPattern | RestElement | AssignmentPattern | SwitchCase | TemplateElement);
	init: (boolean);
	isWrite: (( ) => (boolean));
	isRead: (( ) => (boolean));
	isWriteOnly: (( ) => (boolean));
 ...
 */
onlyModule?: (boolean) })[] | { [index: string]: (string | false | (string)[]) });
 ...
 */
plugins?: (((undefined | null | false | "" | 0 | { [index: string]: any; 
/**
 * The run point of the plugin, required method.
 */
apply: (( arg0: Resolver) => void) } | ((this: Resolver,  arg1: Resolver) => void) | "..."))[]);
...
type RuleSetConditionOrConditions = (string | RegExp | (( value: string) => (boolean)) | RuleSetLogicalConditions | (RuleSetCondition)[]);
 ...
 * Logical NOT.
 */
not?: (string | RegExp | (( value: string) => (boolean)) | RuleSetLogicalConditions | (RuleSetCondition)[]);
 ...
 */
phase?: (string | RegExp | (( value: string) => (boolean)) | RuleSetLogicalConditions | (RuleSetCondition)[]);
 ...
 */
use?: (string | ((undefined | null | string | false | 0 | RuleSetUseFunction | { 
/**
 ...
 * Loader options.
 */
options?: (string | { [index: string]: any }) }))[] | RuleSetUseFunction | { 
/**
 * Unique loader options identifier.
 */
ident?: (string); 
...
type RuleSetUse = (string | ((undefined | null | string | false | 0 | RuleSetUseFunction | { 
/**
 * Unique loader options identifier.
 */
ident?: (string); 
 ...
 */
options?: (string | { [index: string]: any }) });
type RuleSetUseFunction = (( data: EffectData) => (string | RuleSetUseFunction | { 
/**
 * Unique loader options identifier.
 */
ident?: (string); 
 ...
 * Loader options.
 */
options?: (string | { [index: string]: any }) } | ((undefined | null | string | false | 0 | RuleSetUseFunction | { 
/**
 * Unique loader options identifier.
 */
ident?: (string); 
 ...
 */
options?: (string | { [index: string]: any }) }))[]));
type RuleSetUseItem = (string | RuleSetUseFunction | { 
/**
 * Unique loader options identifier.
 */
ident?: (string); 
 ...
 */
type: ("promise" | "expression" | "statements") }): string;
 ...
 */
runtimeRequirements: Set<string> }): string;
 ...
 * module dependency
 */
dependency?: (ModuleDependency) }): [string, string];
 ...
 */
mangleableNamespace?: (boolean) }): string;
...
declare abstract class RuntimeValue {
	fn: (( value: { module: NormalModule; key: string; readonly version: ValueCacheVersion }) => CodeValuePrimitive);
 ...
 * Returns code.
 */
exec( parser: JavascriptParser, valueCacheVersions: Map<string, ValueCacheVersion>, key: string): CodeValuePrimitive;
...
type SchemaUtilErrorObject = (ErrorObject<string> & { children?: ((ErrorObject<string>)[]) });
declare interface Scope {
	type: ("function" | "module" | "with" | "global" | "block" | "catch" | "class" | "class-field-initializer" | "class-static-block" | "for" | "function-expression-name" | "switch" | "TDZ");
	isStrict: (boolean);
	upper: (null | Scope);
	childScopes: (Scope)[];
	variableScope: Scope;
 ...
 */
declare abstract class SerializerMiddleware<DeserializedType, SerializedType, Context> {
	
/**
 * Serializes this instance into the provided serializer context.
 */
serialize( data: DeserializedType, context: Context): (null | SerializedType | Promise<SerializedType>);
...
type ServerLazyCompilationBackend = (ServerImportHttp<typeof IncomingMessage> | ServerImportHttps<typeof IncomingMessage>);
 ...
 */
static moduleHasSideEffects( moduleName: string, flagValue: SideEffectsFlagValue, cache: Map<string, RegExp>): (undefined | boolean);
}
 ...
 */
setContextTimestamps( value: Map<string, (null | ResolvedContextFileSystemInfoEntry)>): void;
 ...
 */
setContextTshs( value: Map<string, (null | ResolvedContextTimestampAndHash)>): void;
...
type SnapshotNormalizedWithDefaults = (SnapshotOptionsWebpackOptions & { managedPaths: ((string | RegExp))[]; unmanagedPaths: ((string | RegExp))[]; immutablePaths: ((string | RegExp))[]; resolveBuildDependencies: { 
/**
 ...
 */
timestamp?: (boolean) }; buildDependencies: { 
/**
 * Use hashes of the content of the files/directories to determine invalidation.
 */
hash?: (boolean); 
...
type SourceType = ("html" | "script" | "css-url" | "stylesheet" | "src" | "srcset" | "script-module" | "stylesheet-style" | "stylesheet-style-attribute" | "srcdoc" | "preload" | "modulepreload" | "prefetch" | "msapplication-task");
type SourceTypeOrResolver = ("html" | "script" | "css-url" | "stylesheet" | "src" | "srcset" | "script-module" | "stylesheet-style" | "stylesheet-style-attribute" | "srcdoc" | "preload" | "modulepreload" | "prefetch" | "msapplication-task" | (( attrs: Map<string, string>, css: (boolean)) => SourceType));
...
declare interface SplitChunksOptions {
	...
	filename?: (string | (( pathData: PathDataChunk, assetInfo?: (AssetInfo)) => string));
	automaticNameDelimiter: string;
	getCacheGroups: (( module: Module, context: CacheGroupsContext) => (null | (CacheGroupSource)[]));
	getName: (( module: Module, chunks: (Chunk)[], key: string) => (undefined | string));
	usedExports: (boolean);
...
declare interface StarListDeserializerContext {
	...
	rest: ObjectDeserializerContextObjectMiddlewareObject_4<[]>;
	setCircularReference: (( value: ReferenceableItem) => void);
}
...
declare interface StarListSerializerContext {
	write: (( value: (HarmonyExportImportedSpecifierDependency)[]) => ObjectSerializerContextObjectMiddlewareObject_5<[]>);
	setCircularReference: (( value: ReferenceableItem) => void);
	snapshot: (( ) => ObjectSerializerSnapshot);
	rollback: (( snapshot: ObjectSerializerSnapshot) => void);
	writeLazy?: ((( item?: any) => void));
...
type StatementPathItem = (UnaryExpression | ArrayExpression | ArrowFunctionExpression | AssignmentExpression | AwaitExpression | BinaryExpression | SimpleCallExpression | NewExpression | ChainExpression | ClassExpression | ConditionalExpression | FunctionExpression | Identifier | ImportExpressionImport | SimpleLiteral | RegExpLiteral | BigIntLiteral | LogicalExpression | MemberExpression | MetaProperty | ObjectExpression | SequenceExpression | TaggedTemplateExpression | TemplateLiteral | ThisExpression | UpdateExpression | YieldExpression | FunctionDeclaration | MaybeNamedFunctionDeclaration | VariableDeclaration | ClassDeclaration | MaybeNamedClassDeclaration | ExpressionStatement | BlockStatement | StaticBlock | EmptyStatement | DebuggerStatement | WithStatement | ReturnStatement | LabeledStatement | BreakStatement | ContinueStatement | IfStatement | SwitchStatement | ThrowStatement | TryStatement | WhileStatement | DoWhileStatement | ForStatement | ForInStatement | ForOfStatement | ImportDeclaration | ExportNamedDeclaration | ExportDefaultDeclaration | ExportAllDeclaration);
declare class Stats {
...
declare interface StatsFactoryHooks {
	...
	filter: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], (boolean | void)>>;
	sort: HookMap<SyncBailHook<[((( a?: any, b?: any) => (0 | 1 | -1)))[], StatsFactoryContext], void>>;
	filterSorted: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], (boolean | void)>>;
	groupResults: HookMap<SyncBailHook<[(GroupConfig<any, any>)[], StatsFactoryContext], void>>;
	sortResults: HookMap<SyncBailHook<[((( a?: any, b?: any) => (0 | 1 | -1)))[], StatsFactoryContext], void>>;
	filterResults: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], (boolean | void)>>;
	...
	getItemFactory: HookMap<SyncBailHook<[any, StatsFactoryContext], (void | StatsFactory)>>;
}
 ...
 */
children?: (boolean | StatsOptions | "verbose" | "none" | "summary" | "errors-only" | "errors-warnings" | "minimal" | "normal" | "detailed" | (StatsValue)[]);
 ...
 * Add logging output.
 */
logging?: (boolean | "error" | "log" | "verbose" | "info" | "none" | "warn");
 ...
 */
warningsFilter?: (string | RegExp | (WarningFilterItemTypes)[] | (( warning: StatsError, warningString: string) => (boolean)));
...
declare interface StatsPrintHooks {
	...
	printElements: HookMap<SyncBailHook<[(PrintedElement)[], StatsPrinterContext], (undefined | string | void)>>;
	sortItems: HookMap<SyncBailHook<[(any)[], StatsPrinterContext], (boolean | void)>>;
	getItemName: HookMap<SyncBailHook<[any, StatsPrinterContext], (string | void)>>;
	printItems: HookMap<SyncBailHook<[(string)[], StatsPrinterContext], (undefined | string)>>;
	print: HookMap<SyncBailHook<[any, StatsPrinterContext], (undefined | string | void)>>;
 ...
 */
print( type: string, object?: any, baseContext?: (StatsPrinterContext)): (undefined | string);
}
type StatsPrinterContext = (KnownStatsPrinterColorFunctions & KnownStatsPrinterFormatters & KnownStatsPrinterContext & Record<string, any>);
type StatsProfile = (KnownStatsProfile & Record<string, any>);
type StatsValue = (boolean | StatsOptions | "verbose" | "none" | "summary" | "errors-only" | "errors-warnings" | "minimal" | "normal" | "detailed");
...
declare interface StreamOptions {
	flags?: (string);
	encoding?: ("base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex");
	fd?: any;
	mode?: (number);
	autoClose?: (boolean);
	emitClose?: (boolean);
...
declare interface TagInfo {
	tag: symbol;
	data?: (Record<string, any> | HarmonySettings | ImportSettings | CommonJsImportSettings | TopLevelSymbol | CompatibilitySettings);
	next?: (TagInfo);
}
type Tail<T extends ReadonlyArray<any>> = (T extends readonly [any, ...infer R] ? R : T);
 ...
 */
static renderChunkModules( renderContext: ChunkRenderContextJavascriptModulesPlugin, modules: (Module)[], renderModule: (( module: Module, renderInArray?: (boolean)) => (null | Source)), prefix?: (string)): (null | Source);
 ...
 */
constructor( name: string, pure?: (boolean | (( compilation: Compilation, module: Module) => (boolean))));
	name: string;
	conditional: (boolean);
...
declare abstract class ValidationErrorWebpackOptionsValidationError extends Error {
	...
	headerName: string;
	baseDataPath: string;
	postFormatter: (null | PostFormatter);
	getSchemaPart( path: string): (Parameters<typeof validateFunction>)[0];
	formatSchema( schema: (Parameters<typeof validateFunction>)[0], logic?: (boolean), prevSchemas?: ((object)[])): string;
	getSchemaPartText( schemaPart?: ((JSONSchema4 & ExtendedSchema) | (JSONSchema6 & ExtendedSchema) | (JSONSchema7 & ExtendedSchema)), additionalPath?: (boolean | (string)[]), needDot?: (boolean), logic?: (boolean)): string;
	getSchemaPartDescription( schemaPart?: ((JSONSchema4 & ExtendedSchema) | (JSONSchema6 & ExtendedSchema) | (JSONSchema7 & ExtendedSchema))): string;
 ...
 */
constructor( declaredScope: ScopeInfo, name: (undefined | string), flags: VariableInfoFlagsType, tagInfo?: (TagInfo));
 ...
 */
source: (( loaderContext: LoaderContext<any>) => (string | Buffer | Promise<(string | Buffer)>));
...
type VirtualModuleContent = (string | (( loaderContext: LoaderContext<any>) => (string | Buffer | Promise<(string | Buffer)>)) | VirtualModule);
 ...
 */
constructor( modules: VirtualModules, schemeOrOptions?: (string | Omit<VirtualUrlOptions, "modules">));
...
type WarningFilterItemTypes = (string | RegExp | (( warning: StatsError, warningString: string) => (boolean)));

/**
 * Returns location of targetPath relative to rootPath.
 */
declare interface WatchFileSystem {
	watch: (( files: Iterable<string>, directories: Iterable<string>, missing: Iterable<string>, startTime: number, options: WatchOptions, callback: (( err: (null | Error), timeInfoEntries1?: (Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>), timeInfoEntries2?: (Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>), changes?: (Set<string>), removals?: (Set<string>)) => void), callbackUndelayed: (( value: string, num: number) => void)) => Watcher);
}
 ...
 */
getFileTimeInfoEntries: (( ) => Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>);
	
/**
 * get info about directories
 */
getContextTimeInfoEntries: (( ) => Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>);
 ...
 * get info about files
 */
fileTimeInfoEntries: Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>;
	
/**
 * get info about directories
 */
contextTimeInfoEntries: Map<string, (null | "ignore" | EntryTypesIndex | OnlySafeTimeEntry | ExistenceOnlyTimeEntryTypesIndex)>;
}
 ...
 */
cachedProvide( compute: (( thisArg: any, ...args: K) => V), thisArg: any, args: K): V;
...
type WebpackOptionsNormalizedWithDefaults = (WebpackOptionsNormalized & { context: string } & { infrastructureLogging: InfrastructureLoggingNormalizedWithDefaults } & { target: NonNullable<(undefined | string | false | (string)[])> } & { output: OutputNormalizedWithDefaults } & { optimization: OptimizationNormalizedWithDefaults } & { devtool: NonNullable<(undefined | string | false | ({ 
/**
 * Which asset type should receive this devtool value.
 */
type: ("all" | "css" | "javascript"); 
 ...
 * A developer tool to enhance debugging (false | eval | [inline-|hidden-|eval-][nosources-][cheap-[module-]]source-map).
 */
use: RawDevTool })[])> } & { stats: NonNullable<StatsValue> } & { node: NonNullable<NodeWebpackOptions> } & { profile: NonNullable<(undefined | boolean)> } & { parallelism: number } & { snapshot: SnapshotNormalizedWithDefaults } & { externalsPresets: ExternalsPresetsNormalizedWithDefaults } & { externalsType: NonNullable<(undefined | "import" | "module" | "promise" | "commonjs" | "jsonp" | "var" | "assign" | "this" | "window" | "self" | "global" | "commonjs2" | "commonjs-module" | "commonjs-static" | "amd" | "amd-require" | "amd-async" | "umd" | "umd2" | "system" | "module-import" | "script" | "node-commonjs" | "asset" | "asset-url" | "css-import" | "css-url")> } & { watch: NonNullable<(undefined | boolean)> } & { performance: NonNullable<(undefined | false | PerformanceOptions)> } & { recordsInputPath: NonNullable<(undefined | string | false)> } & { recordsOutputPath: NonNullable<(undefined | string | false)> } & { dotenv: NonNullable<(undefined | boolean | DotenvPluginOptions)> });
...
declare interface WriteFile {
	( file: PathOrFileDescriptorFs, data: (string | NodeJS.ArrayBufferView), options: WriteFileOptions, callback: (( err: (null | NodeJS.ErrnoException)) => void)): void;
	( file: PathOrFileDescriptorFs, data: (string | NodeJS.ArrayBufferView), callback: (( err: (null | NodeJS.ErrnoException)) => void)): void;
}
type WriteFileOptions = (null | "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64url" | "latin1" | "binary" | "hex" | (ObjectEncodingOptionsFs & Abortable & { mode?: (string | number); flag?: (string); flush?: (boolean) }));
declare interface WriteOnlySet<T> {
	add: (( item: T) => void);
}
type WriteStreamOptions = (StreamOptions & { fs?: (null | CreateWriteStreamFSImplementation); flush?: (boolean) });

/**
 * Compile boolean matcher.
 */
declare interface _functionCompileBooleanMatcher {
...
export let compareChunksNatural: (( chunkGraph: ChunkGraph) => Comparator<Chunk>);
export let compareIds: (( a: (string | number), b: (string | number)) => (0 | 1 | -1));
export let compareIterables: (<T>( elementComparator: Comparator<T>) => Comparator<Iterable<T>>);
export let compareLocations: (( a: DependencyLocation, b: DependencyLocation) => (0 | 1 | -1));
export let compareModulesByFullName: ParameterizedComparator<Compiler, Module>;
export let compareModulesById: ParameterizedComparator<ChunkGraph, Module>;
export let compareModulesByIdOrIdentifier: ParameterizedComparator<ChunkGraph, Module>;
export let compareModulesByIdentifier: (( a: Module, b: Module) => (0 | 1 | -1));
export let compareModulesByPostOrderIndexOrIdentifier: ParameterizedComparator<ModuleGraph, Module>;
export let compareModulesByPreOrderIndexOrIdentifier: ParameterizedComparator<ModuleGraph, Module>;
export let compareNumbers: (( a: number, b: number) => (0 | 1 | -1));
export let compareSelect: (<T, R>( getter: Selector<T, R>, comparator: Comparator<R>) => Comparator<T>);
export let compareStrings: (( a: string, b: string) => (0 | 1 | -1));
export let compareStringsNumeric: (( a: string, b: string) => (0 | 1 | -1));
export let concatComparators: (<T>( c1: Comparator<T>, c2: (undefined | Comparator<T>), ...cRest: (Comparator<T>)[]) => Comparator<T>);
export let keepOriginalOrder: (<T>( iterable: Iterable<T>) => Comparator<T>);
export let sortWithSourceOrder: (( dependencies: (Dependency)[], dependencySourceOrderMap: WeakMap<Dependency, DependencySourceOrder>, onDependencyReSort?: ((( dep: Dependency, index: number) => void))) => void);

}
declare interface declarations {
...
declare class defaultMultiCompiler {
	
/**
 * Creates an instance of MultiCompiler.
 */
constructor( compilers: ((Compiler)[] | Record<string, Compiler>), options: MultiCompilerOptions);
	hooks: Readonly<{ done: SyncHook<[MultiStats]>; invalid: MultiHook<SyncHook<[(null | string), number]>>; run: MultiHook<AsyncSeriesHook<[Compiler]>>; watchClose: SyncHook<[]>; watchRun: MultiHook<AsyncSeriesHook<[Compiler]>>; infrastructureLog: MultiHook<SyncBailHook<[string, string, (undefined | (any)[])], (true | void)>> }>;
	compilers: (Compiler)[];
...
declare abstract class defaultResolverFactory {
	hooks: Readonly<{ resolveOptions: HookMap<SyncWaterfallHook<[ResolveOptionsWithDependencyType], ResolveOptionsWithDependencyType>>; resolver: HookMap<SyncHook<[Resolver, ResolveOptionsResolverFactoryObject2, ResolveOptionsWithDependencyType]>> }>;
...
declare class defaultSplitChunksPlugin {
 ...
 */
options?: (string | { [index: string]: any }) }))[]));
export type WebpackPluginFunction = ((this: Compiler,  compiler: Compiler) => void);
export type ExternalItemFunctionCallback = (( data: ExternalItemFunctionData, callback: (( err?: (null | Error), result?: (string | boolean | (string)[] | (ExternalItemValueObjectKnown & ExternalItemValueObjectUnknown))) => void)) => void);
export type ExternalItemFunctionDataGetResolve = (( options?: (ResolveOptions)) => ((( context: string, request: string, callback: (( err?: (null | Error), result?: (string | false), resolveRequest?: (ResolveRequest)) => void)) => void) | (( context: string, request: string) => Promise<string>)));
export type ExternalItemFunctionDataGetResolveCallbackResult = (( context: string, request: string, callback: (( err?: (null | Error), result?: (string | false), resolveRequest?: (ResolveRequest)) => void)) => void);
export type ExternalItemFunctionDataGetResolveResult = (( context: string, request: string) => Promise<string>);
export type ExternalItemFunctionPromise = (( data: ExternalItemFunctionData) => Promise<ExternalItemValue>);
...
export let filterRuntime: (( runtime: RuntimeSpec, filter: (( runtime?: RuntimeSpec) => (boolean))) => (undefined | string | boolean | SortableSet<string>));
export let forEachRuntime: (( runtime: RuntimeSpec, fn: (( runtime?: (string)) => void), deterministicOrder?: (boolean)) => void);
export let getEntryRuntime: (( compilation: Compilation, name: string, options?: (EntryOptions)) => RuntimeSpec);
export let getRuntimeKey: (( runtime: RuntimeSpec) => string);
export let intersectRuntime: (( a: RuntimeSpec, b: RuntimeSpec) => RuntimeSpec);
export let keyToRuntime: (( key: string) => RuntimeSpec);
export let mergeRuntime: (( a: RuntimeSpec, b: RuntimeSpec) => RuntimeSpec);
export let mergeRuntimeCondition: (( a: RuntimeCondition, b: RuntimeCondition, runtime: RuntimeSpec) => RuntimeCondition);
export let mergeRuntimeConditionNonFalse: (( a: (undefined | string | true | SortableSet<string>), b: (undefined | string | true | SortableSet<string>), runtime: RuntimeSpec) => (undefined | string | true | SortableSet<string>));
export let mergeRuntimeOwned: (( a: RuntimeSpec, b: RuntimeSpec) => RuntimeSpec);
export let runtimeConditionToString: (( runtimeCondition: RuntimeCondition) => string);
export let runtimeEqual: (( a: RuntimeSpec, b: RuntimeSpec) => (boolean));
export let runtimeToString: (( runtime: RuntimeSpec) => string);
export let subtractRuntime: (( a: RuntimeSpec, b: RuntimeSpec) => RuntimeSpec);
export let subtractRuntimeCondition: (( a: RuntimeCondition, b: RuntimeCondition, runtime: RuntimeSpec) => RuntimeCondition);
