...
- Add `performance.duplicatePackages` to report packages included more than once. (by [@alexander-akait](https://github.com/alexander-akait) in [#21726](https://github.com/webpack/webpack/pull/21726))
...
- Recommend `optimization.runtimeChunk` when a large entrypoint carries the runtime. (by [@alexander-akait](https://github.com/alexander-akait) in [#21728](https://github.com/webpack/webpack/pull/21728))
...
- Add `performance.all` to enable every check that is not set individually. (by [@alexander-akait](https://github.com/alexander-akait) in [#21776](https://github.com/webpack/webpack/pull/21776))

- Add `performance.circularDependencies` using the export-inlining cycle scan. (by [@alexander-akait](https://github.com/alexander-akait) in [#21747](https://github.com/webpack/webpack/pull/21747))

- Add `performance.osDependentRules`, `performance.cacheEffectiveness`, `performance.duplicateModules` and `performance.redundantDynamicImports`, and name the largest modules in an oversized asset. (by [@alexander-akait](https://github.com/alexander-akait) in [#21744](https://github.com/webpack/webpack/pull/21744))

- Add `performance.hints: "stats"` to report hints in stats only. (by [@alexander-akait](https://github.com/alexander-akait) in [#21738](https://github.com/webpack/webpack/pull/21738))

- Add performance hints for how chunks load and what splitting refused. (by [@alexander-akait](https://github.com/alexander-akait) in [#21769](https://github.com/webpack/webpack/pull/21769))

- Add performance hints reporting why webpack skipped an optimization. (by [@alexander-akait](https://github.com/alexander-akait) in [#21758](https://github.com/webpack/webpack/pull/21758))

- Add performance hints for defines, externals and aliases nothing uses. (by [@alexander-akait](https://github.com/alexander-akait) in [#21761](https://github.com/webpack/webpack/pull/21761))

- Add `performance.unusedReexports` to report modules a barrel drags in unused. (by [@alexander-akait](https://github.com/alexander-akait) in [#21756](https://github.com/webpack/webpack/pull/21756))

- Add `performance.unusedRules` to report rules that never matched a module. (by [@alexander-akait](https://github.com/alexander-akait) in [#21732](https://github.com/webpack/webpack/pull/21732))
...
- Emit analyzable ESM output for chunk, asset, stylesheet, worker and wasm urls. (by [@alexander-akait](https://github.com/alexander-akait) in [#21788](https://github.com/webpack/webpack/pull/21788))

- Tree-shake module.exports object literals and unused method requires. (by [@xiaoxiaojx](https://github.com/xiaoxiaojx) in [#21543](https://github.com/webpack/webpack/pull/21543))
...
- Add `output.environment.cssColorHexAlpha`, `cssInsetShorthand`, `cssMediaQueryRange` and `cssPlaceShorthand`, resolved from the target like the JavaScript abilities beside them, so CSS minification only reaches for a spelling the target can read. (by [@alexander-akait](https://github.com/alexander-akait) in [#21588](https://github.com/webpack/webpack/pull/21588))
...
- Minify more CSS: values, shorthands, rules, layers, vendor spellings, spacing. (by [@alexander-akait](https://github.com/alexander-akait) in [#21648](https://github.com/webpack/webpack/pull/21648))
...
- Add and drop CSS vendor prefixes for a browserslist target (`vendorPrefixes`). (by [@alexander-akait](https://github.com/alexander-akait) in [#21721](https://github.com/webpack/webpack/pull/21721))

- Shorten CSS custom property values with `rewriteCustomProperties`. (by [@alexander-akait](https://github.com/alexander-akait) in [#21784](https://github.com/webpack/webpack/pull/21784))
...
- Load runtime modules, parsers, generators and dependencies only when used. (by [@alexander-akait](https://github.com/alexander-akait) in [#21652](https://github.com/webpack/webpack/pull/21652))
...
- Improve tree-shaking for a namespace reexported as default. (by [@hai-x](https://github.com/hai-x) in [#21710](https://github.com/webpack/webpack/pull/21710))
...
- Report performance hints after hashing, so enabling one keeps the hash. (by [@alexander-akait](https://github.com/alexander-akait) in [#21783](https://github.com/webpack/webpack/pull/21783))

- Report performance hints in a stable order when entries tie. (by [@alexander-akait](https://github.com/alexander-akait) in [#21746](https://github.com/webpack/webpack/pull/21746))
...
- Match the spec's tree for frameset content, quirks paragraphs and selects. (by [@alexander-akait](https://github.com/alexander-akait) in [#21787](https://github.com/webpack/webpack/pull/21787))

- Write CSS selector lists, An+B and more values in their shortest spelling. (by [@alexander-akait](https://github.com/alexander-akait) in [#21664](https://github.com/webpack/webpack/pull/21664))
...
- Minify a dropped CSS comment to the token boundary it stood for. (by [@bjohansebas](https://github.com/bjohansebas) in [#21635](https://github.com/webpack/webpack/pull/21635))
...
- Parse `<?target data?>` as a processing instruction rather than a bogus comment. (by [@alexander-akait](https://github.com/alexander-akait) in [#21695](https://github.com/webpack/webpack/pull/21695))

- Report comment data and DOCTYPE identifiers from the HTML tokenizer's own states, and drop `</>` as the spec does. (by [@alexander-akait](https://github.com/alexander-akait) in [#21630](https://github.com/webpack/webpack/pull/21630))

- Only make CSS and HTML transformations an engine cannot tell apart. (by [@alexander-akait](https://github.com/alexander-akait) in [#21774](https://github.com/webpack/webpack/pull/21774))

- Drop unused side-effect-free CommonJS require() calls and reexports. (by [@xiaoxiaojx](https://github.com/xiaoxiaojx) in [#21502](https://github.com/webpack/webpack/pull/21502))
...
- Fix `[object Object]` asset urls and crashes in build-time executed modules. (by [@alexander-akait](https://github.com/alexander-akait) in [#21672](https://github.com/webpack/webpack/pull/21672))

- Fix legacy JavaScript script types, void `keygen` and font format detection. (by [@alexander-akait](https://github.com/alexander-akait) in [#21676](https://github.com/webpack/webpack/pull/21676))

- Fix `import.meta` crashing build-time executed modules with ESM output. (by [@alexander-akait](https://github.com/alexander-akait) in [#21673](https://github.com/webpack/webpack/pull/21673))

- Keep an optional end tag the parent or the next element cannot close. (by [@alexander-akait](https://github.com/alexander-akait) in [#21743](https://github.com/webpack/webpack/pull/21743))
...
- Speed up CSS and HTML minification, cut allocations; select output with `mode`. (by [@alexander-akait](https://github.com/alexander-akait) in [#21675](https://github.com/webpack/webpack/pull/21675))

- Keep CSS minification from changing whether a declaration parses. (by [@alexander-akait](https://github.com/alexander-akait) in [#21751](https://github.com/webpack/webpack/pull/21751))

- Report the cache-effectiveness hint's reasons in a stable order. (by [@alexander-akait](https://github.com/alexander-akait) in [#21752](https://github.com/webpack/webpack/pull/21752))
...
- Recover MultiCompiler watch mode after a fatal child error and stop leaking watchings. (by [@bjohansebas](https://github.com/bjohansebas) in [#21584](https://github.com/webpack/webpack/pull/21584))
...
- Generate every CSS and HTML lookup table into `lib/{css,html}/data.js`, the HTML ones distilled from the spec's IDL and the CSS ones now including the value-type facts read out of the value-definition grammars — a range `mdn-data` writes outside the type it bounds among them — leaving both `syntax.js` files algorithm only. (by [@alexander-akait](https://github.com/alexander-akait) in [#21588](https://github.com/webpack/webpack/pull/21588))
...
- Replace `eslint-scope` with a built-in scope analyzer. (by [@hai-x](https://github.com/hai-x) in [#21775](https://github.com/webpack/webpack/pull/21775))

- Share one file watcher pool between MultiCompiler children. (by [@bjohansebas](https://github.com/bjohansebas) in [#21641](https://github.com/webpack/webpack/pull/21641))

- Skip IIFE wrapping for RuntimeModules without locals. (by [@xiaoxiaojx](https://github.com/xiaoxiaojx) in [#21633](https://github.com/webpack/webpack/pull/21633))
...
- Fix `import d from "./mod"; d.member` reading `undefined` when `mod` re-exports a namespace as `default`. (by [@hai-x](https://github.com/hai-x) in [#21702](https://github.com/webpack/webpack/pull/21702))
