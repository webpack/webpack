...
796.output.js  592 bytes   {796}  [emitted]
    output.js    8.6 KiB   {179}  [emitted]  main
Entrypoint main = output.js
chunk {179} output.js (main) 161 bytes (javascript) 4.13 KiB (runtime) [entry] [rendered]
    > ./example.js main
...
796.output.js  96 bytes   {796}  [emitted]
    output.js  1.62 KiB   {179}  [emitted]  main
Entrypoint main = output.js
chunk {179} output.js (main) 161 bytes (javascript) 4.13 KiB (runtime) [entry] [rendered]
    > ./example.js main
