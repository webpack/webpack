...
/* harmony export */   "get": function() { return /* reexport safe */ _magic_wat__WEBPACK_IMPORTED_MODULE_0__.get; },
/* harmony export */   "getNumber": function() { return /* reexport safe */ _magic_wat__WEBPACK_IMPORTED_MODULE_0__.getNumber; },
/* harmony export */   "set": function() { return /* reexport safe */ _magic_wat__WEBPACK_IMPORTED_MODULE_0__.set; }
/* harmony export */ });
...
module.exports = Promise.resolve(WEBPACK_IMPORTED_MODULE_0).then(function(WEBPACK_IMPORTED_MODULE_0) {
...
chunk output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 1.29 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 1.65 KiB [emitted] [minimized] (name: main)
asset 3b415f18e7be9a707201.module.wasm 139 bytes [emitted] [immutable] (auxiliary name: main)
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 1.02 KiB (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 449 bytes (javascript) 139 bytes (webassembly) [dependent] 4 modules
  runtime modules 1.02 KiB 4 modules
  ./example.js 247 bytes [built] [code generated]
    [no exports]
    [no exports used]
    entry ./example.js main
