...
/******/ 			var req = fetch(__webpack_require__.p + "" + {"2":"57cfbfefe1cf7dd20007"}[wasmModuleId] + ".module.wasm");
...
chunk {179} output.js, 57cfbfefe1cf7dd20007.module.wasm (main) 724 bytes (javascript) 139 bytes (webassembly) 1.12 KiB (runtime) [entry] [rendered]
 ...
 [3] ./memory.js 218 bytes {179} [built]
     [exports: memory]
     [used exports unknown]
     wasm import ./memory.js [2] ./magic.wat
 [4] ./magic-number.js 131 bytes {179} [built]
...
chunk {179} output.js, 9eda4b1cb2ea4cc07c20.module.wasm (main) 724 bytes (javascript) 139 bytes (webassembly) 1.12 KiB (runtime) [entry] [rendered]
 ...
 [144] ./example.js 253 bytes {179} [built]
       [no exports]
       entry ./example.js main
 [555] ./magic.js 52 bytes {179} [built]
       [exports: get, getNumber, set]
       [all exports used]
