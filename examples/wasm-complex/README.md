...
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 3.3 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.32 KiB [emitted] [minimized] (name: main)
asset d6bc318b1b50ed7d6329.module.wasm 139 bytes [emitted] [immutable] (auxiliary name: main)
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 3.03 KiB (runtime) [entry] [rendered]
  > ./example.js main
