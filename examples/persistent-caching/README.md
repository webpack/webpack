...
chunk (runtime: main) output.js (main) 2.27 MiB (javascript) 1.74 KiB (runtime) [entry]
  > ./example.js main
  cached modules 2.27 MiB (javascript) 1.74 KiB (runtime) [cached] 1528 modules
...
chunk (runtime: main) output.js (main) 2.21 MiB (javascript) 1.74 KiB (runtime) [entry]
  > ./example.js main
  cached modules 2.21 MiB (javascript) 1.74 KiB (runtime) [cached] 905 modules
