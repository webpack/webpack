...
```
asset output.js 3.82 MiB [emitted] (name: main)
chunk output.js (main) 2.8 MiB (javascript) 1.66 KiB (runtime) [entry]
  > ./example.js main
  cached modules 2.8 MiB (javascript) 1.66 KiB (runtime) [cached] 1191 modules
...
chunk (runtime: main) output.js (main) 1.89 MiB (javascript) 1.37 KiB (runtime) [entry]
  > ./example.js main
  cached modules 1.89 MiB (javascript) 1.37 KiB (runtime) [cached] 570 modules
...
webpack 5.0.0-rc.0 compiled with 3 warnings
```
