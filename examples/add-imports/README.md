 ...
 */
class AddImportsPlugin {
	/**
	 * Creates an instance of AddImportsPlugin.
	 * @param {[RegExp, { before?: string, after?: string }][]} imports pairs of a resource condition and the code to put around it
	 */
	constructor(imports) {
		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			NormalModule.getCompilationHooks(compilation).processResult.tap(
				...
				(result, module) => {
					...
					for (const [test, { before = "", after = "" }] of this.imports) {
