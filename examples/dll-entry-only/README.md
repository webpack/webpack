...
/******/ 	dll_de97a008841ac4853060 = __webpack_exports__;
/******/ 	
/******/ })()
;
```
...
```javascript
{"name":"dll_de97a008841ac4853060","content":{"./example.js":{"id":1,"buildMeta":{"exportsType":"namespace"},"exports":["a","b","c"]}}}
```
...
```
asset dll.js 4.89 KiB [emitted] (name: dll)
