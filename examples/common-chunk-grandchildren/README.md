...
asset 588.output.js 741 bytes [emitted]
asset 366.output.js 563 bytes [emitted]
asset 145.output.js 557 bytes [emitted]
asset 421.output.js 439 bytes [emitted]
...
chunk output.js (main) 220 bytes (javascript) 4.96 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
asset 588.output.js 204 bytes [emitted] [minimized]
asset 145.output.js 140 bytes [emitted] [minimized]
asset 366.output.js 140 bytes [emitted] [minimized]
asset 421.output.js 131 bytes [emitted] [minimized]
chunk (runtime: main) 145.output.js 136 bytes [rendered]
  ...
  ./pageC.js 136 bytes [built] [code generated]
    ...
    cjs require ./pageC ./pageB.js 4:15-33
    cjs self exports reference ./pageC.js 3:0-14
chunk (runtime: main) output.js (main) 220 bytes (javascript) 4.96 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 4.96 KiB 6 modules
  ./example.js 220 bytes [built] [code generated]
    [no exports used]
