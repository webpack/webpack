...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					register("react", "16.14.0", () => __webpack_require__.e("node_modules_react_index_js-_11190").then(() => () => __webpack_require__(25)));
/******/ 					initExternal(12);
/******/ 					initExternal(14);
/******/ 				}
/******/ 				break;
...
/******/ 			5: () => loadSingletonVersionCheckFallback("default", "react", [1,16,14,0], () => __webpack_require__.e("node_modules_react_index_js-_11191").then(() => () => __webpack_require__(25))),
/******/ 			9: () => loadSingletonVersionCheckFallback("default", "react", [1,16,13,1], () => __webpack_require__.e("node_modules_react_index_js-_11191").then(() => () => __webpack_require__(25)))
/******/ 		};
...
/******/ 					register("react", "16.14.0", () => __webpack_require__.e("node_modules_react_index_js").then(() => () => __webpack_require__(238)));
/******/ 				}
/******/ 				break;
/******/ 			}
/******/ 			if(!promises.length) return initPromises[name] = 1;
...
/******/ 		var installedModules = {};
/******/ 		var moduleToHandlerMapping = {
/******/ 			4: () => loadSingletonVersionCheckFallback("default", "react", [1,16,13,1], () => __webpack_require__.e("node_modules_react_index_js").then(() => () => __webpack_require__(238))),
...
```
app:
  asset vendors-node_modules_date-fns_esm_locale_de_index_js-node_modules_react-dom_index_js.js 145 KiB [emitted] (id hint: vendors)
  asset app.js 28.3 KiB [emitted] (name: app)
  asset node_modules_react_index_js-_11190.js 9.02 KiB [emitted]
  asset node_modules_react_index_js-_11191.js 6.92 KiB [emitted]
  asset src_bootstrap_js-webpack_sharing_consume_default_react_react.js 4.14 KiB [emitted]
  chunk (runtime: app) app.js (app) 669 bytes (javascript) 42 bytes (share-init) 18.6 KiB (runtime) [entry] [rendered]
    > ./src/index.js app
    runtime modules 18.6 KiB 13 modules
    built modules 669 bytes (javascript) 42 bytes (share-init) [built]
      ...
      provide shared module (default) react@16.14.0 = ../../node_modules/react/index.js 42 bytes [built] [code generated]
  chunk (runtime: app) node_modules_react_index_js-_11190.js 8.76 KiB [rendered]
    > provide shared module (default) react@16.14.0 = ../../node_modules/react/index.js
  ...
  chunk (runtime: app) node_modules_react_index_js-_11191.js 6.7 KiB [rendered]
    > consume shared module (default) react@^16.14.0 (singleton) (fallback: ../../node_modules/react/index.js)
  ...
  chunk (runtime: app) src_bootstrap_js-webpack_sharing_consume_default_react_react.js 1.56 KiB (javascript) 84 bytes (consume-shared) 12 bytes (remote) 12 bytes (share-init) [rendered]
    ...
    built modules 382 bytes (javascript) 42 bytes (consume-shared) [built]
      ...
      consume shared module (default) react@^16.14.0 (singleton) (fallback: ../../node_modules/react/index.js) 42 bytes [built] [code generated]
...
mfe-b:
  asset vendors-node_modules_date-fns_esm_index_js.js 685 KiB [emitted] (id hint: vendors)
  asset mfeBBB.js 23.7 KiB [emitted] (name: mfeBBB)
  asset node_modules_react_index_js.js 9.02 KiB [emitted]
  asset src-b_Component_js.js 1.8 KiB [emitted]
  ...
  mfe-b (webpack 5.4.0) compiled successfully

mfe-c:
  assets by chunk 702 KiB (id hint: vendors)
    asset vendors-node_modules_date-fns_esm_index_js.js 685 KiB [emitted] (id hint: vendors)
    asset vendors-node_modules_lodash_random_js.js 16.8 KiB [emitted] (id hint: vendors)
  asset mfeCCC.js 24.7 KiB [emitted] (name: mfeCCC)
  asset src-c_LazyComponent_js.js 1.59 KiB [emitted]
  asset src-c_Component_js.js 1.52 KiB [emitted]
  ...
  mfe-c (webpack 5.4.0) compiled successfully
```
...
app:
  ...
  asset app.js 7.33 KiB [emitted] [minimized] (name: app)
...
mfe-b:
  ...
  asset mfeBBB.js 5.71 KiB [emitted] [minimized] (name: mfeBBB)
...
mfe-c:
  asset vendors-node_modules_date-fns_esm_index_js.js 78 KiB [emitted] [minimized] (id hint: vendors)
  asset mfeCCC.js 6.36 KiB [emitted] [minimized] (name: mfeCCC)
