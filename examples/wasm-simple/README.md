...
```
asset output.js 13.5 KiB [emitted] (name: main)
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.96 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.92 KiB [emitted] [minimized] (name: main)
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.73 KiB (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 552 bytes (javascript) 170 bytes (webassembly) [dependent] 4 modules
