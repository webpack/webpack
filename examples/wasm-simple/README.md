...
```
asset output.js 12.5 KiB [emitted] (name: main)
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.29 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
asset 6709ee3440507d7584e6.wasm 67 bytes [emitted] [immutable] (auxiliary name: main)
asset 490b94f4f462ac5a43af.wasm 62 bytes [emitted] [immutable] (auxiliary name: main)
asset 22bbece72ca1604d4d90.wasm 41 bytes [emitted] [immutable] (auxiliary name: main)
