...
chunk (runtime: main) output.js (main) 414 bytes (javascript) 6.85 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.86 KiB [emitted] [minimized] (name: main)
...
chunk (runtime: main) 98.output.js 13 bytes [rendered]
  ...
  ./node_modules/c/2.js 13 bytes [optional] [built] [code generated]
    ...
    import() context element ./2 ./node_modules/c/ lazy ^\.\/.*$ namespace object ./2
    import() context element ./2.js ./node_modules/c/ lazy ^\.\/.*$ namespace object ./2.js
chunk (runtime: main) output.js (main) 403 bytes (javascript) 6.59 KiB (runtime) [entry] [rendered]
  > ./example.js main
