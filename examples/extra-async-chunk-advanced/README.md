...
chunk output.js (main) 346 bytes (javascript) 4.82 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
chunk (runtime: main) output.js (main) 346 bytes (javascript) 4.82 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 4.82 KiB 6 modules
  ./example.js 346 bytes [built] [code generated]
    [no exports used]
