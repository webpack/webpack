...
chunk (runtime: main) output.js (main) 208 bytes (javascript) 5.47 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 5.47 KiB 9 modules
...
chunk (runtime: main) output.js (main) 208 bytes (javascript) 5.72 KiB (runtime) [entry] [rendered]
  > ./example.js main
