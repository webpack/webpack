...
1.hash.worker.js   1.8 KiB          [emitted]  
  hash.worker.js  4.99 KiB          [emitted]  
       output.js  4.43 KiB       0  [emitted]  main
Entrypoint main = output.js
chunk    {0} output.js (main) 332 bytes [entry] [rendered]
    > .\example.js main
 [0] ./example.js 235 bytes {0} [built]
...
Child worker:
               Asset      Size  Chunks             Chunk Names
    1.hash.worker.js   1.8 KiB       1  [emitted]  
      hash.worker.js  4.99 KiB       0  [emitted]  main
    Entrypoint main = hash.worker.js
    chunk    {0} hash.worker.js (main) 168 bytes >{1}< [entry] [rendered]
        > !!.\worker.js main
     [0] ./worker.js 168 bytes {0} [built]
         [used exports unknown]
         entry !!.\worker.js  main
