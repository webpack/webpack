...
```
asset pageA.bundle.js 8.47 KiB [emitted] (name: pageA)
asset pageB.bundle.js 8.47 KiB [emitted] (name: pageB)
asset pageC.bundle.js 8.47 KiB [emitted] (name: pageC)
...
chunk (runtime: pageB) pageB.bundle.js (pageB) 69 bytes (javascript) 4.77 KiB (runtime) [entry] [rendered]
  > ./pageB pageB
  runtime modules 4.77 KiB 6 modules
  ./pageB.js 69 bytes [built] [code generated]
    [used exports unknown]
    entry ./pageB pageB
chunk (runtime: pageA) pageA.bundle.js (pageA) 69 bytes (javascript) 4.77 KiB (runtime) [entry] [rendered]
  > ./pageA pageA
  runtime modules 4.77 KiB 6 modules
...
chunk (runtime: pageC) pageC.bundle.js (pageC) 68 bytes (javascript) 4.77 KiB (runtime) [entry] [rendered]
  > ./pageC pageC
  runtime modules 4.77 KiB 6 modules
...
```
asset pageC.bundle.js 1.75 KiB [emitted] [minimized] (name: pageC)
