...
```
asset pageA.bundle.js 8.93 KiB [emitted] (name: pageA)
asset pageB.bundle.js 8.93 KiB [emitted] (name: pageB)
asset pageC.bundle.js 8.93 KiB [emitted] (name: pageC)
asset 456.chunk.js 6.29 KiB [emitted]
asset 394.chunk.js 606 bytes [emitted]
chunk (runtime: pageB) pageB.bundle.js (pageB) 71 bytes (javascript) 4.99 KiB (runtime) [entry] [rendered]
  > ./pageB pageB
  runtime modules 4.99 KiB 6 modules
  ./pageB.js 71 bytes [built] [code generated]
    [used exports unknown]
    entry ./pageB pageB
chunk (runtime: pageC) pageC.bundle.js (pageC) 70 bytes (javascript) 4.99 KiB (runtime) [entry] [rendered]
  > ./pageC pageC
  runtime modules 4.99 KiB 6 modules
...
chunk (runtime: pageA) pageA.bundle.js (pageA) 71 bytes (javascript) 4.99 KiB (runtime) [entry] [rendered]
  > ./pageA pageA
  runtime modules 4.99 KiB 6 modules
