...
```
asset pageA.bundle.js 8.83 KiB [emitted] (name: pageA)
asset pageB.bundle.js 8.83 KiB [emitted] (name: pageB)
asset pageC.bundle.js 8.83 KiB [emitted] (name: pageC)
...
```
asset pageC.bundle.js 1.72 KiB [emitted] [minimized] (name: pageC)
