...
asset 3.[chunkhash].js 280 bytes [emitted]
Entrypoint main 13.1 KiB = runtime~main.[chunkhash].js 12.5 KiB main.[chunkhash].js 655 bytes
chunk (runtime: runtime~main) main.[chunkhash].js (main) 58 bytes [initial] [rendered]
  > ./example main
  ./example.js 58 bytes [built] [code generated]
    [used exports unknown]
    entry ./example main
chunk (runtime: runtime~main) runtime~main.[chunkhash].js (runtime~main) 7.73 KiB [entry] [rendered]
  > ./example main
  runtime modules 7.73 KiB 9 modules
chunk (runtime: runtime~main) 2.[chunkhash].js 29 bytes [rendered]
  > ./async1 ./example.js 2:0-18
  ./async1.js 29 bytes [built] [code generated]
    [used exports unknown]
    import() ./async1 ./example.js 2:0-18
chunk (runtime: runtime~main) 3.[chunkhash].js 29 bytes [rendered]
...
chunk (runtime: runtime~main) 114.[chunkhash].js 29 bytes [rendered]
  > ./async1 ./example.js 2:0-18
  ./async1.js 29 bytes [built] [code generated]
    [used exports unknown]
    import() ./async1 ./example.js 2:0-18
chunk (runtime: runtime~main) 172.[chunkhash].js 29 bytes [rendered]
  > ./async2 ./example.js 3:0-18
  ./async2.js 29 bytes [built] [code generated]
    [used exports unknown]
    import() ./async2 ./example.js 3:0-18
