...
```
asset runtime~main.[chunkhash].js 2.75 KiB [emitted] [minimized] (name: runtime~main)
...
Entrypoint main 2.91 KiB = runtime~main.[chunkhash].js 2.75 KiB main.[chunkhash].js 155 bytes
