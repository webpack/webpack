...
```
asset output.js 9.06 KiB [emitted] (name: main)
asset 577.output.js 2.25 KiB [emitted]
chunk output.js (main) 251 bytes (javascript) 4.96 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 1.91 KiB [emitted] [minimized] (name: main)
asset 577.output.js 639 bytes [emitted] [minimized]
chunk (runtime: main) output.js (main) 251 bytes (javascript) 4.96 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 4.96 KiB 6 modules
  ./example.js 251 bytes [built] [code generated]
    [no exports used]
