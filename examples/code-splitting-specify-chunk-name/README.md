...
chunk    {1} 1.output.js (chunk-foo) 38 bytes {2} [rendered]
    > duplicate chunk-foo [4] ./example.js 1:0-63
    > duplicate chunk-foo1 [4] ./example.js 5:0-8:16
    [0] ./templates/foo.js 38 bytes {1} [built]
        [exports: default]
        import() ./templates/foo [4] ./example.js 1:0-63
        cjs require ./templates/foo [4] ./example.js 6:12-38
chunk    {2} output.js (main) 571 bytes [entry] [rendered]
    > main [4] ./example.js 
    [1] ./templates async ^\.\/ba.*$ 160 bytes {2} [built]
        import() context ./templates [4] ./example.js 11:0-85
    [4] ./example.js 411 bytes {2} [built]
```
