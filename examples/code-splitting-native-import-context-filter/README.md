...
asset 398.output.js 678 bytes [emitted]
asset 544.output.js 678 bytes [emitted]
asset 718.output.js 678 bytes [emitted]
chunk output.js (main) 597 bytes (javascript) 5.23 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
asset 398.output.js 115 bytes [emitted] [minimized]
asset 544.output.js 115 bytes [emitted] [minimized]
asset 718.output.js 115 bytes [emitted] [minimized]
chunk (runtime: main) output.js (main) 597 bytes (javascript) 5.23 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 5.23 KiB 7 modules
  dependent modules 160 bytes [dependent] 1 module
  ./example.js 437 bytes [built] [code generated]
