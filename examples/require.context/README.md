...
```
asset output.js 3.67 KiB [emitted] (name: main)
chunk output.js (main) 603 bytes (javascript) 103 bytes (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 457 bytes [dependent] 4 modules
  runtime modules 103 bytes 1 module
...
```
asset output.js 873 bytes [emitted] [minimized] (name: main)
chunk (runtime: main) output.js (main) 603 bytes (javascript) 103 bytes (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 457 bytes [dependent] 4 modules
  runtime modules 103 bytes 1 module
  ./example.js 146 bytes [built] [code generated]
