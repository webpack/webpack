...
```
asset runtime.js 11 KiB [emitted] (name: runtime)
asset other-vendors.js 2.16 KiB [emitted] (name: other-vendors)
asset page1.js 1.94 KiB [emitted] (name: page1)
asset app.js 1.48 KiB [emitted] (name: app)
asset react-vendors.js 1.36 KiB [emitted] (name: react-vendors)
asset lazy_js.js 1.11 KiB [emitted]
Entrypoint app 1.48 KiB = app.js
Entrypoint page1 1.94 KiB = page1.js
Entrypoint react-vendors 12.4 KiB = runtime.js 11 KiB react-vendors.js 1.36 KiB
Entrypoint other-vendors 13.2 KiB = runtime.js 11 KiB other-vendors.js 2.16 KiB
...
chunk (runtime: runtime) runtime.js (runtime) 6.65 KiB ={other-vendors}= ={react-vendors}= >{app}< >{page1}< [entry] [rendered]
  > ./other-vendors other-vendors
  > prop-types react-vendors
  > react react-vendors
  > react-dom react-vendors
  runtime modules 6.65 KiB 10 modules
...
```
asset runtime.js 2.32 KiB [emitted] [minimized] (name: runtime)
asset page1.js 300 bytes [emitted] [minimized] (name: page1)
asset other-vendors.js 252 bytes [emitted] [minimized] (name: other-vendors)
asset app.js 220 bytes [emitted] [minimized] (name: app)
asset react-vendors.js 213 bytes [emitted] [minimized] (name: react-vendors)
asset lazy_js.js 159 bytes [emitted] [minimized]
Entrypoint app 220 bytes = app.js
Entrypoint page1 300 bytes = page1.js
Entrypoint react-vendors 2.53 KiB = runtime.js 2.32 KiB react-vendors.js 213 bytes
Entrypoint other-vendors 2.57 KiB = runtime.js 2.32 KiB other-vendors.js 252 bytes
chunk (runtime: runtime) app.js (app) 116 bytes <{other-vendors}> <{runtime}> >{page1}< [initial] [rendered]
  > ./app.js app
  ./app.js 116 bytes [built] [code generated]
    [no exports]
