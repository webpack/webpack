...
Entrypoint other-vendors 13.2 KiB = runtime.js 11.3 KiB other-vendors.js 1.92 KiB
...
chunk runtime.js (runtime) 6.83 KiB ={other-vendors}= ={react-vendors}= >{app}< >{page1}< [entry] [rendered]
  > ./other-vendors other-vendors
  > prop-types react-vendors
  > react react-vendors
  > react-dom react-vendors
...
```
asset runtime.js 2.23 KiB [emitted] [minimized] (name: runtime)
...
Entrypoint react-vendors 2.43 KiB = runtime.js 2.23 KiB react-vendors.js 208 bytes
Entrypoint other-vendors 2.47 KiB = runtime.js 2.23 KiB other-vendors.js 243 bytes
...
chunk (runtime: runtime) react-vendors.js (react-vendors) 87 bytes ={runtime}= >{page1}< [initial] [rendered]
  ...
  ./node_modules/react.js 26 bytes [built] [code generated]
    ...
    harmony import specifier react ./page1.js 5:29-34
    entry react react-vendors
chunk (runtime: runtime) runtime.js (runtime) 6.83 KiB ={other-vendors}= ={react-vendors}= >{app}< >{page1}< [entry] [rendered]
  > ./other-vendors other-vendors
  > prop-types react-vendors
  > react react-vendors
  > react-dom react-vendors
