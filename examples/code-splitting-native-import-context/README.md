...
chunk output.js (main) 441 bytes (javascript) 5.23 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
chunk (runtime: main) output.js (main) 441 bytes (javascript) 5.23 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 5.23 KiB 7 modules
  dependent modules 160 bytes [dependent] 1 module
  ./example.js 281 bytes [built] [code generated]
