...
chunk output.js (main) 441 bytes (javascript) 5.39 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.36 KiB [emitted] [minimized] (name: main)
...
chunk (runtime: main) output.js (main) 441 bytes (javascript) 5.39 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 5.39 KiB 8 modules
  dependent modules 160 bytes [dependent] 1 module
  ./example.js 281 bytes [built] [code generated]
