...
```javascript
(self.webpackChunk=self.webpackChunk||[]).push([[497],{497:(a,e,s)=>{"use strict";s.a(a,(async a=>{s.r(e),s.d(e,{createUser:()=>n});var t=s(447),c=a([t]);t=(c.then?await c:c)[0];const n=async a=>{command=`CREATE USER ${a}`,await(0,t.j)({command})}}))},447:(a,e,s)=>{"use strict";s.a(a,(async a=>{s.d(e,{j:()=>t}),await(async a=>{await new Promise((a=>setTimeout(a,1e3)))})();const t=async a=>(await new Promise((a=>setTimeout(a,100))),"fake data");a()}),1)}}]);
```
...
asset 497.output.js 2.82 KiB [emitted]
chunk (runtime: main) output.js (main) 1.19 KiB (javascript) 7.58 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 7.58 KiB 9 modules
...
asset 497.output.js 461 bytes [emitted] [minimized]
chunk (runtime: main) output.js (main) 1.19 KiB (javascript) 7.58 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 7.58 KiB 9 modules
