...
asset pageB.js 1.5 KiB [emitted] (name: pageB)
...
```
asset pageA.js 276 bytes [emitted] [minimized] (name: pageA)
asset vendor2.js 223 bytes [emitted] [minimized] (name: vendor2)
