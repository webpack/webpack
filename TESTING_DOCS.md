...
- **Purpose**: Non-comparative, CodSpeed-integrated benchmarks: `unit/` for webpack internals (mirrors `lib/`), `e2e/` for full builds, `helpers/` and `lib/` for deterministic fixture generators and the runner.
