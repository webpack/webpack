...
describe("Validation", () => {
	...
	createTestCase("undefined configuration", undefined, (msg) =>
		...
		"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
		 - configuration should be an object:
		   object { amd?, bail?, cache?, context?, dependencies?, devServer?, devtool?, dotenv?, entry?, experiments?, extends?, externals?, externalsPresets?, externalsType?, ignoreWarnings?, infrastructureLogging?, loader?, mode?, module?, name?, node?, optimization?, output?, parallelism?, performance?, plugins?, profile?, recordsInputPath?, recordsOutputPath?, recordsPath?, resolve?, resolveLoader?, snapshot?, stats?, target?, validate?, watch?, watchOptions? }
		...
		(msg) =>
			...
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration.module.rules[0].oneOf[0] has an unknown property 'passer'. These properties are valid:
			   object { assert?, compiler?, dependency?, descriptionData?, descriptionRelativePath?, enforce?, exclude?, extractSourceMap?, generator?, glob?, include?, issuer?, issuerLayer?, layer?, loader?, mimetype?, oneOf?, options?, parser?, phase?, realResource?, resolve?, resource?, resourceFragment?, resourceQuery?, rules?, scheme?, sideEffects?, test?, type?, use?, with? }
		...
		(msg) =>
			...
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration.devtool should be one of these:
			   [object { type, use }, ...] | false | \\"eval\\" | string (should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\")
			   -> A developer tool to enhance debugging (false | eval | [inline-|hidden-|eval-][nosources-][cheap-[module-]]source-map).
			   Details:
			    * configuration.devtool should be an array:
			      [object { type, use }, ...]
			    * configuration.devtool should be one of these:
			      false | \\"eval\\" | string (should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\")
			      -> A developer tool to enhance debugging (false | eval | [inline-|hidden-|eval-][nosources-][cheap-[module-]]source-map).
			      Details:
			       * configuration.devtool should be one of these:
			         false | \\"eval\\"
			       * configuration.devtool should be a string (should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\")."
		`)
	);
		...
		(msg) =>
			...
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration.output has an unknown property 'ecmaVersion'. These properties are valid:
			   object { amdContainer?, assetModuleFilename?, asyncChunks?, auxiliaryComment?, charset?, chunkFilename?, chunkFormat?, chunkLoadTimeout?, chunkLoading?, chunkLoadingGlobal?, clean?, compareBeforeEmit?, copy?, crossOriginLoading?, cssChunkFilename?, cssFilename?, devtoolFallbackModuleFilenameTemplate?, devtoolModuleFilenameTemplate?, devtoolNamespace?, enabledChunkLoadingTypes?, enabledLibraryTypes?, enabledWasmLoadingTypes?, environment?, filename?, globalObject?, hashDigest?, hashDigestLength?, hashFunction?, hashSalt?, hotUpdateChunkFilename?, hotUpdateGlobal?, hotUpdateMainFilename?, html?, htmlChunkFilename?, htmlFilename?, ignoreBrowserWarnings?, iife?, importFunctionName?, importMetaName?, library?, libraryExport?, libraryTarget?, module?, path?, pathinfo?, publicPath?, resourceHints?, scriptType?, sourceMapFilename?, sourcePrefix?, strictModuleErrorHandling?, strictModuleExceptionHandling?, strictModuleResolution?, trustedTypes?, umdNamedDefine?, uniqueName?, wasmLoading?, wasmStreamingFallback?, webassemblyModuleFilename?, workerChunkFilename?, workerChunkLoading?, workerPublicPath?, workerWasmLoading? }
	...
	createTestCase(
		...
		(msg) =>
			expect(msg).toMatchInlineSnapshot(`
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration.devtool should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\".
	...
	createTestCaseOnlyValidate(
		...
		(msg) =>
			expect(msg).toMatchInlineSnapshot(`
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration[0].devtool should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\".
			 - configuration[1].devtool should match pattern \\"^(inline-|hidden-|eval-)?(nosources-)?(cheap-(module-)?)?source-map(-debugids)?(-scopes)?$\\"."
		`)
	);
	...
	createTestCaseWithoutError("unknown and validate", {
		unknown: true,
		validate: false
	});

	createTestCase(
		"unknown and validate #1",
		{
			unknown: true,
			validate: true
		},
		(msg) =>
			expect(msg).toMatchInlineSnapshot(`
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration has an unknown property 'unknown'. These properties are valid:
			   object { amd?, bail?, cache?, context?, dependencies?, devServer?, devtool?, dotenv?, entry?, experiments?, extends?, externals?, externalsPresets?, externalsType?, ignoreWarnings?, infrastructureLogging?, loader?, mode?, module?, name?, node?, optimization?, output?, parallelism?, performance?, plugins?, profile?, recordsInputPath?, recordsOutputPath?, recordsPath?, resolve?, resolveLoader?, snapshot?, stats?, target?, validate?, watch?, watchOptions? }
			   -> Options object as provided by the user.
			   For typos: please correct them.
			   For loader options: webpack >= v2.0.0 no longer allows custom properties in configuration.
	...
	createTestCaseWithoutError("unknown and validate (multi compiler mode)", [
		{
			unknown1: true,
			validate: false
		},
	...
	createTestCase(
		"unknown and validate with (multi compiler mode) #1",
		[
			{
				unknown1: true,
				validate: true
		...
		(msg) =>
			expect(msg).toMatchInlineSnapshot(`
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration[0] has an unknown property 'unknown1'. These properties are valid:
			   object { amd?, bail?, cache?, context?, dependencies?, devServer?, devtool?, dotenv?, entry?, experiments?, extends?, externals?, externalsPresets?, externalsType?, ignoreWarnings?, infrastructureLogging?, loader?, mode?, module?, name?, node?, optimization?, output?, parallelism?, performance?, plugins?, profile?, recordsInputPath?, recordsOutputPath?, recordsPath?, resolve?, resolveLoader?, snapshot?, stats?, target?, validate?, watch?, watchOptions? }
			   -> Options object as provided by the user."
		`)
	);
	...
	createTestCase(
		"unknown and validate with (multi compiler mode) #2",
		[
			{
				unknown1: true,
				validate: false
		...
		(msg) =>
			expect(msg).toMatchInlineSnapshot(`
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration[1] has an unknown property 'unknown2'. These properties are valid:
			   object { amd?, bail?, cache?, context?, dependencies?, devServer?, devtool?, dotenv?, entry?, experiments?, extends?, externals?, externalsPresets?, externalsType?, ignoreWarnings?, infrastructureLogging?, loader?, mode?, module?, name?, node?, optimization?, output?, parallelism?, performance?, plugins?, profile?, recordsInputPath?, recordsOutputPath?, recordsPath?, resolve?, resolveLoader?, snapshot?, stats?, target?, validate?, watch?, watchOptions? }
			   -> Options object as provided by the user."
		`)
	);
	...
	createTestCase(
		"unknown and validate with (multi compiler mode) #3",
		[
			{
				unknown1: true,
				validate: true
		...
		createTestCase(
			...
			"Invalid configuration object. Webpack has been initialized using a configuration object that does not match the API schema.
			 - configuration.optimization has an unknown property 'hashedModuleIds'. These properties are valid:
			   object { avoidEntryIife?, checkWasmTypes?, chunkIds?, concatenateModules?, emitOnErrors?, flagIncludedChunks?, inlineExports?, innerGraph?, localImportBindings?, mangleExports?, mangleWasmImports?, mergeDuplicateChunks?, minimize?, minimizeOptions?, minimizer?, moduleIds?, noEmitOnErrors?, nodeEnv?, portableRecords?, providedExports?, realContentHash?, removeAvailableModules?, removeEmptyChunks?, runtimeChunk?, sideEffects?, splitChunks?, usedExports? }
