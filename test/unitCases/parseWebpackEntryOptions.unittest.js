...
describe("parseWebpackEntryOptions", () => {
	const loc = /** @type {import("../../lib/graph/Dependency").DependencyLocation} */ ({
	 ...
	 * @returns {{ entryOptions: import("../../lib/graph/Entrypoint").EntryOptions | undefined, warnings: unknown[] }} result
	 */
