...
it("should overwrite non-eager shared module with eager shared module", async () => {
	...
	expect(Object.keys(__webpack_share_scopes__["eagerOverrideNonEager"])).toContain(
		"common"
	);
...
it("should not overwrite already shared eager module with non-eager module", async () => {
	...
	expect(Object.keys(__webpack_share_scopes__["nonEagerDontOverrideEager"])).toContain(
		"uncommon"
	);
	const uncommonModule = __webpack_share_scopes__.nonEagerDontOverrideEager.uncommon
