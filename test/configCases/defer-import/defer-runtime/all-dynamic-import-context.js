...
it("should defer the module until first use", async () => {
  ...
  const dynamic_default = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "dynamic_default_ns.cjs";
  const dynamic_default_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "dynamic_named.cjs";
  const dynamic_named = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "dynamic_named_ns.cjs";
  const dynamic_named_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "dynamic_both.cjs";
  const dynamic_both = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "dynamic_both_ns.cjs";
  const dynamic_both_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);

  file = "flagged_default.js";
  const flagged_default = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "flagged_default_ns.js";
  const flagged_default_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "flagged_named.js";
  const flagged_named = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "flagged_named_ns.js";
  const flagged_named_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "flagged_both.js";
  const flagged_both = await import(/* webpackDefer: true */ "./commonjs/" + file);
  file = "flagged_both_ns.js";
  const flagged_both_ns = await import(/* webpackDefer: true */ "./commonjs/" + file);

  file = "esm_default.mjs";
  const esm_default = await import(/* webpackDefer: true */ "./esm/" + file);
  file = "esm_default_ns.mjs";
  const esm_default_ns = await import(/* webpackDefer: true */ "./esm/" + file);
  file = "esm_named.mjs";
  const esm_named = await import(/* webpackDefer: true */ "./esm/" + file);
  file = "esm_named_ns.mjs";
  const esm_named_ns = await import(/* webpackDefer: true */ "./esm/" + file);
  file = "esm_both.mjs";
  const esm_both = await import(/* webpackDefer: true */ "./esm/" + file);
  file = "esm_both_ns.mjs";
  const esm_both_ns = await import(/* webpackDefer: true */ "./esm/" + file);

  file = "reexport.mjs";
  const { reexport_ns, reexport_cjs_ns } = await import(/* webpackDefer: true */ "./esm/" + file);
