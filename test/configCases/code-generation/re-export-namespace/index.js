...
it("should use/preserve accessor form for import object and namespaces", function() {
	...
	expectSourceToContain(source, 'const a = _module1__WEBPACK_IMPORTED_MODULE_0__.obj1["flip"].flap;');
	expectSourceToContain(source, 'const b = _module1__WEBPACK_IMPORTED_MODULE_0__.obj1.zip["zap"];');
	expectSourceToContain(source, 'const c = _module1__WEBPACK_IMPORTED_MODULE_0__.obj1["ding"].dong();');
	expectSourceToContain(source, 'const d = _module1__WEBPACK_IMPORTED_MODULE_0__.obj1.sing["song"]();');

	expectSourceToContain(source, 'const aa = _module1__WEBPACK_IMPORTED_MODULE_0__.obj1["zoom"];');
	...
	expectSourceToContain(source, '_data__WEBPACK_IMPORTED_MODULE_1__.nested.object3["unknownProperty"].depth = "deep";');
