...
it("should pass mangle options", function() {
	...
	source.should.containEql("function e(t){return function(n){try{t()}catch(t){n(t)}}}");
});
...
it("should pass compress options", function() {
	...
	source.should.containEql("function n(){var o=2;o=3,console.log(1+o),console.log(o+3),console.log(4),console.log(1+o+3)}");
});
