...
// The first bundle hashes its ids against a plain path and the others against
// the file URLs naming it - an unconverted URL hashes other identifiers.
if (global.hashedModuleIdsContext === undefined) {
	global.hashedModuleIdsContext = ids;
}

it("should hash the same ids for a path and the file URLs naming it", function () {
