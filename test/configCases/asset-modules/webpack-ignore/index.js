it("should work", async () => {
	...
	expect(textFileContent).toBe("a Ā 𐀀 文 🦄 Text");
	...
	expect(cssFileContent).toBe("body { color: red; }\n");
	...
	expect(htmlFileContent).toBe("<div>test</div>\n");
});
