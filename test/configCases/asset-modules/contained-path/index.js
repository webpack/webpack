...
it("should replace parent segments of [contained-path] with _", () => {
...
it("should keep [contained-path] empty for a file in the context", () => {
	expect(local).toBe("/public/local.txt");
	expect(emitted(local)).toBe(true);
});

it("should replace parent segments of [contained-file] with _", () => {
