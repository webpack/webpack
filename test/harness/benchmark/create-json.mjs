...
/**
 * @param {string} generated output directory
 * @param {string[]} items one JSON module per entry, nested one level deeper each time
 * @returns {Promise<void>}
 */
export default async function createJson(generated, items) {
