...
describe("FileSystemInfo", () => {
	...
	const createFs = () => {
		...
		fs.mkdirpSync("/path/node_modules/@foo");
		fs.mkdirpSync("/path/node_modules/@foo/package1");
		fs.mkdirpSync("/path/node_modules/@foo/package2");
		fs.mkdirpSync("/path/node_modules/bar-package3");
