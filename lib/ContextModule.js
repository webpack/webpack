...
class ContextModule extends Module {
	...
	getReturn(type) {
		...
		if (type === 2) return 'Object.assign({/* fake namespace object */}, typeof module === "object" && module, { "default": module })';
		if (type === 0) {
...
module.exports = webpackAsyncContext;`;
	...
	getLazySource(blocks, id) {
		...
		const requestPrefix = hasMultipleOrNoChunks ? `Promise.all(ids.slice(${chunksStartPosition}).map(__webpack_require__.e))` : `__webpack_require__.e(ids[${chunksStartPosition}])`;
