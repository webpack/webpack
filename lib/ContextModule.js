...
/**
 * Defines the context options type used by this module.
...
/**
 * Defines the context module options extras type used by this module.
...
/**
 * Defines the resolve dependencies callback callback.
...
/**
 * Defines the resolve dependencies callback.
...
class ContextModule extends Module {
	/**
	 * Creates an instance of ContextModule.
	...
	/**
	 * Adds the provided file dependencies to the context module.
	...
	/**
	 * Gets module deferred async deps map.
	 * @param {Dependency[]} dependencies all dependencies
	 * @param {ChunkGraph} chunkGraph chunk graph
	...
	/**
	 * Gets module deferred async deps map init statement.
	...
	/**
	 * Gets return module object source.
	 * @param {FakeMap | FakeMapType} fakeMap fake map
	 * @param {boolean=} asyncModule is async module
...
module.exports = webpackEmptyContext;`;
	...
	/**
	 * Gets source for empty async context.
	 * @param {ModuleId} id module id
	 * @param {RuntimeTemplate} runtimeTemplate runtime template
	 * @returns {string} source for empty async context
	 */
