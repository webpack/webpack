...
class ContextModule extends Module {
	constructor(resolveDependencies, context, recursive, regExp, addon, asyncMode, chunkName, contextDependency) {
		super();
	...
	build(options, compilation, resolver, fs, callback) {
		...
		this.resolveDependencies(fs, this.context, this.recursive, this.regExp, this.contextDependency, (err, dependencies) => {
