...
import { getOutgoingAsyncModules } from "./async-modules/AsyncModuleHelpers.js";
import { ImportPhase, ImportPhaseUtils } from "./dependencies/ImportPhase.js";
import { makeWebpackError } from "./errors/HookWebpackError.js";
...
/** @typedef {import("./ChunkGroup.js").RawChunkGroupOptions} RawChunkGroupOptions */
...
/** @typedef {import("./FileSystemInfo.js").Snapshot} Snapshot */
...
/** @typedef {import("./dependencies/ContextElementDependency.js").default} ContextElementDependency */
/** @typedef {import("./javascript/JavascriptParser.js").ImportAttributes} ImportAttributes */
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, boolean]>} ObjectDeserializerContext */
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, boolean]>} ObjectSerializerContext */
/** @typedef {import("./util/fs.js").InputFileSystem} InputFileSystem */
/** @typedef {import("./dependencies/ImportPhase.js").ImportPhaseType} ImportPhaseType */
...
class ContextModule extends Module {
	...
	_prettyRegExp(regexString, stripSlash = true) {
		const str = stripSlash
			...
			: `${regexString}`;
		return str.replaceAll("!", "%21").replaceAll("|", "%7C");
	}
	...
	build(options, compilation, resolver, fs, callback) {
		...
		(this.resolveDependencies)(fs, this.options, (err, dependencies) => {
			...
			// `Array#sort` is stable, so equal locations keep their insertion order
			dependencies.sort(compareSelect((a) => a.loc, compareLocations));
			...
			if (this.options.mode === "sync" || this.options.mode === "eager") {
				...
				for (const dep of dependencies) {
					...
					if (chunkName) {
						...
						chunkName = chunkName.replaceAll("[index]", `${index++}`);
						chunkName = chunkName.replaceAll(
							"[request]",
...
module.exports = webpackEmptyAsyncContext;`;
	...
	getGlobSyncSource(dependencies, chunkGraph, runtimeTemplate) {
		...
		const globImportAccess = this.getImportPropertyAccess();
		const sortedDependencies =
			/** @type {import("./dependencies/ContextElementDependency.js").default[]} */
...
export { ContextModule as "module.exports" };
