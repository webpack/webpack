 ...
 * @property {CssNamespace[]=} namespaces `@namespace` at-rules, hoisted to the top of the chunk
 */

/**
 * @typedef {object} CssNamespace
 * @property {string} prefix namespace prefix (empty string for the default namespace)
 * @property {string} rule the full `@namespace …` rule text (without the trailing semicolon)
 */
