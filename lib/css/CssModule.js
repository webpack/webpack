...
class CssModule extends NormalModule {
	...
	constructor(options) {
		...
		/** @type {CssBuildInfo | undefined} */
		this.buildInfo = undefined;
		/** @type {CssBuildMeta | undefined} */
