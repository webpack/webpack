...
/** @import { CssData } from "../template/DependencyTemplate" */
...
class CssModule extends NormalModule {
	...
	canBeWrappedInConcatenation() {
		// CssGenerator has no wrapped path: its exports are shared-scope `const`s,
		// and an `exportType: "style"` body pushes into `__webpack_css_styles__`,
		// which the concatenation has already flushed by the time an accessor runs
		return false;
	}
