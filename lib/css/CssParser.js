...
class CssParser extends Parser {
	...
	parse(source, state) {
		...
		// `as` selects the top-level consumer; a `style` attribute is a bare
		// declaration list, everything else a full stylesheet (the default).
		const consume =
		...
		new SourceProcessor()
			...
			.process(source, { locConverter, comment, consume });
