...
const KNOWN_PROPERTIES = {
	...
	grid: GRID,
	"grid-area": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-column": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-column-end": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-column-start": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-row": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-row-end": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-row-start": GRID_AREA_OR_COLUMN_OR_ROW,
	"grid-template": GRID_TEMPLATE,
	"grid-template-areas": GRID_TEMPLATE_ARES,
	"grid-template-columns": GRID_TEMPLATE_COLUMNS_OR_ROWS,
	"grid-template-rows": GRID_TEMPLATE_COLUMNS_OR_ROWS
};
					...
					pos,
					{
						...
						string(_input, start, end) {
							...
							if (
								...
								const matches = areas.matchAll(/\b\w+\b/g);
			...
			function: (input, start, end) => {
				...
				switch (name) {
					...
					default: {
						...
						if (isModules) {
							if (isLocalMode() && isDashedIdentifier(name)) {
								return processDashedIdent(input, start, end);
							}
