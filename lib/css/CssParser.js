			...
			url: (input, start, end, contentStart, contentEnd) => {
				...
				switch (scope) {
					...
					case CSS_MODE_IN_BLOCK: {
						...
						// last line webpackIgnore
						const lineNeedIgnore = this.parseCommentOptions([
							walkCssTokens.eatWhitespaceAndComments(
								input,
						...
						// webpackIgnore before url()
						const functionNeedIgnore = this.parseCommentOptions([
							walkCssTokens.eatWhitespaceAndComments(input, start - 1, {}, -1),
							start
						]).options.needIgnore;
						if (
							functionNeedIgnore !== undefined
								? functionNeedIgnore
								: lineNeedIgnore
						)
							break;
				...
				switch (scope) {
					...
					case CSS_MODE_IN_BLOCK: {
						...
						if (
							...
							// webpackIgnore inside url()
							const stringNeedIgnore = this.parseCommentOptions([
								walkCssTokens.eatWhitespaceAndComments(
									input,
									start - 1,
									{},
