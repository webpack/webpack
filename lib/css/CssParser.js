...
class CssParser extends Parser {
	...
	parse(source, state) {
		 ...
		 * @param {Record<string, any> | null | undefined} options parsed comment options
		 ...
		 * @returns {{ ignored: boolean, options: Record<string, any> | null }} parsed options and `webpackIgnore` flag
		 */
		const magicCommentsIn = (range, warnStart, warnEnd) => {
			/** @type {{ options: Record<string, any> | null, errors: (Error & { comment: Comment })[] | null }} */
