...
// `escapeIdentifier` / `unescapeIdentifier` are pure string utilities
// (CSS Syntax 3 §4.3.7 escape/unescape) imported directly from the
// module. The remaining CSS-syntax helpers below are reached through
// `SourceProcessor`'s static members — byte-level `eat*` primitives and
// the spec parse helpers `CssParser.js` calls for sub-range parsing.
const {
	eatUntil,
	eatWhiteLine,
	eatWhitespace,
