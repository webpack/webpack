				...
				switch (scope) {
					...
					case CSS_MODE_IN_ICSS_IMPORT: {
						if (currIcssImportDeclaration && currIcssImportDeclaration.value) {
							const importMapValue = {
								importValue: currIcssImportDeclaration.value,
								replaceRanges: []
							};
							icssImportMap.set(currIcssImportDeclaration.name, importMapValue);
							currIcssImport.importMap.set(
								currIcssImportDeclaration.name,
								importMapValue
							);
						} else if (
							...
							this._emitWarning(
								state,
								`ICSS import "${currIcssImportDeclaration.name}" has no value.`,
								locConverter,
				...
				switch (scope) {
					...
					case CSS_MODE_IN_ICSS_IMPORT: {
						...
						const dep = new CssIcssImportDependency(
							currIcssImport.url,
							[currIcssImport.start, currIcssImport.end],
							currIcssImport.importMap
						);
