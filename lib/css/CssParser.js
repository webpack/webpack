...
class CssParser extends Parser {
	...
	parse(source, state) {
		...
		/**
		 * Set the value-visitor context for a `Declaration` and run the
		 * inline parts (composes, property-name exports, dashed-ident
		 * walk). `topLevel` only drives the per-item `astModeData` reset.
