					...
					for (const cv of cvs) {
						if (cv.type === "function") {
							...
							if (
								...
								// → `walkFunctionsForUrl`.
								// E4a-1: `local(…)` / `global(…)` declaration-
								// value deps → `walkFunctionsForLocalGlobal`.
								// Recurse here only for the remaining `var(…)`
								// side-effect (dashed-ident handling); E4d
								// will lift that out too.
