...
const MATH_FUNCTION_FOLD = new Map([
	[
		"abs",
		{ read: "same-unit", apply: "absolute", result: "same", table: null }
	],
	[
		"acos",
		{
	...
	[
		"asin",
		{ read: "number", apply: "lookup", result: "deg", table: ARC_SINE_DEGREES }
	],
	[
		"atan",
		{
	...
	[
		"atan2",
		{ read: "same-unit", apply: "arcTangent2", result: "deg", table: null }
	],
	["clamp", { read: "same-unit", apply: "clamp", result: "same", table: null }],
	[
		"cos",
		{
			read: "eighth-turn",
	...
	["exp", { read: "number", apply: "exponential", result: "", table: null }],
	[
		"hypot",
		{ read: "same-unit", apply: "hypotenuse", result: "same", table: null }
	],
	["log", { read: "number", apply: "logarithm", result: "", table: null }],
	["max", { read: "same-unit", apply: "maximum", result: "same", table: null }],
	["min", { read: "same-unit", apply: "minimum", result: "same", table: null }],
	["mod", { read: "same-unit", apply: "modulus", result: "same", table: null }],
	["pow", { read: "number", apply: "power", result: "", table: null }],
	[
		"rem",
		{ read: "same-unit", apply: "remainder", result: "same", table: null }
	],
	["round", { read: "same-unit", apply: "round", result: "same", table: null }],
	["sign", { read: "same-unit", apply: "sign", result: "", table: null }],
	[
		"sin",
		{
			read: "eighth-turn",
			apply: "lookup",
			result: "",
			table: EIGHTH_TURN_SINE
		}
	],
	["sqrt", { read: "number", apply: "squareRoot", result: "", table: null }],
	[
		"tan",
		{
			read: "eighth-turn",
