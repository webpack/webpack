...
const CssIcssComposesGlobalDependency = require("../dependencies/CssIcssComposesGlobalDependency");
const CssIcssComposesLocalDependency = require("../dependencies/CssIcssComposesLocalDependency");
const CssIcssComposesSelfDependency = require("../dependencies/CssIcssComposesSelfDependency");
	...
	apply(compiler) {
		compiler.hooks.compilation.tap(
			...
			(compilation, { normalModuleFactory }) => {
				...
				compilation.dependencyTemplates.set(
					CssIcssComposesLocalDependency,
					new CssIcssComposesLocalDependency.Template()
				);
				compilation.dependencyFactories.set(
				...
				compilation.dependencyTemplates.set(
					CssIcssComposesGlobalDependency,
					new CssIcssComposesGlobalDependency.Template()
				);
				compilation.dependencyFactories.set(
				...
				compilation.dependencyTemplates.set(
					CssIcssComposesSelfDependency,
					new CssIcssComposesSelfDependency.Template()
				);
				compilation.dependencyTemplates.set(
				...
				compilation.hooks.succeedModule.tap(PLUGIN_NAME, (module) => {
					if (
						module.type === CSS_MODULE_TYPE ||
						module.type === CSS_MODULE_TYPE_AUTO ||
						module.type === CSS_MODULE_TYPE_GLOBAL ||
						module.type === CSS_MODULE_TYPE_MODULE
					) {
						const buildMeta = /** @type {BuildMeta} */ (module.buildMeta);

						const exportType = buildMeta.exportType;
						const namedExports = buildMeta.exportsType === "namespace";

						/** @type {string[]} */
						const exports = [];
						if (namedExports && exportType === "text") {
							// For text export type, provide "default" export
							exports.push("default");
						}
						module.addDependency(new StaticExportsDependency(exports, true));
					}
				});
