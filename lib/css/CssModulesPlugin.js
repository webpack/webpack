...
class CssModulesPlugin {
	 ...
	 * @returns {[Source, CssExportsData | undefined, CssIcssImportData]} css module source
	 */
	renderModule({
		metaData,
		undoPath,
	...
	renderChunk({
		...
		for (const module of modules) {
			try {
				const [moduleSource, moduleExport, moduleIcssImport] =
					this.renderModule({
						metaData,
						undoPath,
						chunk,
		...
		for (const [module, moduleSource] of moduleSources.entries()) {
			let replaceSource = String(moduleSource.source());
