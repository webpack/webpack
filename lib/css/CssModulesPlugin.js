...
const getCssParser = lazyModule.sync(() => require("./CssParser"));
const getCssGenerator = lazyModule.sync(() => require("./CssGenerator"));
const getCssLoadingRuntimeModule = lazyModule.sync(() =>
	require("./CssLoadingRuntimeModule")
);
const getCssInjectStyleRuntimeModule = lazyModule.sync(() =>
