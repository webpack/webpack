...
/**
 * Sort comparator for the cascade order. Subtracting the indices would yield
 * `NaN` when both are `Infinity`, and `Array#sort` is not stable on the legacy
 * node versions this repo supports, so the tie-breaker always runs.
