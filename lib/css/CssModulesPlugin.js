...
import { CSS_IMPORT_TYPE, CSS_TYPE } from "../ModuleSourceTypeConstants.js";
import {
	CSS_MODULE_TYPE,
...
import CssIcssExportDependency from "../dependencies/CssIcssExportDependency.js";
import CssIcssImportDependency from "../dependencies/CssIcssImportDependency.js";
import CssIcssSymbolDependency from "../dependencies/CssIcssSymbolDependency.js";
import CssImportDependency from "../dependencies/CssImportDependency.js";
import CssUrlDependency from "../dependencies/CssUrlDependency.js";
import StaticExportsDependency from "../dependencies/StaticExportsDependency.js";
import { tryRunOrWebpackError } from "../errors/HookWebpackError.js";
...
import { digestNonNumericOnlyWithFull } from "../util/nonNumericOnlyHash.js";
import {
	PUBLIC_PATH_AUTO,
	walkFullHashPlaceholders
} from "../util/publicPathPlaceholder.js";
...
/** @typedef {import("../config/defaults.js").OutputNormalizedWithDefaults} OutputOptions */
...
/** @typedef {import("./CssModule.js").Inheritance} Inheritance */
/** @typedef {import("./CssModule.js").CssModuleCreateData} CssModuleCreateData */
/** @typedef {import("../Module.js").default} Module */
/** @typedef {import("../Module.js").BuildInfo} BuildInfo */
/** @typedef {import("./CssModule.js").CssModuleBuildInfo} CssModuleBuildInfo */
/** @typedef {import("../Module.js").RuntimeRequirements} RuntimeRequirements */
/** @typedef {import("../Template.js").RuntimeTemplate} RuntimeTemplate */
/** @typedef {import("../Chunk.js").ChunkFilenameTemplate} ChunkFilenameTemplate */
...
const getCssLoadingRuntimeModule = memoize(
	() =>
		/** @type {typeof import("./CssLoadingRuntimeModule.js").default} */ (
			require("./CssLoadingRuntimeModule.js")
		)
);
const getCssInjectStyleRuntimeModule = memoize(
	() =>
		/** @type {typeof import("./CssInjectStyleRuntimeModule.js").default} */ (
			require("./CssInjectStyleRuntimeModule.js")
		)
);
							...
							switch (type) {
								case CSS_MODULE_TYPE: {
									compiler.validate(
										...
										(options) =>
											/** @type {typeof import("../../schemas/plugins/css/CssParserOptions.check.js")} */ (
								...
								case CSS_MODULE_TYPE_GLOBAL: {
									...
									compiler.validate(
										...
										parserValidationOptions,
										(options) =>
											/** @type {typeof import("../../schemas/plugins/css/CssModuleParserOptions.check.js")} */ (
								...
								case CSS_MODULE_TYPE_MODULE: {
									...
									compiler.validate(
										...
										parserValidationOptions,
										(options) =>
											/** @type {typeof import("../../schemas/plugins/css/CssAutoOrModuleParserOptions.check.js")} */ (
												require("../../schemas/plugins/css/CssAutoOrModuleParserOptions.check.js")
											)(options)
									);
									break;
								}
							...
							switch (type) {
								case CSS_MODULE_TYPE: {
									compiler.validate(
										...
										(options) =>
											/** @type {typeof import("../../schemas/plugins/css/CssGeneratorOptions.check.js")} */ (
								...
								case CSS_MODULE_TYPE_GLOBAL: {
									compiler.validate(
										...
										generatorValidationOptions,
										(options) =>
											/** @type {typeof import("../../schemas/plugins/css/CssModuleGeneratorOptions.check.js")} */ (
...
export { CssModulesPlugin as "module.exports" };
