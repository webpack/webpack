...
const _preprocessInputStream = (input) =>
	...
	// a lone one is already an ident code point, so it tokenizes as the
	// replacement character would, and encoding the emitted asset as UTF-8 writes
	// it out as that character anyway. Scanning every parse for one buys nothing.
