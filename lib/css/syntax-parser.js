...
// The shorthands `_expandUnsupportedShorthand` may write as something else,
// so a property that is none of them is read by what it says.
const LOWERED_SHORTHANDS = new Set([
	...PLACE_SHORTHANDS,
	...ONE_VALUE_PAIR_SHORTHANDS,
	"inset",
	"text-decoration"
...
const _writtenValue = (text, colon, property) => {
	...
	// The lowering writes the shorthand first, so its value stands in front of
	// the longhands written beside it.
