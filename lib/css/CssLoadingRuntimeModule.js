...
import __CssModulesPlugin from "./CssModulesPlugin.js";

const { chunkHasCss } = __CssModulesPlugin;
...
class CssLoadingRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		const code = Template.asString([
			...
			Template.indent(`link.setAttribute("nonce", ${RuntimeGlobals.nonce});`),
			"}",
			uniqueName
...
export default CssLoadingRuntimeModule;

export { CssLoadingRuntimeModule as "module.exports" };
