				...
				? Template.asString([
						...
						`${cst} loadStylesheet = ${runtimeTemplate.basicFunction(
							...
							[
								...
								'if(fetching || (!link.sheet && link.href.indexOf(location.origin + "/") == 0)) {',
								Template.indent([
									...
									`timeout = setTimeout(onLinkComplete.bind(null, undefined, { type: fetching ? 'timeout' : 'load', target: link }), ${loadTimeout});`,
