...
/**
 * Compilation hooks that allow plugins to customize how stylesheet, preload,
 * and prefetch `<link>` elements are emitted by the CSS loading runtime.
...
/**
 * Runtime module that loads CSS chunks, supports preload and prefetch hints,
 * and coordinates CSS hot updates in browser-like environments.
 */
class CssLoadingRuntimeModule extends RuntimeModule {
	/**
	 * Returns the per-compilation hook set used to customize emitted stylesheet
	 * and resource-hint link elements.
	...
	/**
	 * Stores the runtime requirements that determine which CSS loading features
	 * need to be emitted for the current chunk.
	...
	/**
	 * Generates the chunk-loading state machine for CSS assets, including
	 * stylesheet creation, loading promises, preload and prefetch handlers, and
	 * optional HMR replacement logic.
	...
	generate() {
		...
		const conditionMap = chunkGraph.getChunkConditionMap(
			chunk,
			/**
			 * Reports whether the candidate chunk actually contains CSS modules.
