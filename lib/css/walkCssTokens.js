...
// Node classes (used as `@typedef` types), the full CSS-Syntax-3
// `parseA*` parser surface, and the `escape`/`unescapeIdentifier` string
// utils. Byte-level `eat*` / `isWhiteSpace` stay off the module surface.
