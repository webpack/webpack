 ...
 * declaration list — a declaration) to `onNode`. The default is "parse a
 * stylesheet's contents"; a `style` attribute builds one from
 * `parseABlocksContents` ("parse a block's contents").
 ...
 * @property {TopLevelParser=} parse top-level parser driving the walk; defaults to `parseAStylesheetsContents` (a full stylesheet). Pass a driver built on `parseABlocksContents` to parse a bare declaration list (e.g. an HTML `style` attribute)
 */
