...
/** @typedef {Source & { originalReplaceSource?: ReplaceSource }} SourceWithReplace */
...
class CssGenerator extends Generator {
	 ...
	 * @returns {SourceWithReplace} generated code
	 */
	generate(module, generateContext) {
		...
		/** @type {CssIcssImportData} */
		const cssIcssImportData = {};
		...
		data.set("css-icss-imports", templateContext.cssIcssImportData);

		/** @type {SourceWithReplace} */
		const generationResult = InitFragment.addToSource(
			source,
			initFragments,
			generateContext
		);
		generationResult.originalReplaceSource = source;
