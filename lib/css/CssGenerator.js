...
class CssGenerator extends Generator {
	...
	getConcatenationBailoutReason(module, context) {
		...
		// cssInjectStyle relies on moduleId for <style> tag identification,
		// but concatenation inner modules may not have a moduleId assigned.
		// HMR's removeModules also uses moduleId to clean up <style> tags.
		if (exportType === "style") {
