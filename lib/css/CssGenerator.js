...
import HarmonyImportSideEffectDependency from "../dependencies/HarmonyImportSideEffectDependency.js";
import { encodeMappings } from "../util/createMappings.js";
...
/** @typedef {import("../../declarations/WebpackOptions.js").CssModuleGeneratorOptions} CssModuleGeneratorOptions */
...
/** @typedef {import("../DependencyTemplate.js").CssData} CssData */
/** @typedef {import("../DependencyTemplate.js").DependencyTemplateContext} DependencyTemplateContext */
/** @typedef {import("../DependencyTemplate.js").CssDependencyTemplateContext} CssDependencyTemplateContext */
/** @typedef {import("../Generator.js").GenerateContext} GenerateContext */
/** @typedef {import("../Generator.js").UpdateHashContext} UpdateHashContext */
...
/** @typedef {import("./CssModulesPlugin.js").ModuleFactoryCacheEntry} ModuleFactoryCacheEntry */
/** @typedef {import("./CssModule.js").default} CssModule */
/** @typedef {import("./CssModule.js").CssModuleBuildInfo} CssModuleBuildInfo */
/** @typedef {import("./CssModule.js").CssModuleBuildMeta} CssModuleBuildMeta */
...
const getPropertyName = memoize(() => require("../util/property.js"));
const getCssModulesPlugin = memoize(() => require("./CssModulesPlugin.js"));
...
const buildExportsSourceMap = (
	...
	/** @type {(import("../util/createMappings.js").LineMappings)[]} */
...
class CssGenerator extends Generator {
	 ...
	 * @param {import("../../declarations/WebpackOptions.js").DevTool | undefined} devtool the devtool option
	 * @param {GenerateContext} generateContext the generate context
...
export { CssGenerator as "module.exports" };
