...
const AssetGenerator = require("../asset/AssetGenerator");
...
const JAVASCRIPT_AND_CSS_TYPES = new Set(["javascript", "css"]);
	...
	generate(module, generateContext) {
		switch (generateContext.type) {
			...
			case "javascript": {
				...
				return assetGenerator.generate(module, generateContext);
			}
		}
	}
