...
class CssGenerator extends Generator {
	 ...
	 */
	getTypes(module) {
		// if use style-sheet or string exportsType of CSS module, we always need to generate JavaScript output.
		if (this._generatesJsOnly(module)) {
		...
		// if importer is JavaScript module, we need to generate JavaScript output for it,
		// otherwise we can only generate CSS output.
		for (const connection of connections) {
			...
			if (
				module.hot !== true &&
				(connection.dependency instanceof HarmonyImportSideEffectDependency ||
					// importer is css module, skip
