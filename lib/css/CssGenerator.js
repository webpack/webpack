...
class CssGenerator extends Generator {
	...
	/**
	 * @param {CssModule} module module for which the code should be generated
...
__WEBPACK_CSS_STYLE_SHEET__.replaceSync(${convertToTemplateLiteral(generationResult.source().toString())});${RuntimeGlobals.module}.exports = __WEBPACK_CSS_STYLE_SHEET__;`);
		}
		return generationResult;
	}

	/**
	 * @param {CssModule} module fresh module
	 * @returns {Set<string>} available types (do not mutate)
	 */
	getTypes(module) {
		if (module.assertions && module.assertions.type === "css") {
