 ...
 * reads no such pseudo. Only a plain one standing where a class may: a
 * functional pseudo prints with its arguments attached, and nothing after a
 * pseudo-element is what a class stands in for.
 * @param {string[]} parts the prelude's printed parts
 * @returns {void}
 */
