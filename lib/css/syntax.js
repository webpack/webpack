...
const _MATH_REDUCERS = new Map([
	...
	["sin", _trigReducer(EIGHTH_TURN_SINE)],
	["cos", _trigReducer(EIGHTH_TURN_COSINE)],
	["tan", _trigReducer(EIGHTH_TURN_TANGENT)],
	["asin", _arcReducer(ARC_SINE_DEGREES)],
	["acos", _arcReducer(ARC_COSINE_DEGREES)],
	["atan", _arcReducer(ARC_TANGENT_DEGREES)],
	[
		"atan2",
		(sums) => {
			const comparable = _comparableCoefficients(sums);
