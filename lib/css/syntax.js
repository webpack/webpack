...
// source slice carrying escapes. `escapeIdentifier` makes a conformant
// `<ident-token>` out of an arbitrary string, so the result re-tokenizes as the
// same name, and `unescapeIdentifier` reverses tokenizer-time escapes.
