...
// One joined key rather than a level per part: a block assembled in one go
// builds its conditions into the key as it hands them up, where a streamed one
// carries them alongside, and only the joined string makes the two agree.
