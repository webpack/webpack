 ...
 * decides. The unquoted spelling is compared in place, and the gates keep every
 * other function name (`rgb(`, `calc(`, …) off the slice: three code points
 * cannot escape to more than 24, and one of them has to start the name.
 * @param {string} input input
