			...
			(compilation, { normalModuleFactory }) => {
				...
				compilation.mainTemplate.hooks.renderManifest.tap(
					...
					(result, options) => {
						...
						// TODO only use useGlobalHash in webpack 5
						const useGlobalHash =
							typeof compilation.mainTemplate.useGlobalHash === "function"
								? compilation.mainTemplate.useGlobalHash(chunk)
						...
						result.push({
							...
							filenameTemplate,
							pathOptions: {
								noChunkHash: useGlobalHash,
								contentHashType: "javascript",
								chunk
							},
							identifier: `chunk${chunk.id}`,
							hash: !useGlobalHash ? chunk.hash : fullHash
						});
						return result;
					}
				);
