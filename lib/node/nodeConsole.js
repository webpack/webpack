...
import truncateArgs from "../logging/truncateArgs.js";
import memoize from "../util/memoize.js";

const require = createRequire(import.meta.url);
const getCli = memoize(() => require("../cli.js"));
...
/** @typedef {import("../config/defaults.js").InfrastructureLoggingNormalizedWithDefaults} InfrastructureLoggingNormalizedWithDefaults */
/** @typedef {import("../logging/createConsoleLogger.js").LoggerConsole} LoggerConsole */
/**
 ...
 */
const __esmDefault = ({ colors, appendOnly, stream, compiler }) => {
