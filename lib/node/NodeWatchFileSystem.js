...
const getWatchpack = lazyModule(() => require("watchpack"));
...
class NodeWatchFileSystem {
	...
	watch(
		...
		this.watcher = new (getWatchpack.loaded())(options);
...
/**
 * Loads watchpack before `watch` reads it.
 * @returns {Promise<void>} resolves once watchpack is loaded
 */
NodeWatchFileSystem.preloadWatchpack = () =>
	getWatchpack().then(() => undefined);
