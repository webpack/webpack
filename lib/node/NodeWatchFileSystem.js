...
class NodeWatchFileSystem {
	...
	watch(
		...
		// Watchpack reports a watched directory whenever its contents change, and the
		// default `fs.purge(dir)` matches by prefix, wiping the stat cache of every
		// file inside it. Purge the directory's own entry alone: the file-level events
		// in the same batch already carry the file stats.
		/**
