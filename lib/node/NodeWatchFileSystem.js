...
class NodeWatchFileSystem {
	...
	watch(
		...
		// Watchpack reports a watched directory whenever its contents change, and
		// `fs.purge(dir)` matches by prefix, wiping every file's stat cache with it.
		// Only its own entry is purged; the batch's file events carry the rest.
		/**
