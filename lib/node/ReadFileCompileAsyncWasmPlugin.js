...
const { usesFullHashDigest } = require("../template/TemplatedPathPlugin");
const AsyncWasmCompileRuntimeModule = require("../wasm/AsyncWasmCompileRuntimeModule");
const AsyncWasmLoadingRuntimeModule = require("../wasm/AsyncWasmLoadingRuntimeModule");
