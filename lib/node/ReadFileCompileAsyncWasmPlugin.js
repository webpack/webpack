				...
				: (path) =>
						Template.asString([
							...
							Template.indent([
								"try {",
								Template.indent([
									`var { readFile } = require(${compilation.runtimeTemplate.renderNameBuiltInNodeCoreModule("fs")});`,
									`var { join } = require(${compilation.runtimeTemplate.renderNameBuiltInNodeCoreModule("path")});`,
									"",
