...
/** @typedef {{ module: Module, export: string[] | undefined }} TargetItem */
...
class ExportInfo {
	 ...
	 * @returns {TargetItem | null | undefined | false} the target, undefined when there is no target, false when no target is valid
	 */
