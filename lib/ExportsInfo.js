...
/** @typedef {import("./Dependency.js").ExportInfoName} ExportInfoName */
/** @typedef {import("./Dependency.js").ExportsSpecExcludeExports} ExportsSpecExcludeExports */
...
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectDeserializerContext<RestoreProvidedDataTuple>} ObjectDeserializerContext */
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectSerializerContext<RestoreProvidedDataTuple>} ObjectSerializerContext */
...
export default ExportsInfo;
export { ExportInfo };
export { RestoreProvidedData };
export { UsageState };
...
export { ExportsInfo as "module.exports" };
