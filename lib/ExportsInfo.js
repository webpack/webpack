...
class ExportsInfo {
	constructor() {
		...
		// Fallback entry for the unlisted exports, in two roles: the template every
		// `getExportInfo` extends, and the flag for whether this exportsInfo can be
		// analyzed at all. `Used` and `true` are never reached on it.
		/** @type {ExportInfo} */
