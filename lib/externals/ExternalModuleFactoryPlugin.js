...
const ContextElementDependency = require("../dependencies/context/ContextElementDependency");
...
const ImportDependency = require("../dependencies/import/ImportDependency");
const { ASSET_URL_TYPE } = require("../module/ModuleSourceTypeConstants");
...
/** @typedef {((data: ExternalItemFunctionData) => Promise<ExternalItemValue>)} ExternalItemFunctionPromise */
...
// TODO in the next major release: remove this
		...
		normalModuleFactory.hooks.factorize.tapAsync(
			...
			(data, callback) => {
				...
				const handleExternal = (value, type, callback) => {
					...
					if (
						dependency instanceof ESMImportDependency ||
