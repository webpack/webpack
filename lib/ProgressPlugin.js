...
class ProgressPlugin {
	...
	constructor(options = {}) {
		...
		this.profile =
			options.profile !== undefined ? options.profile : DEFAULT_OPTIONS.profile;
		this.handler = options.handler;
		this.modulesCount =
			options.modulesCount !== undefined
				? options.modulesCount
				: DEFAULT_OPTIONS.modulesCount;
		this.dependenciesCount =
			options.dependenciesCount !== undefined
				? options.dependenciesCount
				: DEFAULT_OPTIONS.dependenciesCount;
		this.showEntries =
			options.entries !== undefined ? options.entries : DEFAULT_OPTIONS.entries;
		this.showModules =
			options.modules !== undefined ? options.modules : DEFAULT_OPTIONS.modules;
		this.showDependencies =
			options.dependencies !== undefined
				? options.dependencies
				: DEFAULT_OPTIONS.dependencies;
		this.showActiveModules =
			options.activeModules !== undefined
				? options.activeModules
				: DEFAULT_OPTIONS.activeModules;
		this.percentBy =
			options.percentBy !== undefined
				? options.percentBy
				: DEFAULT_OPTIONS.percentBy;
	}
