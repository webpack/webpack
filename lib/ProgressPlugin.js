...
const getColors = memoize(() => {
	const cli = /** @type {typeof import("./cli.js")} */ (require("./cli.js"));
 ...
 */
/** @typedef {import("../declarations/plugins/ProgressPlugin.js").ProgressPluginArgument} ProgressPluginArgument */
/** @typedef {import("../declarations/plugins/ProgressPlugin.js").ProgressPluginOptions} ProgressPluginOptions */
...
const reportProfile = (logger, lastStateInfo, percentage, msg, args) => {
	...
	const state = fullState.map((s) => s.replaceAll(/\d+\/\d+ /g, ""));
	const now = Date.now();
	...
	_applyOnCompiler(compiler, handler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../schemas/plugins/ProgressPlugin.check.js")} */ (
...
export { ProgressPlugin as "module.exports" };
