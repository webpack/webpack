...
import { ConcatSource, RawSource } from "../util/webpack-sources.js";
import { createChunkHashHandler, getChunkInfo } from "./ChunkFormatHelpers.js";
import __JavascriptModulesPlugin from "./JavascriptModulesPlugin.js";
import { generateEntryStartup } from "./StartupHelpers.js";

const { getChunkFilenameTemplate, getCompilationHooks } =
	__JavascriptModulesPlugin;
...
export default CommonJsChunkFormatPlugin;

export { CommonJsChunkFormatPlugin as "module.exports" };
