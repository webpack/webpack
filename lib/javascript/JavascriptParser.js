...
class JavascriptParser extends Parser {
	...
	detectMode(statements) {
		...
		for (const directiveStatement of statements) {
			if (
				directiveStatement.type !== "ExpressionStatement" ||
				/** @type {Directive} */ (directiveStatement).directive === undefined
			) {
				break;
			}
			if (
				/** @type {Directive} */ (directiveStatement).directive === "use strict"
			) {
