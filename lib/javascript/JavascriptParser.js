...
/** @typedef {KnownTagData | Record<string, unknown>} TagData */
...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto", options = {}) {
		...
		/** @type {ScopeInfo} */
		this.scope = /** @type {ScopeInfo} */ (/** @type {unknown} */ (undefined));
	 ...
	 * @returns {{ options: Record<string, unknown> | null, errors: (Error & { comment: Comment })[] | null }} result
	 */
