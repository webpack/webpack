...
class JavascriptParser extends Parser {
	...
	isPure(expr, commentsStartPos) {
		...
		switch (expr.type) {
			...
			case "BinaryExpression":
				// Strict equality compares without coercion and runs no user code, so it
				// is pure where both sides are. Every other operator may reach `valueOf`,
				// `toString` or a Proxy trap and falls through to the evaluator.
