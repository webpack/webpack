...
// Todo: revert to /** @typedef {import("acorn").Options} AcornOptions */
// when https://github.com/acornjs/acorn/pull/979 is published
/** @typedef {Omit<import("acorn").Options, "ecmaVersion"> & { ecmaVersion: "latest" } } AcornOptions */
