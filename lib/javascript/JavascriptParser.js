...
const { SourcePositions, lazyLocations } = require("./syntax");
...
let parser = AcornParser.extend(importAssertions, lazyLocations);
...
class JavascriptParser extends Parser {
	...
	static _parse(code, options, customParse) {
		...
		const internalParse = (code, options) => {
			...
			// lazyLocations plugin serve them on demand instead of eagerly.
