...
/** @typedef {import("../dependencies/HarmonyImportSpecifierGuardParserPlugin").HarmonyGuardsSettings} HarmonyGuardsSettings */
...
/** @typedef {HarmonySettings | ImportSettings | CommonJsImportSettings | TopLevelSymbol | CompatibilitySettings | HarmonyGuardsSettings} KnownTagData */
...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto", options = {}) {
		...
		this.hooks = Object.freeze({
			...
			collectImportSpecifierGuards: new SyncBailHook(["expression"]),
	...
	walkIfStatement(statement) {
		...
		if (result === undefined) {
			const inGuard = this.hooks.collectImportSpecifierGuards.call(
				statement.test
			);
			if (inGuard) {
				inGuard(() => {
