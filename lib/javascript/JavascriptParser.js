...
/** @typedef {{ consequent?: object, alternate?: object }} GuardCollection per-branch guard frames pushed onto the parser state guard stack */
...
const getImportAttributes = (node) => {
	...
	if (/** @type {any} */ (node.attributes)[LEGACY_ASSERT_ATTRIBUTES]) {
		result._isLegacyAssert = true;
	}
...
/** @typedef {KnownTagData | Record<string, any>} TagData */
...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto", options = {}) {
		...
		/** @type {ScopeInfo} */
		this.scope = /** @type {any} */ (undefined);
		/** @type {JavascriptParserState} */
		this.state = /** @type {any} */ (undefined);
	 ...
	 * @param {object | undefined | null} frame guard frame, or falsy when the branch is unguarded
