...
class JavascriptParser extends Parser {
	...
	preWalkStatement(statement) {
		...
		// only a declaration reaches here: a class declaration is the block pass's
		// to define, and is listed for the typed hook alone
		switch (statement.type) {
			case "VariableDeclaration":
	...
	walkFunctionDeclaration(statement) {
		...
		this.preWalkHoistedDeclarations(
			hoistedDeclarationsOf(statement.body, this._hasParserRecord)
		);
		this.prevStatement = prev;
	...
	walkFunctionExpression(expression) {
		...
		this.preWalkHoistedDeclarations(
			hoistedDeclarationsOf(expression.body, this._hasParserRecord)
		);
		this.prevStatement = prev;
	...
	_walkIIFE(functionExpression, options, currentThis) {
		...
		if (functionExpression.body.type === "BlockStatement") {
			...
			const prev = this.prevStatement;
			this.preWalkHoistedDeclarations(
				hoistedDeclarationsOf(functionExpression.body, this._hasParserRecord)
			);
			this.prevStatement = prev;
	...
	parse(source, state) {
		...
		if (this.hooks.program.call(ast, comments) === undefined) {
			...
			this.prevStatement = undefined;
			this.preWalkHoistedDeclarations(
				hoistedDeclarationsOf(ast, this._hasParserRecord)
			);
			this.prevStatement = undefined;
