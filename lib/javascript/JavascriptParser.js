...
const importDefer = Parser =>
	class extends Parser {
		/**
		 * @this {TODO}
		 * @param {TODO} node import declaration
		 * @returns {TODO} import declaration
		 */
		parseImport(node) {
			this._defer = false;
		...
		/**
		 * @this {TODO}
		 * @returns {TODO} import specifiers
		 */
		...
		/**
		 * @this {TODO}
		 * @param {TODO} forNew import.defer()
		 * @returns {TODO} import expression
		 */
