...
import BasicEvaluatedExpression from "./BasicEvaluatedExpression.js";
import {
...
/** @typedef {import("../dependencies/LocalModule.js").default} LocalModule */
/** @typedef {import("../dependencies/HarmonyExportImportedSpecifierDependency.js").HarmonyStarExportsList} HarmonyStarExportsList */
 ...
 * @property {import("./syntax.js").LazySourcePositions=} lazySourcePositions internal: serve loc/range lazily instead of allocating them during parsing
...
/** @typedef {import("../dependencies/HarmonyImportDependencyParserPlugin.js").HarmonySettings} HarmonySettings */
/** @typedef {import("../dependencies/ImportParserPlugin.js").ImportSettings} ImportSettings */
/** @typedef {import("../dependencies/CommonJsImportsParserPlugin.js").CommonJsImportSettings} CommonJsImportSettings */
/** @typedef {import("../CompatibilityPlugin.js").CompatibilitySettings} CompatibilitySettings */
/** @typedef {import("../optimize/InnerGraph.js").TopLevelSymbol} TopLevelSymbol */
...
class JavascriptParser extends Parser {
	...
	walkGuardedBranch(frame, walk) {
		...
		const stack = (this.state.guardStack ||= []);
		stack.push(frame);
		try {
			walk();
		} finally {
...
export { ALLOWED_MEMBER_TYPES_ALL };
export { ALLOWED_MEMBER_TYPES_CALL_EXPRESSION };
export { ALLOWED_MEMBER_TYPES_EXPRESSION };
export { VariableInfo };
export { VariableInfoFlags };
export { getImportAttributes };
...
export { JavascriptParser as "module.exports" };
