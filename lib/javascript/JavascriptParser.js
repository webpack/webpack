...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto") {
		...
		this.hooks = Object.freeze({
			...
			/** Something like "a.b()" */
			/** @type {HookMap<SyncBailHook<[CallExpressionNode, string[], boolean[], number[]], boolean | void>>} */
			...
			/** @type {HookMap<SyncBailHook<[ExpressionNode, string[], boolean[], number[]], boolean | void>>} */
	 ...
	 * @returns {{ members: string[], object: ExpressionNode | SuperNode, membersOptionals: boolean[], memberRangeStarts: number[] }} member names (reverse order) and remaining object
	 */
	...
	/** @typedef {{ type: "call", call: CallExpressionNode, calleeName: string, rootInfo: string | VariableInfo, getCalleeMembers: () => string[], name: string, getMembers: () => string[], getMembersOptionals: () => boolean[], getMemberRangeStarts: () => number[]}} CallExpressionInfo */
