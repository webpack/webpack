...
class JavascriptParser extends Parser {
	...
	_preWalkScope(node) {
		...
		if (this._needsLegacyPreWalk || this.hooks.preStatement.taps.length !== 0) {
			if (node.type === "Program") this._preWalkStatements(node.body);
	 ...
	 */
	_preWalkBlockStatement(statement) {
		this._preWalkStatements(statement.body);
	}
	 ...
	 */
	_preWalkLabeledStatement(statement) {
	 ...
	 */
	_preWalkWithStatement(statement) {
		this.preWalkStatement(statement.body);
	}
	 ...
	 */
	_preWalkSwitchStatement(statement) {
		this._preWalkSwitchCases(statement.cases);
	}
	 ...
	 */
	_preWalkSwitchCases(switchCases) {
		for (let index = 0, len = switchCases.length; index < len; index++) {
			this._preWalkStatements(switchCases[index].consequent);
		}
	}
	 ...
	 */
	_preWalkTryStatement(statement) {
		this.preWalkStatement(statement.block);
		if (statement.handler) this._preWalkCatchClause(statement.handler);
	 ...
	 */
	_preWalkCatchClause(catchClause) {
	 ...
	 */
	_preWalkWhileStatement(statement) {
		this.preWalkStatement(statement.body);
	}
	 ...
	 */
	_preWalkDoWhileStatement(statement) {
		this.preWalkStatement(statement.body);
	}
	 ...
	 */
	_preWalkForStatement(statement) {
		if (statement.init && statement.init.type === "VariableDeclaration") {
	 ...
	 */
	_preWalkForInStatement(statement) {
		if (statement.left.type === "VariableDeclaration") {
	 ...
	 */
	_preWalkForOfStatement(statement) {
		if (statement.left.type === "VariableDeclaration") {
			this.preWalkStatement(statement.left);
		}
		this.preWalkStatement(statement.body);
	...
	preWalkStatement(statement) {
		...
		switch (statement.type) {
			...
			case "FunctionDeclaration":
				...
				break;
			case "IfStatement":
				this._preWalkIfStatement(statement);
				break;
			case "BlockStatement":
				this._preWalkBlockStatement(statement);
				break;
			case "ForStatement":
				this._preWalkForStatement(statement);
				break;
			case "TryStatement":
				this._preWalkTryStatement(statement);
				break;
			case "SwitchStatement":
				this._preWalkSwitchStatement(statement);
				break;
			case "WhileStatement":
				this._preWalkWhileStatement(statement);
				break;
			case "ForInStatement":
				this._preWalkForInStatement(statement);
				break;
			case "ForOfStatement":
				this._preWalkForOfStatement(statement);
				break;
			case "DoWhileStatement":
				this._preWalkDoWhileStatement(statement);
				break;
			case "LabeledStatement":
				this._preWalkLabeledStatement(statement);
				break;
			case "WithStatement":
				this._preWalkWithStatement(statement);
				break;
		}
		this.prevStatement =
			/** @type {StatementPath} */
