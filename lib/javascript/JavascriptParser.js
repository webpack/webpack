...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto") {
		...
		this.hooks = Object.freeze({
			...
			/** @type {SyncBailHook<[ExpressionNode, ClassExpression | ClassDeclaration], boolean | void>} */
			...
			/** @type {SyncBailHook<[ExpressionNode, MethodDefinition | PropertyDefinition, ClassExpression | ClassDeclaration], boolean | void>} */
			...
			/** @type {SyncBailHook<[ExportNamedDeclaration | ExportAllDeclarationNode], boolean | void>} */
			export: new SyncBailHook(["statement"]),
			/** @type {SyncBailHook<[ExportNamedDeclaration | ExportAllDeclarationNode, ImportSource], boolean | void>} */
			exportImport: new SyncBailHook(["statement", "source"]),
			/** @type {SyncBailHook<[ExportNamedDeclaration | ExportAllDeclarationNode, DeclarationNode], boolean | void>} */
			exportDeclaration: new SyncBailHook(["statement", "declaration"]),
			/** @type {SyncBailHook<[ExportDefaultDeclaration, DeclarationNode], boolean | void>} */
			exportExpression: new SyncBailHook(["statement", "declaration"]),
			/** @type {SyncBailHook<[ExportNamedDeclaration | ExportAllDeclarationNode, string, string, number | undefined], boolean | void>} */
			...
			/** @type {SyncBailHook<[ExportNamedDeclaration | ExportAllDeclarationNode, ImportSource, string, string, number | undefined], boolean | void>} */
