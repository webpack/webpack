...
// cspell:ignore DEFMETHOD, Defun, defun, fnames, funarg, classnames, mangleable, unmangleable, NOINLINE, privatename, argnames
...
const installOutput = (modules) => {
	...
	const driver = AST_Node.prototype._print;
	...
	AST_Toplevel.DEFMETHOD(
		...
		function print(stream, forceParens) {
			if (stream instanceof MinifiedOutput) {
				driver.call(this, stream, forceParens);
				return;
			}
			/** @type {TerserFormatOptions} */
			const options = {};
			...
			driver.call(this, ours, forceParens);
