...
class Parser {
	...
	constructor(options, input, startPos) {
		...
		/** @type {RegExpValidationState | null} */
...
/**
 * The `\p{...}` name tables for one edition, built on first use: only a pattern
 * the engine itself rejected reaches the validator that reads them.
