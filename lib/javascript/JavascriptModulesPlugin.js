...
class JavascriptModulesPlugin {
	...
	_getRenamedInlineModule(
		...
		for (const m of allModules) {
			...
			// Reuse cached `freeNames` to avoid re-parse for non-inlined modules
			if (!isInlinedModule) {
				const freeNames = result.data && result.data.get("freeNames");
			...
			result.data.set("freeNames", freeNames);
		}
