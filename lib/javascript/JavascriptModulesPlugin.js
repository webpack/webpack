...
import { last } from "../util/IterableHelpers.js";
...
import { intersectRuntime } from "../util/runtime.js";
import {
	CachedSource,
	ConcatSource,
	OriginalSource,
...
import { getAllChunks } from "./ChunkHelpers.js";
...
/** @typedef {import("../Compilation.js").ExecuteModuleObject} ExecuteModuleObject */
/** @typedef {import("../Compilation.js").WebpackRequire} WebpackRequire */
...
/** @typedef {import("./JavascriptParser.js").Range} Range */
/** @typedef {import("../util/Hash.js").default} Hash */
/** @typedef {import("../util/concatenate.js").ScopeSet} ScopeSet */
...
class JavascriptModulesPlugin {
	...
	_getEsmEntryModuleToInline(renderContext, allModules) {
		...
		const referenced = moduleGraph
			.getIncomingConnectionsByOriginModule(entryModule)
			.entries()
			.some(
				([originModule, connections]) =>
					...
					Iterator.from(chunkGraph.getModuleRuntimes(originModule)).some(
