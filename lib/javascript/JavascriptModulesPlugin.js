...
class JavascriptModulesPlugin {
	...
	static getChunkFilenameTemplate(chunk, outputOptions) {
		...
		} else if (chunk.getEntryOptions() !== undefined) {
			// Worker entry chunk (a non-initial entrypoint); chunks it loads
			// internally are not entry chunks and keep using `chunkFilename`.
