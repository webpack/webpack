...
/** @typedef {ChunkRenderContext & Partial<{ factory: boolean }>} ModuleContentRenderContext */

/**
 * @typedef {object} CompilationHooks
 * @property {SyncWaterfallHook<[Source, Module, ModuleContentRenderContext]>} renderModuleContent
	...
	renderModule(module, renderContext, hooks, factory) {
		...
		try {
			...
			const moduleSourcePostContent = tryRunOrWebpackError(
				() =>
					hooks.renderModuleContent.call(moduleSource, module, {
						...renderContext,
						factory
					}),
