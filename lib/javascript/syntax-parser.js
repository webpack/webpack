 ...
 * } from "./parser"
 */
/** @typedef {import("./parser").ImportSpecifier | import("./parser").ImportDefaultSpecifier | import("./parser").ImportNamespaceSpecifier} AnyImportSpecifier */
...
/** @typedef {import("./parser").EcmaVersion} EcmaVersion the ECMAScript versions the parser accepts */
/** @typedef {typeof import("./parser").Parser} ParserClass the parser class itself, as a plugin receives and returns it */
