...
class WebpackParser extends BaseParser {
	...
	/**
	 * Whether the declarations of each scope are recorded at all. An overridden
	 * statement or function production leaves the record incomplete, so none is
	 * kept and the consumer collects its own.
	 * @returns {boolean} whether the record is kept
	 */
	_recordsHoisted() {
		return this._lazy && this._stmtFastPath && this._funcStmtOwn;
	}
