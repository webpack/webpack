...
class LazyComment {
	 ...
	 * @param {number} start start offset
	 * @param {number} end end offset
	 * @param {SourcePositions} sourcePositions holder of the source text for the lazy `value` slice
	 */
...
class WebpackParser extends BaseParser {
	...
	constructor(options, input, startPos) {
		...
		// set = lazy mode: gates the owned tokenizer/statement fast paths and
		// hands LazyComment the source text
		this[kSourcePositions] = sourcePositions;
