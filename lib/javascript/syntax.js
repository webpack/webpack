...
/** @typedef {EXPECTED_ANY[]} ModuleDeclarations the program's import and re-export declarations, in source order */
...
class WebpackParser extends BaseParser {
	...
	constructor(options, input, startPos) {
		...
		// the program's import and re-export declarations, in source order
		/** @type {ModuleDeclarations | undefined} */
	...
	_recordModuleDeclaration(node) {
		...
		if (this._moduleDeclarations === undefined) {
			this._moduleDeclarations = [node];
		} else {
			this._moduleDeclarations.push(node);
		}
	}
