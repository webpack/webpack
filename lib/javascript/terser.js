...
// The phases webpack has taken over. Each one replaces a method on terser's own
// classes and is expected to write exactly what terser wrote, only faster; a
// new phase is added here and nowhere else.
/** @type {Phase[]} */
const PHASES = [require("./terserMangle")];
