 ...
 * @property {Set<string>=} classHeritageNames names a class binds while its own heritage clause is parsed in the enclosing scope, so a reference there resolves to the class at runtime but to the outer name here
