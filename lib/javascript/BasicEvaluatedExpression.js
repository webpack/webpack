...
/** @typedef {import("./JavascriptParser.js").VariableInfo} VariableInfo */
/** @typedef {import("./JavascriptParser.js").Members} Members */
/** @typedef {import("./JavascriptParser.js").MembersOptionals} MembersOptionals */
/** @typedef {import("./JavascriptParser.js").MemberRanges} MemberRanges */
...
class BasicEvaluatedExpression {
	...
	asBool() {
		...
		if (this.isBigInt()) return this.bigint !== 0n;
...
export default BasicEvaluatedExpression;

export { BasicEvaluatedExpression as "module.exports" };
