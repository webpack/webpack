...
BasicEvaluatedExpression.isValidRegExpFlags = (flags) => {
	...
	const D = 0b0000_0001; // d hasIndices
	const G = 0b0000_0010; // g global
	const I = 0b0000_0100; // i ignoreCase
	const M = 0b0000_1000; // m multiline
	const S = 0b0001_0000; // s dotAll
	const U = 0b0010_0000; // u unicode
	const V = 0b0100_0000; // v unicodeSets
	const Y = 0b1000_0000; // y sticky
	let seen = 0;
