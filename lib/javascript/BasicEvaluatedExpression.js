...
class BasicEvaluatedExpression {
	...
	/**
	 * @returns {any[] | undefined} const array values
	 */
	get array() {
	...
	/**
	 * @param {any[] | undefined} value const array values
	 */
	set array(value) {
		this._v1 = value;
	}
	 ...
	 * @returns {undefined | null | string | number | boolean | RegExp | any[] | bigint} the javascript value
	 */
	asCompileTimeValue() {
		switch (this.type) {
			case TypeUndefined:
