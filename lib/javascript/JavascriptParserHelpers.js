...
/** @typedef {import("./JavascriptParser.js").default} JavascriptParser */
/** @typedef {import("./JavascriptParser.js").Range} Range */
/** @typedef {import("./BasicEvaluatedExpression.js").GetMembers} GetMembers */
 ...
 */
export const evaluateToBoolean = (value) =>
 ...
 */
export const evaluateToIdentifier = (
	identifier,
	rootInfo,
	getMembers,
	truthy
 ...
 * @returns {(expression: Expression) => BasicEvaluatedExpression} plugin function
 */
export const evaluateToNumber = (value) =>
 ...
 * @returns {(expression: Expression) => BasicEvaluatedExpression} plugin function
 */
export const evaluateToString = (value) =>
	function stringExpression(expr) {
		return new BasicEvaluatedExpression()
			.setString(value)
			.setRange(/** @type {Range} */ (expr.range));
 ...
 */
export const expressionIsUnsupported = (parser, message) =>
...
export const skipTraversal = () => true;
 ...
 */
export const toConstantDependency = (parser, value, runtimeRequirements) =>
