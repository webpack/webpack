 ...
 * @param {Module} module the module
 * @param {boolean | undefined} mangle mangle module and export names
 * @param {number} start the number from which the counting would start
 * @returns {UsedWasmDependency[]} used dependencies and (mangled) name
 */
const getUsedPresentationalDependencies = (module, mangle, start) => {
	const array = [];
...
module.exports.getUsedPresentationalDependencies =
	getUsedPresentationalDependencies;
