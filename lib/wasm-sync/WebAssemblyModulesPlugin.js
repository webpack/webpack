...
const getWebAssemblyGenerator = lazyModule.sync(() =>
	require("./WebAssemblyGenerator")
);
const getWebAssemblyJavascriptGenerator = lazyModule.sync(() =>
	require("./WebAssemblyJavascriptGenerator")
);
const getWebAssemblyParser = lazyModule.sync(() =>
	require("./WebAssemblyParser")
);
const getSyncWasmModule = lazyModule.sync(() => require("./SyncWasmModule"));
