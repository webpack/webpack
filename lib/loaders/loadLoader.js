...
const getLoaderLoadingError = memoize(() =>
	require("../errors/LoaderLoadingError")
);
 ...
 * @type {((url: URL) => Promise<any>) | undefined}
 */
let importModule;
	...
	if (loader.type === "module") {
		try {
			if (importModule === undefined) {
				...
				importModule = /** @type {(url: URL) => Promise<any>} */ (
					dynamicImport
				);
			}
