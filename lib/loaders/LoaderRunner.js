...
function escapeHash(str) {
	return str.includes("#") ? str.replaceAll(HASH_ESCAPE_REGEXP, "\0#") : str;
}
...
function parseIdentifier(identifier) {
	...
	return [
		match[1].replaceAll(ZERO_ESCAPE_REGEXP, "$1"),
		match[2] ? match[2].replaceAll(ZERO_ESCAPE_REGEXP, "$1") : "",
		match[3] || ""
	];
}
