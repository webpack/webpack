...
/** @typedef {string | ({ loader: string } & Record<string, any>)} LoaderItemInput */

/**
 * @typedef {object} ProcessOptions
 * @property {Buffer | null} resourceBuffer the raw resource buffer
 * @property {(loaderContext: any, resource: string, callback: (err: Error | null, ...args: any[]) => void) => void} processResource read and process the resource
 */
 ...
 * @property {any=} context the loader context to augment and pass to loaders
 ...
 * @property {any=} result the loader pipeline result
 * @property {Buffer | null=} resourceBuffer the raw resource buffer
...
/** @typedef {(...args: any[]) => void} LoaderCallback */

/** @typedef {import("../../declarations/LoaderContext").LoaderRunnerLoaderContext<any>} LoaderRunnerLoaderContext */
...
function runSyncOrAsync(fn, context, args, callback) {
	...
	/**
	 * @param {...any} callbackArgs callback args
	 * @returns {void}
	 */
 ...
 * @param {any[]} args arguments
 * @param {(err: Error | null, args?: any[]) => void} callback callback
 * @returns {void}
 */
...
function getState(loaderContext) {
	return /** @type {any} */ (loaderContext)[LOADER_STATE];
}
 ...
 * @param {any=} base object to augment (the caller's context), if any
...
module.exports.runLoaders = function runLoaders(options, callback) {
	...
	const provided = /** @type {any} */ (options.context);
	const loaderContext =
	...
	const processResourceFn =
		...
		/** @type {(readResource: Function, context: any, res: string, cb: (err: Error | null, ...args: any[]) => void) => void} */
		(
