...
class ObjectMiddleware extends SerializerMiddleware {
	...
	serialize(data, context) {
		...
		// Dispatched on `typeof` first: two thirds of the items reaching this are
		// numbers, booleans and `undefined`, which used to reach their one-line
		// branch through a `Buffer.isBuffer` call and four failed comparisons.
		/**
