...
import AggregateErrorSerializer from "./AggregateErrorSerializer.js";
import ArraySerializer from "./ArraySerializer.js";
import DateObjectSerializer from "./DateObjectSerializer.js";
import ErrorObjectSerializer from "./ErrorObjectSerializer.js";
import MapObjectSerializer from "./MapObjectSerializer.js";
import NullPrototypeObjectSerializer from "./NullPrototypeObjectSerializer.js";
import PlainObjectSerializer from "./PlainObjectSerializer.js";
import RegExpObjectSerializer from "./RegExpObjectSerializer.js";
import SerializerMiddleware from "./SerializerMiddleware.js";
import SetObjectSerializer from "./SetObjectSerializer.js";

const require = createRequire(import.meta.url);
/** @typedef {import("../logging/Logger.js").Logger} Logger */
/** @typedef {import("../util/Hash.js").HashFunction} HashFunction */
/** @typedef {import("./SerializerMiddleware.js").LazyOptions} LazyOptions */
 ...
 * @property {((item: (EXPECTED_ANY | (() => EXPECTED_ANY)), obj: LazyOptions | undefined) => import("./SerializerMiddleware.js").LazyFunction<EXPECTED_ANY, EXPECTED_ANY, EXPECTED_ANY, LazyOptions>)=} writeSeparate
 */
...
jsTypes.set(AggregateError, new AggregateErrorSerializer());
...
// `process` is injected from the outer realm, so the root of its prototype
// chain is the outer realm's Object.prototype (CJS used `exports` for this).
{
	let proto = process;
	let rootProto = proto;
	while ((proto = Object.getPrototypeOf(proto)) !== null) rootProto = proto;
	const Obj = /** @type {ObjectConstructor} */ (rootProto.constructor);
	if (Obj !== Object) {
