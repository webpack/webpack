...
/** @typedef {SerializerMiddleware<any, any, Record<string, any>>} LazyTarget */
...
class SerializerMiddleware {
	 ...
	 * @template {LazyTarget} TLazyTarget
	 * @param {any} fn lazy function
	 * @param {TLazyTarget=} target target middleware
	 * @returns {fn is LazyFunction<any, any, TLazyTarget, any>} true, when fn is a lazy function (optionally of that target)
	 */
	 ...
	 * @template TLazyOutputValue
	 * @template {LazyTarget} TLazyTarget
	 * @template {Record<string, any>} TLazyOptions
	 ...
	 * @param {LazyFunction<TLazyInputValue, TLazyOutputValue, TLazyTarget, TLazyOptions> | any} fn lazy function
