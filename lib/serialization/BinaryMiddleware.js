...
import SerializerMiddleware from "./SerializerMiddleware.js";
/** @typedef {import("./types.js").BufferSerializableType} BufferSerializableType */
/** @typedef {import("./types.js").PrimitiveSerializableType} PrimitiveSerializableType */
...
const identifyBigInt = (n) => {
	if (n <= 127n && n >= -128n) return 0;
	if (n <= 2147483647n && n >= -2147483648n) return 1;
	return 2;
};
 ...
 * @typedef {import("./SerializerMiddleware.js").LazyFunction<LazyInputValue, LazyOutputValue, BinaryMiddleware, undefined>} LazyFunction
 */
...
export default BinaryMiddleware;

export { MEASURE_END_OPERATION };
export { MEASURE_START_OPERATION };

// attach named exports as properties to keep the CJS shape
BinaryMiddleware.MEASURE_END_OPERATION = MEASURE_END_OPERATION;
BinaryMiddleware.MEASURE_START_OPERATION = MEASURE_START_OPERATION;

export { BinaryMiddleware as "module.exports" };
