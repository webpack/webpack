 ...
 * @typedef {import("./SerializerMiddleware.js").LazyFunction<BufferSerializableType[], Buffer, FileMiddleware, LazyOptions>} LazyFunction
 */
...
export { FileMiddleware as "module.exports" };
