...
class PlainObjectSerializer {
	 ...
	 * @param {import("./ObjectMiddleware.js").ObjectSerializerContext<((keyof T)[] | keyof T | null | T[keyof T])[]>} context context
	 */
	 ...
	 * @template {object} T
	 * @param {import("./ObjectMiddleware.js").ObjectDeserializerContext<((keyof T)[] | keyof T | null | T[keyof T])[]>} context context
...
export default PlainObjectSerializer;

export { PlainObjectSerializer as "module.exports" };
