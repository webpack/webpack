...
/** @typedef {NormalModuleCreateData & { cssLayer: CssLayer|null, supports: Supports|null, media: Media|null, inheritance: Inheritance|null, assertions: ImportAttributes|null }} CSSModuleCreateData */
...
class CssModule extends NormalModule {
	...
	identifier() {
		...
		if (this.assertions) {
			identifier += `|${JSON.stringify(this.assertions)}`;
		}
	...
	readableIdentifier(requestShortener) {
		...
		if (this.assertions) {
			identifier += ` (assertions: ${JSON.stringify(this.assertions)})`;
		}
