...
/** @typedef {NormalModuleCreateData & { cssLayer: CssLayer|null, supports: Supports|null, media: Media|null, inheritance: Inheritance|null, URLRequest: string | null, isURLEntry: boolean | null }} CSSModuleCreateData */
...
class CssModule extends NormalModule {
	...
	constructor(options) {
		...
		this.isURLEntry = options.isURLEntry;
	}
	...
	readableIdentifier(requestShortener) {
		...
		if (this.URLRequest) {
			identifier += ` (URL: ${this.URLRequest})`;
		}
	...
	updateCacheModule(module) {
		...
		this.URLRequest = m.URLRequest;
		this.isURLEntry = m.isURLEntry;
	}
	...
	serialize(context) {
		...
		write(this.URLRequest);
		write(this.isURLEntry);
	...
	deserialize(context) {
		...
		this.URLDependency = read();
		this.isURLEntry = read();
