...
import { dirname, mkdirp } from "../util/fs.js";
/** @typedef {import("../ChunkGraph.js").ModuleId} ModuleId */
/** @typedef {import("../Compiler.js").default} Compiler */
/** @typedef {import("../Compiler.js").IntermediateFileSystem} IntermediateFileSystem */
					...
					(chunk, callback) => {
						...
						for (const module of chunkGraph.getOrderedChunkModulesIterable(
							...
							if (
								...
								!Iterator.from(moduleGraph.getIncomingConnections(module)).some(
...
export default LibManifestPlugin;

export { LibManifestPlugin as "module.exports" };
