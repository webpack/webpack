...
/** @typedef {import("./LibManifestPlugin.js").ManifestModuleData} ManifestModuleData */
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[DelegatedModuleSourceRequest, DelegatedModuleData, DelegatedModuleType, string, string | Module]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[DelegatedModuleSourceRequest, DelegatedModuleData, DelegatedModuleType, string, string | Module]>} ObjectSerializerContext */
/** @typedef {import("../dependencies/StaticExportsDependency.js").Exports} Exports */
...
export default DelegatedModule;

export { DelegatedModule as "module.exports" };
