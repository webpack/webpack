...
import DelegatedModule from "./DelegatedModule.js";
...
/** @typedef {import("./DelegatedModule.js").DelegatedModuleData} DelegatedModuleData */
/** @typedef {import("./DelegatedModule.js").DelegatedModuleSourceRequest} DelegatedModuleSourceRequest */
/** @typedef {import("./DelegatedModule.js").DelegatedModuleType} DelegatedModuleType */
...
class DelegatedModuleFactoryPlugin {
	...
	constructor(options) {
		...
		options.extensions ||= ["", ".js", ".json", ".wasm"];
	}
...
export default DelegatedModuleFactoryPlugin;

export { DelegatedModuleFactoryPlugin as "module.exports" };
