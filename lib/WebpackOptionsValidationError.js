			...
			if (!err.dataPath) {
				switch (err.params.additionalProperty) {
					case "debug":
						return (
							`${baseMessage}\n` +
							`The 'debug' property was removed in webpack ${packageJSON.version} .\n` +
				...
				return (
					...
					"For loader options: webpack since 2 version no longer allows custom properties in configuration.\n" +
