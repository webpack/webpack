 ...
 * @returns {void}
 */
export const arrayToSetDeprecation = (set, name) => {
 ...
 */
export const createArrayToSetDeprecationSet = (name) => {
 ...
 */
export const createFakeHook = (fakeHook, message, code) => {
	if (message && code) {
 ...
 */
export const soonFrozenObjectDeprecation = (obj, name, code, note = "") => {
