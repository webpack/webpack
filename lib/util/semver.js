 ...
 * @returns {string}
 */
export const parseVersionRuntimeCode = (runtimeTemplate) =>
 ...
 * @returns {string}
 */
export const versionLtRuntimeCode = (runtimeTemplate) =>
 ...
 * @returns {string}
 */
export const rangeToStringRuntimeCode = (runtimeTemplate) =>
 ...
 * @returns {string}
 */
export const satisfyRuntimeCode = (runtimeTemplate) =>
