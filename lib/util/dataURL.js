...
// WHY: `URIRegEx`'s `.` stops at a newline, which a raw `<svg>` payload
// carries, and its optional `base64` group reads `;charset=utf8` as one. This
// is the strict split a rewriter needs; that one stays as the matcher module
// requests are recognized by.
