 ...
 * @returns {void}
 */
const enableImportBindingScopes = (compilation) => {
	collectingModuleGraphs.add(compilation.moduleGraph);
	...
	compilation.dependencyTemplates.updateHash("source-map-scopes");
};
