...
const SerializerModule = require("../serialization/Serializer");
const SerializerMiddleware = require("../serialization/SerializerMiddleware");
const SingleItemMiddlewareModule = require("../serialization/SingleItemMiddleware");
...
const getBinaryMiddlewareInstance = memoize(() => new BinaryMiddleware());
...
module.exports = {
	...
	get MEASURE_START_OPERATION() {
		return BinaryMiddleware.MEASURE_START_OPERATION;
	},
	/** @type {MEASURE_END_OPERATION} */
	get MEASURE_END_OPERATION() {
		return BinaryMiddleware.MEASURE_END_OPERATION;
	},
	get buffersSerializer() {
		...
		const SingleItemMiddleware = SingleItemMiddlewareModule;
