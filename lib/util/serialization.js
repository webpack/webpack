...
const getBinaryMiddleware = lazyModule.sync(() =>
	require("../serialization/BinaryMiddleware")
);
const getObjectMiddleware = lazyModule.sync(() =>
	require("../serialization/ObjectMiddleware")
);
const getSingleItemMiddleware = lazyModule.sync(() =>
	require("../serialization/SingleItemMiddleware")
);
const getSerializer = lazyModule.sync(() =>
	require("../serialization/Serializer")
);
const getSerializerMiddleware = lazyModule.sync(() =>
...
const registerSerializers = lazyModule.sync(() => {
