 ...
 * @param {HashFunction=} params.hashFunction hash function
 * @returns {Serializer} serializer
 */
function createBuffersSerializer({ hashFunction = "xxhash64" }) {
	registerSerializers();
...
module.exports = {
	...
	get buffersSerializer() {
		...
		return (buffersSerializer = createBuffersSerializer({}));
	},
	createBuffersSerializer,
