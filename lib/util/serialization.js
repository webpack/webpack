...
const getBinaryMiddleware = lazyModule(() =>
	require("../serialization/BinaryMiddleware")
);
const getObjectMiddleware = lazyModule(() =>
	require("../serialization/ObjectMiddleware")
);
const getSingleItemMiddleware = lazyModule(() =>
	require("../serialization/SingleItemMiddleware")
);
const getSerializer = lazyModule(() => require("../serialization/Serializer"));
const getSerializerMiddleware = lazyModule(() =>
...
const registerSerializers = lazyModule(() => {
