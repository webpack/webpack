...
const getVm = memoize(() => require("node:vm"));
		...
		if (typeof val === "object" && val !== null) {
			val =
				val.constructor.name === "RegExp"
					? new RegExp(val)
					: // eslint-disable-next-line unicorn/prefer-structured-clone -- JSON round-trip intentionally drops non-cloneable values instead of throwing
