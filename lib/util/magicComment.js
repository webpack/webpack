 ...
 * @param {Record<string, any>} options target to merge into
 ...
 * @param {import("vm").Context} context context from `createMagicCommentContext`
 * @returns {{ options: Record<string, any> | null, errors: (Error & { comment: TComment })[] | null }} result
 */
const parseMagicCommentOptions = (comments, context) => {
	if (comments.length === 0) {
		return /** @type {{ options: Record<string, any> | null, errors: (Error & { comment: TComment })[] | null }} */ (
