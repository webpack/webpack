 ...
 * @typedef {{ mode: "minify" | "beautify", environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, removeEmptyAttributes?: boolean, removeRedundantAttributes?: "smart" | "all", sortAttributes?: boolean, sortClassNames?: boolean }} PrintOptions
 */
/**
...
class SourceProcessor {
	...
	process(input, options) {
		...
		const printOpts =
			/** @type {{ mode?: PrintOptions["mode"], environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, removeEmptyAttributes?: boolean, removeRedundantAttributes?: "smart" | "all", sortAttributes?: boolean, sortClassNames?: boolean }} */ (
				opts
			);
