 ...
 * @typedef {{ mode: "minify" | "beautify", environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, tagOmission?: boolean | "keep-head-and-body" }} PrintOptions
 */
/**
...
class SourceProcessor {
	...
	process(input, options) {
		...
		const printOpts =
			/** @type {{ mode?: PrintOptions["mode"], minimize?: boolean, environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, tagOmission?: PrintOptions["tagOmission"] }} */ (
				opts
			);
		...
		const ctx = new PrintContext(
			{
				...
				tagOmission: printOpts.tagOmission
			},
