 ...
 * @typedef {{ mode: "minify" | "beautify", environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, removeRedundantAttributes?: "none" | "smart" | "all" }} PrintOptions
 */
/**
...
class SourceProcessor {
	...
	process(input, options) {
		...
		const printOpts =
			/** @type {{ mode?: PrintOptions["mode"], environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, removeRedundantAttributes?: "none" | "smart" | "all" }} */ (
				opts
			);
