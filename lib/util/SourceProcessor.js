 ...
 * @typedef {{ mode: "minify" | "beautify", environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, collapseBooleanAttributes?: boolean, rewriteAttributeValues?: boolean }} PrintOptions
 */
/**
...
class SourceProcessor {
	...
	process(input, options) {
		...
		const printOpts =
			/** @type {{ mode?: PrintOptions["mode"], minimize?: boolean, environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean, collapseBooleanAttributes?: boolean, rewriteAttributeValues?: boolean }} */ (
				opts
			);
		...
		const ctx = new PrintContext(
			{
				...
				collapseBooleanAttributes: printOpts.collapseBooleanAttributes,
				rewriteAttributeValues: printOpts.rewriteAttributeValues
			},
