...
class SourceProcessor {
	 ...
	 * @overload
	 * @param {string} input
	 * @param {TProcessOptions & ({ minimize: true } | { mode: PrintOptions["mode"] })} options
	...
	process(input, options) {
		...
		const printOpts =
			/** @type {{ mode?: PrintOptions["mode"], minimize?: boolean, environment?: Readonly<Record<string, boolean>>, convertLengthUnits?: boolean, collapseWhitespace?: boolean }} */ (
				opts
			);
