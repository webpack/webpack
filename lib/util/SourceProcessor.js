 ...
 * print: each name is on unless the options say `false`, so no read of the
 * result asks whether the option was given. Where nothing is set, `all` itself
 * comes back — one frozen object shared by every print that names none.
 * @template {object} T
