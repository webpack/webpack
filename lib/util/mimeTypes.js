...
// ~2500 mime-db entries scored against each other; only a build that resolves
// a type pays for the tables
...
const extension = (type) => {
	...
	const possibleExtensions = getTables().extensions[match[1].toLowerCase()];
...
const lookup = (path) => {
	...
	return getTables().types[extension];
};
