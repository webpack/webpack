...
export default nonNumericOnlyHash;
export { digestNonNumericOnly };
export { digestNonNumericOnlyWithFull };

// attach named exports as properties to keep the CJS shape
nonNumericOnlyHash.digestNonNumericOnly = digestNonNumericOnly;
nonNumericOnlyHash.digestNonNumericOnlyWithFull = digestNonNumericOnlyWithFull;

export { nonNumericOnlyHash as "module.exports" };
