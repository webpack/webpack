...
// A run of separators, which addresses the same file as a single one.
const REPEATED_PATH_SEPARATOR_REGEXP = /\/{2,}/g;
...
module.exports.REPEATED_PATH_SEPARATOR_REGEXP = REPEATED_PATH_SEPARATOR_REGEXP;
