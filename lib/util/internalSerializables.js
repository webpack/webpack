...
module.exports = {
	...
	"cache/DiskCacheStrategy": () => require("../cache/DiskCacheStrategy"),
	"cache/format/CacheIndex": () => require("../cache/format/CacheIndex"),
	"cache/format/CacheSegment": () => require("../cache/format/CacheSegment"),
