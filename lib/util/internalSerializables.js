...
const internalSerializables = {
	...
	"dependencies/WebAssemblyExportImportedDependency": () =>
		/** @type {typeof import("../dependencies/WebAssemblyExportImportedDependency.js").default} */ (
			require("../dependencies/WebAssemblyExportImportedDependency.js")
		),
	...
	"wasm-sync/SyncWasmModule": () =>
		/** @type {typeof import("../wasm-sync/SyncWasmModule.js").default} */ (
			require("../wasm-sync/SyncWasmModule.js")
		),
