...
module.exports = {
	...
	"shared/ProvideModule": () => require("../sharing/ProvideModule"),
	"shared/ProvideDependency": () => require("../sharing/ProvideDependency"),
	"shared/ProvidedDependency": () => require("../sharing/ProvidedDependency"),
