...
module.exports = {
	...
	"util/PathMap": () => require("../util/PathMap"),
	"util/PathSet": () => require("../util/PathSet"),
	"util/PathAsKeyMap": () => require("../util/PathAsKeyMap"),
	"util/PathLazySet": () => require("../util/PathLazySet"),
