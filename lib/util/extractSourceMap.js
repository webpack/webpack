...
import { isAbsolute, join } from "./fs.js";
/** @typedef {import("./fs.js").InputFileSystem} InputFileSystem */
...
export default extractSourceMap;
export { getSourceMappingURL };

// attach named exports as properties to keep the CJS shape
extractSourceMap.getSourceMappingURL = getSourceMappingURL;

export { extractSourceMap as "module.exports" };
