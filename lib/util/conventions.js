 ...
 */
export const cssExportConvention = (input, convention) => {
	/** @type {Set<string>} */
	const set = new Set();
 ...
 * @returns {string} result
 */
export const dashesCamelCase = (input) =>
	input.replaceAll(/-+(\w)/g, (match, firstLetter) =>
