 ...
 * @template {any[]} T
 * @template V
 * @typedef {Map<any, WeakTupleMap<T, V>>} M
 */
...
class WeakTupleMap {
	 ...
	 * @param {(thisArg: any, ...args: K) => V} compute computer, also the first key element
	 * @param {any} thisArg first argument passed to `compute`
