 ...
 *
 * We use StringXor in webpack to create a hash of the current state of the compilation.
 * By XOR'ing the Module hashes, it doesn't matter if the Module hashes are sorted or not.
 * This is useful because it allows us to avoid sorting the Module hashes.
 *
 * @example
 * ```js
