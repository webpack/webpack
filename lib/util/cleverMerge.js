...
/** @typedef {Map<string, Map<string | number | boolean, object>>} InnerPropertyCache */
/** @type {WeakMap<object, InnerPropertyCache>} */
...
/** @typedef {((...x: any) => object) & { [DYNAMIC_INFO]: [DynamicFunction, object] }} DynamicFunction */
...
/** @type {WeakMap<object, ParsedObject<any>>} */
...
/** @typedef {{ [p: string]: { [p: string]: any } } | DynamicFunction} ByObject */
