...
const getJSONParseError = memoize(() => require("../errors/JSONParseError"));

/** @import { JsonValue } from "../util/fs" */
 ...
 * @param {(this: any, key: string, value: any) => any=} reviver reviver
...
const parseJson = (raw, reviver) => {
	...
	try {
		...
		throw new (getJSONParseError())(/** @type {Error} */ (err), raw, txt);
	}
};
