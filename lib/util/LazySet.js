...
import makeSerializable from "./makeSerializable.js";
...
class LazySet {
	 ...
	 * @param {ReadonlySetLike<unknown>} other another set-like
	 * @returns {Set<T>} difference
	 */
	difference(other) {
		if (this._needMerge) this._merge();
	 ...
	 * @template U
	 * @param {ReadonlySetLike<U>} other another set-like
	 * @returns {Set<T & U>} intersection
	 */
	intersection(other) {
		if (this._needMerge) this._merge();
	 ...
	 * @param {ReadonlySetLike<unknown>} other another set-like
	 * @returns {boolean} true, when disjoint
	 */
	 ...
	 * @param {ReadonlySetLike<unknown>} other another set-like
	 * @returns {boolean} true, when this is a subset
	 */
	isSubsetOf(other) {
		if (this._needMerge) this._merge();
	 ...
	 * @param {ReadonlySetLike<unknown>} other another set-like
	 * @returns {boolean} true, when this is a superset
	 */
	isSupersetOf(other) {
		if (this._needMerge) this._merge();
	 ...
	 * @template U
	 * @param {ReadonlySetLike<U>} other another set-like
	 * @returns {Set<T | U>} symmetric difference
	 */
	 ...
	 * @param {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<(number | T)[]>} context context
	 */
	serialize({ write }) {
		if (this._needMerge) this._merge();
	 ...
	 * @template T
	 * @param {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<(number | T)[]>} context context
...
export { LazySet as "module.exports" };
