		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			if (this.type === "module") {
				compilation.hooks.optimize.tap(PLUGIN_NAME, () => {
					...
					const sortedModules = new SortableSet(compilation.modules);
					sortedModules.sortWith(
						compareModulesByIdOrIdentifier(compilation.chunkGraph)
					);

					compilation.modules = sortedModules;
				});
			}
		});
	}
