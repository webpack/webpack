...
import ImportDependency from "./dependencies/ImportDependency.js";
import { coreModules } from "./node/nodeBuiltins.js";
import { cachedSetProperty, resolveByProperty } from "./util/cleverMerge.js";
...
/** @typedef {import("../declarations/WebpackOptions.js").ExternalItemInterop} ExternalItemInterop */
/** @typedef {import("../declarations/WebpackOptions.js").Externals} Externals */
/** @typedef {import("./Dependency.js").default} Dependency */
/** @typedef {import("./ExternalModule.js").DependencyMeta} DependencyMeta */
/** @typedef {import("./ModuleFactory.js").IssuerLayer} IssuerLayer */
...
/** @typedef {((data: import("./ExternalModuleFactoryPlugin.js").ExternalItemFunctionData) => Promise<ExternalItemValue>)} ExternalItemFunctionPromise */
			...
			(data, callback) => {
				...
				const handleExternal = (value, type, callback) => {
					...
					if (
						...
						Object.hasOwn(externalConfig, "interop")
					) {
				...
				const handleExternals = (externals, callback) => {
					if (typeof externals === "string") {
						...
						if (Object.hasOwn(resolvedExternals, dependency.request)) {
						...
						if (
							...
							Object.hasOwn(resolvedExternals, alternateRequest)
						) {
							return handleExternal(
...
export default ExternalModuleFactoryPlugin;

export { ExternalModuleFactoryPlugin as "module.exports" };
