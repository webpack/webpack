...
/** @param {import("./ExportsInfo").UsageStateType} used usage state @returns {boolean} unused */
const IS_UNUSED = (used) => used === UsageState.Unused;
/** @param {import("./ExportsInfo").UsageStateType} used usage state @returns {boolean} not used */
