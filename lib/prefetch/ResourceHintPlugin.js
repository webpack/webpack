...
const collectEntrypointHints = (compilation, entryName, hints) => {
	...
	const publicPath =
		...
		compilation.outputOptions.publicPath !== "auto"
			...
			: "";
	// Auto initial-graph hints — mirror HtmlEntry's boolean/"prefetch" modes.
	// Custom array/function forms take over from here (defaultHints is passed
	// to the callback below).
	if (hints === true || hints === "prefetch") {
