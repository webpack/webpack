...
/** @typedef {import("../Chunk.js").ChunkChildOfTypeInOrder} ChunkChildOfTypeInOrder */
...
export default ChunkPrefetchStartupRuntimeModule;

export { ChunkPrefetchStartupRuntimeModule as "module.exports" };
