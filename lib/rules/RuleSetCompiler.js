...
/** @typedef {import("../../declarations/WebpackOptions.js").Falsy} Falsy */
/** @typedef {import("../../declarations/WebpackOptions.js").RuleSetUseItem} RuleSetUseItem */
/** @typedef {import("../../declarations/WebpackOptions.js").RuleSetLoaderOptions} RuleSetLoaderOptions */
...
class RuleSetCompiler {
				...
				if (Array.isArray(p)) {
					...
					for (const subProperty of p) {
						if (
							...
							Object.hasOwn(current, subProperty)
						) {
	 ...
	 * @param {import("../../declarations/WebpackOptions.js").RuleSetRules | undefined} rules user `module.rules`
...
export { RuleSetCompiler as "module.exports" };
