...
const getMergedDefinitions = (compilation) => {
	...
	for (const key of Object.keys(definitions)) {
		...
		// a nested object definition is walked separately, and an empty string
		// renders to no code, which an object literal cannot hold; every other
		// shape is a leaf this key can be destructured to, falsy ones included
