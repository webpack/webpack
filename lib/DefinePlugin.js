		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser) => {
				...
				function applyDefine(key, code) {
					...
					if(!isTypeof) {
						...
						parser.plugin("evaluate Identifier " + key, {
							path: parserHelpersLocation,
							fnName: "DefinePropertiesEvaluateIdentifier",
						}, { recurse, code });
					...
					parser.plugin("evaluate typeof " + key, {
						path: parserHelpersLocation,
						fnName: "DefinePluginEvaluateTypeof"
					}, { recurseTypeof, typeofCode });
					...
					// });
					parser.plugin("typeof " + key, {
						path: parserHelpersLocation,
						fnName: "DefinePluginTypeof",
					}, { typeofCode });
				}
				...
				function applyObjectDefine(key, obj) {
					...
					parser.plugin("evaluate Identifier " + key, {
						path: parserHelpersLocation,
						fnName: "DefinePluginEvaluateIdentifier",
					});
