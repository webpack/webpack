...
/** @typedef {{ value: CodeValuePrimitive } | { error: Error }} ResolvedRuntimeValue */
					...
					Promise.resolve()
						...
						.then(
							...
							(error) => {
								...
								// Report a rejection only if the parser consumes that value.
								byKey.set(key, {
									error: annotateEvaluationError(key, value, error)
								});
							}
						)
				);
