...
import SourceMapDevToolModuleOptionsPlugin from "./SourceMapDevToolModuleOptionsPlugin.js";
import { getPresentKinds } from "./TemplatedPathPlugin.js";
import createHash from "./util/createHash.js";
import { dirname, relative } from "./util/fs.js";
import generateDebugId from "./util/generateDebugId.js";
import { makePathsAbsolute } from "./util/identifier.js";
...
/** @typedef {import("../declarations/WebpackOptions.js").DevtoolNamespace} DevtoolNamespace */
/** @typedef {import("../declarations/WebpackOptions.js").DevtoolModuleFilenameTemplate} DevtoolModuleFilenameTemplate */
/** @typedef {import("../declarations/WebpackOptions.js").DevtoolFallbackModuleFilenameTemplate} DevtoolFallbackModuleFilenameTemplate */
...
/** @typedef {import("../declarations/plugins/SourceMapDevToolPlugin.js").Rules} Rules */
...
/** @typedef {import("./NormalModule.js").RawSourceMap} RawSourceMap */
/** @typedef {import("./TemplatedPathPlugin.js").TemplatePath} SourceMappingURLComment */
 ...
 */
const quoteMeta = (str) => str.replaceAll(METACHARACTERS_REGEXP, "\\$&");
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../schemas/plugins/SourceMapDevToolPlugin.check.js")} */ (
		...
		options.test ||= CSS_AND_JS_MODULE_EXTENSIONS_REGEXP;
...
export { SourceMapDevToolPlugin as "module.exports" };
