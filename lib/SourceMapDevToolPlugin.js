					...
					tasks.forEach((task, index) => {
						...
						if (sourceMapFilename) {
							...
							asset.__SourceMapDevToolData[file] = compilation.assets[file] = new ConcatSource(
								...
								currentSourceMappingURLComment.replace(/\[map\]/g, () => sourceMapString).replace(/\[url\]/g, () => `data:application/json;charset=utf-8;base64,${Buffer.from(sourceMapString, "utf-8").toString("base64")}`)
							);
						}
					});
					reportProgress(1.0);
