	...
	apply(compiler) {
		...
		compiler.cache.hooks.get.tap(
			...
			(identifier, etag, gotHandlers) => {
				...
				// Etags compare by identity, and a lazy one is interned per source object,
				// so the same content through a second object is a different etag. A
				// mismatch falls through to the file cache, which compares by value.
