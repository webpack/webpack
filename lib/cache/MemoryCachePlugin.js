...
class MemoryCachePlugin {
	 ...
	 * @param {((identifier: string, data: Data) => boolean)=} options.storeFilter a function that filters which cache entries should be stored
	 */
	constructor(options = {}) {
		/** @type {((identifier: string, data: Data) => boolean) | undefined} */
		this.storeFilter = options.storeFilter;
	}
