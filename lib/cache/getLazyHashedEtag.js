...
class LazyHashedEtag {
	...
	toString() {
		if (this._hash === undefined) {
			...
			// Drop the captured object once the hash is memoized: the hash never
			// resets, and callers often capture a heavy `CachedSource` that would
			// otherwise stay reachable for the compilation cache's lifetime.
			this._obj = undefined;
		}
		return this._hash;
	}
