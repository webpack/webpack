...
import SerializerMiddleware from "../serialization/SerializerMiddleware.js";
...
const { NOT_SERIALIZABLE, createFileSerializer } = serialization;
...
/** @typedef {import("../FileSystemInfo.js").ResolveBuildDependenciesResult} ResolveBuildDependenciesResult */
/** @typedef {import("../FileSystemInfo.js").ResolveResults} ResolveResults */
...
class PackFileCacheStrategy {
	...
	constructor({
		...
		/** @type {import("../serialization/Serializer.js").default<PackContainer, null, EXPECTED_OBJECT>} */
...
export default PackFileCacheStrategy;

export { PackFileCacheStrategy as "module.exports" };
