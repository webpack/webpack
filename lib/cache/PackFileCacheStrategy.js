...
class PackFileCacheStrategy {
	 ...
	 * @param {boolean} options.purgeStaleCache allows webpack to remove stale cache files
	...
	constructor({
		...
		this.purgeStaleCache = purgeStaleCache;
	...
	_openPack() {
		...
		return this.fileSerializer
			.deserialize(null, {
				...
				purgeStaleCache: this.purgeStaleCache,
