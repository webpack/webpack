...
const PresetProcessor = require("./PresetProcessor.js");
...
const createCompiler = rawOptions => {
	const mergedOptions = PresetProcessor.recursivelyMergePresets(rawOptions);
	const options = getNormalizedWebpackOptions(mergedOptions);
