...
const getValidateSchema = lazyModule.sync(() => require("./validateSchema"));
const getProgressPlugin = lazyModule.sync(() => require("./ProgressPlugin"));
// only an array config reaches the multi compiler
const getMultiCompiler = lazyModule.sync(() => require("./MultiCompiler"));
