...
const getValidateSchema = lazyModule(() => require("./validateSchema"));
const getProgressPlugin = lazyModule(() => require("./ProgressPlugin"));
// only an array config reaches the multi compiler
const getMultiCompiler = lazyModule(() => require("./MultiCompiler"));
