...
const MultiCompilerModule = require("./MultiCompiler");
const ProgressPluginModule = require("./ProgressPlugin");
...
const hasUserProgressPlugin = (options) =>
	...
	options.plugins.some((p) => p instanceof ProgressPluginModule);
...
const applyDefaultProgressPlugin = (compiler, options, hasUserPlugin) => {
	...
	const ProgressPlugin = ProgressPluginModule;
...
const createMultiCompiler = (childOptions, options) => {
	const MultiCompiler = MultiCompilerModule;
