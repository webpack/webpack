...
const WebpackOptionsApply = require("./config/WebpackOptionsApply");
const {
...
const getValidateSchema = memoize(() => require("./config/validateSchema"));
const getMultiCompiler = memoize(() => require("./MultiCompiler"));
const getProgressPlugin = memoize(() => require("./logging/ProgressPlugin"));
 ...
 * } from "./MultiCompiler"
 */
/** @import MultiStats from "./stats/MultiStats" */
