...
ModuleFilenameHelpers.createFilename = (
	...
	let resource = shortIdentifier.split("!").pop();
	// Escape identifier to fix #11456
	identifier = identifier.replace("[", "internal-bracket-open");
	identifier = identifier.replace("]", "internal-bracket-close");
	resource = resource.replace("[", "internal-bracket-open");
	resource = resource.replace("]", "internal-bracket-close");
	...
	return opts.moduleFilenameTemplate
		...
		.replace("internal-bracket-open", "[")
		.replace("internal-bracket-close", "]");
};
