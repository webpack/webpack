...
const CrossOriginPublicPathRuntimeModule = require("./CrossOriginPublicPathRuntimeModule");
			...
			compilation => {
				...
				compilation.hooks.runtimeRequirementInTree
					...
					.tap("ImportScriptsChunkLoadingPlugin", (chunk, set) => {
						...
						const { publicPath: globalPublicPath } = outputOptions;
						...
						if (
							...
							entryOptions &&
							entryOptions.crossOriginLoading
						) {
							compilation.addRuntimeModule(
								chunk,
								new CrossOriginPublicPathRuntimeModule(publicPath)
							);
							return true;
						}
					});
