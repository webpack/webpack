...
/**
 * Runtime module that loads JavaScript chunks inside web workers by calling
 * `importScripts`, with optional base URI and HMR support.
 */
class ImportScriptsChunkLoadingRuntimeModule extends RuntimeModule {
	/**
	 * Stores the runtime requirements and whether generated URLs should be
	 * wrapped by the Trusted Types-compatible `createScriptUrl` helper.
	...
	/**
	 * Generates the worker-side chunk loading runtime, including synchronous
	 * `importScripts` loading, the global chunk install callback, and optional
	 * hot-update and manifest-loading helpers.
