							...
							hasJsMatcher !== false
								? [
										...
										Template.indent([
											...
											Template.indent(
												`importScripts(${RuntimeGlobals.createScriptURL}(${RuntimeGlobals.publicPath} + ${RuntimeGlobals.getChunkScriptFilename}(chunkId)));`
											),
											"}"
										]),
										"}"
			...
			withHmr
				? Template.asString([
						...
						Template.indent([
							...
							`importScripts(${RuntimeGlobals.createScriptURL}(${RuntimeGlobals.publicPath} + ${RuntimeGlobals.getChunkUpdateScriptFilename}(chunkId)));`,
