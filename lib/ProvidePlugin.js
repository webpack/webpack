...
import ProvidedDependency from "./dependencies/ProvidedDependency.js";
import { approve } from "./javascript/JavascriptParserHelpers.js";
					...
					for (const name of Object.keys(definitions)) {
						...
						parser.hooks.expression.for(name).tap(PLUGIN_NAME, (expr) => {
							const nameIdentifier = name.includes(".")
								? `__webpack_provided_${name.replaceAll(".", "_dot_")}`
								: name;
...
export { ProvidePlugin as "module.exports" };
