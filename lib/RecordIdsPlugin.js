...
var resolveRelative = memoize(function(context, str) {
	return path.relative(context, str);
}, function resolveResolveRelative(context, str) {
	return context + str;
});
var makeRelative = memoize(function makeRelativePreMemoize(context, identifier) {
	...
	compiler.plugin("compilation", function(compilation) {
		compilation.plugin("record-modules", function(modules, records) {
			...
			modules.forEach(function(module) {
				var identifier = makeRelative(compiler.context, module.identifier());
		...
		function getDepBlockIdent(chunk, block) {
			...
			ident.unshift(makeRelative(compiler.context, block.identifier()));
			return ident.join(":");
		}
