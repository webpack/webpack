...
/** @import { AssetInfo, AssetSymlink, PathData } from "./Compilation" */
...
class CopyPlugin {
	...
	apply(compiler) {
		...
		// TODO the stage is fixed, so a copied file is minified and compressed like
		// any other asset; other bundlers let a pattern pick when the copy runs
