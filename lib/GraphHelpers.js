 ...
 * @param {Set<string>=} connectionType connection type, mutable set
 * @returns {void}
 */
const connectChunkGroupParentAndChild = (parent, child, connectionType) => {
	if (parent.addChild(child, connectionType)) {
