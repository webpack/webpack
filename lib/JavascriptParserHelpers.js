...
exports.addParsedVariableToModule = (parser, name, expression) => {
...
exports.requireFileAsExpression = (context, pathToModule) => {
	const moduleJsPath = exports.getModulePath(context, pathToModule);
