 ...
 * `"fallback"`: star re-export, deferred until an unknown name or all names are requested.
 * `"request"`: deferred together with other dependencies of the same request.
 * @typedef {{ id: string } | { local: string } | "fallback" | "request"} LazyUntil
 */
