 ...
 * @property {import("./optimize/InlineExports.js").InlinedValue=} inlined when set: the export binds to a small primitive constant eligible for inlining
 */
...
/** @typedef {typeof TRANSITIVE} TRANSITIVE */
...
export { Dependency as "module.exports" };
