...
class Dependency {
	...
	getReferencedExports(moduleGraph) {
		return Dependency.NS_OBJECT_IMPORTED;
	}
...
// TODO rename to NO_EXPORTS_REFERENCED
Dependency.NO_IMPORTED_NAMES = [];

// TODO rename to NS_OBJECT_REFERENCED
Dependency.NS_OBJECT_IMPORTED = [[]];
