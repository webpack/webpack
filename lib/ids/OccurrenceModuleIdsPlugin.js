...
/**
 * @schema plugins/ids/OccurrenceModuleIdsPlugin
 * @typedef {object} OccurrenceModuleIdsPluginOptions
 * @property {boolean=} prioritiseInitial Prioritise initial size over total size.
 */
