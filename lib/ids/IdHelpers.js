...
import numberHash from "../util/numberHash.js";
...
const requestToId = (request) =>
	request.replace(/^(\.\.?\/)+/, "").replaceAll(/(^[.-]|[^a-z0-9_-])+/gi, "_");
...
export { assignAscendingChunkIds };
export { assignAscendingModuleIds };
export { assignDeterministicIds };
export { assignNames };
export { getFullChunkName };
export { getFullModuleName };
export { getLongChunkName };
export { getLongModuleName };
export { getShortChunkName };
export { getShortModuleName };
export { getUsedChunkIds };
export { getUsedModuleIdsAndModules };
export { requestToId };
