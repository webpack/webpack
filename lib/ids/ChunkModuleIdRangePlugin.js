...
/** @typedef {import("../ChunkGraph.js").ModuleComparator} ModuleComparator */
		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.moduleIds.tap(PLUGIN_NAME, (modules) => {
				...
				const chunk = compilation.chunks
					.values()
					.find((chunk) => chunk.name === this.options.name);
				if (!chunk) {
					throw new Error(
...
export default ChunkModuleIdRangePlugin;

export { ChunkModuleIdRangePlugin as "module.exports" };
