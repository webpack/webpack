...
class LoaderOptionsPlugin {
	 ...
	 */
	apply(compiler) {
		// resolve once here, since the options are copied per module below
		if (this.options.options && this.options.options.context !== undefined) {
			this.options.options.context = maybeFileURLToPath(
