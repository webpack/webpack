...
/** @typedef {import("../util/fs.js").JsonArray} JsonArray */
...
const stringifySafe = (data) => {
	...
	return stringified.replaceAll(/\u2028|\u2029/g, (str) =>
		str === "\u2029" ? "\\u2029" : "\\u2028"
	...
	generate(
		...
		const jsonExpr =
			...
			typeof finalJson === "object"
				? `/*#__PURE__*/JSON.parse('${jsonStr.replaceAll(/[\\']/g, "\\$&")}')`
				: jsonStr.replaceAll('"__proto__":', '["__proto__"]:');
		/** @type {string} */
		let content;
...
export { JsonGenerator as "module.exports" };
