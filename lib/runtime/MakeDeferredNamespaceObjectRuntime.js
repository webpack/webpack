			...
			Template.indent([
				...
				Template.indent([
					...
					Template.indent([
						...
						'if(mode == undefined || (mode == 6 && exports.__esModule)) Object.defineProperty(this, "a", { value: exports });',
						"return exports;"
					]),
					"}"
				]),
		...
		return `${fn} = ${runtimeTemplate.basicFunction("moduleId, mode", [
			...
			Template.indent([
				...
				hasAsync
					...
					: "",
				"if (mode == undefined) return exports;",
			...
			`var init = ${runtimeTemplate.basicFunction("", [
				...
				hasAsync
					...
					: "",
				"init = null;",
				"if (mode == undefined || mode == 6 && ns.__esModule && typeof ns === 'object') {",
				Template.indent([
			...
			Template.indent([
				...
				`getOwnPropertyDescriptor: ${runtimeTemplate.basicFunction("_, name", [
					"switch (name) {",
					Template.indent([
						'case "__esModule": return { value: true, configurable: mode != undefined };',
						'case Symbol.toStringTag: return { value: "Deferred Module", configurable: mode != undefined };',
						'case "then": return undefined;'
					]),
					"}",
					init,
