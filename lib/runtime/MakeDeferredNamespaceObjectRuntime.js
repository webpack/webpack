...
export { MakeDeferredNamespaceObjectRuntimeModule };
export { MakeOptimizedDeferredNamespaceObjectRuntimeModule };
export { getMakeDeferredNamespaceModeFromExportsType };
export { getOptimizedDeferredModule };
