		...
		return `${fn} = ${runtimeTemplate.basicFunction(
			...
			[
				...
				`${lt} init = ${runtimeTemplate.basicFunction("", [
					...
					`${cst} keys = exportNames ? [] : Reflect.ownKeys(ns);`,
				...
				"if (exportNames) for (var e = 0; e < exportNames.length; e++) ns_target[exportNames[e]] = undefined;",
				...
				'if (!exportNames) Object.defineProperty(ns_target, "__esModule", { value: true });',
				'Object.defineProperty(ns_target, Symbol.toStringTag, { value: "Deferred Module" });',
				"if (exportNames) Object.seal(ns_target);",
				`${lt} ns = ns_target;`,
				`${cst} handler = {`,
				Template.indent([
					"__proto__: null,",
					...
					`${runtimeTemplate.method("get", "_, name", [
						...
						"if (exportNames) return name in ns_target ? ns[name] : undefined;",
						"return ns[name];"
					])},`,
					`${runtimeTemplate.method("has", "_, name", [
						...
						Template.indent(
							[
								'case "__esModule": if (!exportNames) return true; break;',
						...
						init,
						"if (exportNames) return name in ns_target;",
						"return name in ns;"
					])},`,
					`${runtimeTemplate.method("ownKeys", "", [
						init,
						// The sealed target already carries the spec's keys, sorted.
						"if (exportNames) return Reflect.ownKeys(ns_target);",
					...
					`${runtimeTemplate.method("getOwnPropertyDescriptor", "_, name", [
						...
						Template.indent([
							...
							'case "__esModule": if (!exportNames) return { value: true, writable: false, enumerable: false, configurable: false }; break;',
						...
						"if (exportNames) return name in ns_target ? { value: ns[name], writable: true, enumerable: true, configurable: false } : undefined;",
