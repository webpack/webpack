	...
	generate() {
		...
		return `${fn} = ${runtimeTemplate.basicFunction(
			...
			[
				...
				"",
				// A fresh placeholder, not `__webpack_module_deferred_exports__`, which
				// `__webpack_require__` reuses as `module.exports` and would clash with
				// the non-configurable properties pre-populated here.
