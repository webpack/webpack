 ...
 * Bails out when a name is emitted mangled, since the runtime reads them off
 * the exports object.
 * @param {ModuleGraph} moduleGraph the module graph
 * @param {Module} module the deferred module
 ...
 */
const getKnownExportNames = (moduleGraph, module, runtime) => {
	...
	for (const exportInfo of exportsInfo.orderedExports) {
		...
		const usedName = exportInfo.getUsedName(exportInfo.name, runtime);
		if (typeof usedName === "string" && usedName !== exportInfo.name) {
			return null;
		}
