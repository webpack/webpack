...
/**
 * Runtime module that exposes a single computed filename, such as an update or
 * manifest filename, through a runtime function.
 */
class GetMainFilenameRuntimeModule extends RuntimeModule {
	/**
	 * Creates the runtime module that resolves one main filename template.
	...
	/**
	 * Generates the runtime function that expands the configured filename
	 * template using the current compilation hash and chunk context.
