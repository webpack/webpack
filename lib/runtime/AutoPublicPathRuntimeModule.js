...
class AutoPublicPathRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		// The build-time chunk is virtual and sits at the output root: there is
		// no script url to derive from (`import.meta` does not even parse in the
		// vm script wrapper), so urls resolve against the `importModule` baseUri.
