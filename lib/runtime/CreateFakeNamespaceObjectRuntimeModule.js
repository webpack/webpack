...
/**
 * Runtime helper that synthesizes namespace objects for non-namespace module
 * values.
 */
class CreateFakeNamespaceObjectRuntimeModule extends HelperRuntimeModule {
	/**
	 * Creates the runtime module that emits webpack's fake-namespace helper.
	 */
	constructor() {
	...
	/**
	 * /**
	 * Generates the helper used to build namespace-like objects from required
	 * values, honoring the runtime mode flags passed by callers.
