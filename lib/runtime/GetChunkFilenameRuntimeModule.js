...
import { reEncodeDigest } from "../TemplatedPathPlugin.js";
...
/** @typedef {import("../Compilation.js").HashWithLengthFunction} HashWithLengthFunction */
...
export default GetChunkFilenameRuntimeModule;

export { GetChunkFilenameRuntimeModule as "module.exports" };
