...
class RuntimeModule extends Module {
	...
	updateHash(hash, context) {
		...
		try {
			...
			const { toError } = require("../errors/ErrorHelpers");
			const RuntimeModuleGenerationError = require("../errors/RuntimeModuleGenerationError");

			throw new RuntimeModuleGenerationError(this, toError(err));
		}
