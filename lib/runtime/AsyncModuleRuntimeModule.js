		...
		return Template.asString([
			...
			`${fn} = ${runtimeTemplate.basicFunction(
				...
				[
					...
					// The sync require wrapper clears `module.evaluating` the moment `.a`
					// returns, so a deferred namespace reaching this module through a cycle
					// needs `evaluatingAsync` to keep throwing until evaluation ends.
