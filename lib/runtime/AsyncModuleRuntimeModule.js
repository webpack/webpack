...
/**
 * Runtime helper that implements webpack's async module protocol, including
 * dependency queueing, deferred interop, and promise-backed module exports.
 */
class AsyncModuleRuntimeModule extends HelperRuntimeModule {
	/**
	 * Creates the runtime module that wires async dependency evaluation into
	 * module execution.
	...
	/**
	 * Generates the runtime implementation behind `__webpack_require__.a`,
	 * including dependency wrapping, queue resolution, and completion handling.
