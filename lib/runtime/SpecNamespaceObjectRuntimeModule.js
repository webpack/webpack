...
class SpecNamespaceObjectRuntimeModule extends HelperRuntimeModule {
	...
	generate() {
		...
		return Template.asString([
			`${fn} = ${runtimeTemplate.basicFunction("exports, key", [
				// Mangled exports are read through an importer-local object, so the
				// module's own exports object is what identifies the namespace.
				"if (key === undefined) key = exports;",
				`${cst} cached = ${fn}.c.get(key);`,
