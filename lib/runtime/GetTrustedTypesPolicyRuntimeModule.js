...
/**
 * Runtime helper that lazily creates and caches the Trusted Types policy used
 * by other runtime modules.
 */
class GetTrustedTypesPolicyRuntimeModule extends HelperRuntimeModule {
	/**
	 * Creates the runtime module that exposes webpack's Trusted Types policy
	 * factory.
	...
	/**
	 * Generates the runtime function that creates the Trusted Types policy on
	 * first use and reuses it for later calls.
