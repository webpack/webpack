...
class StartupChunkDependenciesRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		return Template.asString([
			`${runtimeTemplate.renderConst()} next = ${RuntimeGlobals.startup};`,
...
export default StartupChunkDependenciesRuntimeModule;

export { StartupChunkDependenciesRuntimeModule as "module.exports" };
