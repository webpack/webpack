...
// only a chunk with startup dependencies emits these
const getStartupChunkDependenciesRuntimeModule = lazyModule(() =>
	require("./StartupChunkDependenciesRuntimeModule")
);
const getStartupEntrypointRuntimeModule = lazyModule(() =>
	require("./StartupEntrypointRuntimeModule")
);
		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
				...
				(chunk, set, { chunkGraph }) => {
					...
					if (chunkGraph.hasChunkEntryDependentChunks(chunk)) {
						...
						compilation.addLazyRuntimeModule(
							chunk,
							getStartupChunkDependenciesRuntimeModule,
							(Ctor) => new Ctor(this.asyncChunkLoading)
						);
					}
				}
			);
			compilation.hooks.runtimeRequirementInTree
				...
				.tap(PLUGIN_NAME, (chunk, set) => {
					...
					compilation.addLazyRuntimeModule(
						chunk,
						getStartupEntrypointRuntimeModule,
						(Ctor) => new Ctor(this.asyncChunkLoading)
					);
				});
		});
