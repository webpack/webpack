...
/**
 * Runtime helper that decodes base64-encoded strings into immutable byte
 * arrays across Node.js, web, and neutral platform targets.
 */
class ToBinaryRuntimeModule extends RuntimeModule {
	/**
	 * Registers the runtime helper exposed as `RuntimeGlobals.toBinary`.
	 */
	constructor() {
		super("to binary");
	}
	...
	/**
	 * Generates a platform-specific base64 decoder and freezes its underlying
	 * buffer so emitted binary assets behave like immutable data at runtime.
