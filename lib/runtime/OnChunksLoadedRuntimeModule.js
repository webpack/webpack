...
/**
 * Runtime module that schedules callbacks to run once the required chunks have
 * all reported themselves as loaded.
 */
class OnChunksLoadedRuntimeModule extends RuntimeModule {
	/**
	 * Initializes the runtime helper that backs `RuntimeGlobals.onChunksLoaded`.
	 */
	constructor() {
		super("chunk loaded");
	}
	...
	/**
	 * Generates the deferred-execution queue used by the runtime to register
	 * chunk-load callbacks, order them by priority, and flush them when their
	 * chunk dependencies become available.
