...
/**
 * Compilation hooks exposed by the load-script runtime module so plugins can
 * customize how script tags are created before they are attached.
...
class LoadScriptRuntimeModule extends HelperRuntimeModule {
	/**
	 * Returns the `LoadScriptRuntimeModule` hooks object for a compilation,
	...
	/**
	 * Creates the runtime module that loads chunks by inserting script tags.
	...
	/**
	 * Generates the runtime `loadScript` helper, including deduplication,
	 * timeout handling, error propagation, and optional Trusted Types support.
