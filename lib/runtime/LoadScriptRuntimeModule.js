...
class LoadScriptRuntimeModule extends HelperRuntimeModule {
	 ...
	 * @param {boolean=} withImportScripts load through `importScripts`, for a worker without `document`
	 */
	constructor(withCreateScriptUrl, withFetchPriority, withImportScripts) {
		super("load script");
		...
		/** @type {boolean | undefined} */
		this._withImportScripts = withImportScripts;
	}
	 ...
	 */
	generate() {
		if (this._withImportScripts) return this._generateImportScripts();
