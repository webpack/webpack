...
class OptionsDefaulter {
	...
	/**
	 * @description process options with defaults
	 * @see OptionsDefaulter.defaults
	 * @param  {Object} options check against defaults for each property
	 * @return {void}
	 */
	process(options) {
	...
	/**
	 * @description chainable seting on defaults
	 * @param {string} name property to set
	 * @param {any} config data to store
	 * @param {any} def default value to use
	 * @return {OptionsDefaulter} @chainable
	 */
	set(name, config, def) {
