...
/**
 * @import ESMImportSpecifierDependency, {
 * 	idsSymbol as HarmonyImportSpecifierDependencyIDsSymbol
 * } from "../dependencies/esm/ESMImportSpecifierDependency"
 */
 ...
 * } from "../dependencies/commonjs/CommonJsExportRequireDependency"
 */
/**
 * @import {
...
class ModuleGraph {
	...
	updateParent(dependency, connection, parentModule) {
		...
		const currentSourceOrder =
			/** @type {ESMImportSideEffectDependency | ESMImportSpecifierDependency} */
	...
	finishUpdateParent() {
		...
		for (const mod of this._modulesNeedingSort) {
			// If dependencies like ESMImportSideEffectDependency and ESMImportSpecifierDependency have a SourceOrder,
	...
	_flushUnassignedConnections(module) {
		...
		mgm._unassignedConnections = undefined;
	}
