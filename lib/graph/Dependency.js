...
/** @import ModuleDependency from "../dependencies/core/ModuleDependency" */
/**
...
/**
 * The category used by dependencies created from ECMAScript module syntax.
 * @type {"esm"}
 */
const ESM_CATEGORY = "esm";
...
class Dependency {
	 ...
	 * @returns {SourceType} the source type read from the referenced module
	 */
...
// TODO in the next major release: call canConcatenate() directly on the dependency instance instead of using this static method.
/**
 ...
 */
Dependency.canConcatenate = (dependency, concatenateCommonJsModules) => {
	if (typeof dependency.canConcatenate === "function") {
		return dependency.canConcatenate(concatenateCommonJsModules);
	}
	return false;
};
...
Dependency.ESM_CATEGORY = ESM_CATEGORY;
