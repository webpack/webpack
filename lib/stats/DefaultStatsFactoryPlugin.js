...
import { LogType } from "../logging/Logger.js";
import AggressiveSplittingPlugin from "../optimize/AggressiveSplittingPlugin.js";
import SizeLimitsPlugin from "../performance/SizeLimitsPlugin.js";
...
import { makePathsRelative, parseResource } from "../util/identifier.js";

const require = createRequire(import.meta.url);
const { version: WEBPACK_VERSION } = packageJson;
/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("../../declarations/WebpackOptions.js").StatsValue} StatsValue */
/** @typedef {import("./StatsFactory.js").default} StatsFactory */
/** @typedef {import("./StatsFactory.js").StatsFactoryContext} StatsFactoryContext */
...
/** @typedef {import("../ChunkGroup.js").OriginRecord} OriginRecord */
...
/** @typedef {import("../Compilation.js").ExcludeModulesType} ExcludeModulesType */
...
/** @typedef {import("../serialization/AggregateErrorSerializer.js").AggregateError} AggregateError */
/** @typedef {import("../serialization/ErrorObjectSerializer.js").ErrorWithCause} ErrorWithCause */
/** @typedef {import("../ExportsInfo.js").ExportInfoName} ExportInfoName */

/**
 * Defines the shared type used by this module.
 * @template T
 * @typedef {import("../util/comparators.js").Comparator<T>} Comparator<T>
 */

/**
 * Defines the group config type used by this module.
 * @template I, G
 * @typedef {import("../util/smartGrouping.js").GroupConfig<I, G>} GroupConfig
 */
...
/** @type {ExtractorsByOption<ErrorWithCause | AggregateError | WebpackError, StatsError>} */
const EXTRACT_ERROR = {
	...
	errorCause: (object, error, context, options, factory) => {
		if (/** @type {ErrorWithCause} */ (error).cause) {
		...
		_: (object, compilation, context, options) => {
			...
			if (logging || (loggingDebug && loggingDebug.length > 0)) {
				...
				for (const [origin, logEntries] of compilation.logging) {
					...
					let name = cachedMakePathsRelative(origin).replaceAll("|", " ");
		...
		assets: (object, compilation, context, options, factory) => {
			...
			for (const [file, chunks] of [
				...
				for (const chunk of chunks) {
					...
					if (!name) continue;
					if (!Object.hasOwn(object.assetsByChunkName, name)) {
...
export default DefaultStatsFactoryPlugin;

export { DefaultStatsFactoryPlugin as "module.exports" };
