...
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsAsset} StatsAsset */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsChunk} StatsChunk */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsChunkGroup} StatsChunkGroup */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsCompilation} StatsCompilation */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsError} StatsError */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsLogging} StatsLogging */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsModule} StatsModule */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsModuleIssuer} StatsModuleIssuer */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsModuleReason} StatsModuleReason */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsModuleTraceDependency} StatsModuleTraceDependency */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsModuleTraceItem} StatsModuleTraceItem */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsProfile} StatsProfile */
...
export { StatsPrinter as "module.exports" };
