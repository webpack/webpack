...
/** @typedef {import("../logging/Logger.js").LogTypeEnum} LogTypeEnum */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").ChunkId} ChunkId */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").ChunkName} ChunkName */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsAsset} KnownStatsAsset */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsChunk} KnownStatsChunk */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsChunkGroup} KnownStatsChunkGroup */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsChunkOrigin} KnownStatsChunkOrigin */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsCompilation} KnownStatsCompilation */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsError} KnownStatsError */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsLogging} KnownStatsLogging */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsLoggingEntry} KnownStatsLoggingEntry */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsModule} KnownStatsModule */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsModuleIssuer} KnownStatsModuleIssuer */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsModuleReason} KnownStatsModuleReason */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsModuleTraceDependency} KnownStatsModuleTraceDependency */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsModuleTraceItem} KnownStatsModuleTraceItem */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").KnownStatsProfile} KnownStatsProfile */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsCompilation} StatsCompilation */
/** @typedef {import("./StatsPrinter.js").default} StatsPrinter */
/** @typedef {import("./StatsPrinter.js").ColorFunction} ColorFunction */
/** @typedef {import("./StatsPrinter.js").KnownStatsPrinterColorFunctions} KnownStatsPrinterColorFunctions */
/** @typedef {import("./StatsPrinter.js").KnownStatsPrinterContext} KnownStatsPrinterContext */
/** @typedef {import("./StatsPrinter.js").KnownStatsPrinterFormatters} KnownStatsPrinterFormatters */
/** @typedef {import("./StatsPrinter.js").StatsPrinterContext} StatsPrinterContext */
/** @typedef {import("./StatsPrinter.js").StatsPrinterContextWithExtra} StatsPrinterContextWithExtra */
...
const AVAILABLE_FORMATS = {
	...
	formatSize: /** @type {typeof import("../util/formatSize.js").default} */ (
		require("../util/formatSize.js")
	),
...
export default DefaultStatsPrinterPlugin;

export { DefaultStatsPrinterPlugin as "module.exports" };
