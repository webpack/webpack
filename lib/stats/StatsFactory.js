...
/** @import { OriginRecord } from "../ChunkGroup" */
 ...
 * @property {HookMap<SyncBailHook<[GroupConfig<any, any>[], StatsFactoryContext], void>>} groupResults
 ...
 * @param {any[]} items items to sort in place
