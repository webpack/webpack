...
import smartGrouping from "../util/smartGrouping.js";
...
/** @typedef {import("../ModuleGraph.js").ModuleProfile} ModuleProfile */
...
/** @typedef {import("../util/comparators.js").Comparator<EXPECTED_ANY>} Comparator */
/** @typedef {import("../util/runtime.js").RuntimeSpec} RuntimeSpec */
/**
 * Defines the group config type used by this module.
 * @template T, R
 * @typedef {import("../util/smartGrouping.js").GroupConfig<T, R>} GroupConfig
 */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").ChunkGroupInfoWithName} ChunkGroupInfoWithName */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").ModuleIssuerPath} ModuleIssuerPath */
/** @typedef {import("./DefaultStatsFactoryPlugin.js").ModuleTrace} ModuleTrace */
...
/** @typedef {import("./DefaultStatsFactoryPlugin.js").StatsChunkOrigin} StatsChunkOrigin */
	...
	_create(type, data, baseContext) {
		...
		if (Array.isArray(data)) {
			...
			if (comparators.length > 0) {
				// `Array#sort` is stable, so ties keep their insertion order
				items.sort(
...
export { StatsFactory as "module.exports" };
