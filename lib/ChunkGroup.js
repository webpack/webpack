 ...
 * @param {ChunkGroup} a first sorting cooperator
 * @param {ChunkGroup} b second sorting cooperator
...
/**
 * @param {OriginRecord} a the first cooperator in sort
 * @param {OriginRecord} b the second cooperator in sort
