...
const { compareChunks, compareIterables } = require("./util/comparators");
...
class ChunkGroup {
	 ...
	 * @param {Chunk} newChunk new chunk that will be replaced
	 * @returns {boolean} returns true if the chunk has been replaced
	 */
	...
	/**
	 * @param {Iterable<ChunkGroup>} newParents the parent groups to be added into
	 * @returns {void}
	 */
