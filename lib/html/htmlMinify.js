...
const htmlMinify = (input, sourceMap, minimizerOptions = {}) => {
	...
	// TODO widen boolean-attribute collapsing to any value, not only the
	// canonical spellings.
