 ...
 * @param {{ environment?: CssEnvironment, convertLengthUnits?: boolean, collapseWhitespace?: boolean, removeEmptyAttributes?: boolean, removeRedundantAttributes?: "smart" | "all", sortAttributes?: boolean, sortClassNames?: boolean }=} minimizerOptions minimizer options — `environment` and `convertLengthUnits` reach the CSS minifier this runs over inline CSS; the rest is `optimization.minimize.html`
