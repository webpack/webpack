...
const htmlMinify = (input, sourceMap, minimizerOptions = {}) => {
	...
	// TODO take `renderJavascriptInHtml` / `renderCssInHtml` through
	// `minimizerOptions` — `render*InJavascript`'s siblings for HTML-hosted content.
	// Both must be async-capable: terser is, and the serializer is not yet.
