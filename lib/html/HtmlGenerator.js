...
class HtmlGenerator extends Generator {
	 ...
	 * `${PUBLIC_PATH_AUTO}<chunkFilename>`. Sentinels whose filename template
	 * can't resolve in this context (e.g. `[contenthash]` from `_renderHtml`'s
	 * JS-export path, before chunk hashes exist) are left in place for the
	 * later `HtmlModulesPlugin#renderManifest` pass.
