 ...
 * print again with it: the element going empty, or a join its source forbade.
 * @param {string} css the body
...
const _sheetDecides = (css) => {
	...
	const joining = _S._mergeStyles && !_sheetEndsCleanly(css);
	if (!emptying && !joining) return undefined;
	return (answer) =>
		typeof answer === "string" &&
		((emptying && answer === "") || (joining && _sheetEndsCleanly(answer)));
};
