...
const DEFAULT_SOURCES_BY_TAG = dict({
	...
	// SVG. Tag names are the tree builder's adjusted camelCase (`feImage`,
	// `linearGradient`, …). A fragment-only `#id` is left untouched, so only an
	// external `file.svg#id` is rewritten.
