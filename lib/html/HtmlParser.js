...
// What may sit between two tags of a run that a classic script runs through:
// no node the second body could have seen.
const RUN_GAP_REGEXP = /^(?:\s|<!--[\s\S]*?-->)*$/;
									...
									if (content) {
										...
										const joinsRun =
											...
											(outputModule ||
												...
												RUN_GAP_REGEXP.test(
													source.slice(inlineRunEnd, elementStart)
												));
