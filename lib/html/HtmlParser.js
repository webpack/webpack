...
class HtmlParser extends Parser {
	...
	parse(source, state) {
		...
		// `<base href>` resolves the relative URLs after it. A relative base keeps
		// them bundled under a subdirectory; a root-relative or absolute one points
		// outside the build, so those URLs are left untouched.
		/** @type {string | undefined} */
		let documentBase;
		/** @type {string | undefined} */
		let baseDir;
