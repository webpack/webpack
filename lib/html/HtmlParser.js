...
import CommentCompilationWarning from "../errors/CommentCompilationWarning.js";
import ModuleDependencyError from "../errors/ModuleDependencyError.js";
import UnsupportedFeatureWarning from "../errors/UnsupportedFeatureWarning.js";
import WebpackError from "../errors/WebpackError.js";
import LazySet from "../util/LazySet.js";
import LocConverter from "../util/LocConverter.js";
...
/** @typedef {import("../../declarations/WebpackOptions.js").HtmlParserOptions} HtmlParserOptions */
...
/** @typedef {import("./syntax.js").ParsedSource} ParsedSource */
 ...
 * @param {import("./syntax.js").HtmlPath} path walk path (used only for attribute-ref reads)
 * @param {string} source HTML source
 * @param {import("./syntax.js").HtmlAttributeRef} attr attribute ref
 ...
 * @param {import("./syntax.js").HtmlPath} path walk path (for attribute reads)
 * @param {string} source HTML source
...
const parseSrc = (input) => {
	...
	if (IGNORE_CHARS_REGEXP.test(value)) {
		value = value.replaceAll(IGNORE_CHARS_REGEXP, "");
...
class HtmlParser extends Parser {
	...
	parse(source, state) {
		...
		/**
		 * @param {import("./syntax.js").HtmlPath} path walk path (used only for attribute-ref reads)
		 * @param {import("./syntax.js").HtmlAttributeRef} typeAttr type attribute ref (0 = none)
		 ...
		 * that follow it.
		 * @param {import("./syntax.js").HtmlPath} path walk path (for attribute reads)
		 * @param {import("./syntax.js").HtmlAttributeRef} hrefAttr the base's href attribute
		 */
		...
		/** @type {import("./syntax.js").HtmlPath | undefined} */
		let attrMapPath;
		let attrMapCount = 0;
		...
		const getAttributesMap = () => {
			...
			const path = /** @type {import("./syntax.js").HtmlPath} */ (attrMapPath);
				...
				[NodeType.Element]: {
					...
					enter: (path) => {
						...
						for (let i = 0; i < attributeCount + 1; i++) {
							...
							/** @type {number} */
							let end;
							/** @type {import("./syntax.js").HtmlAttributeRef} */
							let attr = 0;
							if (content) {
...
export { HtmlParser as "module.exports" };
