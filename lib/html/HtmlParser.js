...
class HtmlParser extends Parser {
	...
	constructor(hashFunction, context, outputModule, css, options) {
		...
		// always override regardless of position. Per-tag writes use
		// spread, so default buckets stay safely aliased until overwritten.
		/** @type {Record<string, Record<string, SourceItem>>} */
		const byTag = sources.includes("...") ? { ...DEFAULT_SOURCES_BY_TAG } : {};
