 ...
 * @property {(boolean | "keep-head-and-body")=} tagOmission leave out the `<html>` / `<head>` / `<body>` tags §13.1.2.4 lets the parser imply; `"keep-head-and-body"` leaves out only `<html>` (default false)
 */
...
let _tagOmission = /** @type {boolean | "keep-head-and-body"} */ (false);
...
const grammar = (input, visitors, writer, options) => {
	...
	_tagOmission =
		tagOmission === "keep-head-and-body" ? tagOmission : tagOmission === true;
