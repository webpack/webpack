 ...
 */
const escapeAttribute = (s, delimiter) => {
...
/**
 * A value whose escaped quotes stand literal under the other delimiter:
 * `alt="say &quot;hi&quot;"` is `alt='say "hi"'`. Null when it holds both.
...
const _respellAttributeValue = (value) => {
	// Escaping the apostrophe would cost more than the swap saves.
	if (value.includes("'")) return null;
	return `'${escapeAttribute(value, CC_APOSTROPHE)}'`;
};
