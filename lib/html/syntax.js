	...
	for (let k = 0; k < count; k++) {
		...
		if (quoted) {
			...
			if (
				...
				// The synchronous renderer, never `_renderEmbedded`: that one defers
				// where a collector is set, and reaching here means this attribute is
				// the one kept off the deferred path.
