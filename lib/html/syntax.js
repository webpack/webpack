 ...
 * @property {boolean=} mergeScripts print a run of adjacent bare `<script>` elements as one, which removes elements and lets a throwing body end the whole run (default false)
