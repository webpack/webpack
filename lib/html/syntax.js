...
// Whether that nested CSS minifier may rewrite a length's unit — forwarded like
// `_cssEnvironment`, and for the same reason: the inline copy of a declaration
// must not disagree with the `.css` asset's.
