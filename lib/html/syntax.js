 ...
 * @property {boolean=} minimize print the safely-minified serialization (nodes rebuilt from source, inert comments dropped) as `process` walks, and return it (default false = walk only, return `""`)
 */
 ...
 * minify transform is dropping inert comments; DOM-absent whitespace (between the
 * doctype and `<html>`, etc.) naturally falls away with it.
