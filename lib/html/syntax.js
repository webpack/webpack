 ...
 * @property {("none" | "smart" | "all")=} removeRedundantAttributes drop an attribute whose value is the element's own default (default `"none"`)
 */
...
// The two unsafe attribute/element drops (see `HtmlProcessOptions`), off
// unless asked for: each changes what a selector or a script can find.
/** @type {"none" | "smart" | "all"} */
...
const _isRedundantAttribute = (tagName, name, value) => {
	if (_removeRedundantAttributes === "none") return false;
