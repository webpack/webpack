...
module.exports.A = A;
// The `as` a classic `<script>` is offered under, and the one a wrapped event
// handler becomes: a function declaration at a script's top level.
module.exports.CLASSIC_SCRIPT = CLASSIC_SCRIPT;
module.exports.EMBEDDED_LANGUAGES = EMBEDDED_LANGUAGES;
// The `as` an event handler attribute is offered under, read by whoever turns
// that production into the whole script a JavaScript minifier takes.
