 ...
 * @typedef {Pick<CssProcessOptions, "environment" | "convertLengthUnits"> & { collapseWhitespace?: boolean | "conservative" | "smart" | "all", mergeStyles?: boolean, removeEmptyAttributes?: boolean, removeEmptyElements?: boolean, preserveComments?: (string | RegExp)[], removeRedundantAttributes?: boolean | "smart" | "all", sortAttributes?: boolean, sortTokenLists?: boolean, removeImpliedTags?: boolean | "smart" | "all", collapseBooleanAttributes?: boolean | "all", normalizeAttributeValues?: boolean, minifyStyleAttribute?: boolean, removeAttributeQuotes?: boolean }} HtmlPrintOptions
 */
		...
		case NodeType.Element: {
			...
			if (open === "") {
				...
				if (
					...
					if ((name === "body" || name === "html") && startsWithWs(inner)) {
						return `<${name}>${inner}`;
					}
					return inner;
				}
