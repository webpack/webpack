 ...
 * @property {CssTransformOptions=} transforms CSS's too, handed over with `environment` (see `HtmlPrintOptions`)
 ...
 * @typedef {Pick<CssProcessOptions, "environment" | "convertLengthUnits" | "rewriteCustomProperties" | "transforms"> & { collapseWhitespace?: boolean | "conservative" | "smart" | "all", mergeStyles?: boolean, removeEmptyAttributes?: boolean, removeEmptyElements?: boolean, preserveComments?: (string | RegExp)[], removeRedundantAttributes?: boolean | "smart" | "all", sortAttributes?: boolean, sortTokenLists?: boolean, removeImpliedTags?: boolean | "smart" | "all", renderEmbeddedSource?: EmbeddedSourceRenderer }} HtmlPrintOptions
 */
...
const grammar = (input, visitors, writer, options) => {
	...
	_cssTransforms = writer === undefined ? undefined : writer.options.transforms;
	const preserve =
