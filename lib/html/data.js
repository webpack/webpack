 ...
 * @type {Set<string>}
 */
const OPTIONAL_END_TAG_UNLESS_TRAILING_NODE = new Set([
	"caption",
	"colgroup",
	"head"
]);
 ...
 * @type {Set<string>}
 */
const OPTIONAL_END_TAG_UNLESS_COMMENT = new Set(["body", "html"]);
 ...
 * @type {Set<string>}
 */
const BODY_START_TAG_BLOCKERS = new Set([
	"base",
	"basefont",
	"bgsound",
	"link",
...
const ENUMERATED_KEYWORDS = Object.assign(Object.create(null), {
	...
	area: Object.assign(Object.create(null), {
		shape: new Set([
			"circle",
			"circ",
			"default",
	...
	base: Object.assign(Object.create(null), {
		target: new Set(["_blank", "_self", "_parent", "_top"])
	}),
	...
	button: Object.assign(Object.create(null), {
		...
		formtarget: new Set(["_blank", "_self", "_parent", "_top"]),
	...
	textarea: Object.assign(Object.create(null), {
		wrap: new Set(["soft", "hard"])
	}),
 ...
 * @type {Set<string>}
 */
const EMPTY_REMOVABLE_ATTRIBUTES = new Set(["class", "dir", "id", "style"]);
...
module.exports.BODY_START_TAG_BLOCKERS = BODY_START_TAG_BLOCKERS;
...
module.exports.OPTIONAL_END_TAG_UNLESS_COMMENT =
