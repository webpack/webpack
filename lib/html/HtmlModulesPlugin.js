...
import { HTML_TYPE } from "../ModuleSourceTypeConstants.js";
import { HTML_MODULE_TYPE } from "../ModuleTypeConstants.js";
import NormalModule from "../NormalModule.js";
import ConstDependency from "../dependencies/ConstDependency.js";
import HtmlEntryDependency from "../dependencies/HtmlEntryDependency.js";
import HtmlInlineHtmlDependency from "../dependencies/HtmlInlineHtmlDependency.js";
import HtmlInlineScriptDependency from "../dependencies/HtmlInlineScriptDependency.js";
import HtmlInlineStyleDependency from "../dependencies/HtmlInlineStyleDependency.js";
import HtmlSourceDependency from "../dependencies/HtmlSourceDependency.js";
...
import { getUndoPath, makePathsRelative } from "../util/identifier.js";
import { digestNonNumericOnly } from "../util/nonNumericOnlyHash.js";
import { PUBLIC_PATH_AUTO as autoPlaceholder } from "../util/publicPathPlaceholder.js";
import removeBOM from "../util/removeBOM.js";
...
/** @typedef {import("./HtmlModule.js").HtmlModuleBuildInfo} HtmlModuleBuildInfo */
...
class HtmlModulesPlugin {
	 ...
	 * @param {import("../../declarations/WebpackOptions.js").Output} outputOptions output options
	 * @returns {string} content hash
	 */
	static computeContentHash(content, outputOptions) {
		const hash = createHash(
			/** @type {import("../../declarations/WebpackOptions.js").HashFunction} */
	 ...
	 * @param {import("../Chunk.js").default} chunk chunk
	 * @param {import("../../declarations/WebpackOptions.js").Output} outputOptions output options
	 * @returns {import("../Chunk.js").ChunkFilenameTemplate} used filename template
	 */
	static getChunkFilenameTemplate(chunk, outputOptions) {
		return chunk.canBeInitial()
			? /** @type {import("../Chunk.js").ChunkFilenameTemplate} */ (
	...
	apply(compiler) {
		...
		/** @type {WeakMap<import("../Compilation.js").default, { htmlModules: Set<import("../Module.js").default>, stylesheetEntries: Set<string>, htmlAssetNames: Set<string> }>} */
		const compilationState = new WeakMap();
		/**
		 * @param {import("../Compilation.js").default} compilation compilation
		 * @returns {{ htmlModules: Set<import("../Module.js").default>, stylesheetEntries: Set<string>, htmlAssetNames: Set<string> }} per-compilation state
		 */
		...
		compiler.hooks.finishMake.tapAsync(PLUGIN_NAME, (compilation, callback) => {
			...
			/** @type {(module: import("../Module.js").default) => { context: string, request: string, name: string, dependOn: string[] | undefined }[]} */
			...
			/** @type {(spec: { context: string, request: string, name: string, dependOn: string[] | undefined }) => Promise<import("../Module.js").default | null>} */
			const addEntry = (spec) =>
			...
			/** @type {WeakSet<import("../Module.js").default>} */
			const processed = new WeakSet();
			/** @type {(module: import("../Module.js").default) => Promise<void>} */
		...
		compiler.hooks.compilation.tap(
			...
			(compilation, { normalModuleFactory }) => {
				...
				const trackHtmlModule = (
					/** @type {import("../Module.js").default} */ module
				) => {
						...
						for (const name of Object.keys(assets)) {
							...
							if (
								...
								resolved = HtmlGenerator.resolveChunkIntegritySentinels(
									resolved,
									compilation,
									/** @type {import("./HtmlGenerator.js").HtmlIntegrity} */ (
										integrity
									)
								);
							}
				...
				normalModuleFactory.hooks.createParser
					...
					.tap(PLUGIN_NAME, (parserOptions) => {
						compiler.validate(
							...
							(options) =>
								/** @type {typeof import("../../schemas/plugins/HtmlParserOptions.check.js")} */ (
									require("../../schemas/plugins/HtmlParserOptions.check.js")
								)(options)
						);
				...
				normalModuleFactory.hooks.createGenerator
					...
					.tap(PLUGIN_NAME, (generatorOptions) => {
						compiler.validate(
							...
							(options) =>
								/** @type {typeof import("../../schemas/plugins/HtmlGeneratorOptions.check.js")} */ (
									require("../../schemas/plugins/HtmlGeneratorOptions.check.js")
								)(options)
						);
				...
				const computePageEmit = (
					...
					/** @type {import("../Chunk.js").default} */ chunk
				) => {
					const { chunkGraph, outputOptions } = compilation;
					const codeGenResult =
						/** @type {import("../CodeGenerationResults.js").default} */ (
					...
					const { path: filename, info } = compilation.getPathWithInfo(
						/** @type {import("../TemplatedPathPlugin.js").TemplatePath} */
						(filenameTemplate),
						{
							module,
				...
				jsHooks.render.tap(PLUGIN_NAME, (source, renderContext) => {
					...
					const resolved = HtmlGenerator.stripChunkIntegritySentinels(
						HtmlGenerator.resolveHtmlPageUrlSentinels(
							...
							.split(autoPlaceholder)
							.join("")
					).replaceAll(/__WEBPACK_HTML_INLINE__[0-9a-f]+__[a-z]+__END__/g, "");
...
export default HtmlModulesPlugin;

export { HtmlModulesPlugin as "module.exports" };
