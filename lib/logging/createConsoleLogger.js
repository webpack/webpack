...
/** @typedef {import("../../declarations/WebpackOptions.js").FilterItemTypes} FilterItemTypes */
/** @typedef {import("../../declarations/WebpackOptions.js").FilterTypes} FilterTypes */
 ...
 */
const __esmDefault = ({ level = "info", debug = false, console }) => {
	const debugFilters =
		/** @type {FilterFunction[]} */
		(
