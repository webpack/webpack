 ...
 * @property {InitFragment<unknown>[]} chunkInitFragments chunk init fragments for javascript modules
 ...
 * @typedef {Omit<Map<string, unknown>, "get" | "set" | "has" | "delete"> & CodeGenMapOverloads} CodeGenerationResultData
 */
...
/** @typedef {KnownBuildMeta & Record<string, unknown>} BuildMeta */
/** @typedef {KnownBuildInfo & Record<string, unknown>} BuildInfo */
