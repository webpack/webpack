...
class Module extends DependenciesBlock {
	...
	serialize(context) {
		const { write, writeAbsolutePath } = context;
		write(this.type);
		writeAbsolutePath(this.context);
		...
		// TODO (de)serialize this.buildInfo absolute paths
	...
	deserialize(context) {
		const { read, readAbsolutePath } = context;
		this.type = read();
		this.context = readAbsolutePath();
