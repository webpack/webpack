 ...
 * @property {string[]=} constReassignments bindings declared `const` that the module writes to
 * @property {string[]=} namespaceCalls namespaces the module imports with `import * as` and calls
