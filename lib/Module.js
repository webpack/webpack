...
/**
 * @typedef {object} KnownGenerationMeta
 * @property {Record<string, string>=} exportsFinalName
 * @property {string=} exportsBindingStmt
 */
...
/** @typedef {KnownGenerationMeta} GenerationMeta */
...
class Module extends DependenciesBlock {
	...
	constructor(type, context = null, layer = null) {
		...
		/** @type {GenerationMeta | undefined} */
		this.generationMeta = undefined;
