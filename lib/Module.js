 ...
 * @property {Set<string>=} lazyDependencies request keys of re-export targets still deferred by the lazy barrel optimization; part of the provided-exports cache key
 */
