 ...
 * @property {InitFragment<any>[]} chunkInitFragments chunk init fragments for javascript modules
 ...
 * @template {string} K
 * @typedef {K extends (keyof AllCodeGenerationSchemas) ? AllCodeGenerationSchemas[K] : any} CodeGenValue
 */
 ...
 * @typedef {Omit<Map<string, any>, "get" | "set" | "has" | "delete"> & CodeGenMapOverloads} CodeGenerationResultData
 */
