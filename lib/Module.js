...
class Module extends DependenciesBlock {
	...
	constructor(type, context = null, layer = null) {
		...
		// snapshot over this module's dependency-resolution probes, set between
		// watch rebuilds (declared here to keep the instance shape stable)
		/** @type {import("./FileSystemInfo").Snapshot | undefined} */
		this._incrementalResolveSnapshot = undefined;
	}
