...
class Module extends DependenciesBlock {
	 ...
	 * @param {ResolverWithOptions | null} resolver the resolver, or `null` if the module type does not need it
	 * @param {InputFileSystem | null} fs the file system, or `null` if the module type does not need it
