...
Object.defineProperty(Module.prototype, "forEachChunk", {
	...
	value: util.deprecate(
		/**
		 * @deprecated
		 * @typedef {function(any, any, Set<any>): void} ForEachChunkCallback
		 * @param {ForEachChunkCallback} fn callback function
		 * @returns {void}
		 * @this {Module}
		 */
		function(fn) {
...
Object.defineProperty(Module.prototype, "mapChunks", {
	...
	value: util.deprecate(
		/**
		 * @deprecated
		 * @typedef {function(any, any, Set<any>): void} MapChunksCallback
		 * @param {MapChunksCallback} fn Mapper function
