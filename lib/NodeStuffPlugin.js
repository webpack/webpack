...
import CachedConstDependency from "./dependencies/CachedConstDependency.js";
import ConstDependency from "./dependencies/ConstDependency.js";
import ExternalModuleDependency from "./dependencies/ExternalModuleDependency.js";
import ExternalModuleInitFragmentDependency from "./dependencies/ExternalModuleInitFragmentDependency.js";
import ImportMetaPlugin, {
	IMPORT_META_DIRNAME,
	IMPORT_META_FILENAME,
	isImportMetaFieldEnabled
} from "./dependencies/ImportMetaPlugin.js";
import NodeStuffInWebError from "./errors/NodeStuffInWebError.js";
import { evaluateToString } from "./javascript/JavascriptParserHelpers.js";
import { relative } from "./util/fs.js";
import { parseResource } from "./util/identifier.js";
/** @typedef {import("../declarations/WebpackOptions.js").JavascriptParserOptions} JavascriptParserOptions */
/** @typedef {import("../declarations/WebpackOptions.js").NodeOptions} NodeOptions */
...
/** @typedef {import("./javascript/JavascriptParser.js").Expression} Expression */
	...
	apply(compiler) {
		...
		compiler.hooks.compilation.tap(
			...
			(compilation, { normalModuleFactory }) => {
				 ...
				 * @param {JavascriptParser} parser the parser
				 * @param {NodeOptions} nodeOptions options
				 * @param {{ dirname: "__dirname" | "import.meta.dirname", filename: "__filename" | "import.meta.filename", dirnameEnabled?: boolean, filenameEnabled?: boolean }} identifiers options
				 * @returns {void}
				 */
				const dirnameAndFilenameHandler = (
					parser,
					nodeOptions,
					{ dirname, filename, dirnameEnabled = true, filenameEnabled = true }
				) => {
					...
					if (filenameEnabled && nodeOptions.__filename) {
					...
					if (dirnameEnabled && nodeOptions.__dirname) {
				...
				const handler = (parser, parserOptions, a, b) => {
					if (b && parserOptions.node === false) {
						if (isImportMetaFieldEnabled(parserOptions.importMeta, "dirname")) {
							setModuleConstant(
								parser,
								IMPORT_META_DIRNAME,
								() => IMPORT_META_DIRNAME,
						...
						if (
							isImportMetaFieldEnabled(parserOptions.importMeta, "filename")
						) {
							setModuleConstant(
								parser,
								IMPORT_META_FILENAME,
					...
					if (
						b &&
						(isImportMetaFieldEnabled(parserOptions.importMeta, "dirname") ||
							isImportMetaFieldEnabled(parserOptions.importMeta, "filename"))
					) {
						dirnameAndFilenameHandler(parser, localOptions, {
							dirname: IMPORT_META_DIRNAME,
							filename: IMPORT_META_FILENAME,
							dirnameEnabled: isImportMetaFieldEnabled(
								parserOptions.importMeta,
								"dirname"
							),
							filenameEnabled: isImportMetaFieldEnabled(
								parserOptions.importMeta,
								"filename"
							)
						});
...
export default NodeStuffPlugin;

export { NodeStuffPlugin as "module.exports" };
