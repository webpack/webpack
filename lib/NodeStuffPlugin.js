...
NodeStuffPlugin.prototype.apply = function(compiler) {
	...
	compiler.parser.plugin("expression module", function() {
		return ModuleParserHelpers.addParsedVariable(this, "module", "require(" + JSON.stringify(path.relative(this.state.module.context, path.join(__dirname, "..", "buildin", "module.js"))) + ")(module)");
	});
};
