...
export default ModuleGraphConnection;
export { CIRCULAR_CONNECTION };
export { TRANSITIVE_ONLY };
export { addConnectionStates };

// attach named exports as properties to keep the CJS shape
ModuleGraphConnection.CIRCULAR_CONNECTION = CIRCULAR_CONNECTION;
ModuleGraphConnection.TRANSITIVE_ONLY = TRANSITIVE_ONLY;
ModuleGraphConnection.addConnectionStates = addConnectionStates;

export { ModuleGraphConnection as "module.exports" };
