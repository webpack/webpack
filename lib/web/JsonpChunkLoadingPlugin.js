...
class JsonpChunkLoadingPlugin {
	...
	apply(compiler) {
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			/**
			 * Loading a chunk is the only part that writes the module factories and looks
			 * a chunk id up; a base uri or `onChunksLoaded` comes without either. Kept off
			 * `handler`, which runs once per chunk and so cannot see which of the
