...
/** @typedef {import("../../declarations/WebpackOptions").WasmImportObject} WasmImportObject */
 ...
 * @property {WasmImportObject} [wasmImportObject] Controls the memory configuration for the `importObj` parameter in `WebAssembly.instantiate`.
 */
				...
				.tap(PLUGIN_NAME, (chunk, set, { chunkGraph }) => {
					...
					compilation.addRuntimeModule(
						...
						new WasmChunkLoadingRuntimeModule({
							...
							wasmImportObject: this.options.wasmImportObject
						})
					);
				});
		});
