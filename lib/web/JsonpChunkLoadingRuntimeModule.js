...
class JsonpChunkLoadingRuntimeModule extends RuntimeModule {
	constructor(runtimeRequirements, linkPreload, linkPrefetch) {
	...
	generate() {
		...
		const chunkLoadingGlobal = `${outputOptions.globalObject}[${JSON.stringify(
			outputOptions.chunkLoadingGlobal
		)}]`;
		...
		return Template.asString([
			...
			withDefer || withLoading
				? Template.asString([
						...
						"};",
						"",
						`var chunkLoadingGlobal = ${chunkLoadingGlobal} = ${chunkLoadingGlobal} || [];`,
						"var oldChunkLoadingFunction = chunkLoadingGlobal.push.bind(chunkLoadingGlobal);",
						"chunkLoadingGlobal.push = webpackJsonpCallback;",
						"var parentChunkLoadingFunction = oldChunkLoadingFunction;"
				  ])
				: "// no jsonp function"
		]);
	}
