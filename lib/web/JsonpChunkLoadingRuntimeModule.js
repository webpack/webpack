										...
										Template.indent([
											...
											Template.indent([
												...
												Template.indent([
													...
													"var error = new Error();",
													`var webpackJsonpRuntimeErrorCallback = ${runtimeTemplate.basicFunction(
														"event",
														[
															"if (event.filename === url) {",
															Template.indent([
																"error.evaluationError = event.message;"
															]),
															"}"
														]
													)}`,
													`${RuntimeGlobals.global}.addEventListener("error", webpackJsonpRuntimeErrorCallback)`,
													`var loadingEnded = ${runtimeTemplate.basicFunction(
														"event",
														[
															`${RuntimeGlobals.global}.removeEventListener("error", webpackJsonpRuntimeErrorCallback)`,
															...
															Template.indent([
																...
																Template.indent([
																	...
																	"error.message = error.evaluationError ? error.message + ' - ' + error.evaluationError : error.message;",
