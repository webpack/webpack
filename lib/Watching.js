...
/** @typedef {import("./Compiler.js").ErrorCallback} ErrorCallback */
/** @typedef {import("./logging/Logger.js").Logger} Logger */
/** @typedef {import("./util/fs.js").TimeInfoEntries} TimeInfoEntries */
/** @typedef {import("./util/fs.js").WatchFileSystem} WatchFileSystem */
/** @typedef {import("./util/fs.js").Watcher} Watcher */
...
export { Watching as "module.exports" };
