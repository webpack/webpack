...
const { dirname, join, maybeFileURLToPath } = require("./util/fs");
...
class NormalModuleReplacementPlugin {
	 ...
	 * @param {string | URL | ModuleReplacer} newResource the resource replacement (a path, a file `URL` instance, or a function)
	 */
	...
	apply(compiler) {
		...
		const newResource =
			typeof this.newResource === "function"
				? this.newResource
				: maybeFileURLToPath(this.newResource);
