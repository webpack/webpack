...
const {
	ImportPhase,
	ImportPhaseUtils
} = require("../dependencies/core/ImportPhase");
...
/** @import ContextElementDependency from "../dependencies/context/ContextElementDependency" */
...
/** @import { ImportPhaseType } from "../dependencies/core/ImportPhase" */
...
module.exports = webpackEmptyAsyncContext;`;
	...
	getGlobSyncSource(dependencies, chunkGraph, runtimeTemplate) {
		...
		const globImportAccess = this.getImportPropertyAccess();
		const sortedDependencies =
			/** @type {import("../dependencies/context/ContextElementDependency")[]} */
