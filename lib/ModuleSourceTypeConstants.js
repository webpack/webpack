...
/**
 * @type {Readonly<"html-url">}
 */
const HTML_URL_TYPE = "html-url";

/**
 * @typedef {JAVASCRIPT_TYPE | RUNTIME_TYPE | WEBASSEMBLY_TYPE | ASSET_TYPE | CSS_TYPE | CSS_IMPORT_TYPE | CSS_URL_TYPE | HTML_TYPE | HTML_URL_TYPE | SHARED_INIT_TYPE | REMOTE_GENERATOR_TYPE | CONSUME_SHARED_GENERATOR_TYPE | UNKNOWN_TYPE} AllTypes
 */
...
module.exports.HTML_URL_TYPE = HTML_URL_TYPE;
