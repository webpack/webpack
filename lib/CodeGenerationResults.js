...
Caller might not support runtime-dependent code generation (opt-out via optimization.usedExports: "global").`
	...
	getSource(module, runtime, sourceType) {
		return this.getResult(module, runtime).sources.get(sourceType);
	}
	...
	getRuntimeRequirements(module, runtime) {
		return this.getResult(module, runtime).runtimeRequirements;
	}
	...
	getData(module, runtime, key) {
		const data = this.getResult(module, runtime).data;
