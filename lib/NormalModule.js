 ...
 * @property {(context: string, request: string) => string} absolutify makes a request relative to a context
 * @property {(context: string, request: string) => string} contextify makes a request absolute against a context
