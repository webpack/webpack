...
/** @typedef {{ [k: string]: unknown }} ParserOptions */
/** @typedef {{ [k: string]: unknown }} GeneratorOptions */
 ...
 * @property {string | null | undefined | Record<string, unknown>} options
...
class NormalModule extends Module {
	...
	/**
	 * @param {Exclude<NoParse, unknown[]>} rule rule
	...
	static deserialize(context) {
		const obj = new NormalModule({
			...
			resource: "",
			context: "",
			request: /** @type {string} */ (/** @type {unknown} */ (null)),
			userRequest: /** @type {string} */ (/** @type {unknown} */ (null)),
			rawRequest: /** @type {string} */ (/** @type {unknown} */ (null)),
			loaders: /** @type {LoaderItem[]} */ (/** @type {unknown} */ (null)),
			matchResource: undefined,
			parser: /** @type {Parser} */ (/** @type {unknown} */ (null)),
			parserOptions: undefined,
			generator: /** @type {Generator} */ (/** @type {unknown} */ (null)),
			generatorOptions: undefined,
			resolveOptions: undefined,
			extractSourceMap: /** @type {boolean} */ (/** @type {unknown} */ (null))
		});
