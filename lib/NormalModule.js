...
class NormalModule extends Module {
	...
	sourceVariables(variable, availableVars, vars, dependencyTemplates, outputOptions, requestShortener) {
	...
	sourceBlock(block, availableVars, dependencyTemplates, source, outputOptions, requestShortener) {
		...
		if(block.variables.length > 0) {
			block.variables.forEach((variable) => this.sourceVariables(
				variable, availableVars, vars, dependencyTemplates, outputOptions, requestShortener));
			const varNames = [];
			...
			const emitFunction = () => {
				...
				// exports === this, but exports do compress better...
				varEndCode = (this === block ? "}.call(" + (this.exportsArgument || "exports") + ", " : "}.call(this, ") +
