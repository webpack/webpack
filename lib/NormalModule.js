...
const getInvalidDependenciesModuleWarning = lazyModule(() =>
	require("./errors/InvalidDependenciesModuleWarning")
);

const getExtractSourceMap = lazyModule(() =>
	require("./util/extractSourceMap")
);

const getValidate = lazyModule(() => require("schema-utils").validate);

const getHarmonyImportSideEffectDependency = lazyModule(() =>
