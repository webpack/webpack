...
class NormalModule extends Module {
	...
	static deserialize(context) {
		const obj = new NormalModule({
			...
			resource: "",
			context: "",
			request: /** @type {string} */ (/** @type {EXPECTED_ANY} */ (null)),
			userRequest: /** @type {string} */ (/** @type {EXPECTED_ANY} */ (null)),
			rawRequest: /** @type {string} */ (/** @type {EXPECTED_ANY} */ (null)),
			loaders: /** @type {LoaderItem[]} */ (/** @type {EXPECTED_ANY} */ (null)),
			matchResource: undefined,
			parser: /** @type {Parser} */ (/** @type {EXPECTED_ANY} */ (null)),
			parserOptions: undefined,
			generator: /** @type {Generator} */ (/** @type {EXPECTED_ANY} */ (null)),
			generatorOptions: undefined,
			resolveOptions: undefined,
			extractSourceMap: /** @type {boolean} */ (
