...
import ModuleParseError from "./errors/ModuleParseError.js";
import ModuleWarning from "./errors/ModuleWarning.js";
import NonErrorEmittedError from "./errors/NonErrorEmittedError.js";
import UnhandledSchemeError from "./errors/UnhandledSchemeError.js";
import {
	createLoaderContext,
	getContext,
	runLoaders
} from "./loaders/LoaderRunner.js";
...
import { createFakeHook } from "./util/deprecation.js";
...
/** @typedef {import("../declarations/WebpackOptions.js").NoParse} NoParse */
...
/** @typedef {import("./Generator.js").GenerateErrorFn} GenerateErrorFn */
...
/** @typedef {import("./Module.js").KnownBuildInfo} KnownBuildInfo */
...
/** @typedef {import("./Module.js").UnsafeCacheData} UnsafeCacheData */
...
/** @typedef {import("./NormalModuleFactory.js").NormalModuleTypes} NormalModuleTypes */
/** @typedef {import("./NormalModuleFactory.js").ParserByType} ParserByType */
/** @typedef {import("./NormalModuleFactory.js").ParserOptionsByType} ParserOptionsByType */
/** @typedef {import("./NormalModuleFactory.js").GeneratorByType} GeneratorByType */
/** @typedef {import("./NormalModuleFactory.js").GeneratorOptionsByType} GeneratorOptionsByType */
/** @typedef {import("./NormalModuleFactory.js").ResourceSchemeData} ResourceSchemeData */
...
/**
 * @template T
 * @typedef {import("./util/deprecation.js").FakeHook<T>} FakeHook
 */
...
/**
 * @template T
 * @typedef {import("../declarations/LoaderContext.js").NormalModuleLoaderContext<T>} NormalModuleLoaderContext
 */
...
const getExtractSourceMap = memoize(
	() =>
		/** @type {typeof import("./util/extractSourceMap.js").default} */ (
			require("./util/extractSourceMap.js")
		)
);
...
const walkSideEffects = (rootMod, moduleGraph, SideEffectDep) => {
	...
	while (fMod.length > 0) {
		...
		if (pending !== undefined) {
			...
			if (state !== CIRCULAR_CONNECTION) {
				current = addConnectionStates(current, state);
			}
			i++;
		}
...
const normalModuleHooksRegistry = createHooksRegistry(() => {
	...
	hooks.readResourceForScheme = new HookMap((scheme) => {
		...
		return createFakeHook(
			...
			"NormalModule.getCompilationHooks().readResourceForScheme is deprecated (use readResource instead)",
			"DEP_WEBPACK_NORMAL_MODULE_READ_RESOURCE_FOR_SCHEME"
		);
	});
...
class NormalModule extends Module {
	...
	createSourceForAsset(
		...
		if (sourceMap) {
			if (typeof sourceMap === "string" && this.sourceMapKind !== "none") {
	 ...
	 * @returns {import("../declarations/LoaderContext.js").LoaderContext<T>} loader context
	 */
	_createLoaderContext(resolver, options, compilation, fs, hooks) {
		...
		const loaderContext = {
			...
			getResolve(options) {
				...
				return /** @type {ReturnType<import("../declarations/LoaderContext.js").NormalModuleLoaderContext<T>["getResolve"]>} */ (
			...
			webpack: true,
			sourceMap: this.sourceMapKind === "full",
	...
	createSource(context, content, sourceMap, associatedObjectForCache) {
		...
		if (this.sourceMapKind === "full" && sourceMap) {
			return new SourceMapSource(
				content,
		...
		runLoaders(
			{
				...
				processResource: async (loaderContext, resourcePath, callback) => {
					...
					try {
						...
						if (this.extractSourceMap && this.sourceMapKind !== "none") {
							try {
	...
	build(options, compilation, resolver, fs, callback) {
		...
		return this._doBuild(options, compilation, resolver, fs, hooks, (err) => {
			...
			const handleParseResult = () => {
				...
				this.dependencies.sort(Dependency.compareLocations);
...
export { NormalModule as "module.exports" };
