...
const getModuleError = lazyModule.sync(() => require("./errors/ModuleError"));
const getModuleParseError = lazyModule.sync(() =>
	require("./errors/ModuleParseError")
);
const getModuleWarning = lazyModule.sync(() =>
	require("./errors/ModuleWarning")
);
const getNonErrorEmittedError = lazyModule.sync(() =>
	require("./errors/NonErrorEmittedError")
);
const getUnhandledSchemeError = lazyModule.sync(() =>
...
const getInvalidDependenciesModuleWarning = lazyModule.sync(() =>
	require("./errors/InvalidDependenciesModuleWarning")
);

const getExtractSourceMap = lazyModule.sync(() =>
	require("./util/extractSourceMap")
);

const getValidate = lazyModule.sync(() => require("schema-utils").validate);

const getHarmonyImportSideEffectDependency = lazyModule.sync(() =>
