...
/**
 * Defines the normal module loader context type used by this module.
 * @template T
...
/**
 * Defines the loader item type used by this module.
...
class NonErrorEmittedError extends WebpackError {
	/**
	 * Creates an instance of NonErrorEmittedError.
...
/**
 * Defines the deprecated read resource for scheme type used by this module.
...
/**
 * Defines the normal module compilation hooks type used by this module.
...
/**
 * Defines the normal module create data type used by this module.
...
/**
 * Defines the read resource type used by this module.
...
class NormalModule extends Module {
	...
	/**
	 * Creates an instance of NormalModule.
	...
	/**
	 * Returns return the resource path.
	...
	_createLoaderContext(resolver, options, compilation, fs, hooks) {
		...
		const utils = {
			...
			/**
			 * Creates a hash from the provided type.
	...
	/**
	 * Creates a source from the provided string.
	 * @param {string} context the compilation context
	 * @param {string | Buffer} content the content
	...
	/**
	 * Processes the provided webpack option.
	 * @param {WebpackOptions} options webpack options
	 * @param {Compilation} compilation the compilation
		...
		runLoaders(
			{
				...
				/**
				 * Processes the provided loader context.
	...
	/**
	 * Determines whether it should prevent parsing.
	...
	/**
	 * Adds the provided file dependencies to the normal module.
