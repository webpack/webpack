...
class NormalModule extends Module {
	...
	/**
	 * @param {string | Function | RegExp} rule the parse-rule
	 * @param {string} content the request-content
	 * @returns {boolean} true if the module is not to be parsed
	 */
	...
	/**
	 * @param {[RegExp | string | Function, ...(RegExp | string | Function)[]] | RegExp | string | Function} noParseRule the parse-rule
	 * @param {string} request the request
	 * @returns {boolean} true if the module should not be parsed
	 */
