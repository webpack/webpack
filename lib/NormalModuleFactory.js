			...
			asyncLib.parallel(
				...
				(err, results) => {
					...
					for (const r of result) {
						if (r.type === "use") {
							if (r.enforce === "post" && !noPrePostAutoLoaders) useLoadersPost.push(r.value);
							else if (r.enforce === "pre" && !noPreAutoLoaders && !noPrePostAutoLoaders) useLoadersPre.push(r.value);
