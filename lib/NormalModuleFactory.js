...
import { JAVASCRIPT_MODULE_TYPE_AUTO } from "./ModuleTypeConstants.js";
import { ImportPhaseUtils } from "./dependencies/ImportPhase.js";
import { getContext } from "./loaders/LoaderRunner.js";
import BasicEffectRulePlugin from "./rules/BasicEffectRulePlugin.js";
import BasicMatcherRulePlugin from "./rules/BasicMatcherRulePlugin.js";
import ObjectMatcherRulePlugin from "./rules/ObjectMatcherRulePlugin.js";
import RuleSetCompiler from "./rules/RuleSetCompiler.js";
import UseEffectRulePlugin from "./rules/UseEffectRulePlugin.js";
import LazySet from "./util/LazySet.js";
import { getScheme } from "./util/URLAbsoluteSpecifier.js";
import { cachedCleverMerge, cachedSetProperty } from "./util/cleverMerge.js";
...
/** @typedef {import("./Generator.js").default} Generator */
...
/** @typedef {import("./NormalModule.js").LoaderItem} LoaderItem */
...
/** @typedef {import("./Parser.js").default} Parser */
/** @typedef {import("./ResolverFactory.js").default} ResolverFactory */
...
/** @typedef {import("./rules/RuleSetCompiler.js").RuleSetRules} RuleSetRules */
/** @typedef {import("./rules/RuleSetCompiler.js").RuleSet} RuleSet */
 ...
 * @template T
 * @typedef {import("./Compiler.js").Callback<T>} Callback
 */
...
/** @typedef {import("./ModuleTypeConstants.js").JAVASCRIPT_MODULE_TYPE_AUTO} JAVASCRIPT_MODULE_TYPE_AUTO */
/** @typedef {import("./ModuleTypeConstants.js").JAVASCRIPT_MODULE_TYPE_DYNAMIC} JAVASCRIPT_MODULE_TYPE_DYNAMIC */
/** @typedef {import("./ModuleTypeConstants.js").JAVASCRIPT_MODULE_TYPE_ESM} JAVASCRIPT_MODULE_TYPE_ESM */
/** @typedef {import("./ModuleTypeConstants.js").JSON_MODULE_TYPE} JSON_MODULE_TYPE */
/** @typedef {import("./ModuleTypeConstants.js").ASSET_MODULE_TYPE} ASSET_MODULE_TYPE */
/** @typedef {import("./ModuleTypeConstants.js").ASSET_MODULE_TYPE_INLINE} ASSET_MODULE_TYPE_INLINE */
/** @typedef {import("./ModuleTypeConstants.js").ASSET_MODULE_TYPE_RESOURCE} ASSET_MODULE_TYPE_RESOURCE */
/** @typedef {import("./ModuleTypeConstants.js").ASSET_MODULE_TYPE_SOURCE} ASSET_MODULE_TYPE_SOURCE */
/** @typedef {import("./ModuleTypeConstants.js").ASSET_MODULE_TYPE_BYTES} ASSET_MODULE_TYPE_BYTES */
/** @typedef {import("./ModuleTypeConstants.js").WEBASSEMBLY_MODULE_TYPE_ASYNC} WEBASSEMBLY_MODULE_TYPE_ASYNC */
/** @typedef {import("./ModuleTypeConstants.js").CSS_MODULE_TYPE} CSS_MODULE_TYPE */
/** @typedef {import("./ModuleTypeConstants.js").CSS_MODULE_TYPE_GLOBAL} CSS_MODULE_TYPE_GLOBAL */
/** @typedef {import("./ModuleTypeConstants.js").CSS_MODULE_TYPE_MODULE} CSS_MODULE_TYPE_MODULE */
/** @typedef {import("./ModuleTypeConstants.js").CSS_MODULE_TYPE_AUTO} CSS_MODULE_TYPE_AUTO */
/** @typedef {import("./ModuleTypeConstants.js").HTML_MODULE_TYPE} HTML_MODULE_TYPE */

/** @typedef {JAVASCRIPT_MODULE_TYPE_AUTO | JAVASCRIPT_MODULE_TYPE_DYNAMIC | JAVASCRIPT_MODULE_TYPE_ESM | JSON_MODULE_TYPE | ASSET_MODULE_TYPE | ASSET_MODULE_TYPE_INLINE | ASSET_MODULE_TYPE_RESOURCE | ASSET_MODULE_TYPE_SOURCE | WEBASSEMBLY_MODULE_TYPE_ASYNC | CSS_MODULE_TYPE | CSS_MODULE_TYPE_GLOBAL | CSS_MODULE_TYPE_MODULE | CSS_MODULE_TYPE_AUTO | HTML_MODULE_TYPE} KnownNormalModuleTypes */
...
/** @typedef {import("./javascript/JavascriptGenerator.js").default} JavascriptGenerator */
/** @typedef {import("../declarations/WebpackOptions.js").EmptyGeneratorOptions} EmptyGeneratorOptions */

/** @typedef {import("./json/JsonParser.js").default} JsonParser */
/** @typedef {import("../declarations/WebpackOptions.js").JsonParserOptions} JsonParserOptions */
/** @typedef {import("./json/JsonGenerator.js").default} JsonGenerator */
/** @typedef {import("../declarations/WebpackOptions.js").JsonGeneratorOptions} JsonGeneratorOptions */

/** @typedef {import("./asset/AssetParser.js").default} AssetParser */
/** @typedef {import("./asset/AssetSourceParser.js").default} AssetSourceParser */
/** @typedef {import("./asset/AssetBytesParser.js").default} AssetBytesParser */
/** @typedef {import("../declarations/WebpackOptions.js").AssetParserOptions} AssetParserOptions */
/** @typedef {import("../declarations/WebpackOptions.js").EmptyParserOptions} EmptyParserOptions */
/** @typedef {import("./asset/AssetGenerator.js").default} AssetGenerator */
/** @typedef {import("../declarations/WebpackOptions.js").AssetGeneratorOptions} AssetGeneratorOptions */
/** @typedef {import("../declarations/WebpackOptions.js").AssetInlineGeneratorOptions} AssetInlineGeneratorOptions */
/** @typedef {import("../declarations/WebpackOptions.js").AssetResourceGeneratorOptions} AssetResourceGeneratorOptions */
/** @typedef {import("./asset/AssetSourceGenerator.js").default} AssetSourceGenerator */
/** @typedef {import("./asset/AssetBytesGenerator.js").default} AssetBytesGenerator */

/** @typedef {import("./wasm-async/AsyncWebAssemblyParser.js").default} AsyncWebAssemblyParser */

/** @typedef {import("./css/CssParser.js").default} CssParser */
/** @typedef {import("../declarations/WebpackOptions.js").CssParserOptions} CssParserOptions */
/** @typedef {import("../declarations/WebpackOptions.js").CssModuleParserOptions} CssModuleParserOptions */
...
/** @typedef {import("./html/HtmlParser.js").default} HtmlParser */
/** @typedef {import("../declarations/WebpackOptions.js").EmptyParserOptions} HtmlParserOptions */
/** @typedef {import("./html/HtmlGenerator.js").default} HtmlGenerator */
...
class NormalModuleFactory extends ModuleFactory {
	...
	constructor({
		...
		/** @type {(resource: string) => import("./util/identifier.js").ParsedResource} */
							...
							(err, createdModule) => {
								if (!createdModule) {
									...
									if (!createdModule) {
										return callback(
											new Error(
												`No module class is registered for module type '${createData.settings.type}' (module classes are registered via NormalModuleFactory.hooks.createModuleClass)`
											)
										);
									}
								}
...
export { NormalModuleFactory as "module.exports" };
