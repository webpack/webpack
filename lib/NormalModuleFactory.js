...
const { ImportPhase } = require("./dependencies/ImportPhase");
			...
			(data, callback) => {
				...
				const continueCallback = needCalls(2, (err) => {
					...
					if (
						...
						/** @type {ModuleDependency & { phase?: number }} */
						const dep = dependencies[0];
						let phase = "evaluation";
						if (dep && typeof dep.phase === "number") {
							if (dep.phase === ImportPhase.Defer) {
								phase = "defer";
							} else if (dep.phase === ImportPhase.Source) {
								phase = "source";
							}
						}
