				...
				const continueCallback = needCalls(2, err => {
					...
					if (
						...
						for (const r of result) {
							// https://github.com/webpack/webpack/issues/16466 & https://github.com/webpack/webpack/issues/17747
							// if a request exists PrePostAutoLoaders and the request is not a compiler request, should disable modifying Rule.type
							if (
								!(
									resourceData.data.context &&
									resourceData.data.context.compiler
								) &&
								r.type === "type" &&
