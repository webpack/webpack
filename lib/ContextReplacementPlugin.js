...
const { join, maybeFileURLToPath } = require("./util/fs");
...
class ContextReplacementPlugin {
	 ...
	 * @param {(string | URL | ((context: BeforeContextResolveData | AfterContextResolveData) => void) | RegExp | boolean)=} newContentResource A new resource to replace the match (a path or a file `URL` instance)
	...
	constructor(
		...
		// resolve a file URL instance before branching on the argument type
		newContentResource = maybeFileURLToPath(newContentResource);
