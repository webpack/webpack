...
/** @typedef {import("../declarations/WebpackOptions.js").DotenvPluginOptions} DotenvPluginOptions */
/** @typedef {import("./Compiler.js").default} Compiler */
/** @typedef {import("./CacheFacade.js").ItemCacheFacade} ItemCacheFacade */
...
function expand(options) {
	...
	for (const key in options.parsed) {
		...
		value =
			Object.hasOwn(processEnv, key) && processEnv[key] !== value
...
class DotenvPlugin {
	...
	_getEnvFilesForMode(inputFileSystem, dir, mode) {
		...
		return templates
			.map((pattern) => pattern.replaceAll("[mode]", mode || "development"))
...
export { DotenvPlugin as "module.exports" };
