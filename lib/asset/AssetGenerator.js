...
class AssetGenerator extends Generator {
	...
	/**
	 * Gets the source file name as seen by a filename template, so `[path]` and
	 * `[file]` of a module outside of `context` can't emit the asset outside of
	 * `output.path`.
	 * @param {NormalModule} module module
	 * @param {RuntimeTemplate} runtimeTemplate runtime template
