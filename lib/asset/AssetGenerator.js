...
import nonNumericOnlyHash from "../util/nonNumericOnlyHash.js";
import {
	PUBLIC_PATH_AUTO,
	PUBLIC_PATH_FULL_HASH
} from "../util/publicPathPlaceholder.js";
import { updateHashFromSource } from "../util/source.js";
import { RawSource } from "../util/webpack-sources.js";

const require = createRequire(import.meta.url);

const getMimeTypes = memoize(() => require("../util/mimeTypes.js"));

/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("../../declarations/WebpackOptions.js").AssetGeneratorDataUrlOptions} AssetGeneratorDataUrlOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").AssetGeneratorOptions} AssetGeneratorOptions */
...
/** @typedef {import("../../declarations/WebpackOptions.js").AssetResourceGeneratorOptions} AssetResourceGeneratorOptions */
...
const encodeDataUri = (encoding, source) => {
	...
	switch (encoding) {
		...
		case false: {
			...
			encodedContent = encodeURIComponent(encodedContent).replaceAll(
				/[!'()*]/g,
				(character) =>
...
export { AssetGenerator as "module.exports" };
