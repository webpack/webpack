...
class AssetGenerator extends Generator {
	 ...
	 * `experiments.futureDefaults` (webpack 6 default) `[path]` and `[file]` of a
	...
	generate(module, generateContext) {
		...
		if (
			...
			// TODO in the next major release: For back-compat reasons we also store in on module.buildInfo
			/** @type {AssetModuleBuildInfo} */
