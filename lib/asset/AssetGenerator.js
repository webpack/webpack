...
const { languageOfMediaType } = require("../util/dataURL");
...
class AssetGenerator extends Generator {
	...
	generate(module, generateContext) {
		...
		if (
			...
			// A payload bound for CSS or HTML is offered by their serializers, which
			// see the `url()` it ends up in; only the JavaScript one is ours.
