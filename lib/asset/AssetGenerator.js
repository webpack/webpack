...
class AssetGenerator extends Generator {
	...
	_renderEmbedded(module, runtimeTemplate) {
		...
		return runtimeTemplate.compilation._resolveEmbeddedSource(
			new RawSource(
				typeof content === "string" ? content : content.toString("utf8")
			),
	...
	updateHash(hash, updateHashContext) {
		...
		if (
			...
			if (updateHashContext.runtimeTemplate) {
				updateHashContext.runtimeTemplate.compilation.hooks.embeddedSourceHash.call(
					module,
					hash
				);
			}
