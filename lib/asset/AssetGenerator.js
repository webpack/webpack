...
class AssetGenerator extends Generator {
	...
	getTypes(module) {
		...
		// call site still requires the module (e.g. under an `eval` devtool). Build-time
		// execution is the known exception: it keeps the runtime form and
		// `AssetModulesPlugin` emulates the dropped wrapper's exports.
