...
class AssetGenerator extends Generator {
	...
	getTypes(module) {
		...
		// Only analyzable ESM output can drop a bare `new URL()` to an asset url, so
		// otherwise the cheap path stands. This must match the condition `URLDependency`
		// emits the literal under, or the wrapper goes while the call site still needs it.
