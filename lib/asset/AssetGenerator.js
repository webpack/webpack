...
class AssetGenerator extends Generator {
	...
	getTypes(module) {
		...
		for (const connection of connections) {
			...
			hasOrigin = true;
			// The dependency says how the asset is read — a bare url embedded into css,
			// html or a manifest, or the module wrapper — so a reference added later
			// answers for itself instead of being enumerated here. The origin module
			// cannot: concatenation re-points the connection at the javascript module
			// that absorbed the one holding the reference.
