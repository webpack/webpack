...
import { ASSET_MODULE_TYPE_RAW_DATA_URL } from "../ModuleTypeConstants.js";
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Buffer | undefined, string, string]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Buffer | undefined, string, string]>} ObjectSerializerContext */
...
export default RawDataUrlModule;

export { RawDataUrlModule as "module.exports" };
