			...
			case JAVASCRIPT_TYPE: {
				...
				if (concatenationScope) {
					if (isNamespace) {
						...
						sourceContent = `${runtimeTemplate.renderConst()} ${ConcatenationScope.DEFAULT_EXPORT} = ${JSON.stringify(encodedSource)};`;
					} else {
					...
					// ESM-style exports: namespace only contains "default", no __esModule.
