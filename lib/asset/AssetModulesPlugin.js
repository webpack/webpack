...
const getAssetGenerator = lazyModule.sync(() => require("./AssetGenerator"));
const getAssetParser = lazyModule.sync(() => require("./AssetParser"));
const getAssetSourceParser = lazyModule.sync(() =>
	require("./AssetSourceParser")
);
const getAssetBytesParser = lazyModule.sync(() =>
	require("./AssetBytesParser")
);
const getAssetSourceGenerator = lazyModule.sync(() =>
	require("./AssetSourceGenerator")
);
const getAssetBytesGenerator = lazyModule.sync(() =>
	require("./AssetBytesGenerator")
);
const getAssetModule = lazyModule.sync(() => require("./AssetModule"));
const getWebManifestParser = lazyModule.sync(() =>
	require("./WebManifestParser")
);
const getWebManifestGenerator = lazyModule.sync(() =>
