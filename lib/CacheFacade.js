...
import getLazyHashedEtag from "./cache/getLazyHashedEtag.js";
import mergeEtags from "./cache/mergeEtags.js";
import { forEachBail } from "./util/enhanced-resolve.js";

/** @typedef {import("./Cache.js").default} Cache */
/** @typedef {import("./Cache.js").Etag} Etag */
/** @typedef {import("./cache/getLazyHashedEtag.js").HashableObject} HashableObject */
...
export { ItemCacheFacade };
export { MultiItemCache };

// attach named exports as properties to keep the CJS shape
CacheFacade.ItemCacheFacade = ItemCacheFacade;
CacheFacade.MultiItemCache = MultiItemCache;

export { CacheFacade as "module.exports" };
