...
function MainTemplate(outputOptions) {
	...
	this.plugin("require", function(source, chunk, hash) {
		return this.asString([
			...
			"modules[moduleId].moduleIndex = moduleId;",
			"// Execute the module function",
			"modules[moduleId].call(module.exports, module, module.exports, " + this.renderRequireFunctionForModule(hash, chunk, "moduleId") + ");",
			"} else {",
			"// Grab the previously loaded module's id and exports",
			"module.id = installedModules[modules[moduleId].moduleIndex].id;",
			"module.exports = installedModules[modules[moduleId].moduleIndex].exports;",
			"}",
			"",
