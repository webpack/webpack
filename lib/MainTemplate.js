...
function MainTemplate(outputOptions) {
	...
	this.plugin("startup", function(source, chunk, hash) {
		...
		if(chunk.entryModule) {
			buf.push("// The main module id");
			buf.push(this.requireFn + ".s = " + chunk.entryModule.id + ";");
			buf.push("");
			buf.push("// Load entry module and return exports");
			buf.push("return " + this.renderRequireFunctionForModule(hash, chunk, this.requireFn + ".s") +
				"(" + this.requireFn + ".s);");
		}
