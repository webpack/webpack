...
MainTemplate.prototype.useChunkHash = function(chunk) {
	...
	var hashInPublicPath = Template.REGEXP_HASH.test(publicPath) || Template.REGEXP_CHUNKHASH.test(publicPath);
	var hashInFilename = Template.REGEXP_HASH.test(filename) || Template.REGEXP_CHUNKHASH.test(filename);
	var hashInChunkFilename = Template.REGEXP_HASH.test(chunkFilename) || Template.REGEXP_CHUNKHASH.test(chunkFilename);
	return !hashInPublicPath && !hashInFilename && !hashInChunkFilename;
};