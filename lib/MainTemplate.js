...
module.exports = class MainTemplate extends Tapable {
	 ...
	 * @param {any} chunk Chunk instance
	 * @param {any} moduleTemplate ModuleTemplate instance for render
	 ...
	 * @param {any} chunk Chunk instance for require
	 ...
	 * @param {any} chunk Chunk instance for require add fn
	 * @param {(string|number)=} varModuleId module id
	 * @param {any} varModule Module instance
