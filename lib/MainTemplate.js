...
/** @typedef {import("../declarations/WebpackOptions.js").Output} OutputOptions */
...
/** @typedef {import("./Compilation.js").InterpolatedPathAndAssetInfo} InterpolatedPathAndAssetInfo */
/** @typedef {import("./util/Hash.js").default} Hash */
/** @typedef {import("./DependencyTemplates.js").default} DependencyTemplates */
/** @typedef {import("./javascript/JavascriptModulesPlugin.js").RenderBootstrapContext} RenderBootstrapContext */
...
/** @typedef {import("./TemplatedPathPlugin.js").PathData} PathData */
/**
...
const getJsonpTemplatePlugin = memoize(
	() =>
		/** @type {typeof import("./web/JsonpTemplatePlugin.js").default} */ (
			require("./web/JsonpTemplatePlugin.js")
		)
);
const getLoadScriptRuntimeModule = memoize(
	() =>
		/** @type {typeof import("./runtime/LoadScriptRuntimeModule.js").default} */ (
			require("./runtime/LoadScriptRuntimeModule.js")
		)
);
...
export { MainTemplate as "module.exports" };
