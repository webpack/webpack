...
module.exports = class MainTemplate extends Template {
	constructor(outputOptions) {
		...
		this.plugin("require", (source, chunk, hash) => {
			return this.asString([
				...
				this.indent([
					...
					"if(!supportGetter) {",
					this.indent([
						"for(var key in installedModule.exports){",
						this.indent([
							"var moduleExport = installedModule.exports[key];",
							"if(moduleExport && typeof moduleExport.__esGetter === 'function'){",
							this.indent("installedModule.exports[key] = moduleExport.__esGetter();"),
							"}"
						]),
						"}"
					]),
					"}",
					"return installedModule.exports;"
				]),
				"}",
				...
				"module.l = true;",
				"if(!supportGetter) {",
				this.indent("module.loaded = true;"),
				"}",
				"",
		...
		this.plugin("require-extensions", (source, chunk, hash) => {
			...
			buf.push(this.indent([
				...
				this.indent([
					"if(!supportGetter) {",
					this.indent("exports[name] = {__esGetter: getter};"),
					"}",
					"else {",
					this.indent([
	...
	render(hash, chunk, moduleTemplate, dependencyTemplates) {
		...
		buf.push("");
		buf.push("var supportGetter = (function(){try{Object.defineProperty({}, 'a', {get: function(){}})}catch(e){return false;}return true;})();");
