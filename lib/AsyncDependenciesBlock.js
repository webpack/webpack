...
/** @import { DependencyLocation, UpdateHashContext } from "./Dependency" */
...
/**
 * `url` marks a block from `new URL()`: without `entryOptions` it stays in the
 * parent chunk; with `entryOptions` it becomes an async entry (e.g. CSS url).
 * @typedef {(ChunkGroupOptions & { entryOptions?: EntryOptions } & { circular?: boolean, url?: boolean })} GroupOptions
 */
