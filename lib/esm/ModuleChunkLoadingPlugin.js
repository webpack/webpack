...
const getExportWebpackRequireRuntimeModule = memoize(() =>
	require("./ExportWebpackRequireRuntimeModule")
);
const getModuleChunkLoadingRuntimeModule = memoize(() =>
		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			const handler = (chunk, set) => {
				...
				compilation.addRuntimeModule(
					chunk,
					new (getModuleChunkLoadingRuntimeModule())(set)
				);
			};
			...
			compilation.hooks.runtimeRequirementInTree
				...
				.tap(PLUGIN_NAME, (chunk) => {
					...
					compilation.addRuntimeModule(
						chunk,
						new (getExportWebpackRequireRuntimeModule())()
					);
				});
