...
import { generateJavascriptHMR } from "../hmr/JavascriptHotModuleReplacementHelper.js";
import __JavascriptModulesPlugin, {
	chunkHasJs
} from "../javascript/JavascriptModulesPlugin.js";
import { getInitialChunkIds } from "../javascript/StartupHelpers.js";
...
const { getChunkFilenameTemplate } = __JavascriptModulesPlugin;
							...
							linkPrefetch.call(
								Template.asString([
									...
									crossOriginLoading
										...
										: "",
									`if (${RuntimeGlobals.nonce}) {`,
									Template.indent(
										`link.setAttribute("nonce", ${RuntimeGlobals.nonce});`
									),
									"}",
									'link.rel = "prefetch";',
									'link.as = "script";',
...
export default ModuleChunkLoadingRuntimeModule;

export { ModuleChunkLoadingRuntimeModule as "module.exports" };
