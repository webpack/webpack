			...
			withHmrManifest
				? Template.asString([
						`${RuntimeGlobals.hmrDownloadManifest} = ${runtimeTemplate.basicFunction(
							"",
							[
								`return ${importFunctionName}(${RuntimeGlobals.publicPath} + ${RuntimeGlobals.getUpdateManifestFilename}()).then(${runtimeTemplate.basicFunction(
									"update",
									["return update;"]
								)}, ${runtimeTemplate.basicFunction("e", [
									`if (typeof e !== "undefined" && e.code !== "MODULE_NOT_FOUND") throw e;`
								])});`
							]
						)};`
					])
