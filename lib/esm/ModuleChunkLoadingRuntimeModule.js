		...
		return Template.asString([
										...
										Template.indent([
											...
											Template.indent([
												...
												Template.indent([
													...
													`promise = ${RuntimeGlobals.promise}.race([promise, new ${RuntimeGlobals.promise}(${runtimeTemplate.expressionFunction(
			...
			withAnalyzableImport
				? `${
						...
						`return ${RuntimeGlobals.promise}.all(promises);`
					])};`
			...
			withHmr
				? Template.asString([
						...
						Template.indent([
							`return new ${RuntimeGlobals.promise}(${runtimeTemplate.basicFunction(
								"resolve, reject",
								[
