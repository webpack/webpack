...
/**
 * Module Federation runtime utilities object.
 * Exposes helpers for federated module management, e.g. `invalidateRemote`.
 * Signature of invalidateRemote: (moduleId: string | number) => void
 */
module.exports.externalInstallChunk = "__webpack_require__.C";
module.exports.federation = "__webpack_require__.federation";
