...
/**
 * merge multiple CSS stylesheets (CSSStyleSheet or string) into one
 * Arguments: (sheets: Array<CSSStyleSheet | string>, returnType: "text" | "css-style-sheet") => CSSStyleSheet | string
 */
