...
/**
 * a flag marking a chunk whose analyzable ESM output bakes the full hash (a
 * `[fullhash]` publicPath); it pulls in a full-hash runtime module so the chunk's
 * content hash tracks the full hash and re-renders when it changes
 */
module.exports.analyzableEsmFullHash = "analyzable esm full hash";
