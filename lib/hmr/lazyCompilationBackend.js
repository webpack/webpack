...
/** @typedef {import("./LazyCompilationPlugin.js").BackendHandler} BackendHandler */
/** @typedef {import("../../declarations/WebpackOptions.js").LazyCompilationDefaultBackendOptions} LazyCompilationDefaultBackendOptions */
 ...
 */
const __esmDefault = (options) => (compiler, callback) => {
				...
				module(originalModule) {
					const key = `${encodeURIComponent(
						originalModule
							...
							.replaceAll("\\", "/")
							.replaceAll("@", "_")
					).replaceAll(/%(2F|3A|24|26|2B|2C|3B|3D)/g, decodeURIComponent)}`;
