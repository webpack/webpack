...
class LazyCompilationPlugin {
	 ...
	 * @param {(function(Compiler, string, number, function(Error?, any?): void): void) | function(Compiler, string, number): Promise<any>} options.backend the backend
	 * @param {string} options.client the client reference
	 * @param {boolean} options.entries true, when entries are lazy compiled
	 * @param {boolean} options.imports true, when import() modules are lazy compiled
	 * @param {number} options.port port number for lazy compilation backend
	 * @param {RegExp | string | (function(Module): boolean)} options.test additional filter for lazy compiled entrypoint modules
	 */
	constructor({ backend, client, entries, imports, test, port }) {
