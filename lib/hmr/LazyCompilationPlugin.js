...
import { WEBPACK_MODULE_TYPE_LAZY_COMPILATION_PROXY } from "../ModuleTypeConstants.js";
import * as RuntimeGlobals from "../RuntimeGlobals.js";
import Template from "../Template.js";
import CommonJsRequireDependency from "../dependencies/CommonJsRequireDependency.js";
import { resolveByProperty } from "../util/cleverMerge.js";
import serialization from "../util/serialization.js";
import { RawSource } from "../util/webpack-sources.js";

const { registerNotSerializable } = serialization;
 ...
 * @param {import("../../declarations/WebpackOptions.js").OutputNormalized} output normalized output option
 ...
 * @param {import("../../declarations/WebpackOptions.js").Externals | undefined} externals normalized externals option
...
const collectStaticExternalRequests = (externals, layer) => {
	...
	/** @param {import("../../declarations/WebpackOptions.js").ExternalItem} item one item */
	const visit = (item) => {
...
export { LazyCompilationPlugin as "module.exports" };
