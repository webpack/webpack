...
module.exports = function () {
	...
	$interceptModuleExecution$.push(function (options) {
		...
		// For ESM modules, also set import.meta.webpackHot
		if (options.importMeta) {
			options.importMeta.webpackHot = module.hot;
		}
	});
	...
	function internalApply(options) {
		...
		var results = currentUpdateApplyHandlers.map(function (handler, index) {
			if (typeof handler !== "function") {
				return { error: new Error("Handler is not a function") };
			}
