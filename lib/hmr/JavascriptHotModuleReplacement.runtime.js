...
/** @typedef {{ module: ModuleId, require: (id?: ModuleId) => void, errorHandler: boolean | Function }} SelfAcceptedModule */
...
module.exports = function () {
	...
	/** @type {Record<ModuleId, Function | false>} */
	var currentUpdate;
	/** @type {ModuleId[]} */
	...
	function applyHandler(options) {
		...
		for (var moduleId in currentUpdate) {
			if ($hasOwnProperty$(currentUpdate, moduleId)) {
				...
				if (doApply) {
					appliedUpdate[moduleId] = /** @type {Function} */ (newModuleFactory);
					addAllToSet(
						outdatedModules,
		...
		currentUpdate = /** @type {Record<ModuleId, Function | false>} */ (
			/** @type {unknown} */ (undefined)
		);
