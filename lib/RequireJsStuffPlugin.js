	...
	apply(compiler) {
		compiler.plugin("compilation", function(compilation, params) {
			...
			params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
				...
				parser.plugin("call require.config", {
					path: parserHelpersLocation,
					fnName: "toConstantDependency",
				}, { code: "undefined" });

				parser.plugin("call requirejs.config", {
					path: parserHelpersLocation,
					fnName: "toConstantDependency",
				}, { code: "undefined" });
				...
				parser.plugin("expression require.version", {
					path: parserHelpersLocation,
					fnName: "toConstantDependency"
				}, { code: JSON.stringify("0.0.0") });

				parser.plugin("expression requirejs.onError", {
					path: parserHelpersLocation,
					fnName: "toConstantDependency",
				}, { code: "__webpack_require__.oe" });
			});
		});
	}
