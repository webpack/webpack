...
/** @typedef {import("../declarations/WebpackOptions.js").CleanOptions} CleanOptions */
...
/** @typedef {import("./util/fs.js").StatsCallback} StatsCallback */
		...
		compiler.hooks.emit.tapAsync(
			...
			(compilation, callback) => {
				...
				for (const asset of Object.keys(compilation.assets)) {
					...
					/** @type {string} */
					let normalizedAsset;
					let newNormalizedAsset = asset.replaceAll("\\", "/");
					do {
						normalizedAsset = newNormalizedAsset;
						newNormalizedAsset = normalizedAsset.replaceAll(
							/(^|\/)(?!\.\.)[^/]+\/\.\.\//g,
							"$1"
						);
...
export { getDirectories as _getDirectories };

// attach named exports as properties to keep the CJS shape
CleanPlugin._getDirectories = getDirectories;

export { CleanPlugin as "module.exports" };
