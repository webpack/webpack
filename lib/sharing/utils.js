...
const getDescriptionFile = (
	...
	const satisfiesDescriptionFileDataInternal = satisfiesDescriptionFileData;
	...
	const tryLoadCurrent = () => {
		...
		readJson(fs, filePath, (err, data) => {
			...
			if (
				typeof satisfiesDescriptionFileDataInternal === "function" &&
				!satisfiesDescriptionFileDataInternal({ data, path: filePath })
			) {
				i++;
