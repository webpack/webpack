			...
			*/
			...
			`var findVersion = ${runtimeTemplate.basicFunction(
				...
				[
					...
					// If we couldn't find the library above, try retrieving *any* version we might have to help debugging
					// TODO: try finding the closest version by iterating through
					"var msg;",
					`if (lastVersion === undefined) { if (${RuntimeGlobals.hasOwnProperty}(scope, key)) {lastVersion = scope[key].version} else {lastVersion=[]}}`,
