		...
		return Template.asString([
			...
			`var checkSingletonVersion = ${runtimeTemplate.basicFunction(
				...
				[
					...
					'var requiredRange = ">="+requiredVersion.join(".")+" <" + requiredVersion.reduce((acc, val) => {acc[0].push(acc[1] ? 0 : +val + (typeof val !== "string")); return [acc[0], acc[1] || (typeof val !== "string")]}, [[], false])[0].join(".")',
					'var msg = "Unsatisfied version of shared singleton module " + key + "@" + (version && version.join(".")) + " (required " + key + "@" + requiredRange + ")";',
