...
/**
 * Runtime module that resolves consumed shared modules from Module Federation
 * share scopes and installs the resulting factories into the local runtime.
 */
class ConsumeSharedRuntimeModule extends RuntimeModule {
	/**
	 * Stores the runtime requirements that determine whether consume-shared
	 * handlers need to be emitted for chunk loading.
	...
	/**
	 * Generates the share-scope resolution helpers, version-selection logic, and
	 * chunk handlers used to provide consumed shared modules at runtime.
	...
	generate() {
		...
		/**
		 * Records consume-shared modules for a chunk and captures the generated
		 * runtime factory source that will load each module from a share scope.
