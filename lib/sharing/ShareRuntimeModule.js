			...
			`${RuntimeGlobals.initializeSharing} = ${runtimeTemplate.basicFunction(
				...
				[
					...
					`var register = ${runtimeTemplate.basicFunction(
						"moduleName, version, factory, eager",
						[
							// using eval due that CompatibilityPlugin is renaming the variable dynamically
							`var versions = scope[moduleName] = eval('${RuntimeGlobals.shareScopeMap}') ? (eval('${RuntimeGlobals.shareScopeMap}')[name][moduleName] || scope[moduleName] || {}) : scope[moduleName] || {}`,
