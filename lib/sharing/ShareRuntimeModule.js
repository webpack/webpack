		...
		return Template.asString([
			...
			`${RuntimeGlobals.initializeSharing} = ${runtimeTemplate.basicFunction(
				...
				[
					...
					"// using eval due that CompatibilityPlugin is renaming the variable dynamically and get parent shared modules",
					`if(eval('${RuntimeGlobals.shareScopeMap}') && eval('${RuntimeGlobals.shareScopeMap}')[name]) ${RuntimeGlobals.shareScopeMap}[name] = eval('${RuntimeGlobals.shareScopeMap}')[name]`,
