			...
			`${RuntimeGlobals.initializeSharing} = ${runtimeTemplate.basicFunction(
				...
				[
					...
					`var register = ${runtimeTemplate.basicFunction(
						"name, version, factory, eager=false",
						[
							"var versions = scope[name] = scope[name] || {};",
							"var activeVersion = versions[version];",
							"if(!activeVersion || (!activeVersion.loaded && !activeVersion.eager && (uniqueName > activeVersion.from || eager))) versions[version] = { get: factory, from: uniqueName, eager: eager };"
						]
					)};`,
