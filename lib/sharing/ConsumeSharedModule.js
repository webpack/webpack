 ...
 * @property {(Array.<string|RegExp> | Function | string | RegExp)=} exclude Exclusion criteria from sharing based on context
 ...
 * @property {(Array.<string|RegExp> | string | RegExp)=} prefer Container names to match when preferentially loading modules
