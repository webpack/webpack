...
const { satisfy, parseRange } = require("../util/semver");
 ...
 * @property {import("../../declarations/plugins/sharing/ConsumeSharedPlugin").SharedExclusionCriteria} exclusionCriteria
			...
			(compilation, { normalModuleFactory }) => {
				...
				const provideSharedModule = (
					...
					if (
						...
						config.exclusionCriteria.version &&
						satisfy(parseRange(config.exclusionCriteria.version), version)
					) {
						return;
					}
