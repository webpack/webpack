...
import { parseRange } from "../util/semver.js";
import ConsumeSharedFallbackDependency from "./ConsumeSharedFallbackDependency.js";
import ConsumeSharedModule from "./ConsumeSharedModule.js";
import ConsumeSharedRuntimeModule from "./ConsumeSharedRuntimeModule.js";
import ProvideForSharedDependency from "./ProvideForSharedDependency.js";
import { resolveMatchedConfigs } from "./resolveMatchedConfigs.js";
import {
	getDescriptionFile,
...
/** @typedef {import("../../declarations/plugins/sharing/ConsumeSharedPlugin.js").ConsumeSharedPluginOptions} ConsumeSharedPluginOptions */
/** @typedef {import("../Compiler.js").default} Compiler */
/** @typedef {import("../Compilation.js").FileSystemDependencies} FileSystemDependencies */
/** @typedef {import("../ResolverFactory.js").ResolveOptionsWithDependencyType} ResolveOptionsWithDependencyType */
/** @typedef {import("../util/semver.js").SemVerRange} SemVerRange */
/** @typedef {import("./ConsumeSharedModule.js").ConsumeOptions} ConsumeOptions */
/** @typedef {import("./utils.js").DescriptionFile} DescriptionFile */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/sharing/ConsumeSharedPlugin.check.js")} */ (
...
export { ConsumeSharedPlugin as "module.exports" };
