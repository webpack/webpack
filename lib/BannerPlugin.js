 ...
 * @typedef {Object|string|Function} BannerOptions
 * @property {string|Function} banner The banner as string, it will be wrapped in a comment
...
class BannerPlugin {
	/**
	 *
	 * @param {BannerOptions} options The BannerPlugin options object
	 */
	constructor(options) {
