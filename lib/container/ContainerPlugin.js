...
import ContainerEntryModuleFactory from "./ContainerEntryModuleFactory.js";
import ContainerExposedDependency from "./ContainerExposedDependency.js";
import { parseOptions } from "./options.js";

const require = createRequire(import.meta.url);
/** @typedef {import("../../declarations/plugins/container/ContainerPlugin.js").ContainerPluginOptions} ContainerPluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/container/ContainerPlugin.check.js")} */ (
...
export { ContainerPlugin as "module.exports" };
