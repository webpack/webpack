...
/**
 * Runtime module that coordinates loading exposed modules from remote
 * containers in Module Federation builds.
 */
class RemoteRuntimeModule extends RuntimeModule {
	/**
	 * Initializes the runtime handler that resolves remote container modules for
	 * chunks referencing `remote` source-type modules.
	 */
	constructor() {
	...
	/**
	 * Generates the mapping tables and ensure-chunk handler that initialize share
	 * scopes, request remote containers, obtain exposed factories, and install
	 * them into the local module factory table.
