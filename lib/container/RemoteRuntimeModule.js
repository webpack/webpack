...
class RemoteRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		return Template.asString([
			...
			// Expose the mapping on the federation namespace so that
			// InvalidateFederatedModuleRuntimeModule can reset data.p.
			`if(${RuntimeGlobals.federation}) ${RuntimeGlobals.federation}._remoteMapping = idToExternalAndNameMapping;`,
			`${
