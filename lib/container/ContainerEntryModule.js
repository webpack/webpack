...
import ContainerExposedDependency from "./ContainerExposedDependency.js";
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, ExposesList, string]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, ExposesList, string]>} ObjectSerializerContext */
...
export { ContainerEntryModule as "module.exports" };
