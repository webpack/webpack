...
import { forEachRuntime } from "../util/runtime.js";
...
const getModuleFederationPlugin = memoize(
	() =>
		/** @type {typeof import("./ModuleFederationPlugin.js").default} */ (
			require("./ModuleFederationPlugin.js")
		)
);
...
export { HoistContainerReferences as "module.exports" };
