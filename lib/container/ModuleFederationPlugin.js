 ...
 * @property {SyncHook<import("../Dependency")>} addContainerEntryDependency
 * @property {SyncHook<import("../Dependency")>} addFederationRuntimeDependency
 * @property {SyncBailHook<[import("../javascript/StartupHelpers").StartupChunkDependencyParams], boolean>} generateFederationStartup
 * @property {SyncBailHook<[string | import("webpack-sources").Source, import("../Chunk")], import("webpack-sources").Source | string | null>} wrapFederationSource
 * @property {SyncHook<[Set<string>, import("../Module"), import("../Chunk"), import("../ExportsInfo").ExportInfo], boolean>} libraryExport
 */
...
/** @type {WeakMap<import("../Compilation"), CompilationHooks>} */
const compilationHooksMap = new WeakMap();

class ModuleFederationPlugin {
	/**
	 * @param {import("../../declarations/plugins/container/ModuleFederationPlugin").ModuleFederationPluginOptions} options options
	 */
	constructor(options) {
		validate(options);
	...
	static getCompilationHooks(compilation) {
		...
		if (!hooks) {
			hooks = {
				...
				generateFederationStartup: new SyncBailHook(["params"]),
				wrapFederationSource: new SyncBailHook(["source", "chunk"]),
				libraryExport: new SyncBailHook([
					"exportString",
					"module",
					"chunk",
					"exportInfo"
