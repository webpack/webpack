...
import FallbackModuleFactory from "./FallbackModuleFactory.js";
import RemoteModule from "./RemoteModule.js";
import RemoteRuntimeModule from "./RemoteRuntimeModule.js";
import RemoteToExternalDependency from "./RemoteToExternalDependency.js";
import { parseOptions } from "./options.js";

const require = createRequire(import.meta.url);
/** @typedef {import("../../declarations/plugins/container/ContainerReferencePlugin.js").ContainerReferencePluginOptions} ContainerReferencePluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/container/ContainerReferencePlugin.check.js")} */ (
...
export { ContainerReferencePlugin as "module.exports" };
