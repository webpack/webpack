...
import { TRANSITIVE_ONLY } from "./ModuleGraphConnection.js";
import { DEFAULTS } from "./config/defaults.js";
import { first } from "./util/SetHelpers.js";
...
import findGraphRoots from "./util/findGraphRoots.js";
import {
	RuntimeSpecMap,
	RuntimeSpecSet,
	forEachRuntime,
...
/** @typedef {import("./Chunk.js").Chunks} Chunks */
/** @typedef {import("./Chunk.js").Entrypoints} Entrypoints */
...
Caller might not support runtime-dependent code generation (opt-out via optimization.usedExports: "global").`
	...
	_getModuleGraphHashWithConnections(cgm, module, runtime) {
		...
		const activeStateToString = (state) => {
			...
			if (state === TRANSITIVE_ONLY) return "O";
...
export default ChunkGraph;

export { ChunkGraph as "module.exports" };
