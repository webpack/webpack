 ...
 * @property {boolean=} css true, when the asset was rendered by webpack's native CSS pipeline
 * @property {boolean=} html true, when the asset was rendered by webpack's native HTML pipeline
