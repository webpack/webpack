...
const { CACHE_TYPES, MultiItemCache } = require("./CacheFacade");
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		this._modulesCache = this.getCache(CACHE_TYPES.MODULES);
		this._assetsCache = this.getCache(CACHE_TYPES.ASSETS);
		this._codeGenerationCache = this.getCache(CACHE_TYPES.CODE_GENERATION);
