...
/** @typedef {any} ExecuteModuleExports */
...
/** @typedef {object} DependencyReportCacheToken */
...
/** @typedef {{ chunk: Chunk, load: () => Promise<any>, create: (loaded: any) => RuntimeModule, chunkGraph: ChunkGraph }} PendingRuntimeModule */
...
Or do you want to use the entrypoints '${name}' and '${runtime}' independently on the same page with a shared runtime? In this case give them both the same value for the 'runtime' option. It must be a name not already used by an entrypoint.`);
	 ...
	 * @param {() => Promise<any>} load resolves the runtime module implementation
	 * @param {(loaded: any) => RuntimeModule} create builds the runtime module from it
				...
				asyncLib.each(
					...
					(fileManifest, callback) => {
						...
						assetCacheItem.get((err, sourceFromCache) => {
							/** @type {string | import("./TemplatedPathPlugin").TemplatePathFn<any>} */
