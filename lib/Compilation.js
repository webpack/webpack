...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		/** @type {{ chunkGraph: ChunkGraph, chunks: Chunks, chunkGroups: ChunkGroup[], entrypoints: Map<string, Entrypoint>, asyncEntrypoints: Entrypoint[], namedChunks: Map<string, Chunk>, namedChunkGroups: Map<string, ChunkGroup> } | undefined} */
