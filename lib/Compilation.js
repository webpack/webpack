...
/**
 * @typedef {Object} PreparedEntrypoint
...
class Compilation {
	...
	constructor(compiler) {
		...
		this.entries = [];
		/** @type {Set<PreparedEntrypoint>} */
		this.preparedEntrypoints = new Set();
	...
	addEntry(context, entry, name, callback) {
		...
		this.preparedEntrypoints.add(slot);
		this._addModuleChain(
			...
			(err, module) => {
				...
				if (module) {
					...
					this.preparedEntrypoints.delete(slot);
				}
				return callback(null, module);
			}
		);
	...
	seal(callback) {
		...
		for (const preparedEntrypoint of this.preparedEntrypoints) {
