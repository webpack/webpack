...
import { MultiItemCache } from "./CacheFacade.js";
import Chunk from "./Chunk.js";
import ChunkGraph from "./ChunkGraph.js";
import ChunkGroup from "./ChunkGroup.js";
import CodeGenerationResults from "./CodeGenerationResults.js";
import Dependency from "./Dependency.js";
import DependencyTemplates from "./DependencyTemplates.js";
import Entrypoint from "./Entrypoint.js";
import * as ErrorHelpers from "./ErrorHelpers.js";
import FileSystemInfo from "./FileSystemInfo.js";
import LazyBarrelController from "./LazyBarrel.js";
import ModuleGraph from "./ModuleGraph.js";
import ModuleProfile from "./ModuleProfile.js";
import { WEBPACK_MODULE_TYPE_RUNTIME } from "./ModuleTypeConstants.js";
import * as RuntimeGlobals from "./RuntimeGlobals.js";
import RuntimeTemplate from "./RuntimeTemplate.js";
import Stats from "./Stats.js";
import buildChunkGraph from "./buildChunkGraph.js";
import BuildCycleError from "./errors/BuildCycleError.js";
import ChunkRenderError from "./errors/ChunkRenderError.js";
import CodeGenerationError from "./errors/CodeGenerationError.js";
import {
	makeWebpackError,
	tryRunOrWebpackError
} from "./errors/HookWebpackError.js";
import ModuleDependencyError from "./errors/ModuleDependencyError.js";
import ModuleDependencyWarning from "./errors/ModuleDependencyWarning.js";
import ModuleHashingError from "./errors/ModuleHashingError.js";
import ModuleNotFoundError from "./errors/ModuleNotFoundError.js";
import ModuleRestoreError from "./errors/ModuleRestoreError.js";
import ModuleStoreError from "./errors/ModuleStoreError.js";
import WebpackError from "./errors/WebpackError.js";
import { LogType, Logger } from "./logging/Logger.js";
import StatsFactory from "./stats/StatsFactory.js";
import StatsPrinter from "./stats/StatsPrinter.js";
import { equals as arrayEquals } from "./util/ArrayHelpers.js";
import AsyncQueue from "./util/AsyncQueue.js";
import LazySet from "./util/LazySet.js";
import { getOrInsert } from "./util/MapHelpers.js";
import WeakTupleMap from "./util/WeakTupleMap.js";
...
import {
	...
	concatComparators
} from "./util/comparators.js";
import createHash from "./util/createHash.js";
import {
	arrayToSetDeprecation,
	createFakeHook,
	soonFrozenObjectDeprecation
} from "./util/deprecation.js";
import processAsyncTree from "./util/processAsyncTree.js";
import { getRuntimeKey } from "./util/runtime.js";
import { isSourceEqual } from "./util/source.js";
import { CachedSource } from "./util/webpack-sources.js";

const require = createRequire(import.meta.url);

/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("../declarations/WebpackOptions.js").OutputNormalized} OutputOptions */
/** @typedef {import("../declarations/WebpackOptions.js").HashFunction} HashFunction */
/** @typedef {import("../declarations/WebpackOptions.js").HashDigest} HashDigest */
/** @typedef {import("../declarations/WebpackOptions.js").HashDigestLength} HashDigestLength */
/** @typedef {import("../declarations/WebpackOptions.js").StatsOptions} StatsOptions */
/** @typedef {import("../declarations/WebpackOptions.js").Plugins} Plugins */
/** @typedef {import("./config/defaults.js").WebpackOptionsNormalizedWithDefaults} WebpackOptions */
/** @typedef {import("./config/defaults.js").OutputNormalizedWithDefaults} OutputOptionsWithDefaults */
/** @typedef {import("./AsyncDependenciesBlock.js").default} AsyncDependenciesBlock */
/** @typedef {import("./Cache.js").default} Cache */
/** @typedef {import("./CacheFacade.js").default} CacheFacade */
...
/** @typedef {import("./Compiler.js").MemCache} MemCache */
/** @typedef {import("./Compiler.js").WeakReferences} WeakReferences */
/** @typedef {import("./Compiler.js").ModuleMemCachesItem} ModuleMemCachesItem */
/** @typedef {import("./Compiler.js").Records} Records */
...
/** @typedef {import("./ModuleFactory.js").ModuleFactoryCreateDataContextInfo} ModuleFactoryCreateDataContextInfo */
/** @typedef {import("./ModuleFactory.js").ModuleFactoryResult} ModuleFactoryResult */
/** @typedef {import("./NormalModule.js").default} NormalModule */
/** @typedef {import("./NormalModule.js").AnyLoaderContext} AnyLoaderContext */
/** @typedef {import("./NormalModule.js").ParserOptions} ParserOptions */
/** @typedef {import("./NormalModule.js").GeneratorOptions} GeneratorOptions */
/** @typedef {import("./RequestShortener.js").default} RequestShortener */
/** @typedef {import("./RuntimeModule.js").default} RuntimeModule */
 ...
 * Defines the shared type used by this module.
 * @template T
 * @typedef {import("./util/deprecation.js").FakeHook<T>} FakeHook<T>
 */
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
			...
			additionalAssets:
				...
				(
					createProcessAssetsHook(
						...
						() => [],
						"DEP_WEBPACK_COMPILATION_ADDITIONAL_ASSETS"
					)
				),
			/** @deprecated */
			optimizeAssets:
				/** @type {FakeHook<Pick<AsyncSeriesHook<[CompilationAssets]>, "tap" | "tapAsync" | "tapPromise" | "name">>} */
				(
					createProcessAssetsHook(
						"optimizeAssets",
						Compilation.PROCESS_ASSETS_STAGE_OPTIMIZE,
						() => [this.assets],
						"DEP_WEBPACK_COMPILATION_OPTIMIZE_ASSETS"
					)
				),
			/** @deprecated */
			afterOptimizeAssets: this._backCompat
				? createFakeHook(
						{
							name: "afterOptimizeAssets",
							/** @type {SyncHook<[CompilationAssets]>["tap"]} */
							tap: (options, fn) => {
								afterProcessAssetsHook.tap(options, fn);
							}
						},
						"afterOptimizeAssets is deprecated (use Compilation.hooks.afterProcessAssets instead)",
						"DEP_WEBPACK_COMPILATION_AFTER_OPTIMIZE_ASSETS"
					)
				: undefined,
	...
	finish(callback) {
		...
		if (this.profile) {
			...
			const ParallelismFactorCalculator =
				/** @type {typeof import("./util/ParallelismFactorCalculator.js").default} */ (
					require("./util/ParallelismFactorCalculator.js")
				);
...
This prevents using hashes of each other and should be avoided.`);
	...
	getAssets() {
		...
		for (const assetName of Object.keys(this.assets)) {
			if (Object.hasOwn(this.assets, assetName)) {
				array.push({
					name: assetName,
	 ...
	 */
	getAsset(name) {
		if (!Object.hasOwn(this.assets, name)) return;
		return {
			name,
				...
				asyncLib.each(
					...
					(fileManifest, callback) => {
						...
						assetCacheItem.get((err, sourceFromCache) => {
							/** @type {string | import("./TemplatedPathPlugin.js").TemplatePathFn<EXPECTED_ANY>} */
	 ...
	 * @param {string | import("./TemplatedPathPlugin.js").TemplatePathFn<T>} filename used to get asset path with hash
...
export { Compilation as "module.exports" };
