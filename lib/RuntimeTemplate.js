...
class RuntimeTemplate {
	...
	_foldAnalyzableNames(chunk, hash) {
		...
		if (folded === undefined) {
			...
			// Exactly the chunks a stand-in here names, read back off what was generated.
			// Walking the graph instead would fold in whatever this chunk's *group*
			// reaches, moving the name of a split chunk that references nothing.
