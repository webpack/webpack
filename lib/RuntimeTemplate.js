...
class RuntimeTemplate {
	...
	_getAnalyzableChunkSpecifier(
		...
		// A content-named consumer bakes without repair when this chunk settles first:
		// the fold puts the name into its hash. Only what `_foldsWholeName` covers,
		// though, and a pair that reaches back has no fold order — the rest is repaired.
