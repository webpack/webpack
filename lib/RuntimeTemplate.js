...
import { forEachRuntime, subtractRuntime } from "./util/runtime.js";

const require = createRequire(import.meta.url);
const getHarmonyImportDependency = memoize(
	() =>
		/** @type {typeof import("./dependencies/HarmonyImportDependency.js").default} */ (
			require("./dependencies/HarmonyImportDependency.js")
		)
);
...
/** @typedef {import("./NormalModuleFactory.js").ModuleDependency} ModuleDependency */
...
export { RuntimeTemplate as "module.exports" };
