...
class RuntimeTemplate {
	...
	/**
	 * @returns {boolean} true, when the output is a real ESM module and references can be emitted in a statically analyzable form (e.g. `new URL(…, import.meta.url)`)
	 */
	supportsAnalyzableEsm() {
		return this.isModule() && this.supportsEcmaScriptModuleSyntax();
	}
