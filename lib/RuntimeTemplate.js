...
class RuntimeTemplate {
	...
	supportsAnalyzable(form, chunkGraph, module, runtime) {
		...
		// Opting out is the configuration's answer, not a module's, so it records no
		// bailout — every dynamic import of the build would report the same one.
		if (form === "import" && !outputOptions.analyzableChunkImport) return false;
