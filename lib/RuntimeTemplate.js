...
const getHarmonyImportDependency = lazyModule.sync(() =>
	require("./dependencies/HarmonyImportDependency")
);
const getImportDependency = lazyModule.sync(() =>
	require("./dependencies/ImportDependency")
);
const getJavascriptModulesPlugin = lazyModule.sync(() =>
	require("./javascript/JavascriptModulesPlugin")
);
const getModuleHotAcceptDependency = lazyModule.sync(() =>
	require("./dependencies/ModuleHotAcceptDependency")
);
const getAPIPlugin = lazyModule.sync(() => require("./APIPlugin"));
