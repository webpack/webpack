...
class RuntimeTemplate {
	...
	generatePublicPath(filename) {
		const publicPath = `typeof ${RuntimeGlobals.publicPath} === "function" ? ${RuntimeGlobals.publicPath}("${filename}") : (${this.concatenation({ expr: RuntimeGlobals.publicPath }, filename)})`;
		return publicPath;
	}
