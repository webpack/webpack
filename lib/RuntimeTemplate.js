...
// What the deferred pass scans for — the other half of what the methods above spell.
RuntimeTemplate.ANALYZABLE_TOKEN_REGEXP =
	/\.\/@@webpackAnalyzableChunk:([\w-]+)@@/g;
...
RuntimeTemplate.FULL_HASH_TOKEN_REGEXP = /@@webpackFullHash(?:-(\d+))?@@/g;
