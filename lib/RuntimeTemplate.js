...
class RuntimeTemplate {
	...
	/**
	 * @returns {boolean | undefined} `process.getBuiltinModule()` is available to load core modules synchronously
	 */
	supportsNodeBuiltinModuleGetter() {
		return this.outputOptions.environment.nodeBuiltinModuleGetter;
	}
