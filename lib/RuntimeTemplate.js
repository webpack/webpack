...
class RuntimeTemplate {
	...
	concatenation(...args) {
		...
		// Cost comparison: a template literal spends 3 chars per expression, an es5
		// concatenation 3 + n for n expressions in a row, less 3 where it starts or
		// ends on one. Which wins depends on how the literal parts interleave.
