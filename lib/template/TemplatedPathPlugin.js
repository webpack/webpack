...
const PathVariableError = require("../errors/PathVariableError");
...
const toTemplateSourceFileName = (sourceFilename, compilation) =>
	// TODO in the next major release: remove the check, always contain
...
const replacer = (value, allowEmpty) => {
	...
	const fn = (match, arg, input) => {
		...
		if (value === null || value === undefined) {
			if (!allowEmpty) {
				throw new PathVariableError(match, input);
			}
