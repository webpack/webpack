...
makeSerializable(InitFragment, "webpack/lib/template/InitFragment");

// TODO in the next major release: remove
// Restores caches written before this moved into lib/template/
registerLegacyRequest(InitFragment, "webpack/lib/InitFragment");
