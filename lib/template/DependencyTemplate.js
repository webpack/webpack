...
/** @import Module, { CodeGenerationResultData, RuntimeRequirements } from "../module/Module" */
 ...
 * @property {Map<string, string>=} importBindings what each imported binding of the current module reads, by its name in the source, for the source map `scopes` field
 */
