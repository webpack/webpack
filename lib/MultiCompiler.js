...
import ConcurrentCompilationError from "./errors/ConcurrentCompilationError.js";
...
/** @typedef {import("../declarations/WebpackOptions.js").WatchOptions} WatchOptions */
/** @typedef {import("./Compiler.js").default} Compiler */
/**
 * Defines the callback type used by this module.
 * @template T
 * @template [R=void]
 * @typedef {import("./webpack.js").Callback<T, R>} Callback
 */
...
/** @typedef {import("./util/fs.js").WatchFileSystem} WatchFileSystem */
...
export default class MultiCompiler {
	/**
...
export { MultiCompiler as "module.exports" };
