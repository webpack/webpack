 ...
 * @typedef {(value: EXPECTED_OBJECT | EXPECTED_OBJECT[], schema: Schema, options?: ValidationErrorConfiguration, check?: ((value: EXPECTED_ANY) => boolean)) => void} SchemaValidationFunction
 */
...
module.exports = class MultiCompiler {
	...
	constructor(compilers, options) {
		...
		this.hooks = Object.freeze({
			...
			/** @type {MultiHook<AsyncSeriesHook<[SchemaValidationFunction]>>} */
			validate: new MultiHook(compilers.map((c) => c.hooks.validate))
		});
