...
import { getExternalModuleNodeCommonjsInitFragment } from "./ExternalModule.js";
import {
...
import ModuleInitFragmentDependency from "./dependencies/ModuleInitFragmentDependency.js";
...
import ChunkNameRuntimeModule from "./runtime/ChunkNameRuntimeModule.js";
import GetFullHashRuntimeModule from "./runtime/GetFullHashRuntimeModule.js";
...
function getReplacements() {
	return {
		...
		__webpack_nonce__: {
			expr: RuntimeGlobals.nonce,
			req: [RuntimeGlobals.nonce],
			type: "string",
			assign: true
		},
		__webpack_hash__: {
...
export { APIPlugin as "module.exports" };
