 ...
 * @property {import("../declarations/WebpackOptions").Target=} target the target environments
 */
							...
							if (key === "__non_webpack_require__" && this.options.module) {
								...
								if (
									...
									(Array.isArray(this.options.target) &&
										this.options.target.includes("web"))
								) {
									const warning = new WebpackError(
										`${PLUGIN_NAME}\nrequire is not allowed in ESM mode with the web target`
									);
