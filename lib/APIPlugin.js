...
/**
 * Make __webpack_public_path__, __webpack_require__, __webpack_modules__, __webpack_chunk_load__ accessible.
 * Ensures that require.valueOf and require.onError are not processed by other plugins.
 */
class APIPlugin {
	/**
	 * Apply the plugin
