...
/** @typedef {Record<"importVarMap" | "deferredImportVarMap", Map<Module, string>> & Record<CommonJsExportRequireDependencyIDsSymbol | HarmonyImportSpecifierDependencyIDsSymbol | HarmonyExportImportedSpecifierDependencyIDsSymbol, string[]>} KnownMeta */

/** @typedef {KnownMeta & Record<string, EXPECTED_ANY>} Meta */
