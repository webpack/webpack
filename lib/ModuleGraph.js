...
class ModuleGraph {
	constructor() {
		this.CommonJsSelfReferenceDependency = require("./dependencies/CommonJsSelfReferenceDependency")
	...
	isDeferred(module) {
		...
		for (const connection of connections) {
			if (
				...
				connection.dependency instanceof this.CommonJsSelfReferenceDependency
			) {
				continue;
			}
