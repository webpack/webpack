...
/** @import { ModuleMemCaches } from "./Compilation" */
/** @import DependenciesBlock from "./DependenciesBlock" */
/** @import Dependency, { ExportInfoName } from "./Dependency" */
...
/** @import HarmonyImportSideEffectDependency from "./dependencies/HarmonyImportSideEffectDependency" */
/**
 * @import HarmonyImportSpecifierDependency, {
 * 	idsSymbol as HarmonyImportSpecifierDependencyIDsSymbol
 * } from "./dependencies/HarmonyImportSpecifierDependency"
 */
/** @import { DependencySourceOrder } from "./util/comparators" */
...
/**
 * @import {
 * 	idsSymbol as CommonJsExportRequireDependencyIDsSymbol
 * } from "./dependencies/CommonJsExportRequireDependency"
 */
/**
 * @import {
 * 	idsSymbol as HarmonyExportImportedSpecifierDependencyIDsSymbol
 ...
 * @property {boolean=} onDemandExports generate export definitions on demand
 */
...
class ModuleGraph {
	...
	updateParent(dependency, connection, parentModule) {
		...
		// Specifiers of one import statement share its source order, so `a` and `b`
		// of `import { a, b } from "lib"` both take the statement's index.
		...
		if (
			...
			// A re-exported specifier keeps the importing statement's order as `main`
			// and its own position as `sub`, so the pair orders it within that
			// statement without disturbing the statements around it.
	 ...
	 * @returns {InstanceType<ExportInfo>} info about the export
	 */
	 ...
	 * @param {Module} module the module
	 * @param {string} exportName the export
	 * @returns {InstanceType<ExportInfo>} info about the export (do not modify)
	 */
...
ModuleGraph.ModuleGraphConnection = ModuleGraphConnection;
