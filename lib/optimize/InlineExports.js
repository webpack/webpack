 ...
 * @param {import("../javascript/BasicEvaluatedExpression.js").default} evaluated evaluated expression
...
const isInlineEnabled = (module) =>
	Boolean(
		module.buildInfo &&
		/** @type {import("../Module.js").BuildInfo} */
...
export { InlinedUsedName };
export { InlinedValue };
export { MAX_INLINE_BYTES };
export { enableInlineExports };
export { isExportInlined };
export { isInlineEnabled };
export { isInlineExportsEnabled };
export { toInlinedValue };
