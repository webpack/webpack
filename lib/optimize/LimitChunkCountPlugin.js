...
import LazyBucketSortedSet from "../util/LazyBucketSortedSet.js";
import { compareChunks } from "../util/comparators.js";

const require = createRequire(import.meta.url);
/** @typedef {import("../../declarations/plugins/optimize/LimitChunkCountPlugin.js").LimitChunkCountPluginOptions} LimitChunkCountPluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/optimize/LimitChunkCountPlugin.check.js")} */ (
...
export default LimitChunkCountPlugin;

export { LimitChunkCountPlugin as "module.exports" };
