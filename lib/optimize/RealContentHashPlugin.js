	...
	apply(compiler) {
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.processAssets.tapPromise(
				...
				async () => {
					// Set by the deferred fill where a baked name landed in a chunk whose
					// hashed name would otherwise go stale. `[chunkhash]` is repaired only
					// then; elsewhere it keeps naming the modules, as documented.
