		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			compilation.hooks.optimizeChunks.tap(
				...
				(chunks) => {
					...
					// One pair is merged per pass and the hook re-runs, so the maximum is
					// tracked directly rather than sorting every pair each time. A strict
					// `>` keeps the first best found, as a stable descending sort would.
