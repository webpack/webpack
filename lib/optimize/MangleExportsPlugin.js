...
import { assignDeterministicIds } from "../ids/IdHelpers.js";
import { compareSelect, compareStringsNumeric } from "../util/comparators.js";

const { numberToIdentifier } = Template;
...
export default MangleExportsPlugin;

export { MangleExportsPlugin as "module.exports" };
