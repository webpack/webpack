...
import Referencer from "eslint-scope/lib/referencer.js";
...
import { JAVASCRIPT_MODULE_TYPE_ESM } from "../ModuleTypeConstants.js";
import * as RuntimeGlobals from "../RuntimeGlobals.js";
import Template from "../Template.js";
import { DEFAULTS } from "../config/defaults.js";
import { ImportPhaseUtils } from "../dependencies/ImportPhase.js";
...
import { concatComparators } from "../util/comparators.js";
import {
	RESERVED_NAMES,
	addScopeSymbols,
	findNewName,
...
import { propertyAccess, propertyName } from "../util/property.js";
import {
	filterRuntime,
	intersectRuntime,
...
import { InlinedUsedName } from "./InlineExports.js";
...
/** @typedef {import("../dependencies/ModuleDependency.js").default} ModuleDependency */
/** @typedef {import("../dependencies/HarmonyImportDependency.js").default} HarmonyImportDependency */
/** @typedef {import("../DependencyTemplates.js").default} DependencyTemplates */
/** @typedef {import("../ExportsInfo.js").ExportInfo} ExportInfo */
/** @typedef {import("../Module.js").BuildCallback} BuildCallback */
/** @typedef {import("../Module.js").BuildInfo} BuildInfo */
/** @typedef {import("../Module.js").FileSystemDependencies} FileSystemDependencies */
/** @typedef {import("../Module.js").BuildMeta} BuildMeta */
/** @typedef {import("../Module.js").ExportsType} ExportsType */
...
/** @typedef {import("../javascript/JavascriptModulesPlugin.js").Scope} Scope */
/** @typedef {import("../javascript/JavascriptModulesPlugin.js").Reference} Reference */
/** @typedef {import("../javascript/JavascriptModulesPlugin.js").Variable} Variable */
/** @typedef {import("../javascript/JavascriptParser.js").Program} Program */
...
/** @typedef {import("../util/concatenate.js").UsedNames} UsedNames */
/** @typedef {import("../util/concatenate.js").UsedNamesInScopeInfo} UsedNamesInScopeInfo */
...
/**
 * @template T
 * @typedef {import("../util/comparators.js").Comparator<T>} Comparator
 */
			...
			const references = connections
				.filter((connection) => {
					if (
						...
						!connection.dependency.canConcatenate()
					) {
						return false;
					}
...
export { ConcatenatedModule as "module.exports" };
