...
class ConcatenatedModule extends Module {
	...
	codeGeneration({
		...
		for (const info of neededNamespaceObjects) {
			...
			const namespaceWithoutEsModule = /** @type {BuildMeta} */ (
				info.module.buildMeta
			).namespaceWithoutEsModule;
			namespaceObjectSources.set(
				info,
				`
// NAMESPACE OBJECT: ${info.module.readableIdentifier(requestShortener)}
var ${name} = {};
${RuntimeGlobals.makeNamespaceObject}(${name}${namespaceWithoutEsModule ? ", true" : ""});
${defineGetters}`
			);
