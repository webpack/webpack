...
/** @typedef {boolean | "partial-deferred"} DeferredState */
 ...
 * @property {DeferredState} deferred the module is deferred at least once
 ...
 * @property {RuntimeSpec | boolean} runtimeCondition
 * @property {DeferredState} deferred
...
class ConcatenatedModule extends Module {
	...
	_createConcatenationList(rootModule, modulesSet, runtime, moduleGraph) {
		...
		const list = [];
		/** @type {Map<Module, { runtimeCondition: RuntimeSpec | true, deferred: DeferredState }>} */
		const existingEntries = new Map();

		/**
		 * @param {Module} module a module
		 * @returns {Iterable<{ connection: ModuleGraphConnection, runtimeCondition: RuntimeSpec | true, deferred: DeferredState }>} imported modules in order
		 */
		const getConcatenatedImports = (module) => {
			...
			/** @type {Map<Module, { connection: ModuleGraphConnection, runtimeCondition: RuntimeSpec | true, deferred: DeferredState }>} */
		 ...
		 * @param {DeferredState} deferred deferred condition
		 * @returns {void}
		 */
