...
/**
 * Defines the raw binding type used by this module.
...
/**
 * Defines the symbol binding type used by this module.
...
/**
 * Defines the concatenated module info type used by this module.
...
/**
 * Defines the external module info type used by this module.
...
/**
 * Defines the reference to module info type used by this module.
...
/**
 * Defines the concatenation entry type used by this module.
...
/**
 * Defines the concatenate module hooks type used by this module.
...
class ConcatenatedModule extends Module {
	...
	/**
	 * Creates an instance of ConcatenatedModule.
	...
	_createConcatenationList(rootModule, modulesSet, runtime, moduleGraph) {
		...
		const getConcatenatedImports = (module) => {
			...
			/**
			 * Describes how this defer operation behaves.
			 * @example
		...
		/**
		 * Processes the provided connection.
	...
	/**
	 * Creates an identifier from the provided root module.
	 * @param {Module} rootModule the root module of the concatenation
	 * @param {Set<Module>} modules all modules in the concatenation (including the root module)
	 * @param {AssociatedObjectForCache=} associatedObjectForCache object for caching
	 * @param {HashFunction=} hashFunction hash function to use
	...
	/**
	 * Adds the provided file dependencies to the concatenated module.
	...
	codeGeneration({
		...
		/**
		 * Returns the new name or undefined if the name is not found.
...
${defineGetters}`
	...
	/**
	 * Processes the provided modules map.
