...
const entryCanBeWrapped = (entry) => {
	// TODO webpack 6: call it directly, every module answers by then. A module
	// built against an older webpack extends a base class without it, so fall
	// back to the type check this replaced.
