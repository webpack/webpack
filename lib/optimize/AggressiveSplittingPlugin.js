...
/** @typedef {import("../../declarations/plugins/optimize/AggressiveSplittingPlugin.js").AggressiveSplittingPluginOptions} AggressiveSplittingPluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/optimize/AggressiveSplittingPlugin.check.js")} */ (
...
export default AggressiveSplittingPlugin;

export { AggressiveSplittingPlugin as "module.exports" };
