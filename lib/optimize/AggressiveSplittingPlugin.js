...
/**
 * @schema plugins/optimize/AggressiveSplittingPlugin
 * @typedef {object} AggressiveSplittingPluginOptions
 * @property {number=} chunkOverhead Extra cost for each chunk (Default: 9.8kiB).
 * @property {number=} entryChunkMultiplicator Extra cost multiplicator for entry chunks (Default: 10).
 * @property {number=} maxSize Byte, max size of per file (Default: 50kiB).
 * @property {number=} minSize Byte, split point. (Default: 30kiB).
 */
