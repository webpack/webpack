...
import { requestToId } from "../ids/IdHelpers.js";
...
import deterministicGrouping from "../util/deterministicGrouping.js";
import { makePathsRelative } from "../util/identifier.js";
import memoize from "../util/memoize.js";
import MinMaxSizeWarning from "./MinMaxSizeWarning.js";
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationSplitChunksCacheGroup} OptimizationSplitChunksCacheGroup */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationSplitChunksOptions} OptimizationSplitChunksOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationSplitChunksSizes} OptimizationSplitChunksSizes */
...
/** @typedef {import("../util/deterministicGrouping.js").GroupedItems<Module>} DeterministicGroupingGroupedItemsForModule */
/** @typedef {import("../util/deterministicGrouping.js").Options<Module>} DeterministicGroupingOptionsForModule */
/** @typedef {import("../util/deterministicGrouping.js").Sizes} Sizes */
		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.optimizeChunks.tap(
				...
				(chunks) => {
					...
					// to allow to check less sets via isSubsetOf
...
export { SplitChunksPlugin as "module.exports" };
