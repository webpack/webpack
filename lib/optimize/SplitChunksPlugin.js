...
module.exports = class SplitChunksPlugin {
	...
	constructor(options = {}) {
		...
		this.options = {
			...
			minChunks: options.minChunks !== undefined ? options.minChunks : 1,
			maxAsyncRequests:
				options.maxAsyncRequests !== undefined ? options.maxAsyncRequests : 1,
			maxInitialRequests:
				options.maxInitialRequests !== undefined
					? options.maxInitialRequests
					: 1,
			hidePathInfo:
				options.hidePathInfo !== undefined ? options.hidePathInfo : false,
			filename: options.filename !== undefined ? options.filename : undefined,
			...
			automaticNameDelimiter:
				options.automaticNameDelimiter !== undefined
					? options.automaticNameDelimiter
					: "-",
			usedExports:
				options.usedExports !== undefined ? options.usedExports : false,
			fallbackCacheGroup: {
				chunksFilter:
					/** @type {ChunkFilterFn} */
					(
	...
	_getCacheGroup(cacheGroupSource) {
		...
		const cacheGroup = {
			...
			reuseExistingChunk:
				cacheGroupSource.reuseExistingChunk !== undefined
					? cacheGroupSource.reuseExistingChunk
					: false,
