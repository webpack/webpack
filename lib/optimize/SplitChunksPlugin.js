		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.optimizeChunks.tap(
				...
				(chunks) => {
					...
					// Only `SplitChunksCappedPlugin` reads these, and it reports through
					// `hints`, so mirror both of its gates: a build that would not
					// report records nothing and allocates nothing.
