...
import { STAGE_BASIC } from "../OptimizationStages.js";
import { runtimeEqual } from "../util/runtime.js";

const require = createRequire(import.meta.url);
/** @typedef {import("../../declarations/plugins/optimize/MergeDuplicateChunksPlugin.js").MergeDuplicateChunksPluginOptions} MergeDuplicateChunksPluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/optimize/MergeDuplicateChunksPlugin.check.js")} */ (
...
export default MergeDuplicateChunksPlugin;

export { MergeDuplicateChunksPlugin as "module.exports" };
