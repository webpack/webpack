...
/**
 * @schema plugins/optimize/MergeDuplicateChunksPlugin
 * @typedef {object} MergeDuplicateChunksPluginOptions
 * @property {number=} stage Specifies the stage for merging duplicate chunks.
 */
