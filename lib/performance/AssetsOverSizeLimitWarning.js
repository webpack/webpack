...
/** @typedef {import("./SizeLimitsPlugin.js").AssetDetails} AssetDetails */
...
export default AssetsOverSizeLimitWarning;

export { AssetsOverSizeLimitWarning as "module.exports" };
