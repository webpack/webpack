...
// Packages whose whole purpose is to emulate language features. A module of one
// of these in a build whose target has the features is weight for nobody.
const EMULATING_PACKAGES = [
	"core-js",
	"core-js-pure",
	"regenerator-runtime",
	"@babel/runtime"
...
// The features the report leans on: each is what one of those packages exists
// to supply, so a target with all of them needs none of it.
