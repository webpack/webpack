...
EmittedAssetSizeLimitPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("after-emit", function(compilation, callback) {
		...
		if(doesExceedInitialLimit(totalInitialChunkSize, actualTotalInitialSize)) {
			...
			warnings.push(
				new Error(
					"EmittedAssetSizeWarning: " +
					"The total initial download cost for these assets are likey to impact web performance. Consider keeping the total size of your initial assets < " +
