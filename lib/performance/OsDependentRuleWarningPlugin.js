...
/**
 * Which separator a pattern can match, by walking its source so an escape is
 * never mistaken for the separator that follows it (`\.` is not `\\`).
 * A pattern carrying both — `[\\/]`, or an alternation — matches everywhere.
