...
/** @typedef {import("./SizeLimitsPlugin.js").EntrypointDetails} EntrypointDetails */
...
export default EntrypointsOverSizeLimitWarning;

export { EntrypointsOverSizeLimitWarning as "module.exports" };
