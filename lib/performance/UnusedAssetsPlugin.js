...
const ESMImportBareSideEffectDependency = require("../dependencies/esm/ESMImportBareSideEffectDependency");
			...
			compilation.hooks.afterSeal.tap(PLUGIN_NAME, () => {
				...
				for (const module of compilation.modules) {
					...
					for (const connection of moduleGraph.getIncomingConnections(module)) {
						...
						if (
							!(dependency instanceof ESMImportSideEffectDependency) ||
							dependency instanceof ESMImportBareSideEffectDependency
						) {
							onlyUnread = false;
							break;
						}
