...
import AssetsOverSizeLimitWarning from "./AssetsOverSizeLimitWarning.js";
import EntrypointsOverSizeLimitWarning from "./EntrypointsOverSizeLimitWarning.js";
import NoAsyncChunksWarning from "./NoAsyncChunksWarning.js";
/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("../../declarations/WebpackOptions.js").PerformanceOptions} PerformanceOptions */
...
export default class SizeLimitsPlugin {
	/**
		...
		compiler.hooks.afterEmit.tap(PLUGIN_NAME, (compilation) => {
			...
			if (hints) {
				...
				if (warnings.length > 0) {
					const someAsyncChunk = compilation.chunks
						.values()
...
export { SizeLimitsPlugin as "module.exports" };
