	...
	apply(compiler) {
		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			compilation.hooks.afterSeal.tap(PLUGIN_NAME, () => {
				...
				// The hint is about work redone despite a warm cache, so it needs both
				// ends: something reused, and something rebuilt anyway. Everything
				// rebuilt is a cold build and nothing rebuilt is the cache working.
