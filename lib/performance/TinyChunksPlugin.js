...
class TinyChunksPlugin {
	...
	apply(compiler) {
		...
		/**
		 * Read from the option rather than fixed here, so raising the size worth
		 * splitting raises what counts as too small to be worth a request. The
		 * option is either one number or a floor per source type.
