...
// A pattern that opens with a bare wildcard takes every name in the directory,
// whether it is the one `require.context` falls back to or the one webpack
// derives from an expression — `import(`./locale/${l}.js`)` gives `^\./.*\.js$`.
