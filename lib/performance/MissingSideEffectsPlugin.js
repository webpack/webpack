...
/** @typedef {import("../errors/MissingSideEffectsWarning").MissingSideEffectsDetails} MissingSideEffectsDetails */
 ...
 * unsaid. Nearly every package omits the field, so only the ones already
 * costing bytes are worth naming.
	...
	apply(compiler) {
		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.optimizeModules.tap(PLUGIN_NAME, (modules) => {
				...
				const warning = new MissingSideEffectsWarning(
