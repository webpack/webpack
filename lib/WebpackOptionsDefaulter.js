...
class WebpackOptionsDefaulter extends OptionsDefaulter {
	constructor() {
		...
		this.set("output.hotUpdateFunction", "make", (options) => Template.toIdentifier(`webpackHotUpdate${options.output.library}`));
		this.set("output.jsonpFunction", "make", (options) => Template.toIdentifier(`webpackJsonp${options.output.library}`));
