...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.optimization.localImportBindings) {
			const LocalImportBindingsPlugin = require("./optimize/LocalImportBindingsPlugin");

			new LocalImportBindingsPlugin().apply(compiler);
		}
