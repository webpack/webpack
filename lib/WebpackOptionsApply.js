...
/**
 * @param {ResolveOptionsWithDependencyType} enhancedResolveOptions enhanced options
...
const applyByDependency = enhancedResolveOptions => {
	...
	if (
		!enhancedResolveOptions.byDependency ||
		!enhancedResolveOptions.dependencyType
	)
		return options;
