...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		let ExternalsPlugin;
		// resolve relative output path directly on options object since it's passed
		// directly into multiple plugins below
		options.output.path = require("path").resolve(process.cwd(), options.output.path);
