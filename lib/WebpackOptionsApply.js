...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.experiments.parallel && options.experiments.parallel.loader) {
			const ParallelLoaderPlugin = require("./loaders/ParallelLoaderPlugin");

			new ParallelLoaderPlugin(options.experiments.parallel.loader).apply(
				compiler
			);
		}
