...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.watchOptions.additional) {
			const AdditionalWatchPathsPlugin = require("./AdditionalWatchPathsPlugin");

			new AdditionalWatchPathsPlugin(options.watchOptions.additional).apply(
				compiler
			);
		}
