...
const ReloadChunksPlugin = require("./optimize/ReloadChunksPlugin");
...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		if (options.optimization.reloadChunks) {
			new ReloadChunksPlugin(options.optimization.reloadChunks).apply(compiler);
		}
