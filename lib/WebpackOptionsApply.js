...
const ConstValueParserPlugin = require("./javascript/ConstValueParserPlugin");

const JavascriptModulesPlugin = require("./javascript/JavascriptModulesPlugin");
const JavascriptParser = require("./javascript/JavascriptParser");
const JavascriptParserApplyPlugin = require("./javascript/JavascriptParserApplyPlugin");
...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		new JavascriptParserApplyPlugin(
			new ConstValueParserPlugin({
