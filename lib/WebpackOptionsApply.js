...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.experiments.moduleSplitting) {
			const ModuleSplittingPlugin = require("./optimize/ModuleSplittingPlugin");

			new ModuleSplittingPlugin(options.experiments.moduleSplitting).apply(
				compiler
			);
		}
