	...
	if(typeof options.target === "string") {
		...
		case "atom":
			...
			compiler.apply(
				...
				new FunctionModulePlugin(options.output),
				new NodeTargetPlugin(),
				new ExternalsPlugin("commonjs", "app"),
                                new ExternalsPlugin("commonjs", "auto-updater"),
                                new ExternalsPlugin("commonjs", "browser-window"),
                                new ExternalsPlugin("commonjs", "content-tracing"),
                                new ExternalsPlugin("commonjs", "dialog"),
                                new ExternalsPlugin("commonjs", "global-shortcut"),
                                new ExternalsPlugin("commonjs", "ipc"),
                                new ExternalsPlugin("commonjs", "menu"),
                                new ExternalsPlugin("commonjs", "menu-item"),
                                new ExternalsPlugin("commonjs", "power-monitor"),
                                new ExternalsPlugin("commonjs", "protocol"),
                                new ExternalsPlugin("commonjs", "tray"),
                                new ExternalsPlugin("commonjs", "remote"),
                                new ExternalsPlugin("commonjs", "web-view"),
                                new ExternalsPlugin("commonjs", "clipboard"),
                                new ExternalsPlugin("commonjs", "crash-reporter"),
                                new ExternalsPlugin("commonjs", "screen"),
                                new ExternalsPlugin("commonjs", "shell"),
