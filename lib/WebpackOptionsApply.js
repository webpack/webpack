...
const StrictModeChecksPlugin = require("./StrictModeChecksPlugin");
...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		// Enable strict-mode checks plugin when parser option may need it; plugin itself checks per-module parser options
		new StrictModeChecksPlugin().apply(compiler);
