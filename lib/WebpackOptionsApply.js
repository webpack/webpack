...
const VerboseStatsPresetPlugin = require("./stats/VerboseStatsPreset");
const DetailedStatsPresetPlugin = require("./stats/DetailedStatsPreset");
const MinimalStatsPresetPlugin = require("./stats/MinimalStatsPreset");
const ErrorOnlyStatsPresetPlugin = require("./stats/ErrorOnlyStatsPreset");
const NoStatsPresetPlugin = require("./stats/NoStatsPreset");
const AssetsStatsPlugin = require("./stats/AssetsStatsPlugin");
const ModuleStatsPlugin = require("./stats/ModuleStatsPlugin");
const ChunkStatsPlugin = require("./stats/ChunksStatsPlugin");
const AdditionalStatsPlugin = require("./stats/AdditionalStatsPlugin");
...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		switch ((options.stats && options.stats.preset) || options.stats) {
			case "verbose":
				new VerboseStatsPresetPlugin().apply(compiler);
				break;
			case "detailed":
				new DetailedStatsPresetPlugin().apply(compiler);
				break;
			case "minimal":
				new MinimalStatsPresetPlugin().apply(compiler);
				break;
			case "errors-only":
				new ErrorOnlyStatsPresetPlugin().apply(compiler);
				break;
			case "none":
			case 0:
			case false:
			case "":
				new NoStatsPresetPlugin().apply(compiler);
				break;
			default:
				new AssetsStatsPlugin().apply(compiler);
				new ModuleStatsPlugin().apply(compiler);
				new ChunkStatsPlugin().apply(compiler);
				new AdditionalStatsPlugin().apply(compiler);
				break;
		}
