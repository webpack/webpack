...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.performance) {
			...
			if (options.performance.uncacheableModules) {
				const UncacheableModulesPlugin = require("./performance/UncacheableModulesPlugin");

				new UncacheableModulesPlugin(options.performance).apply(compiler);
			}
