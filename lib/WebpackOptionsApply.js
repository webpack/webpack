...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler, interception) {
		...
		if (options.experiments.sourceImport) {
			const JsSourcePhaseModulesPlugin = require("./javascript/JsSourcePhaseModulesPlugin");

			new JsSourcePhaseModulesPlugin().apply(compiler);
		}
