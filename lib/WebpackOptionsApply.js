...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		if (options.optimization.removeEmptyAssets) {
			const RemoveEmptyAssetsPlugin = require("./optimize/RemoveEmptyAssetsPlugin");
			new RemoveEmptyAssetsPlugin().apply(compiler);
		}
