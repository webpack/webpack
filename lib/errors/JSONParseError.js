...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Error, EXPECTED_ANY, string]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Error, EXPECTED_ANY, string]>} ObjectSerializerContext */
...
class JSONParseError extends SyntaxError {
	...
	constructor(err, raw, txt) {
		...
		if (typeof raw !== "string") {
			...
			// V8 puts single quotes around the token and a comma after it
			...
			if (badIndexMatch) {
				...
				// V8 always reports a position; custom `parse` implementations may not
...
export { JSONParseError as "module.exports" };
