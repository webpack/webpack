...
class TopLevelThisWarning extends WebpackError {
	...
	constructor(modules, total) {
		...
		super(
			`top-level this: ${total} ${total === 1 ? "read" : "reads"} of 'this' at the top level of an ES module:${list}\nAt the top level of an ES module 'this' is 'undefined', not the module object and not 'globalThis' — code moved from CommonJS that reads it silently gets nothing. Use 'globalThis' where the global object was meant, or 'import.meta' for anything about the module itself.\nFor more info visit https://webpack.js.org/api/module-variables/#importmeta`
		);
