...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Error, string]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Error, string]>} ObjectSerializerContext */
...
export { makeWebpackErrorCallback };
...
export { tryRunOrWebpackError };

// attach named exports as properties to keep the CJS shape
HookWebpackError.makeWebpackError = makeWebpackError;
HookWebpackError.makeWebpackErrorCallback = makeWebpackErrorCallback;
HookWebpackError.tryRunOrWebpackError = tryRunOrWebpackError;

export { HookWebpackError as "module.exports" };
