...
import AsyncWasmModule from "./AsyncWasmModule.js";
...
const getAsyncWebAssemblyGenerator = memoize(
	() =>
		/** @type {typeof import("./AsyncWebAssemblyGenerator.js").default} */ (
			require("./AsyncWebAssemblyGenerator.js")
		)
);
const getAsyncWebAssemblyJavascriptGenerator = memoize(
	() =>
		/** @type {typeof import("./AsyncWebAssemblyJavascriptGenerator.js").default} */ (
			require("./AsyncWebAssemblyJavascriptGenerator.js")
		)
);
const getAsyncWebAssemblyParser = memoize(
	() =>
		/** @type {typeof import("./AsyncWebAssemblyParser.js").default} */ (
			require("./AsyncWebAssemblyParser.js")
		)
);
...
export default AsyncWebAssemblyModulesPlugin;

export { AsyncWebAssemblyModulesPlugin as "module.exports" };
