...
const getAsyncWebAssemblyGenerator = lazyModule.sync(() =>
	require("./AsyncWebAssemblyGenerator")
);
const getAsyncWebAssemblyJavascriptGenerator = lazyModule.sync(() =>
	require("./AsyncWebAssemblyJavascriptGenerator")
);
const getAsyncWebAssemblyParser = lazyModule.sync(() =>
