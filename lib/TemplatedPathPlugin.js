...
Template.REGEXP_PLUGIN = REGEXP_PLUGIN;
		...
		compiler.plugin("compilation", compilation => {
			...
			const replacePathVariables = (path, data) => {
				...
				var result = path
						...
						.replace(REGEXP_PLUGIN, function(match, group) {
							if(!compiler.hasPlugins(group)) {
								throw "replacePathVariables(): " + group + " plugin not found."
							}
		
							return compiler.applyPluginsWaterfall(group, result, data);
						});
