...
class HarmonyImportSpecifierDependency extends HarmonyImportDependency {
	...
	getWarnings(moduleGraph) {
		...
		return this._getLinkingErrorOrWarnings(moduleGraph, {
			deferModuleMode: false, // this options never emits warnings, only errors.
	 ...
	 * Returns errors
	 * @param {ModuleGraph} moduleGraph module graph
	 * @param {false | DeferImportExperimentOptions=} deferModuleMode deferred module check mode
	 * @returns {WebpackError[] | null | undefined} errors
	 */
	getErrors(moduleGraph, deferModuleMode) {
		const exportsPresence = this._getEffectiveExportPresenceLevel(moduleGraph);
		return this._getLinkingErrorOrWarnings(moduleGraph, {
			deferModuleMode: deferModuleMode,
