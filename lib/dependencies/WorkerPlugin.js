						...
						if (importOptions) {
							...
							if (importOptions.webpackPrefetch !== undefined) {
								if (importOptions.webpackPrefetch === true) {
									...
									// Validate prefetch order is within reasonable bounds
							...
							if (importOptions.webpackPreload !== undefined) {
								if (importOptions.webpackPreload === true) {
									...
									// Validate preload order is within reasonable bounds
								...
								parser.state.module.addWarning(
									new CommentCompilationWarning(
										"Both webpackPrefetch and webpackPreload are specified. " +
											...
											"while webpackPrefetch is typically used for future navigation.",
										/** @type {DependencyLocation} */ (expr.loc)
									)
								);
							}
