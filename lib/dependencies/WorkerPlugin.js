...
import CreateScriptUrlDependency from "./CreateScriptUrlDependency.js";
...
import WorkerDependency from "./WorkerDependency.js";
...
/** @typedef {import("../../declarations/WebpackOptions.js").ChunkLoading} ChunkLoading */
/** @typedef {import("../../declarations/WebpackOptions.js").JavascriptParserOptions} JavascriptParserOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").OutputModule} OutputModule */
/** @typedef {import("../../declarations/WebpackOptions.js").WasmLoading} WasmLoading */
/** @typedef {import("../../declarations/WebpackOptions.js").WorkerPublicPath} WorkerPublicPath */
			...
			(compilation, { normalModuleFactory }) => {
				...
				const parserPlugin = (parser, parserOptions) => {
					...
					const handleNewWorker = (expr, isGlobalWorker = false) => {
						...
						if (
							!Object.hasOwn(entryOptions, "name") &&
							options &&
...
export { WorkerPlugin as "module.exports" };
