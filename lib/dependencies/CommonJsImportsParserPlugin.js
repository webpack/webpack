...
import traverseDestructuringAssignmentProperties from "../util/traverseDestructuringAssignmentProperties.js";
...
import { getLocalModule } from "./LocalModulesHelpers.js";
...
/** @typedef {import("../javascript/JavascriptParser.js").CalleeMembers} CalleeMembers */
 ...
 * @property {InstanceType<typeof import("./CommonJsRequireDependency.js").default> | null} dep dependency for the `require()` call, null until the `require()` is walked; kept so a later whole-namespace use can null its list directly
 */
...
export default CommonJsImportsParserPlugin;
export { createProcessResolveHandler };
export { createRequireAsExpressionHandler };
export { createRequireCacheDependency };
export { createRequireCallHandler as createRequireHandler };
...
export { CommonJsImportsParserPlugin as "module.exports" };
