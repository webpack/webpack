...
class CssIcssExportDependency extends NullDependency {
	 ...
	 * @param {string=} reexportName value
	 */
	constructor(name, value, reexportName) {
		super();
		this.name = name;
		this.value = value;
...
CssIcssExportDependency.Template = class CssIcssExportDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		// TODO improve me
		if (typeof dep.value === "undefined") return;
		...
		for (const used of [...usedNames, ...names]) {
			cssData.exports.set(used, value);
		}
	}
};
