...
import { interpolate } from "../TemplatedPathPlugin.js";
...
import CssIcssImportDependency from "./CssIcssImportDependency.js";
import NullDependency from "./NullDependency.js";

const require = createRequire(import.meta.url);
const getCssTokens = memoize(() => require("../css/syntax.js"));

/** @typedef {import("webpack-sources").ReplaceSource} ReplaceSource */
/** @typedef {import("../../declarations/WebpackOptions.js").CssGeneratorExportsConvention} CssGeneratorExportsConvention */
/** @typedef {import("../../declarations/WebpackOptions.js").CssGeneratorLocalIdentName} CssGeneratorLocalIdentName */
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<(number | string | Value | Range | boolean | ExportMode | ExportType | DependencyLocation | undefined)[]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<(number | string | Value | Range | boolean | ExportMode | ExportType | DependencyLocation | undefined)[]>} ObjectSerializerContext */
/** @typedef {import("../util/Hash.js").default} Hash */
/** @typedef {import("../util/runtime.js").RuntimeSpec} RuntimeSpec */
/** @typedef {import("../errors/WebpackError.js").default} WebpackErrorType */
...
const prepareLocalIdentId = (id) => {
	...
	return (
		id
			...
			.replaceAll(IDENT_INVALID_CHARS_REGEXP, "_")
	);
};
...
const getLocalIdent = (local, module, chunkGraph, runtimeTemplate) => {
	...
	localIdent = localIdent.replaceAll(IDENT_LOCAL_PLACEHOLDER_REGEXP, local);
	...
	getReferencedExports(moduleGraph, runtime) {
		...
		for (const entry of this.entries) {
			if (
				...
				generator ||= /** @type {CssGenerator} */ (module.generator);
...
export default CssIcssExportDependency;

export { CssIcssExportDependency as "module.exports" };
