...
module.exports = class HarmonyDetectionParserPlugin {
	apply(parser) {
		...
		parser.hooks.topLevelAwait.tap("HarmonyDetectionParserPlugin", () => {
			...
			const harmonyCompatibilityDependency =
				parser.state.harmonyCompatibilityDependency;
			if (!harmonyCompatibilityDependency.hasAwait) {
				harmonyCompatibilityDependency.hasAwait = true;
