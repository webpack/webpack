...
import RequireContextDependency from "./RequireContextDependency.js";
...
export default class RequireContextDependencyParserPlugin {
	/**
...
export { RequireContextDependencyParserPlugin as "module.exports" };
