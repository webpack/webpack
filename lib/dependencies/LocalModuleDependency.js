...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[LocalModule, Range | undefined, boolean]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[LocalModule, Range | undefined, boolean]>} ObjectSerializerContext */
...
export default LocalModuleDependency;

export { LocalModuleDependency as "module.exports" };
