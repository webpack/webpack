	...
	apply(compiler) {
		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				parser.evaluateTypeOfPlugin.plugin("evaluate typeof define.amd", ParserHelpers.evaluateToString(typeof amdOptions));
				parser.evaluateTypeOfPlugin.plugin("evaluate typeof require.amd", ParserHelpers.evaluateToString(typeof amdOptions));
				parser.evaluateIdentifierPlugin.plugin("define.amd", ParserHelpers.evaluateToBoolean(true));
				parser.evaluateIdentifierPlugin.plugin("require.amd", ParserHelpers.evaluateToBoolean(true));
				parser.plugin("typeof define", ParserHelpers.toConstantDependency(JSON.stringify("function")));
				parser.evaluateTypeOfPlugin.plugin("evaluate typeof define", ParserHelpers.evaluateToString("function"));
				...
				parser.evaluateTypeOfPlugin.plugin("evaluate typeof require", ParserHelpers.evaluateToString("function"));
			});
		});
