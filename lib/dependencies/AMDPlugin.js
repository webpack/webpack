	...
	apply(compiler) {
		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				parser.evaluateTypeOfWalker.plugin("evaluate typeof define.amd", ParserHelpers.evaluateToString(typeof amdOptions));
				parser.evaluateTypeOfWalker.plugin("evaluate typeof require.amd", ParserHelpers.evaluateToString(typeof amdOptions));
				parser.evaluateIdentifierWalker.plugin("define.amd", ParserHelpers.evaluateToBoolean(true));
				parser.evaluateIdentifierWalker.plugin("require.amd", ParserHelpers.evaluateToBoolean(true));
				parser.plugin("typeof define", ParserHelpers.toConstantDependency(JSON.stringify("function")));
				parser.evaluateTypeOfWalker.plugin("evaluate typeof define", ParserHelpers.evaluateToString("function"));
				...
				parser.evaluateTypeOfWalker.plugin("evaluate typeof require", ParserHelpers.evaluateToString("function"));
			});
		});
