...
/** @typedef {import("./CommonJsRequireDependency.js").default} CommonJsRequireDependency */
/** @typedef {import("./HarmonyEvaluatedImportSpecifierDependency.js").default} HarmonyEvaluatedImportSpecifierDependency */
/** @typedef {import("./HarmonyImportSpecifierDependency.js").default} HarmonyImportSpecifierDependency */
/** @typedef {import("./ImportDependency.js").default} ImportDependency */
...
const getHarmonyImportSpecifierDependency = memoize(
	() =>
		/** @type {typeof import("./HarmonyImportSpecifierDependency.js").default} */ (
			require("./HarmonyImportSpecifierDependency.js")
		)
);
const getHarmonyEvaluatedImportSpecifierDependency = memoize(
	() =>
		/** @type {typeof import("./HarmonyEvaluatedImportSpecifierDependency.js").default} */ (
			require("./HarmonyEvaluatedImportSpecifierDependency.js")
		)
);
...
export { attachDependencyGuards };
export { isDeadByGuards };
export { isPresentByGuards };
