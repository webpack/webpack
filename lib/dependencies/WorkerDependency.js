...
WorkerDependency.Template = class WorkerDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		// ESM output emits the analyzable `new URL("./worker.<name>.js",
		// import.meta.url)`, which another bundler can follow statically. A resource
		// hint does not block it, its `<link>` being emitted at chunk startup.
