...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[WorkerDependencyOptions]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[WorkerDependencyOptions]>} ObjectSerializerContext */
...
export default WorkerDependency;

export { WorkerDependency as "module.exports" };
