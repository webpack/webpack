...
class CommonJsRequireDependencyParserPlugin {
	...
	apply(parser) {
		...
		parser.plugin("expression require.cache", {
			path: parserHelpersLocation,
			fnName: "toConstantDependency"
		}, { code: "__webpack_require__.c" });
		...
		parser.plugin("expression require", {
			path: parserHelpersLocation,
			fnName: "CommonJSPluginExpressionRequire",
		}, {
			unknownContextRequest: options.unknownContextRequest,
			unknownContextRecursive: options.unknownContextRecursive,
			unknownContextRegExp: options.unknownContextRegExp,
			unknownContextCritical: options.unknownContextCritical,
		});
		...
		parser.plugin("call require", {
			path: parserHelpersLocation,
			fnName: "CommonJSPluginCallRequire",
		});
		...
		// 	}
		// });
		parser.plugin("call require:commonjs:item", {
			path: parserHelpersLocation,
			fnName: "CommonJSPluginRequireCommonJSItem"
		});
		...
		// 	return true;
		// });
		parser.plugin("call require:commonjs:context", {
			path: parserHelpersLocation,
			fnName: "CommonJSPluginRequireCommonJSContext",
		}, options);
	}
}
