...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, ExportInfoName[]]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, ExportInfoName[]]>} ObjectSerializerContext */
...
export default ProvidedDependency;

export { ProvidedDependency as "module.exports" };
