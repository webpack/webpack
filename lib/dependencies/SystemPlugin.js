		...
		compiler.plugin("compilation", (compilation, params) => {
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				function setNotSupported(name) {
					parser.evaluateTypeOfWalker.plugin("evaluate typeof " + name, ParserHelpers.evaluateToString("undefined"));
				...
				parser.evaluateTypeOfWalker.plugin("evaluate typeof System", ParserHelpers.evaluateToString("object"));

				parser.plugin("typeof System.import", ParserHelpers.toConstantDependency(JSON.stringify("function")));
				parser.evaluateTypeOfWalker.plugin("evaluate typeof System.import", ParserHelpers.evaluateToString("function"));
