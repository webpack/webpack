...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, ArrayImportSpecifiers, string | undefined]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, ArrayImportSpecifiers, string | undefined]>} ObjectSerializerContext */
...
export default ExternalModuleInitFragmentDependency;

export { ExternalModuleInitFragmentDependency as "module.exports" };
