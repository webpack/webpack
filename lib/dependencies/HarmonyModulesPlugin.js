...
var CommonJsInHarmonyDependencyParserPlugin = require("./CommonJsInHarmonyDependencyParserPlugin");
...
HarmonyModulesPlugin.prototype.apply = function(compiler) {
	compiler.plugin("compilation", function(compilation, params) {
		...
		compilation.dependencyFactories.set(CommonJsInHarmonyDependency, new NullFactory());
		compilation.dependencyTemplates.set(CommonJsInHarmonyDependency, new CommonJsInHarmonyDependency.Template());
		...
		params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
			...
			parser.apply(
				new CommonJsInHarmonyDependencyParserPlugin(),
