...
const HarmonyNode12CreateRequireDependencyParserPlugin = require("./HarmonyNode12CreateRequireDependencyParserPlugin");
		...
		compiler.hooks.compilation.tap(
			...
			(compilation, { normalModuleFactory }) => {
				...
				const handler = (parser, parserOptions) => {
					...
					new HarmonyNode12CreateRequireDependencyParserPlugin(
						parserOptions
					).apply(parser);
