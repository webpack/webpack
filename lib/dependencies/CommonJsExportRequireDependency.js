...
class CommonJsExportRequireDependency extends ModuleDependency {
	...
	getExports(moduleGraph) {
		...
		// The imported module has no exports determined yet, so whether it unwraps
		// is unknown. Star-reexporting now would add names the monotonic merge can
		// never retract, so this defers until `from.module` re-queues it.
		if (
			importedModule &&
