...
/** @typedef {import("../serialization/ObjectMiddleware").ObjectDeserializerContext<[string, string, HtmlScriptElementKind, number, number, boolean, string, number, boolean, number]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware").ObjectSerializerContext<[string, string, HtmlScriptElementKind, number, number, boolean, string, number, boolean, number]>} ObjectSerializerContext */
