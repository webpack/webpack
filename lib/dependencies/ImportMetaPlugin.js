...
// Ordering contract for the `import.meta` hooks: ESM detection must observe every
// access before any bailing replacement, and the replacements here must precede
// DefinePlugin's object defines and its destructuring handler.
