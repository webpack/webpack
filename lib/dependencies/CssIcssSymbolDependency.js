...
class CssIcssSymbolDependency extends NullDependency {
	 ...
	 * @param {string | undefined} value value when it was defined in this module
	 * @param {string | undefined} importName import name when it was imported from other module
	 * @param {Range} range range
	 * @param {boolean=} isReference true when is reference, otherwise false
	 */
	constructor(localName, value, importName, range, isReference) {
		super();
