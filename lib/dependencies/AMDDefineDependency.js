...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Range, Range | null, Range | null, Range | null, string | null, LocalModule | null]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Range, Range | null, Range | null, Range | null, string | null, LocalModule | null]>} ObjectSerializerContext */
...
AMDDefineDependency.Template = class AMDDefineDependencyTemplate extends (
	...
	replace(dependency, source, definition, text) {
		...
		if (localModuleVar) {
			text = text.replaceAll("XXX", localModuleVar.replaceAll("$", "$$$$"));
			definition = definition.replaceAll(
				"XXX",
				localModuleVar.replaceAll("$", "$$$$")
			);
		}

		if (dependency.namedModule) {
			text = text.replaceAll("YYY", JSON.stringify(dependency.namedModule));
		}
...
export default AMDDefineDependency;

export { AMDDefineDependency as "module.exports" };
