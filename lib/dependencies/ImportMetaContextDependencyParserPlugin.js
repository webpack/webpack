							...
							switch (prop.key.name) {
								...
								case "prefetch": {
									...
									if (expr.isBoolean()) {
										...
										errors.push(
											createPropertyParseError(prop, "boolean|number")
										);
									}
									break;
								}
...
module.exports.isImportMetaContextEnabled = isImportMetaContextEnabled;
module.exports.isImportMetaGlobEnabled = isImportMetaGlobEnabled;
