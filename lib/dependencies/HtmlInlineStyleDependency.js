...
class HtmlInlineStyleDependency extends ModuleDependency {
	...
	updateHash(hash, context) {
		...
		// rendered text (which can itself contain hashed asset filenames
		// via `url(...)`) into the HTML at code-generation time. Folding
		// the CSS module's content hash into the dependency hash ensures
		// the HTML module's hash invalidates — and the HTML output's
		// contenthash updates — whenever the inlined CSS text changes.
