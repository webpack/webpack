 ...
 * declaration list). The content is fed into webpack's CSS pipeline as a
...
class HtmlInlineStyleDependency extends ModuleDependency {
	 ...
	 * @param {boolean=} attribute true when the source is a `style="..."` attribute (declaration list) rather than a `<style>` block (stylesheet)
	 */
