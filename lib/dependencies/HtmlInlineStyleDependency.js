...
import { CSS_TEXT_TYPE } from "../ModuleSourceTypeConstants.js";
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<boolean[]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<boolean[]>} ObjectSerializerContext */
...
export default HtmlInlineStyleDependency;

export { HtmlInlineStyleDependency as "module.exports" };
