...
/** @typedef {import("../javascript/JavascriptParser.js").StatementPath} StatementPath */
...
export default CommonJsExportsParserPlugin;

export { CommonJsExportsParserPlugin as "module.exports" };
