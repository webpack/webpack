...
/** @import Dependency, { GetConditionFn } from "../../graph/Dependency" */
...
/** @import { Ids } from "./ESMImportDependency" */
 ...
 */
// TODO in the next major release: rename to `ESMEvaluatedImportSpecifierDependency`
class HarmonyEvaluatedImportSpecifierDependency extends ESMImportSpecifierDependency {
...
makeSerializable(
	...
	"webpack/lib/dependencies/esm/ESMEvaluatedImportSpecifierDependency"
);
registerLegacyRequest(
	HarmonyEvaluatedImportSpecifierDependency,
	"webpack/lib/dependencies/ESMEvaluatedImportSpecifierDependency"
);
registerLegacyRequest(
	HarmonyEvaluatedImportSpecifierDependency,
...
HarmonyEvaluatedImportSpecifierDependency.Template = class HarmonyEvaluatedImportSpecifierDependencyTemplate extends (
	ESMImportSpecifierDependency.Template
) {
	/**
