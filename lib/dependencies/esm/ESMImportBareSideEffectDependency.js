...
const { ASSET_TYPE } = require("../../module/ModuleSourceTypeConstants");
...
/** @import { GetConditionFn } from "../../graph/Dependency" */
 ...
 */
// TODO in the next major release: rename to `ESMImportBareSideEffectDependency`
class HarmonyImportBareSideEffectDependency extends ESMImportSideEffectDependency {
	/**
...
makeSerializable(
	...
	"webpack/lib/dependencies/esm/ESMImportBareSideEffectDependency"
);
registerLegacyRequest(
	HarmonyImportBareSideEffectDependency,
	"webpack/lib/dependencies/ESMImportBareSideEffectDependency"
);
registerLegacyRequest(
	HarmonyImportBareSideEffectDependency,
