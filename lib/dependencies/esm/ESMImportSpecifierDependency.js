...
const { getTrimmedIdsAndRange } = require("../helpers/chainedImports");
...
/** @import { IdRanges } from "../helpers/chainedImports" */
...
makeSerializable(
	...
	"webpack/lib/dependencies/esm/ESMImportSpecifierDependency"
);
	...
	_getCodeForIds(dep, source, templateContext, ids, connection) {
		...
		if (
			...
			if (
				...
				templateContext.dependencyTemplates.importBindingScopes
			) {
