...
/**
 * Initialization fragment that emits ESM import statements for external
 * modules required by generated runtime or module code.
 * @extends {InitFragment<GenerateContext>}
 */
class ExternalModuleInitFragment extends InitFragment {
	/**
	 * Creates an init fragment for a specific external import statement.
	 * The fragment can represent default imports, named imports, or both.
	...
	/**
	 * Merges import specifiers from another fragment that targets the same
	 * external module.
	...
	/**
	 * Renders the final `import ... from ...` statement for this fragment.
	...
	/**
	 * Serializes the fragment so it can be cached and restored across
	 * compilations.
	...
	/**
	 * Restores a previously serialized fragment instance.
