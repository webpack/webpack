...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<(string | ArrayImportSpecifiers | ImportSpecifiers | undefined)[]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<(string | ArrayImportSpecifiers | ImportSpecifiers | undefined)[]>} ObjectSerializerContext */
...
export default ExternalModuleInitFragment;

export { ExternalModuleInitFragment as "module.exports" };
