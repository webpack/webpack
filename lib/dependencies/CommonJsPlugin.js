		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				for(let expression of requireExpressions) {
					...
					parser.evaluateTypeOfWalker.plugin(`evaluate typeof ${expression}`, ParserHelpers.evaluateToString("function"));
				}

				parser.evaluateTypeOfWalker.plugin("evaluate typeof module", ParserHelpers.evaluateToString("object"));
				...
				parser.evaluateTypeOfWalker.plugin("evaluate typeof exports", ParserHelpers.evaluateToString("object"));
				parser.apply(
