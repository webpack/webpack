		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				for(let expression of requireExpressions) {
					...
					parser.evaluateTypeOfPlugin.plugin(`evaluate typeof ${expression}`, ParserHelpers.evaluateToString("function"));
				}

				parser.evaluateTypeOfPlugin.plugin("evaluate typeof module", ParserHelpers.evaluateToString("object"));
				...
				parser.evaluateTypeOfPlugin.plugin("evaluate typeof exports", ParserHelpers.evaluateToString("object"));
				parser.apply(
