		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => {
				...
				for(let expression of requireExpressions) {
					...
					parser.plugin(`typeof ${expression}`, {
				...
				// 	return true;
				// });
				parser.plugin("assign require", {
					path: parserHelpersLocation,
					fnName: "CommonJSPluginAssignRequire",
				});

				// parser.plugin("can-rename require", () => true);
				parser.plugin("can-rename require", {
					path: parserHelpersLocation,
					fnName: "approve",
				});
				...
				// 	return false;
				// });
				parser.plugin("rename require", {
					path: parserHelpersLocation,
					fnName: "CommonJSPluginRenameRequire",
				});

				// parser.plugin("typeof module", () => true);
				parser.plugin("typeof module", {
					path: parserHelpersLocation,
					fnName: "approve"
				});
