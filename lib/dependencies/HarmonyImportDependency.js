...
class HarmonyImportDependency extends ModuleDependency {
	...
	getImportStatement(update, runtime, chunk) {
...
HarmonyImportDependency.Template = class HarmonyImportDependencyTemplate {
	...
	harmonyInit(dep, source, runtime, dependencyTemplates, chunk) {
		let sourceInfo = importEmittedMap.get(source);
		if (!sourceInfo) {
		...
		const content = dep.getImportStatement(false, runtime, chunk);
