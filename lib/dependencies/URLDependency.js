...
URLDependency.Template = class URLDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		// ESM output emits the analyzable `new URL("./asset", import.meta.url)`, a
		// literal another bundler can follow statically; `url: "relative"` keeps the
		// runtime form. A resource hint does not force it, its `<link>` being separate.
		if (
			!dep.relative &&
