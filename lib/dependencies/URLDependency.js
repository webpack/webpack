...
const getAnalyzableUrlSpecifier = (dep, templateContext) => {
	...
	if (typeof jsUrl === "string") {
		...
		return jsUrl.startsWith('"') ? jsUrl : JSON.stringify(jsUrl);
	}
	...
	return typeof assetUrl === "string" ? JSON.stringify(assetUrl) : null;
};
...
URLDependency.Template = class URLDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		if (
			...
			!dep.prefetch &&
			!dep.preload &&
			runtimeTemplate.supportsAnalyzableEsmUrl()
		) {
