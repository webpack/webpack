...
URLDependency.Template = class URLDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		// eval-only: an unresolved request stays a runtime URL against the base URI
		if (dep.optional && !moduleGraph.getModule(dep)) {
			runtimeRequirements.add(RuntimeGlobals.baseURI);
			source.replace(
				dep.range[0],
				dep.range[1] - 1,
				`/* unresolved asset import */ ${JSON.stringify(dep.request)}, ${
