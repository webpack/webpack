...
class HarmonyExportExpressionDependency extends NullDependency {
	...
	getExports(moduleGraph) {
		...
		const spec = { name: DEFAULT_EXPORT_NAME, immutableBinding: true, isPure };
		// Declare nested property exports for compound component / object literal pattern
	...
	deserialize(context) {
		...
		this._defaultExportLocalName = read();
