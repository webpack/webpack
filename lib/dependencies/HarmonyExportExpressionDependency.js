...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Range, Range, string, DeclarationId | undefined, boolean]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Range, Range, string, DeclarationId | undefined, boolean]>} ObjectSerializerContext */
...
export default HarmonyExportExpressionDependency;

export { HarmonyExportExpressionDependency as "module.exports" };
