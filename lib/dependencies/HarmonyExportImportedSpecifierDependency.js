...
class HarmonyExportImportedSpecifierDependency extends HarmonyImportDependency {
	 ...
	 */
	getForwardId() {
		// star re-exports and namespace re-exports need all exports of the target
		if (this.name === null || this.ids.length === 0) return true;
		return this.ids[0];
	}
	 ...
	 */
	getLazyUntil() {
		return this.name !== null ? { id: this.name } : "fallback";
	}
