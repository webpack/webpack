...
import ConditionalInitFragment from "../ConditionalInitFragment.js";
...
import {
	...
	isExportInlined,
	isInlineEnabled
} from "../optimize/InlineExports.js";
import { getMakeDeferredNamespaceModeFromExportsType } from "../runtime/MakeDeferredNamespaceObjectRuntime.js";
import { countIterable } from "../util/IterableHelpers.js";
import { combine, first } from "../util/SetHelpers.js";
import makeSerializable from "../util/makeSerializable.js";
import { propertyAccess, propertyName } from "../util/property.js";
import { filterRuntime, getRuntimeKey, keyToRuntime } from "../util/runtime.js";
...
import HarmonyLinkingError from "./HarmonyLinkingError.js";
import { ImportPhaseUtils } from "./ImportPhase.js";
import processExportInfo from "./processExportInfo.js";
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<SerializedData>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<SerializedData>} ObjectSerializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[HarmonyExportImportedSpecifierDependency[]]>} StarListDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[HarmonyExportImportedSpecifierDependency[]]>} StarListSerializerContext */
...
HarmonyExportImportedSpecifierDependency.Template = class HarmonyExportImportedSpecifierDependencyTemplate extends (
	 ...
	 * Returns value.
	 * @param {string} name name
	 * @param {null | false | string | string[] | import("../optimize/InlineExports.js").InlinedUsedName} valueKey value key
...
export default HarmonyExportImportedSpecifierDependency;
export { HarmonyStarExportsList };
export { idsSymbol };
...
export { HarmonyExportImportedSpecifierDependency as "module.exports" };
