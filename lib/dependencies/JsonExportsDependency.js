...
/** @typedef {import("../json/JsonData.js").default} JsonData */
/** @typedef {import("../json/JsonData.js").JsonValue} JsonValue */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[JsonData, number]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[JsonData, number]>} ObjectSerializerContext */
...
export default JsonExportsDependency;

export { JsonExportsDependency as "module.exports" };
