 ...
 * @param {Error | null} err error object
 * @param {(string | Buffer)=} source source of the loaded module
 * @param {(object | null)=} sourceMap source map of the loaded module
 * @param {Module=} module the loaded module
 * @returns {void}
 */

/**
 * `importModule` takes a callback or, given none, answers with a promise, and
 * TypeScript reads an intersection of call signatures as an overload set
 * @typedef {{ (request: string, options: ImportModuleOptions | undefined, callback: ImportModuleCallback): void } & { (request: string, options?: ImportModuleOptions): Promise<ExecuteModuleExports> }} ImportModuleMethod
 */

/**
 * These properties are added by the LoaderPlugin
 * @typedef {object} LoaderPluginLoaderContext
 * @property {(request: string, callback: LoadModuleCallback) => void} loadModule Resolves the given request to a module, applies all configured loaders and calls
 * back with the generated source, the sourceMap and the module instance (usually an
 * instance of NormalModule). Use this function if you need to know the source code
 * of another module to generate the result.
 * @property {ImportModuleMethod} importModule
 */
