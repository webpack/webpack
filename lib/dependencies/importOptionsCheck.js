...
/**
 * Builds the call the spec's `import(specifier, options)` evaluation asks for:
 * the arguments are evaluated in source order, the options are checked, and a
 * failing check rejects rather than throws. The last parameter holds them.
