...
class CssIcssGlobalIdentifierDependency extends NullDependency {
	/**
...
CssIcssGlobalIdentifierDependency.Template = class CssIcssComposesGlobalDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		const dep = /** @type {CssIcssGlobalIdentifierDependency} */ (dependency);
