...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, string[], string | undefined]>} ObjectSerializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, string[], string | undefined]>} ObjectDeserializerContext */
/**
...
export default ModuleInitFragmentDependency;

export { ModuleInitFragmentDependency as "module.exports" };
