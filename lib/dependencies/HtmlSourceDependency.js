...
class HtmlSourceDependency extends ModuleDependency {
	...
	updateHash(hash, context) {
		...
		// filename into the rendered HTML at code-generation time. Folding
		// the asset module's content hash into the dependency hash ensures
		// the HTML module's hash invalidates — and the HTML output's
		// contenthash updates — whenever the referenced asset's content
		// changes.
