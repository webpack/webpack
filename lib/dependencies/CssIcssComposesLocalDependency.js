...
class CssIcssComposesLocalDependency extends ModuleDependency {
	 ...
	 */
	constructor(request, mode, className, exportName, range) {
		super(request);
		this.mode = mode;
	...
	getResourceIdentifier() {
		return `${super.getResourceIdentifier()}|mode${this.mode}|className${this.className}|exportName${this.exportName}`;
	}
