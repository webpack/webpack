...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, string, string]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, string, string]>} ObjectSerializerContext */
...
export default WebAssemblyExportImportedDependency;

export { WebAssemblyExportImportedDependency as "module.exports" };
