...
class CssExportsDependency extends NullDependency {
	...
	/**
	 * Returns the exported names aggregated across all entries.
	...
	/**
	 * Returns list of exports referenced by this dependency, aggregated.
	 * @param {ModuleGraph} moduleGraph module graph
	...
	/**
	 * Returns warnings aggregated across entries.
	 * @param {ModuleGraph} moduleGraph module graph
	 * @returns {WebpackErrorType[] | null} warnings
	 */
