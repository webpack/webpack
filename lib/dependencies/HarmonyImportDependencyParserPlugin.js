 ...
 * @returns {boolean} whether the import is deferred or not
 */
function isDeferredImport(parser, node, deferImportEnabled) {
	...
	return defer && deferImportEnabled;
}
	...
	apply(parser) {
		...
		parser.hooks.import.tap(
			...
			(statement, source) => {
				...
				const defer = isDeferredImport(parser, statement, this.deferImport);
				if (
					defer &&
...
module.exports.isDeferredImport = isDeferredImport;
