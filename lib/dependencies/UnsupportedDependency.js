...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, Range]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, Range]>} ObjectSerializerContext */
...
export default UnsupportedDependency;

export { UnsupportedDependency as "module.exports" };
