...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Range | false, Range]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Range | false, Range]>} ObjectSerializerContext */
...
export default HarmonyExportHeaderDependency;

export { HarmonyExportHeaderDependency as "module.exports" };
