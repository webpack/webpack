...
const { HarmonyDependencyTemplate } = require("./HarmonyInitDependency");
...
HarmonyExportSpecifierDependency.Template = class HarmonyExportSpecifierDependencyTemplate extends HarmonyDependencyTemplate {
	/**
