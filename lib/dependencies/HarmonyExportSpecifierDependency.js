...
import ExportBindingInitFragment from "./ExportBindingInitFragment.js";
import HarmonyExportInitFragment from "./HarmonyExportInitFragment.js";
...
/** @typedef {import("../optimize/InlineExports.js").InlinedValue} InlinedValue */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string, string, InlinedValue | null | undefined]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string, string, InlinedValue | null | undefined]>} ObjectSerializerContext */
/** @typedef {import("./HarmonyExportInitFragment.js").UnusedExports} UnusedExports */
/** @typedef {import("./HarmonyExportInitFragment.js").ExportMap} ExportMap */
...
HarmonyExportSpecifierDependency.Template = class HarmonyExportSpecifierDependencyTemplate extends (
	...
	apply(
		...
		const canUseValueBinding =
			...
			/** @type {import("../Module.js").BuildInfo} */ (module.buildInfo)
				.isCircular === false;
...
export default HarmonyExportSpecifierDependency;

export { HarmonyExportSpecifierDependency as "module.exports" };
