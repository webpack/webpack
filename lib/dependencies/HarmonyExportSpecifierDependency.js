...
HarmonyExportSpecifierDependency.Template.prototype.apply = function(dep, source) {
	...
	var content;
	if(dep.name) {
		content = "/* harmony export */ Object.defineProperty(exports, " + JSON.stringify(dep.name) + ", {configurable: false, enumerable: true, get: function() { return " + (name ? name + "[" + JSON.stringify(dep.id) + "]" : dep.id) + "; }});";
	} else {
		content = "/* harmony namespace export */ for(var __WEBPACK_IMPORT_KEY__ in " + name + ") (function(key) { Object.defineProperty(exports, key, {configurable: false, enumerable: true, get: function() { return " + name + "[key]; }}) }(__WEBPACK_IMPORT_KEY__));";
	}
