...
class CssIcssFromDependency extends ModuleDependency {
	/**
	 ...
	 */
	constructor(request, mode, name, exportName, range, prefix) {
		super(request);
		this.mode = mode;
		this.name = name;
	...
	getResourceIdentifier() {
		return `${super.getResourceIdentifier()}|mode${this.mode}|className${this.name}|exportName${this.exportName}|prefix${this.prefix}`;
	}
...
CssIcssFromDependency.Template = class CssIcssComposesDependencyTemplate extends (
	...
	apply(dependency, source, templateContext) {
		...
		const dep = /** @type {CssIcssFromDependency} */ (dependency);
		const module =
			/** @type {CssModule} */
...
makeSerializable(
	CssIcssFromDependency,
	"webpack/lib/dependencies/CssIcssFromDependency"
);

module.exports = CssIcssFromDependency;
