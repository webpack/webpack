...
class RequireResolveDependencyParserPlugin {
	...
	apply(parser) {
		...
		// 	}
		// });
		parser.plugin("call require.resolve(Weak)", {
			path: parserHelpersLocation,
			fnName: "RequireResolveResolveWeak2",
		});
		...
		// 	}
		// });
		parser.plugin("call require.resolve(Weak):item", {
			path: parserHelpersLocation,
			fnName: "RequireResolveWeakItem",
		});
		...
		// 	return true;
		// });
		parser.plugin("call require.resolve(Weak):context", {
			path: parserHelpersLocation,
			fnName: "RequireResolveWeakContext"
		}, options);
	}
}
