...
/** @typedef {import("../ContextModule.js").default} ContextModule */
...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[string | undefined, string, RawReferencedExports | null | undefined, ImportAttributes | undefined]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[string | undefined, string, RawReferencedExports | null | undefined, ImportAttributes | undefined]>} ObjectSerializerContext */
...
export default ContextElementDependency;

export { ContextElementDependency as "module.exports" };
