...
/** @typedef {import("./HarmonyImportGuard.js").DependencyGuard} DependencyGuard */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[RawReferencedExports | null, Range | undefined, DependencyGuard[] | undefined]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[RawReferencedExports | null, Range | undefined, DependencyGuard[] | undefined]>} ObjectSerializerContext */

const getHarmonyImportGuard = memoize(() => require("./HarmonyImportGuard.js"));
...
export default CommonJsRequireDependency;

export { CommonJsRequireDependency as "module.exports" };
