...
// TODO in the next major release: rename to `ESMImportSideEffectDependency`
class HarmonyImportSideEffectDependency extends ESMImportDependency {
	/**
...
makeSerializable(
	...
	"webpack/lib/dependencies/ESMImportSideEffectDependency"
);
