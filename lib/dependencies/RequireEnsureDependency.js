...
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectDeserializerContext<[Range, Range, Range | false]>} ObjectDeserializerContext */
/** @typedef {import("../serialization/ObjectMiddleware.js").ObjectSerializerContext<[Range, Range, Range | false]>} ObjectSerializerContext */
...
export default RequireEnsureDependency;

export { RequireEnsureDependency as "module.exports" };
