...
// ES5 `<link rel="modulepreload">` polyfill: fetch each target with the tag's
// own credentials and integrity, so the pending module import reuses it. The
// `.ep` guard makes it idempotent; the observer catches later-inserted links.
