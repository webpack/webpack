...
class ImportEagerDependency extends ImportDependency {
	 ...
	 * @param {boolean=} defer whether the import is deferred
	 */
	constructor(request, range, referencedExports, attributes, defer) {
		super(request, range, referencedExports, attributes, defer);
	}
