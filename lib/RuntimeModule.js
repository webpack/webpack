...
class RuntimeModule extends Module {
	...
	constructor(name, stage = 0) {
		...
		// A module that reads a chunk handler map rather than installing onto one, so
		// reading its code to learn the installed keys would generate it in a cycle.
		/** @type {boolean} */
		this._dispatchesChunkHandlers = false;
		// The `[handlerMap, key]` pairs this module installs, or `undefined` where it
		// does not say and its code is read instead. An empty array states "none".
		/** @type {[string, string][] | undefined} */
		this._installedChunkHandlers = undefined;
