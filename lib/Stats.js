...
class Stats extends Tapable {
	constructor(compilation) {
		...
		this.hooks = {
			...
			error: new SyncHook(),
			setValue: new HookMap(() => new SyncBailHook())
		};
	}
	...
	toJson(options, forToString) {
		...
		//TODO:- Add Additional Blocks for block scoping of y or we can assign const y
		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("performance").call()) === "boolean"
			) {
				options.performance = y;
			}
		}

		{
			let y;
			if (typeof (y = this.hooks.setValue.for("hash").call()) === "boolean") {
				options.hash = y;
			}
		}
		...
		{
			let y;
			if (typeof (y = this.hooks.setValue.for("env").call()) === "boolean") {
				options.env = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("version").call()) === "boolean"
			) {
				options.version = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("timings").call()) === "boolean"
			) {
				options.timings = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("builtAt").call()) === "boolean"
			) {
				options.builtAt = y;
			}
		}
		...
		{
			let y;
			if (typeof (y = this.hooks.setValue.for("assets").call()) === "boolean") {
				options.assets = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("entrypoints").call()) === "boolean"
			) {
				options.entrypoints = y;
			}
		}

		{
			let y;
			if (typeof (y = this.hooks.setValue.for("chunks").call()) === "boolean") {
				options.chunks = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("chunkModules").call()) ===
				"boolean"
			) {
				options.chunkModules = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("chunkOrigins").call()) ===
				"boolean"
			) {
				options.chunkOrigins = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("modules").call()) === "boolean"
			) {
				options.modules = y;
			}
		}
		...
		{
			let y;
			if (typeof (y = this.hooks.setValue.for("depth").call()) === "boolean") {
				options.depth = y;
			}
		}
		...
		{
			let y;
			if (typeof (y = this.hooks.setValue.for("cached").call()) === "boolean") {
				options.cached = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("cachedAssets").call()) ===
				"boolean"
			) {
				options.cachedAssets = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("reasons").call()) === "boolean"
			) {
				options.reasons = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("providedExports").call()) ===
				"boolean"
			) {
				options.providedExports = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("optiomizationBailout").call()) ===
				"boolean"
			) {
				options.optiomizationBailout = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("children").call()) === "boolean"
			) {
				options.children = y;
			}
		}
		...
		{
			let y;
			if (typeof (y = this.hooks.setValue.for("source").call()) === "boolean") {
				options.source = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("moduleTrace").call()) === "boolean"
			) {
				options.moduleTrace = y;
			}
		}

		{
			let y;
			if (typeof (y = this.hooks.setValue.for("errors").call()) === "boolean") {
				options.errors = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("warnings").call()) === "boolean"
			) {
				options.warnings = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("warningFilter").call()) ===
				"boolean"
			) {
				options.warningFilter = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("publicPath").call()) === "boolean"
			) {
				options.publicPath = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("sortModules").call()) === "boolean"
			) {
				options.sortModules = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("sortChunks").call()) === "boolean"
			) {
				options.sortChunks = y;
			}
		}

		{
			let y;
			if (
				typeof (y = this.hooks.setValue.for("outputPath").call()) === "boolean"
			) {
				options.outputPath = y;
			}
		}
