...
class Stats extends Tapable {
	...
	toJson(options, forToString) {
		...
		// Leveraging Block scoping of ES6
		{
			const y = this.hooks.setValue.for("performance").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("hash").call();
			if (typeof y === "boolean") {
				options.hash = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("env").call();
			if (typeof y === "boolean") {
				options.env = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("version").call();
			if (typeof y === "boolean") {
				options.version = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("timings").call();
			if (typeof y === "boolean") {
				options.timings = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("builtAt").call();
			if (typeof y === "boolean") {
				options.builtAt = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("assets").call();
			if (typeof y === "boolean") {
				options.assets = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("entrypoints").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("chunks").call();
			if (typeof y === "boolean") {
				options.chunks = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("chunkModules").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("chunkOrigins").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("modules").call();
			if (typeof y === "boolean") {
				options.modules = y;
			}
		}
		{
			const y = this.hooks.setValue.for("nestedModules").call();
			if (typeof y === "boolean") {
				options.nestedModules = y;
			}
		}

		{
			const y = this.hooks.setValue.for("depth").call();
			if (typeof y === "boolean") {
				options.depth = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("cached").call();
			if (typeof y === "boolean") {
				options.cached = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("cachedAssets").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("reasons").call();
			if (typeof y === "boolean") {
				options.reasons = y;
			}
		}
		{
			const y = this.hooks.setValue.for("usedExports").call();
			if (typeof y === "boolean") {
				options.usedExports = y;
			}
		}

		{
			const y = this.hooks.setValue.for("providedExports").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("optiomizationBailout").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("children").call();
			if (typeof y === "boolean") {
				options.children = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("source").call();
			if (typeof y === "boolean") {
				options.source = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("moduleTrace").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("errors").call();
			if (typeof y === "boolean") {
				options.errors = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("warnings").call();
			if (typeof y === "boolean") {
				options.warnings = y;
			}
		}
		...
		{
			const y = this.hooks.setValue.for("warningFilter").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("publicPath").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("sortModules").call();
			if (typeof y === "boolean") {
		...
		{
			const y = this.hooks.setValue.for("sortChunks").call();
			if (typeof y === "boolean") {
				options.sortChunks = y;
			}
		}
		{
			const y = this.hooks.setValue.for("maxModules").call();
			if (typeof y === "number") {
				options.maxModules = y;
			}
		}
		{
			const y = this.hooks.setValue.for("outputPath").call();
			if (typeof y === "boolean") {
