...
import { cachedSetProperty } from "./util/cleverMerge.js";
...
} from "./util/globUtils.js";
/** @typedef {import("./util/globUtils.js").ResolvedContextModuleGlobPattern} ResolvedContextModuleGlobPattern */
...
/** @typedef {import("./ContextModule.js").ResolveDependenciesCallback} ResolveDependenciesCallback */
...
/** @typedef {import("./dependencies/ContextDependency.js").ContextOptions} ContextOptions */
						...
						if (!exclude || !exclude.test(subResource)) {
							fs.stat(subResource, (err, _stat) => {
								...
								if (stat.isDirectory()) {
									...
									fileObjs.push({
										context: ctx,
										request: `.${subResource.slice(ctx.length).replaceAll("\\", "/")}`
									});
									callback();
								} else {
									callback();
...
export default ContextModuleFactory;

export { ContextModuleFactory as "module.exports" };
