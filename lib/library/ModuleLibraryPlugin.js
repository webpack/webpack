...
import HarmonyExportImportedSpecifierDependency from "../dependencies/HarmonyExportImportedSpecifierDependency.js";
import HarmonyExportSpecifierDependency from "../dependencies/HarmonyExportSpecifierDependency.js";
...
import { getEntryRuntime, getRuntimeKey } from "../util/runtime.js";
		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			onDemandExportsGeneration.tap(
				...
				(module, runtimes, source, finalName) => {
					...
					const exportsSourceByRuntime = (buildMeta.exportsSourceByRuntime ||=
						new Map());
			...
			if (topLevelDeclarations) {
				for (const dep of module.dependencies) {
					if (
						...
						(directBindings ||= new Map()).set(dep.name, dep.id);
					}
				}
			}
		}
...
export default ModuleLibraryPlugin;

export { ModuleLibraryPlugin as "module.exports" };
