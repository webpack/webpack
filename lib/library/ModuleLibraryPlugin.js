...
class ModuleLibraryPlugin extends AbstractLibraryPlugin {
	...
	_analyzeUnknownProvidedExports(
		 ...
		 * @param {boolean} isDynamicReexport if is dynamic reexported
		 */
		const resolveDynamicStarReexport = (module, isDynamicReexport) => {
			for (const connection of moduleGraph.getOutgoingConnections(module)) {
				...
				if (
					...
					// The imported module's provided exports are unknown
					...
					// If parent importer modules existing `dynamic-reexport` dependency
