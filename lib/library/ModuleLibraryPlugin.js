		...
		compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.additionalChunkRuntimeRequirements.tap(
				...
				(chunk, set, { chunkGraph, codeGenerationResults }) => {
					...
					// If the generated source already references
					// `__webpack_require__.d` for some other reason
					// (namespace objects, deferred externals) the helpers are
					// still needed.
					...
					if (
						jsSource &&
						String(jsSource.source()).includes(
