...
import StackedCacheMap from "./util/StackedCacheMap.js";
import createHash from "./util/createHash.js";
import { create as createResolver } from "./util/enhanced-resolve.js";
import { dirname, join, lstatReadlinkAbsolute, relative } from "./util/fs.js";
...
/** @typedef {import("./util/fs.js").JsonObject} JsonObject */
/** @typedef {import("./util/fs.js").IStats} IStats */
 ...
 * @template T
 * @typedef {import("./util/AsyncQueue.js").Callback<T>} ProcessorCallback
 */
/**
 * Defines the processor type used by this module.
 * @template T, R
 * @typedef {import("./util/AsyncQueue.js").Processor<T, R>} Processor
 */
								...
								if (childPath) {
									...
									for (const modulePath of module.paths) {
										if (childPath.startsWith(modulePath)) {
											...
											let request = subPath.replaceAll("\\", "/");
...
export { FileSystemInfo as "module.exports" };
