...
class FileSystemInfo {
	...
	/**
	 * @param {ReadonlyMap<string, FileSystemInfoEntry | ExistanceOnlyTimeEntry | "ignore" | null>} map timestamps
	...
	/**
	 * @param {ReadonlyMap<string, ContextFileSystemInfoEntry | ExistanceOnlyTimeEntry | "ignore" | null>} map timestamps
	 * @param {boolean=} immutable if 'map' is immutable and FileSystemInfo can keep referencing it
	 * @returns {void}
	 */
