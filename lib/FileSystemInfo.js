...
class FileSystemInfo {
	...
	clear() {
		...
		this._fileTimestamps = undefined;
		this._contextTimestamps = undefined;
	 ...
	 * @returns {void}
	 */
	useFileTimestamps(map) {
		this._fileTimestamps = map;
		this._cachedDeprecatedFileTimestamps = undefined;
	}
	 ...
	 * @returns {void}
	 */
	useContextTimestamps(map) {
		this._contextTimestamps = map;
		this._cachedDeprecatedContextTimestamps = undefined;
	}

	/**
	 * @deprecated File stamps are managed by Compiler object. To be removed in v6.
	 * @param {Map<string, FileSystemInfoEntry | "ignore" | null>} map timestamps
	 * @returns {void}
	 */
