...
/** @typedef { "amd" | "commonjs" | "dynamic-import" | "static-import" } ExternalCategory */
/** @typedef {{ attributes?: ImportAttributes, externalCategory?: ExternalCategory | undefined }} ImportDependencyMeta */
...
class ExternalModule extends Module {
	...
	_resolveExternalType(externalType) {
		if (externalType === "module-import") {
			...
			// fall back to "module" for non `import` or `import()` external
			return "module";
