...
ExternalModule.prototype.source = function() {
	...
	str = sourceBuilders[type].call(this);
...
registSourceBuilder('amd umd umd2', function(request) {
	var source = "";
	if(this.optional) {
		source += "if(typeof __WEBPACK_EXTERNAL_MODULE_" + this.id + "__ === 'undefined') {" + WebpackMissingModule.moduleCode(request) + "}\n";
	}
	source += "module.exports = __WEBPACK_EXTERNAL_MODULE_" + this.id + "__;";
	return source;
});
...
registSourceBuilder('*', function(request) {
	var source = "";
	if(this.optional) {
		source += "if(typeof " + request + " === 'undefined') {" + WebpackMissingModule.moduleCode(request) + "}\n";
	}
	source += "module.exports = " + request + ";";
	return source;
});
