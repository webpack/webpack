...
import extractUrlAndGlobal from "./util/extractUrlAndGlobal.js";
...
/** @typedef {import("../declarations/WebpackOptions.js").ExternalItemInterop} ExternalInterop */
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectDeserializerContext<[ExternalModuleRequest, ExternalsType, string, DependencyMeta | undefined, ExternalInterop | undefined]>} ObjectDeserializerContext */
/** @typedef {import("./serialization/ObjectMiddleware.js").ObjectSerializerContext<[ExternalModuleRequest, ExternalsType, string, DependencyMeta | undefined, ExternalInterop | undefined]>} ObjectSerializerContext */
...
/** @typedef {{ sourceType: "asset-url" }} AssetDependencyMeta */
...
export { ModuleExternalInitFragment };
export { getExternalModuleNodeCommonjsInitFragment };
...
export { ExternalModule as "module.exports" };
