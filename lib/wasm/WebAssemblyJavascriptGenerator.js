	...
	generate(module, dependencyTemplates, runtimeTemplate) {
		...
		const source = new RawSource(
			[
				...
				// export symbols from wasm to be available by imported modules (when circular)
				"// export exports from WebAssembly module",
				generateExports(),

				// exec all imported modules to keep esm import order correct
				"// exec imports from WebAssembly module",
				generateImports(),
