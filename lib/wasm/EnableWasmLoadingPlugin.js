			...
			switch (type) {
				case "fetch": {
					if (compiler.options.experiments.syncWebAssembly) {
						const FetchCompileWasmPlugin =
							/** @type {typeof import("../web/FetchCompileWasmPlugin.js").default} */ (
								require("../web/FetchCompileWasmPlugin.js")
							);
				...
				case "async-node": {
					if (compiler.options.experiments.syncWebAssembly) {
						const ReadFileCompileWasmPlugin =
							/** @type {typeof import("../node/ReadFileCompileWasmPlugin.js").default} */ (
								require("../node/ReadFileCompileWasmPlugin.js")
							);
