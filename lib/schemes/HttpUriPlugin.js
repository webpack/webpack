...
/** @typedef {import("../../declarations/plugins/schemes/HttpUriPlugin.js").HttpUriPluginOptions} HttpUriPluginOptions */
/** @typedef {import("../Compiler.js").default} Compiler */
/** @typedef {import("../FileSystemInfo.js").Snapshot} Snapshot */
/** @typedef {import("../Module.js").BuildInfo} BuildInfo */
/** @typedef {import("../NormalModuleFactory.js").ResourceDataWithData} ResourceDataWithData */
...
const proxyFetch = (request, proxy) => (url, options, callback) => {
	...
	// eslint-disable-next-line unicorn/prefer-event-target -- Node-only code; EventEmitter is the idiomatic error channel here
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/schemes/HttpUriPlugin.check.js")} */ (
...
Run build with un-frozen lockfile to automatically fix lockfile.`
					...
					hooks.readResource
						...
						.tapAsync(PLUGIN_NAME, (loaderContext, callback) =>
							getInfo(loaderContext.resource, (err, _result) => {
								if (err) return callback(err);
								const result = /** @type {Info} */ (_result);
...
export default HttpUriPlugin;

export { HttpUriPlugin as "module.exports" };
