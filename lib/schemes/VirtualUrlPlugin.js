...
import { getContext } from "../loaders/LoaderRunner.js";
import { isAbsolute, join } from "../util/fs.js";
import { parseResourceWithoutFragment } from "../util/identifier.js";
 ...
 * @typedef {import("../../declarations/plugins/schemes/VirtualUrlPlugin.js").VirtualModule} VirtualModuleConfig
 * @typedef {import("../../declarations/plugins/schemes/VirtualUrlPlugin.js").VirtualModuleContent} VirtualModuleInput
 * @typedef {import("../../declarations/plugins/schemes/VirtualUrlPlugin.js").VirtualUrlOptions} VirtualUrlOptions
 */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/schemes/VirtualUrlPlugin.check.js")} */ (
						require("../../schemas/plugins/schemes/VirtualUrlPlugin.check.js")
					)(options)
			);
		});
						...
						if (context === "auto") {
							...
							if (context === path) {
								...
								resourceData.context = isAbsolute(resolvedContext)
									? resolvedContext
									: join(
											/** @type {import("../index.js").InputFileSystem} */
...
export default VirtualUrlPlugin;

export { VirtualUrlPlugin as "module.exports" };
