...
/**
 * @import {
 * 	VirtualModule as VirtualModuleConfig,
 * 	VirtualModuleContent as VirtualModuleInput,
 * 	VirtualUrlOptions
 * } from "../../declarations/plugins/schemes/VirtualUrlPlugin"
 */

/** @typedef {(loaderContext: LoaderContext<any>) => Promise<string | Buffer> | string | Buffer} SourceFn */
