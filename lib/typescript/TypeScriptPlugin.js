...
import ModuleBuildError from "../errors/ModuleBuildError.js";
...
/** @typedef {import("../NormalModule.js").default} NormalModuleType */
/** @typedef {import("../NormalModule.js").Result} Result */
...
class TypeScriptPlugin {
	...
	_processResult(result, module) {
		...
		const needSourceMap = module.sourceMapKind !== "none";
...
export { TypeScriptPlugin as "module.exports" };
