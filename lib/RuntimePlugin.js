...
const ConcatenationWrapRuntimeModule = require("./runtime/ConcatenationWrapRuntimeModule");
const ConstructRequireRuntimeModule = require("./runtime/ConstructRequireRuntimeModule");
...
const GetWorkletBootstrapRuntimeModule = require("./runtime/GetWorkletBootstrapRuntimeModule");
...
const SIMPLE_TREE_RUNTIME_MODULES = [
	...
	[RuntimeGlobals.concatenationWrap, ConcatenationWrapRuntimeModule],
	[RuntimeGlobals.constructRequire, ConstructRequireRuntimeModule],
	[
		RuntimeGlobals.setAnonymousDefaultName,
