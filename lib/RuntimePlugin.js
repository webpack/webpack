...
const AnalyzableEsmFullHashRuntimeModule = require("./runtime/AnalyzableEsmFullHashRuntimeModule");
...
class RuntimePlugin {
	...
	apply(compiler) {
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.runtimeRequirementInTree
				.for(RuntimeGlobals.analyzableEsmFullHash)
				.tap(PLUGIN_NAME, (chunk) => {
					compilation.addRuntimeModule(
						chunk,
						new AnalyzableEsmFullHashRuntimeModule()
					);
					return true;
				});
			compilation.hooks.runtimeRequirementInTree
