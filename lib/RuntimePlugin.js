...
const PromiseRuntimeModule = require("./runtime/PromiseRuntimeModule");
...
class RuntimePlugin {
	...
	apply(compiler) {
		compiler.hooks.compilation.tap("RuntimePlugin", compilation => {
			...
			compilation.hooks.runtimeRequirementInTree
				.for(RuntimeGlobals.promise)
				.tap("RuntimePlugin", chunk => {
					compilation.addRuntimeModule(chunk, new PromiseRuntimeModule());
					return true;
				});
			compilation.hooks.runtimeRequirementInTree
