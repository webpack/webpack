...
const getMergeExportsRuntimeModule = lazyModule(() =>
	require("./runtime/MergeExportsRuntimeModule")
);
...
const TREE_DEPENDENCIES = {
	...
	[RuntimeGlobals.mergeExports]: [RuntimeGlobals.makeNamespaceObject],
...
const SIMPLE_TREE_RUNTIME_MODULES = [
	...
	[RuntimeGlobals.mergeExports, getMergeExportsRuntimeModule],
	[
		RuntimeGlobals.createFakeNamespaceObject,
