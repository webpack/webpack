...
const GetWorkletChunksRuntimeModule = require("./runtime/GetWorkletChunksRuntimeModule");
...
const GetWorkletBootstrapFilenameRuntimeModule = require("./runtime/GetWorkletBootstrapFilenameRuntimeModule");
...
class RuntimePlugin {
	...
	apply(compiler) {
		compiler.hooks.compilation.tap("RuntimePlugin", compilation => {
			...
			compilation.hooks.runtimeRequirementInTree
				.for(RuntimeGlobals.getWorkletChunks)
				.tap("RuntimePlugin", chunk => {
					compilation.addRuntimeModule(
						chunk,
						new GetWorkletChunksRuntimeModule()
					);
					return true;
				});
			compilation.hooks.runtimeRequirementInTree
				.for(RuntimeGlobals.getWorkletBootstrapFilename)
				.tap("RuntimePlugin", (chunk, set) => {
					compilation.addRuntimeModule(
						chunk,
						new GetWorkletBootstrapFilenameRuntimeModule(
							RuntimeGlobals.getWorkletBootstrapFilename
						)
					);
					return true;
				});
