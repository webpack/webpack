...
const getPromiseRuntimeModule = lazyModule(() =>
	require("./runtime/PromiseRuntimeModule")
);
...
const TREE_DEPENDENCIES = {
	[RuntimeGlobals.ensureChunk]: [RuntimeGlobals.promise],
	[RuntimeGlobals.asyncModule]: [RuntimeGlobals.promise],
	[RuntimeGlobals.startupEntrypoint]: [RuntimeGlobals.promise],
...
const SIMPLE_TREE_RUNTIME_MODULES = [
	...
	[RuntimeGlobals.promise, getPromiseRuntimeModule],
