...
// Each runtime module below is only constructed from a `runtimeRequirementInTree`
// tap, so it loads only for a build that emits it — most reach a handful of ~30.
