...
const DynamicPublicPathRuntimeModule = require("./runtime/DynamicPublicPathRuntimeModule");
		...
		compiler.hooks.compilation.tap("RuntimePlugin", compilation => {
			...
			compilation.hooks.runtimeRequirementInTree
				...
				.tap("RuntimePlugin", (chunk, set) => {
					...
					if (publicPath === "__webpack_dynamic_public_path__") {
						const module = new DynamicPublicPathRuntimeModule();
