...
module.exports = mergeExports(fn, {
	...
	// TODO webpack 7 remove
	get WebpackOptionsValidationError() {
		return util.deprecate(
			() => require("schema-utils").ValidationError,
			"webpack.WebpackOptionsValidationError is deprecated and has been replaced by webpack.ValidationError",
			"DEP_WEBPACK_OPTIONS_DEFAULTER"
		)();
	},
	get ValidationError() {
