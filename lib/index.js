...
module.exports = mergeExports(fn, {
	...
	javascript: {
		...
		// terser, carrying the phases of it webpack implements itself. What
		// `jsMinify` minifies with, and where a further phase is installed.
		get terser() {
			return require("./javascript/terser");
		}
	},
