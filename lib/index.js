...
/** @typedef {import("./asset/AssetModule").AssetBuildInfo} AssetBuildInfo */
/** @typedef {import("./ChunkGroup")} ChunkGroup */
/** @typedef {import("./Compiler").AssetEmittedInfo} AssetEmittedInfo */
/** @typedef {import("./ContextModule").ContextModuleBuildInfo} ContextModuleBuildInfo */
/** @typedef {import("./css/CssModule").CssBuildInfo} CssBuildInfo */
/** @typedef {import("./css/CssModule").CssBuildMeta} CssBuildMeta */
/** @typedef {import("./ExternalModule").ExternalModuleBuildInfo} ExternalModuleBuildInfo */
/** @typedef {import("./html/HtmlModule").HtmlBuildInfo} HtmlBuildInfo */
...
/** @typedef {import("./json/JsonModule").JsonBuildInfo} JsonBuildInfo */
...
/** @typedef {import("./wasm-sync/SyncWasmModule").SyncWasmBuildMeta} SyncWasmBuildMeta */
