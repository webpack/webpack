...
module.exports = mergeExports(fn, {
	...
	dependencies: {
		get ModuleDependency() {
			return require("./dependencies/core/ModuleDependency");
		},
		...
		get ConstDependency() {
			return require("./dependencies/core/ConstDependency");
		},
		get NullDependency() {
			return require("./dependencies/core/NullDependency");
		}
	},
	...
	module: {
		get NullFactory() {
			return require("./module/NullFactory");
		}
	},

	template: {
		get DependencyTemplate() {
			return require("./template/DependencyTemplate");
		}
	},
	...
	util: {
		...
		// The wrapper `serialization.register` is normally reached through: a
		// dependency or module a plugin adds must call it to survive the cache.
		get makeSerializable() {
			return require("./util/makeSerializable");
		},
		get cleverMerge() {
