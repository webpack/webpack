...
module.exports = mergeExports(fn, {
	...
	/**
	 * @returns {(configuration: Configuration | ReadonlyArray<Configuration> & MultiCompilerOptions) => void} validate fn
	 */
	get validate() {
		const webpackOptionsSchemaCheck =
			/** @type {(configuration: Configuration | ReadonlyArray<Configuration> & MultiCompilerOptions) => boolean} */
