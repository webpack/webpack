...
module.exports = mergeExports(fn, {
	...
	javascript: {
		...
		// What `jsMinify` minifies with: terser, carrying the phases of it webpack
		// implements itself, and where a further phase is installed.
		get printer() {
			return require("./javascript/syntax-printer");
		}
	},
