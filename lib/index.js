...
module.exports = mergeExports(fn, {
	...
	/**
	 * Types a configuration object, or a factory returning one.
	 * @deprecated use `config.defineConfig` — TODO in the next major release: remove
	 * @returns {typeof import("./config/defineConfig")} the moved export
	 */
	get defineConfig() {
