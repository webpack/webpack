...
import { ConcatSource, PrefixSource } from "./util/webpack-sources.js";
...
/** @typedef {import("./ModuleTemplate.js").default} ModuleTemplate */
...
/** @typedef {import("./javascript/JavascriptModulesPlugin.js").RenderContext} RenderContext */
 ...
 * @property {string | import("./TemplatedPathPlugin.js").TemplatePathFn<EXPECTED_ANY>} filenameTemplate
...
class Template {
	...
	static getFunctionContent(fn) {
		return fn
			.toString()
			.replaceAll(JSDOC_LINE_REGEX, "")
			.replaceAll(JSDOC_INLINE_REGEX, "")
			.replaceAll(FUNCTION_CONTENT_REGEX, "")
			.replaceAll(INDENT_MULTILINE_REGEX, "")
	...
	static toIdentifier(str) {
		...
		return str
			...
			.replaceAll(IDENTIFIER_ALPHA_NUMERIC_NAME_REPLACE_REGEX, "_");
	}
	...
	static toComment(str) {
		if (!str) return "";
		return `/*! ${str.includes("*/") ? str.replaceAll(COMMENT_END_REGEX, "* /") : str} */`;
	}
	...
	static toPath(str) {
		if (typeof str !== "string") return "";
		return str
			.replaceAll(PATH_NAME_NORMALIZE_REPLACE_REGEX, "-")
			.replaceAll(MATCH_PADDED_HYPHENS_REPLACE_REGEX, "");
	}
...
export { NUMBER_OF_IDENTIFIER_START_CHARS };

// attach named exports as properties to keep the CJS shape
Template.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS =
	NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS;
Template.NUMBER_OF_IDENTIFIER_START_CHARS = NUMBER_OF_IDENTIFIER_START_CHARS;

export { Template as "module.exports" };
