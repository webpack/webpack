...
class Chunk {
	...
	integrate(otherChunk, reason) {
		...
		if (this.name && otherChunk.name) {
			if (this.name.length !== otherChunk.name.length) this.name = this.name.length < otherChunk.name.length ? this.name : otherChunk.name;
			else this.name = this.name < otherChunk.name ? this.name : otherChunk.name;
		}
