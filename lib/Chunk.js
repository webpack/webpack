...
class Chunk {
	 ...
	 */
	getParents() {
		return this._parents.getCachedInfo(getArray);
	}
	 ...
	 */
	getBlocks() {
		return this._blocks.getCachedInfo(getArray);
	}
	...
	getModules() {
		return this._modules.getCachedInfo(getArray);
	}
	...
	modulesSize() {
		return this._modules.getOrderIndependentCachedInfo(getModulesSize);
	}
...
Object.defineProperty(Chunk.prototype, "modules", {
	...
	get: util.deprecate(function() {
		return this._modules.getCachedInfo(getFrozenArray);
...
Object.defineProperty(Chunk.prototype, "chunks", {
	configurable: false,
	get: util.deprecate(function() {
		return this._chunks.getCachedInfo(getFrozenArray);
...
Object.defineProperty(Chunk.prototype, "parents", {
	configurable: false,
	get: util.deprecate(function() {
		return this._parents.getCachedInfo(getFrozenArray);
...
Object.defineProperty(Chunk.prototype, "blocks", {
	configurable: false,
	get: util.deprecate(function() {
		return this._blocks.getCachedInfo(getFrozenArray);
