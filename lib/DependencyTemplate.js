 ...
 * @property {CssIcssImportData} cssIcssImportData the icss import data
 */
...
/** @typedef {{[importName: string]: {importValue: string, module: Module, replaceRanges: [number, number][]}}} CssIcssImportData the icss imports */
