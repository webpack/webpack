 ...
 * } from "../../declarations/plugins/debug/ProfilingPlugin"
 */
...
class Profiler {
	 ...
	 * @returns {Promise<any | void>} Promise for the result
	 */
...
/** @typedef {Record<string, Hook<any, any> | FakeHook<any> | HookMap<any>>} Hooks */

/**
 * Intercept all hooks for.
 * @param {object & { hooks?: Hooks }} instance instance
...
/** @typedef {(...args: any[]) => any | Promise<(...args: any[]) => any>} PluginFunction */
 ...
 * @param {Trace} tracer tracer
 * @returns {(hookName: string) => HookInterceptor<any, any>} interceptor
 */
