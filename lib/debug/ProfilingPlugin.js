...
import { dirname, mkdirpSync } from "../util/fs.js";

const require = createRequire(import.meta.url);
/** @typedef {import("inspector").Session} Session */
/** @typedef {import("tapable").FullTap} FullTap */
/** @typedef {import("../../declarations/plugins/debug/ProfilingPlugin.js").ProfilingPluginOptions} ProfilingPluginOptions */
	...
	apply(compiler) {
		compiler.hooks.validate.tap(PLUGIN_NAME, () => {
			compiler.validate(
				...
				(options) =>
					/** @type {typeof import("../../schemas/plugins/debug/ProfilingPlugin.check.js")} */ (
