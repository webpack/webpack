...
class ProfilingPlugin {
	...
	apply(compiler) {
		...
		// Compiler Hooks
		for (cnst [hookName, hook] of getHooks(null, compiler.hooks))
...
const interceptTemplateInstancesFrom = (compilation, tracer) => {
	...
	[
		...
		for (const [hookName, hook] of getHooks(templateObject.instance)) {
...
const interceptAllHooksFor = (instance, tracer, logLabel) => {
	for (const [hookName, hook] of getHooks(instance)) {
