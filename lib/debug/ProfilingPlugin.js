...
/**
 * @template T
 * @typedef {import("tapable").HookMapInterceptor<T>} HookMapInterceptor
 */
...
/**
 * @param {{ hooks: Record<string, Hook<EXPECTED_ANY, EXPECTED_ANY> | FakeHook<EXPECTED_ANY> | HookMap<EXPECTED_ANY>> }} instance instance
