 ...
 * @param {{counter: number, trace: *, profiler: *}} tracer Instance of tracer.
 // @ts-ignore
 * @param {{name: string, type: string, fn: Function}} obj Options for the profiled fn.
...
// @ts-ignore An export assignment cannot be used in a module with other exported elements.
