...
const { dirname, join, maybeFileURLToPath, mkdirp } = require("./util/fs");
...
class Compiler {
	...
	constructor(context, options = /** @type {WebpackOptions} */ ({})) {
		...
		this.context = maybeFileURLToPath(context);

		this.requestShortener = new RequestShortener(this.context, this.root);
