...
class Compiler {
	...
	constructor(context, options = /** @type {WebpackOptions} */ ({})) {
		this.hooks = Object.freeze({
			...
			/** @type {AsyncParallelHook<[Validate]>} */
...
${other}`);
	...
	/**
	 * @param {Parameters<Validate>} args the arguments to pass to the validate function
	 * @returns {ReturnType<Validate>} the return value of the validate function
	 */
	validate(...args) {
		return getValidate()(...args);
	}
}
