 ...
 * @typedef {(value: EXPECTED_OBJECT | EXPECTED_OBJECT[], schema: Schema, check?: ((value: EXPECTED_ANY) => boolean), options?: ValidationErrorConfiguration) => void} SchemaValidationFunction
 */
