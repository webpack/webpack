 ...
 * @typedef {(value: EXPECTED_OBJECT | EXPECTED_OBJECT[], schema: Schema, check?: ((value: EXPECTED_OBJECT | EXPECTED_OBJECT[]) => boolean), options?: ValidationErrorConfiguration) => void} SchemaValidationFunction
 */
