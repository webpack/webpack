...
/** @typedef {KnownRecords & Record<string, KnownRecords[]> & Record<string, any>} Records */
...
/** @typedef {import("./util/WeakTupleMap")<any[], any>} MemCache */
...
${other}`);
	 ...
	 * @template {object | object[]} [T=object]
