			...
			apply: (compiler) => {
				...
				if (minifyJs && !minifyCss && !minifyHtml && !minifyJson) {
					new TerserPlugin({
						...
						minify: require.resolve("../javascript/jsMinify"),
				...
				const htmlOptions =
					typeof minimizeByType.html === "object"
						...
						: undefined;
				if (minifyJs) {
					minify.push(require.resolve("../javascript/jsMinify"));
					minimizerOptions.push(terserOptions);
					extensions.push("[cm]?js");
				}
				if (minifyCss) {
					minify.push(require.resolve("../css/cssMinify"));
				...
				if (minifyHtml) {
					minify.push(require.resolve("../html/htmlMinify"));
				...
				if (minifyJson) {
					minify.push(require.resolve("../json/jsonMinify"));
					minimizerOptions.push({});
