...
const applyOutputDefaults = (
	...
	// Stage 3 syntax no target preset reports on yet, so nothing is assumed: a
	// build says its runtime reads it, or the phase keeps webpack's own form.
	D(environment, "deferImport", false);
	D(environment, "sourceImport", false);
	F(
		environment,
		"destructuring",
		() =>
