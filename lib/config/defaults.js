	...
	A(optimization, "minimizer", () => [
		{
			apply: (compiler) => {
				...
				/** @type {(typeof import("../javascript/jsMinify") | typeof import("../css/cssMinify") | typeof import("../html/htmlMinify") | typeof TerserPlugin.jsonMinify)[]} */
				const minify = [];
				...
				if (minifyJson) {
					// It cannot run in a worker, so it minifies on the main thread
					// while the pool keeps the other languages.
					minify.push(TerserPlugin.jsonMinify);
					minimizerOptions.push({});
