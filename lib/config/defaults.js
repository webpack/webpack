 ...
 * usedExportProperties: NonNullable<Optimization["usedExportProperties"]>,
...
const applyOptimizationDefaults = (
	optimization,
	{ production, development, css, records, library }
) => {
	...
	D(optimization, "usedExportProperties", production && !library);
