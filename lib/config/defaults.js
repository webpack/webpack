	...
	A(optimization, "minimizer", () => [
		{
			apply: (compiler) => {
				...
				// One minimizer instance, so one worker pool, dispatching an array of
				// minify functions by `filter`. `test` is widened to let the CSS and
				// HTML assets reach that dispatcher.
