...
const applyOptimizationDefaults = (
	...
	// normalization: fold it in here too, so `minimize` stays a boolean. The
	// normalized type is already one, hence the cast.
	...
	if (typeof minimizeAssignedInApply === "object") {
		F(
			optimization,
			"minimizeOptions",
			() => /** @type {OptimizationMinimizeOptions} */ (minimizeAssignedInApply)
		);
