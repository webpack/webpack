...
/** @typedef {import("../../declarations/WebpackOptions").JavascriptGeneratorOptions} JavascriptGeneratorOptions */
...
const applyJavascriptParserOptionsDefaults = (
	parserOptions,
	{ futureDefaults, deferImport, sourceImport, isNode, outputModule, library }
) => {
...
/**
 * Apply javascript generator options defaults.
 * @param {JavascriptGeneratorOptions} generatorOptions generator options
 * @param {object} options options
 * @param {WebpackOptionsNormalized["output"]["library"]} options.library library options
 * @returns {void}
 */
const applyJavascriptGeneratorOptionsDefaults = (
	generatorOptions,
	{ library }
) => {};
...
const applyModuleDefaults = (
	...
	F(module.generator, "javascript", () => ({}));
	applyJavascriptGeneratorOptionsDefaults(
		/** @type {NonNullable<GeneratorOptionsByModuleTypeKnown["javascript"]>} */
		(module.generator.javascript),
		{ library }
	);
