...
/** @typedef {import("../../declarations/WebpackOptions").ExperimentsNormalizedExtra} ExperimentsNormalizedExtra */
...
const applyWebpackOptionsDefaults = (options, compilerIndex) => {
	...
	applyModuleDefaults(options.module, {
		...
		strictModeChecks:
			/** @type {NonNullable<ExperimentsNormalizedExtra["strictModeChecks"]>} */
			(options.experiments.strictModeChecks),
		futureDefaults,
 ...
 * @param {boolean | "warn" | "error"} options.strictModeChecks is strictModeChecks experiment enabled
 * @returns {void}
 */
const applyJavascriptParserOptionsDefaults = (
	parserOptions,
	{ futureDefaults, deferImport, isNode, strictModeChecks }
) => {
	...
	// Backward-compat: map deprecated strictCompatibility -> strictModeChecks
	if (
		parserOptions.strictModeChecks === undefined &&
		parserOptions.strictCompatibility !== undefined
	) {
		parserOptions.strictModeChecks = parserOptions.strictCompatibility;
	}
	// Default when experiment is enabled
	if (strictModeChecks && parserOptions.strictModeChecks === undefined) {
		parserOptions.strictModeChecks = "warn";
	}
