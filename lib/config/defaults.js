...
const applyOutputDefaults = (
	...
	const declaredLibraryTypes = () => {
		...
		// A plugin declaring its own library (`ModuleFederationPlugin`) is applied
		// before the defaults and has pushed its type here already. `"..."` is the
		// extend placeholder `A` resolves later, never a type of its own.
