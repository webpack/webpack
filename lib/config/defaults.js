...
const applyPerformanceDefaults = (performance, { production }) => {
	...
	D(performance, "cacheEffectiveness", false);
	D(performance, "circularDependencies", false);
	D(performance, "conflictingResourceHints", false);
	D(performance, "duplicateModules", false);
	D(performance, "duplicatePackages", false);
	D(performance, "dynamicExports", false);
	D(performance, "entrypointOverlap", false);
	D(performance, "missingSideEffects", false);
	D(performance, "osDependentRules", false);
	D(performance, "redundantDynamicImports", false);
	D(performance, "scopeHoistingBailouts", false);
	D(performance, "splitChunksCapped", false);
	D(performance, "unsplitVendors", false);
	D(performance, "unusedAliases", false);
	D(performance, "unusedDefines", false);
	D(performance, "unusedExternals", false);
	D(performance, "unusedReexports", false);
	D(performance, "unusedRules", false);
