 ...
 * localImportBindings: NonNullable<Optimization["localImportBindings"]>,
...
const applyOptimizationDefaults = (
	...
	D(optimization, "localImportBindings", development);
	...
	if (optimization.minimize) {
		...
		F(minimizeOptions, "javascript", () => ({ compress: { passes: 2 } }));
