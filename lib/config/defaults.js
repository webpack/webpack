	...
	A(optimization, "minimizer", () => [
		{
			apply: (compiler) => {
				...
				if (minifyHtml) {
					// `optimization.minimize` as an object carries what each minimizer
					// may do beyond the transforms that always apply.
					const { minimize } = compiler.options.optimization;
					minify.push(require("../html/htmlMinify"));
					minimizerOptions.push({
						environment: cssEnvironment,
						...(typeof minimize === "object" ? minimize.html : undefined)
					});
				}
