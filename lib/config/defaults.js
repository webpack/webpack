...
const applyModuleDefaults = (
	...
	A(module, "defaultRules", () => {
		...
		if (html) {
			...
			// `data:text/html` module. Force `extract` so the nested module exposes
			// the processed HTML on the `html` codegen channel that
			// `HtmlInlineHtmlDependency.Template` reads back into the attribute.
			rules.push({
