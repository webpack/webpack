	...
	A(optimization, "minimizer", () => [
		{
			apply: (compiler) => {
				...
				if (minifyHtml) {
					...
					// `terserOptions` for the same reason as `environment`: an inline
					// `<script>` runs through terser too, and a `.js` asset and the same
					// source inline must not be minified differently.
