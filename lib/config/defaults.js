...
const applyOutputDefaults = (
	...
	F(output, "globalObject", () => {
		if (tp) {
			...
			// Universal target (web + node, neither specific): `globalThis` is the only
			// accessor available everywhere, so prefer it even for non-ESM (e.g. UMD)
			// output unless a merged version explicitly lacks it (tp.globalThis === false)
