	...
	A(optimization, "minimizer", () => [
		{
			apply: (compiler) => {
				...
				if (!minifyJs && !minifyCss && !minifyHtml) return;
				...
				if (minifyJs && !minifyCss && !minifyHtml) {
					new TerserPlugin({
				...
				/** @type {(typeof import("../javascript/jsMinify") | typeof import("../css/cssMinify") | typeof import("../html/htmlMinify"))[]} */
				const minify = [];
