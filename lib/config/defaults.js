...
import RuleSetCompiler from "../rules/RuleSetCompiler.js";
...
/** @typedef {import("../../declarations/WebpackOptions.js").CacheOptionsNormalized} CacheOptionsNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").Context} Context */
/** @typedef {import("../../declarations/WebpackOptions.js").DevTool} Devtool */
/** @typedef {import("../../declarations/WebpackOptions.js").CssGeneratorOptions} CssGeneratorOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").EntryDescription} EntryDescription */
/** @typedef {import("../../declarations/WebpackOptions.js").EntryNormalized} Entry */
/** @typedef {import("../../declarations/WebpackOptions.js").Environment} Environment */
/** @typedef {import("../../declarations/WebpackOptions.js").Experiments} Experiments */
/** @typedef {import("../../declarations/WebpackOptions.js").ExperimentsNormalized} ExperimentsNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").ExternalsPresets} ExternalsPresets */
...
/** @typedef {import("../../declarations/WebpackOptions.js").JsonGeneratorOptions} JsonGeneratorOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").Library} Library */
...
/** @typedef {import("../../declarations/WebpackOptions.js").Loader} Loader */
/** @typedef {import("../../declarations/WebpackOptions.js").Mode} Mode */
/** @typedef {import("../../declarations/WebpackOptions.js").HashFunction} HashFunction */
/** @typedef {import("../../declarations/WebpackOptions.js").HashSalt} HashSalt */
...
/** @typedef {import("../../declarations/WebpackOptions.js").ModuleOptionsNormalized} ModuleOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").Node} WebpackNode */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationNormalized} Optimization */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationSplitChunksOptions} OptimizationSplitChunksOptions */
/** @typedef {import("../../declarations/WebpackOptions.js").OutputNormalized} Output */
/** @typedef {import("../../declarations/WebpackOptions.js").ParserOptionsByModuleTypeKnown} ParserOptionsByModuleTypeKnown */
/** @typedef {import("../../declarations/WebpackOptions.js").Performance} Performance */
...
/** @typedef {import("../../declarations/WebpackOptions.js").RuleSetRules} RuleSetRules */
/** @typedef {import("../../declarations/WebpackOptions.js").SnapshotOptions} SnapshotOptions */
...
/** @typedef {import("../javascript/EnableChunkLoadingPlugin.js").ChunkLoadingTypes} ChunkLoadingTypes */
/** @typedef {import("../wasm/EnableWasmLoadingPlugin.js").WasmLoadingTypes} WasmLoadingTypes */
/** @typedef {import("./target.js").PlatformTargetProperties} PlatformTargetProperties */
/** @typedef {import("./target.js").TargetProperties} TargetProperties */
 ...
 * @param {RuleSetRules} options.rules user `module.rules`, used to resolve the css/html/asyncWebAssembly "auto" defaults
 * @returns {void}
 */
const applyExperimentsDefaults = (
	...
	if (experiments.asyncWebAssembly === "auto") {
		experiments.asyncWebAssembly = !RuleSetCompiler.hasRuleForResource(
			rules,
			"/file.wasm"
		);
	}
...
const applyOutputDefaults = (
	...
	F(output, "uniqueName", () => {
		const libraryName = getLibraryName(output.library).replaceAll(
			/^\[(\\*[\w:]+\\*)\](\.)|(\.)\[(\\*[\w:]+\\*)\](?=\.|$)|\[(\\*[\w:]+\\*)\]/g,
			(m, a, d1, d2, b, c) => {
				const content = a || b || c;
	...
	D(output, "hashFunction", DEFAULTS.HASH_FUNCTION);
	...
	if (trustedTypes) {
		F(
			...
			() =>
				...
				(output.uniqueName).replaceAll(/[^a-z0-9\-#=_/@.%]+/gi, "_") ||
				"webpack"
		);
...
export { DEFAULTS };
export { applyWebpackOptionsBaseDefaults };
export { applyWebpackOptionsDefaults };
