...
const applyModuleDefaults = (
	...
	if (html) {
		...
		// `module.parser.html.sources` is intentionally left undefined by
		// default — HtmlParser treats undefined as "use the built-in source
		// list" (same as `true`). Users may pass `false` to disable URL
		// extraction or `{ list: [...] }` to customize it.
