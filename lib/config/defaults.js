...
/** @typedef {import("../../declarations/WebpackOptions").HttpUriOptions} HttpUriOptions */
/** @typedef {import("../../declarations/WebpackOptions").LazyCompilationOptions} LazyCompilationOptions */
...
const applyWebpackOptionsDefaults = (options, compilerIndex) => {
	...
	applyModuleDefaults(options.module, {
		...
		lazyCompilation:
			/** @type {NonNullable<ExperimentsNormalized["lazyCompilation"]>} */
 ...
 * @param {false | LazyCompilationOptions} options.lazyCompilation is lazyCompilation enabled
 * @param {boolean} options.futureDefaults is future defaults enabled
 ...
 * @param {boolean} options.asyncWebAssembly is asyncWebAssembly enabled
 * @param {boolean} options.html is html enabled
 * @param {HttpUriOptions | boolean} options.buildHttp is buildHttp enabled
 * @returns {void}
 */
