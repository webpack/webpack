...
/** @typedef {import("../../declarations/WebpackOptions.js").CacheOptionsNormalized} CacheOptions */
...
/** @typedef {import("../../declarations/WebpackOptions.js").ModuleOptionsNormalized} ModuleOptionsNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationNormalized} OptimizationNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationRuntimeChunk} OptimizationRuntimeChunk */
/** @typedef {import("../../declarations/WebpackOptions.js").OptimizationRuntimeChunkNormalized} OptimizationRuntimeChunkNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").OutputNormalized} OutputNormalized */
/** @typedef {import("../../declarations/WebpackOptions.js").PluginsNormalized} PluginsNormalized */
...
const getNormalizedWebpackOptions = (config) => ({
	...
	optimization: nestedConfig(config.optimization, (optimization) => ({
		...
		emitOnErrors: optimization.emitOnErrors
	})),
	output: nestedConfig(config.output, (output) => {
		...
		const result = {
			...
			library: libraryBase && {
				type: libraryBase.type,
				auxiliaryComment: libraryBase.auxiliaryComment,
				amdContainer: libraryBase.amdContainer,
				export: libraryBase.export,
				name: libraryBase.name,
				umdNamedDefine: libraryBase.umdNamedDefine
			},
