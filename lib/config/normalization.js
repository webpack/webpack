...
/**
 * Gets the per-asset-type options out of the `minimize` shorthand: `minimize`
 * itself stays the boolean plugins have always read off the resolved config.
 ...
 */
const getNormalizedOptimizationMinimizeOptions = (minimize) => {
