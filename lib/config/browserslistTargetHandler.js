...
const resolve = (browsers) => {
	...
	const es6DynamicImport = rawChecker({
		...
		and_uc: [15, 5],
		kaios: [3, 0],
		// Support was added in version 13.2, but the filename parameter can be a WHATWG URL object using the `file:` protocol since version 13.12.0
		node: [13, 12]
