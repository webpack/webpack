...
/**
 * The raw browserslist selection behind the targets (`["chrome 100", "safari
 * 15", …]`), merged across every `browserslist` target and deduplicated —
 * undefined when none is a browserslist target. Prefixing reads this: without a
 * browser list there is no target to prefix for, so it stays off.
 * @param {string[]} targets the targets
 * @param {string} context the context directory
