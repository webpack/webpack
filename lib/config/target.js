 ...
 * @property {boolean | null} nodeBuiltinModuleGetter node.js allows to use `process.getBuiltinModule()` to load core modules synchronously
	...
	[
		...
		(asyncFlag, _, major, minor) => {
			...
			return {
				...
				// process.getBuiltinModule: v22.3.0, backported to v20.16.0 (never in v21)
				nodeBuiltinModuleGetter: Number(major) < 21 ? v(20, 16) : v(22, 3),
