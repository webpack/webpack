...
class ByTypeGenerator extends Generator {
	 ...
	 */
	getConcatenationBailoutReason(module, context) {
		const generator = this.map[JAVASCRIPT_TYPE];
		if (!generator) return super.getConcatenationBailoutReason(module, context);
		return generator.getConcatenationBailoutReason(module, context);
	}
