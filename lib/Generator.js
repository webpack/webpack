...
class Generator {
	 ...
	 */
	static throwBuildErrorCode(error) {
		// A source the parser rejected is a syntax error to every engine, so the
		// module throws what a native import of it would.
		const name =
			error instanceof getModuleParseError() ? "SyntaxError" : "Error";
