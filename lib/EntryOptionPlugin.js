	...
	static applyEntryOption(compiler, context, entry) {
		if (typeof entry === "function") {
			const DynamicEntryPlugin =
				/** @type {typeof import("./DynamicEntryPlugin.js").default} */ (
					require("./DynamicEntryPlugin.js")
				);

			new DynamicEntryPlugin(context, entry).apply(compiler);
		} else {
			const EntryPlugin =
				/** @type {typeof import("./EntryPlugin.js").default} */ (
...
export { EntryOptionPlugin as "module.exports" };
