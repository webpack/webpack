					...
					() => {
						...
						for (const key of Object.keys(records.chunkHashes)) {
							...
							if (
								...
								let chunkLoadingValue;
								if (currentChunk) {
									const entryOptions = currentChunk.getEntryOptions();
									chunkLoadingValue =
										(entryOptions && entryOptions.chunkLoading) ||
										compilation.outputOptions.chunkLoading;
								} else {
									chunkLoadingValue = compilation.outputOptions.chunkLoading;
								}

								// add runtime requirements for ESM format
								if (chunkLoadingValue === "import") {
