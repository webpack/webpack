...
const schema = require("../schemas/plugins/HotModuleReplacementPlugin.json");

/** @typedef {import("../declarations/plugins/HotModuleReplacementPlugin").HotModuleReplacementPluginOptions} HotModuleReplacementPluginOptions */
...
class HotModuleReplacementPlugin {
	...
	/**
	 * @param {HotModuleReplacementPluginOptions=} options options object
	 */
	constructor(options = {}) {
		...
		this.multiStep = this.options.multiStep || false;
