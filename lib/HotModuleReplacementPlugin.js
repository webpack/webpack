...
import __CssModulesPlugin from "./css/CssModulesPlugin.js";
import ConstDependency from "./dependencies/ConstDependency.js";
import ImportMetaHotAcceptDependency from "./dependencies/ImportMetaHotAcceptDependency.js";
import ImportMetaHotDeclineDependency from "./dependencies/ImportMetaHotDeclineDependency.js";
import { isImportMetaFieldEnabled } from "./dependencies/ImportMetaPlugin.js";
import ModuleHotAcceptDependency from "./dependencies/ModuleHotAcceptDependency.js";
import ModuleHotDeclineDependency from "./dependencies/ModuleHotDeclineDependency.js";
import WebpackError from "./errors/WebpackError.js";
import HotModuleReplacementRuntimeModule from "./hmr/HotModuleReplacementRuntimeModule.js";
...
import TupleSet from "./util/TupleSet.js";
...
/** @typedef {import("./Compilation.js").Records} Records */
...
/** @typedef {import("./javascript/JavascriptParserHelpers.js").Range} Range */
				...
				compilation.hooks.processAssets.tap(
					...
					() => {
						...
						for (const key of Object.keys(records.chunkHashes)) {
							...
							const currentChunk = compilation.chunks
								.values()
								.find((chunk) => `${chunk.id}` === key);
							if (currentChunk) {
						...
						for (const {
							...
							if (
								old &&
								(!removedChunkIds.isSubsetOf(old.removedChunkIds) ||
									!removedModules.isSubsetOf(old.removedModules) ||
									!updatedChunkIds.isSubsetOf(old.updatedChunkIds) ||
									!forceLoadChunkIds.isSubsetOf(old.forceLoadChunkIds))
							) {
...
export { HotModuleReplacementPlugin as "module.exports" };
