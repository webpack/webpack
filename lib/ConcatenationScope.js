...
import { DEFAULT_EXPORT, NAMESPACE_OBJECT_EXPORT } from "./util/concatenate.js";
/** @typedef {import("./Chunk.js").default} Chunk */
/** @typedef {import("./Module.js").default} Module */
/** @typedef {import("./optimize/ConcatenatedModule.js").ConcatenatedModuleInfo} ConcatenatedModuleInfo */
/** @typedef {import("./optimize/ConcatenatedModule.js").ModuleInfo} ModuleInfo */
/** @typedef {import("./optimize/ConcatenatedModule.js").ExportName} Ids */
...
export default ConcatenationScope;

export { ConcatenationScope as "module.exports" };
